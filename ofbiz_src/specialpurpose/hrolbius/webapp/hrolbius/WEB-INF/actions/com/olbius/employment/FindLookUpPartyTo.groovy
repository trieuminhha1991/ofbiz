...
parameters.roleTypeIdTo = 'EMPLOYEE';

Map<String, Object> results = dispatcher.runSync("performFind", UtilMisc.toMap("entityName", "PartyRelationshipToAndPerson",
...
parameters.roleTypeId = 'EMPLOYEE';
parameters.partyTypeId = 'PERSON';
