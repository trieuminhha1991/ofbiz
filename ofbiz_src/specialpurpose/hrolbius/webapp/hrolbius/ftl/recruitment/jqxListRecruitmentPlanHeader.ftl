...
<#assign columnlist="{ text: '${uiLabelMap.Department}', datafield: 'partyId', editable: false, filter: deptColumnFilter, width: 200,
                     ...
                     { text: '${uiLabelMap.comment}', datafield: 'reason', editable: true, width: 150}
					 "/>
...
<@jqGrid id="jqxgrid" jqGridMinimumLibEnable="false" addType="popup" editable="true" addrefresh="true" filtersimplemode="true" addrow=addrow showtoolbar="true" clearfilteringbutton="true"
		 ...
		 updateUrl="jqxGeneralServicer?sname=updateRecruitmentPlanHeader&jqaction=U" editColumns="partyId;year;statusId;reason"
		 customcontrol1="icon-trash@${uiLabelMap.accDeleteSelectedRow}@javascript:void(0);@removeRPH()"
	/>
<#--=========================================================Create Context Menu ===============================================================-->
