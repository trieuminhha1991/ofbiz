		...
		<div class="row-fluid" >
    		<div class="span12">
    			<div class="span6">
					...
					<div class="control-group no-left-margin">
						<label class="control-label">${uiLabelMap.HumanResWeight}(kg):</label>
						<div class="controls">
							<div id="weight"></div>
						</div>
					</div>
					<div class="control-group no-left-margin">
						<label class="control-label">${uiLabelMap.finAccountName}:</label>
						<div class="controls">
    			...
    			<div class="span6">
					...
					<div class="control-group no-left-margin">
						<label class="control-label">${uiLabelMap.finAccountCode}:</label>
						<div class="controls">
							<input id="finAccountCode"></input>
						</div>
					</div>
				</div>
			</div>
