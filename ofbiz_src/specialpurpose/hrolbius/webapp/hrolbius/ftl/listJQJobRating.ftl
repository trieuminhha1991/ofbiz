...
<script type="text/javascript">
	  ...
	  $('#formAdd').jqxValidator({
                rules: [
	                       { input: '#jobRequirementAdd', message: '${StringUtil.wrapString(uiLabelMap.FieldRequired?default(''))}', action: 'blur', rule: function(){
	                       		...
	                       		var validate = valRequirement != null && (valRequirement.length > 12)  && valRequirement !=='undefined';
	                       		return validate;
	                       	}
	                       },
	                       { input: '#jobIntentAdd', message: '${StringUtil.wrapString(uiLabelMap.FieldRequired?default(''))}', action: 'blur', rule:function(){
	                       		...
	                       		return valjobIntent != null && (valjobIntent.length > 12) && valjobIntent !=='undefined';
	                       	}}
                       ]
           			 });
    ...
    $("#alterSave").click(function () {
    	if(!$('#formAdd').jqxValidator('validate')){
    	    $('#jobRequirementAdd').show();$('#jobIntentAdd').show();return false;}
    });
