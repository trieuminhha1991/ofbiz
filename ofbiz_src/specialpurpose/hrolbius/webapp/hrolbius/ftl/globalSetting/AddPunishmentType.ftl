<div id="${dataToggleModalId}" class="modal hide fade" tabindex="-1" >
	<div class="modal-header no-padding">
		<div class="table-header">
			...
			${uiLabelMap.CommonAdd} ${uiLabelMap.PunishmentType}
		</div>
	</div>	
		...
		<form action="<@ofbizUrl>${linkUrl}</@ofbizUrl>" id="${formId}" class="form-horizontal" method="post" name="${formId}">
			<div class="row-fluid">
				<div class="control-group no-left-margin">
					...
					<div class="controls">
						<input type="text" name="punishmentTypeId" class="required">
					</div>
				</div>					
				<div class="control-group no-left-margin">
				...
				<div class="control-group no-left-margin">
					<label class="control-label asterisk">${uiLabelMap.NumberRemindToWarning}</label>
					<div class="controls">
						<input type="text" name="numberRemindToWarning" class="required">
					</div>
				</div>
