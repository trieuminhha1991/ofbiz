<div id="${dataToggleModalId}" class="modal hide fade" tabindex="-1">
	<div class="modal-header no-padding">
		<div class="table-header">
			...
			${uiLabelMap.HROlbiusAddQualificationType}
		</div>
	</div>	
	<div class="modal-body no-padding">
		<form action="<@ofbizUrl>createQualificationType</@ofbizUrl>" id="AddSkillType" class="form-horizontal" method="post">
			<input type="hidden" name="parentTypeId" value="DEGREE">
			<div class="row-fluid">
				<div class="control-group no-left-margin">
					<label class="control-label">${uiLabelMap.CommonId}</label>
					<div class="controls">
						<input type="text" name="partyQualTypeId">
					</div>
				</div>
				<div class="control-group no-left-margin">
