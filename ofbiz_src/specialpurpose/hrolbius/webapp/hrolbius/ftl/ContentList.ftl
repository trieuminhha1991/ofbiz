...
under the License.
-->
  <div id="partyContentList" style="overflow-x:scroll;width:100%;display:inline-block;">
          ...
          <#list partyContent as pContent>
            ...
            <tr>
              ...
              <td>
                ...
                <form name="removePartyContent_${pContent_index}" method="post" action="<@ofbizUrl>removePartyContent/EmployeeProfile</@ofbizUrl>">
