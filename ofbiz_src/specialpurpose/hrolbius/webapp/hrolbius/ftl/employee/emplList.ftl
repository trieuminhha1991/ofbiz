...
<script type="text/javascript">
	...
	<#assign columnlist = "{text: '${uiLabelMap.EmployeeName}', datafield: 'partyName', width: 130, pinned: true},
						   {text: '${uiLabelMap.EmployeeId}', datafield: 'partyId', width: 100, pinned: true},
	...
	<div class="widget-body">
		...
		<div class="row-fluid">
			<@jqGrid url="" dataField=datafield columnlist=columnlist
				...
				editable="false" width="100%" filterable="false"
