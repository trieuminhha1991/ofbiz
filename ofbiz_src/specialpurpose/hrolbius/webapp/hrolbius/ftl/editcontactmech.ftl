...
<#if !mechMap.contactMech?exists>
  ...
  <#if !preContactMechTypeId?has_content>
    <h4 style="margin-top:20px;">${uiLabelMap.PartyCreateNewContact}</h4>
      ...
      <table class="basic-table" cellspacing="0">
        <tr>
          ...
          <td>
            ...
            <a href="javascript:document.createcontactmechform.submit()" class="btn btn-mini margin-bottom8 btn-info icon-ok open-sans">${uiLabelMap.CommonCreate}</a>
          </td>
        </tr>
      </table>
    </form>
...
<#if mechMap.contactMechTypeId?has_content>
  ...
  <#else>  
    <h4 style="margin-top:20px;">${uiLabelMap.PartyEditContactInformation}</h4>
    <div id="mech-purpose-types">
      <table class="basic-table" cellspacing="0">
          ...
          <td>
            <table class="basic-table" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="button-col">
                      <form name="deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}" method="post" action="<@ofbizUrl>deletePartyContactMechPurpose</@ofbizUrl>" >
                         ...
                         <a href="javascript:document.deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}.submit()" class="btn btn-small btn-info icon-trash open-sans">${uiLabelMap.CommonDelete}</a> 
                       </form>
                    </td>
                  </tr>
                </#list>
              ...
              <tr>
                ...
                <td><a class="btn btn-small btn-info icon-ok open-sans" href="javascript:document.newpurposeform.submit()">${uiLabelMap.PartyAddPurpose}</a></td>
              </tr>
            </table>
          </tr>
      </#if>
  ...
  <div class="button-bar" style="margin-top: 15px;margin-left: 15px;">
    <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn btn-small btn-info icon-arrow-left open-sans"> ${uiLabelMap.CommonGoBack}</a>
    <a href="javascript:document.editcontactmechform.submit()" class="btn btn-small btn-info icon-save open-sans">${uiLabelMap.CommonSave}</a>
  </div>
<#else>
  <a class="btn btn-small btn-info icon-arrow-left open-sans" href="<@ofbizUrl>backHome</@ofbizUrl>">${uiLabelMap.CommonGoBack}</a>
</#if>
