 ...
 * under the License.
 */
package org.ofbiz.storebase.product;
...
import org.ofbiz.storebase.product.ProductSearch.CategoryConstraint;
import org.ofbiz.storebase.product.ProductSearch.FeatureConstraint;
import org.ofbiz.storebase.product.ProductSearch.KeywordConstraint;
import org.ofbiz.storebase.product.ProductSearch.ProductSearchConstraint;
import org.ofbiz.storebase.product.ProductSearch.ProductSearchContext;
import org.ofbiz.storebase.product.ProductSearch.ResultSortOrder;
import org.ofbiz.storebase.product.ProductSearch.SortKeywordRelevancy;
	...
	public static void processSearchParameters(Map<String, Object> parameters,
		...
		if (UtilValidate.isNotEmpty(parameters.get("SEARCH_CATALOG_ID"))) {
			...
			if (searchCatalogId != null
				...
				String topCategory = CatalogWorker.getCatalogTopCategoryId(
						request, searchCatalogId);
				if (UtilValidate.isEmpty(topCategory)) {
					topCategory = CatalogWorker.getCatalogTopEbayCategoryId(
							request, searchCatalogId);
				}
