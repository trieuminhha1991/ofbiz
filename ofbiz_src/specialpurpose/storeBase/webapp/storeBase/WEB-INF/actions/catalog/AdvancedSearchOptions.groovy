...
prodCategoryId = request.getAttribute("productCategoryId") ? request.getAttribute("productCategoryId"):searchCategoryId;
context.test = prodCategoryId;
searchCategory = delegator.findOne("ProductCategory", [productCategoryId : prodCategoryId], false);
productFeaturesByTypeMap = ParametricSearch.makeCategoryFeatureLists(prodCategoryId, delegator); //searchCategory
