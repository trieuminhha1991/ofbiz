...
<#assign columnlist = "{text: '${StringUtil.wrapString(uiLabelMap.DAStatementId)}', dataField: 'salesGroupId', width: '14%',
							cellsrenderer: function(row, colum, value) {
	                        	...
	                        	if (data) {
	                        		...
	                        		return \"<span><a href='/delys/control/viewSalesStatementGroup?customTimePeriodId=\" + data.customTimePeriodId + \"&salesTypeId=\" + data.salesTypeId + \"&statusId=\" + data.statusId + \"'>\" + data.periodName + ' - ${uiLabelMap.DAYear} ' + fromDate.getFullYear() + \"</a></span>\";
	                        	}
	                        	return \"<span><a href='/delys/control/viewSalesStatement?customTimePeriodId=\" + data.customTimePeriodId + \"&salesTypeId=\" + data.salesTypeId + \"&statusId=\" + data.statusId + \"'>\" + data.periodName + \"</a></span>\";
	                        }
						}, 
