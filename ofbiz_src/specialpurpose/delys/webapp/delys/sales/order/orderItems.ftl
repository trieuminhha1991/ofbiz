                        ...
                        <#if shipmentReceipts?has_content>
                            <#list shipmentReceipts as shipmentReceipt>
                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    ...
                                    <td align="center">
                                        ${shipmentReceipt.quantityAccepted?string.number}&nbsp;/&nbsp;${shipmentReceipt.quantityRejected?default(0)?string.number}&nbsp;/&nbsp;${shipmentReceipt.quantityQualityAssurance?default(0)?string.number}
                                    </td>
                                    <td colspan="4">&nbsp;</td>
                                </tr>
                            </#list>
