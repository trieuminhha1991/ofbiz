						...
						<div class="span12">
							...
							<span class="help-inline tooltipob">
								<a href="<@ofbizUrl>LookupBulkAddProductsAndCatalog</@ofbizUrl>" class="btn btn-mini btn-primary" tabindex="-1" style="margin-bottom:5px">
									${uiLabelMap.DAQuickLookup} <i class="fa-plus open-sans icon-on-right"></i>
								</a>
							</span>
							<span class="help-inline tooltipob">
								<a href="<@ofbizUrl>LookupBulkAddOrderItem2</@ofbizUrl>" class="btn btn-mini btn-primary" tabindex="-1" style="margin-bottom:5px">
