...
<#if security.hasEntityPermission("ORDERMGR", "_CREATE", session)>
	...
	<div class="widget-body">
		<div class="widget-main">
			<div class="row-fluid">
				<form class="form-horizontal basic-custom-form" id="initOrderEntry" name="initOrderEntry" method="post" action="<@ofbizUrl>initOrderEntry</@ofbizUrl>" style="display: block;">
