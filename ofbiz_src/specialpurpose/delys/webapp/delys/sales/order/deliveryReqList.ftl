				...
				<div class="form-horizontal basic-custom-form form-decrease-padding" style="display: block;"> 
        			<table class="table table-striped table-bordered table-hover dataTable" cellspacing='0' style="width: 100%; margin-bottom: 2%;">
			          	...
			          	<tr class="header-row">
				            ...
				            <th>${uiLabelMap.DADeliveryProposalId}</th>
				            <th>${uiLabelMap.DADescription}</th>
				            <th>${uiLabelMap.DARequirementStartDate}</th>
				            <th>${uiLabelMap.DARequiredByDate}</th>
				            <th>${uiLabelMap.DAStatus}</th>
			          	</tr>
			          	</thead>
          				<#list deliveryReqList as deliveryReqItem>
            				...
            				<tr>
            					<td>${deliveryReqItem_index + 1}</td>
				              	<td><a href="<@ofbizUrl>viewDeliveryProposal?requirementId=${deliveryReqItem.requirementId}</@ofbizUrl>">${deliveryReqItem.requirementId}</a></td>
