...
<style type="text/css">
	.screenlet-border-title {
		border: 1px solid #ddd;
		margin-top:25px;
	}
	.screenlet-border-title .screenlet-title-bar {
		margin-top:-10px;
		font-size:14px;
		font-weight:bold;
		padding: 0 10px;
	...
	.screenlet-border-title .screenlet-title-bar span {
		padding: 0 5px;
		background-color:#fff;
	}
</style>
<#if orderHeader?has_content>
	<div class="screenlet screenlet-border-title">
	  	<div class="screenlet-title-bar">
	    	<span>${uiLabelMap.DAAddToOrder}</span>
	  	</div>
	  	<div class="screenlet-body">
        	<form method="post" action="<@ofbizUrl>appendItemToOrder</@ofbizUrl>" name="appendItemForm">
	            ...
	            <table class="basic-table" cellspacing="0">
	                ...
	                <tr>
	                  	<td class="label">&nbsp;</td>
	                  	<td><input class=" btn btn-small btn-primary open-sans icon-plus-sign" type="submit" value="${uiLabelMap.DAAddToOrder}"/></td>
	                </tr>
	            </table>
	        </form>
	    </div>
