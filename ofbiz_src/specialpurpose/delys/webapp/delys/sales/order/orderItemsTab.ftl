<#if orderHeader?has_content>
	<div id="items-tab" class="tab-pane">
        ...
        <table class="table table-striped table-bordered table-hover dataTable" cellspacing='0' style="width: auto;">
            <thead>
                ...
                <#list orderItemList as orderItem>
                    ...
                    <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                        ...
                        <#if productId?exists && productId == "shoppingcart.CommentLine">
                            <td colspan="7" valign="top" class="border-top-2px"> &gt;&gt; ${orderItem.itemDescription}</td>
                        <#else>
                            <td colspan="7" class="border-top-2px">
                                <div class="order-item-description" style="font-weight:bold">
                                    ...
                                    &nbsp;
                                    <a href="<@ofbizUrl>editProduct</@ofbizUrl>?productId=${productId}${externalKeyParam}" target="_blank">
                                    	<i class="icon-pencil open-sans"></i>
                                	</a>
                    ...
                    <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                        ...
                        <#else>
                                ...
                                <#if productId?exists>
                                    ...
                                    <#if (orderHeader.statusId != "ORDER_COMPLETED") && availableToPromiseMap?exists && quantityOnHandMap?exists && availableToPromiseMap.get(productId)?exists && quantityOnHandMap.get(productId)?exists>
                                        ...
                                        <#if unplannedQuantity < 0><#assign unplannedQuantity = 0></#if>
                                            <table cellspacing="0" cellpadding="0" border="0" class="no-top-margin">
                                                <#--<tr>
                            ...
                            <#-- QUANTITY -->
                            <td align="right" class="align-left" valign="top" nowrap="nowrap">
                            	<div>
                            		<span>${uiLabelMap.DAExpireDate}: </span>
                            		<#if orderItem.expireDate?exists && orderItem.expireDate?has_content>${Static["org.ofbiz.base.util.UtilFormatOut"].formatDateTime(orderItem.expireDate, "dd/MM/yyyy - HH:mm:ss:SSS", locale, timeZone)!}</#if>
                            	</div>
                                ...
                                <div class="screenlet order-item-quantity">
                                    <div class="screenlet-body">
                                    	...
                                    	<h6>${uiLabelMap.DACalculateByBasicUnit}: <#if product?exists>${product.quantityUomId?if_exists}</#if></h6>
                                        <table>
                                            <tr valign="top">
                                        ...
                                        <hr style="margin:5px 0"/>
                                        <h6>${uiLabelMap.DACalculateByDerivedUnit}: ${orderItem.quantityUomId?if_exists}</h6>
                            ...
                            <td align="right" class="align-right" valign="top" nowrap="nowrap">
                                ...
                                <#if orderItem.alternativeUnitPrice?exists><hr style="margin:10px 0 5px"/><@ofbizCurrency amount=orderItem.alternativeUnitPrice isoCode=currencyUomId/></#if>
                            </td>
                            <td align="right" class="align-right" valign="top" nowrap="nowrap">
            ...
            <tr>
                <td align="right" class="align-right" colspan="5">
                    <span><b>${uiLabelMap.OrderTotalOtherOrderAdjustments}</b></span>
                </td>
                <td align="right" class="align-right" nowrap="nowrap">
