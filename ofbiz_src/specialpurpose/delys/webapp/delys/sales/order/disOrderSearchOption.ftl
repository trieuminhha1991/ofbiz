...
<div id="orderLookup" >
	<div class="row-fluid">
    	<div class="widget-main"><#--orderListSmOrigin-->
      		<form method="post" name="findorder" style="margin: -12px !important" action="<#if targetOrderSearch?exists><#if targetOrderSearch == "orderListSm"><@ofbizUrl>findSalesOrderListDis</@ofbizUrl><#elseif targetOrderSearch == "orderListPurchaseDis"><@ofbizUrl>findPurcharseOrderListDis</@ofbizUrl><#elseif targetOrderSearch == "orderListSalesDis"><@ofbizUrl>findSalesOrderListDis</@ofbizUrl></#if><#else><@ofbizUrl>orderListOrigin</@ofbizUrl></#if>">
