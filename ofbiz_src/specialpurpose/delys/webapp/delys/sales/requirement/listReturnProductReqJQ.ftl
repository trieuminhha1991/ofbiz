...
<script type="text/javascript">
	...
	$('#alterpopupWindow').jqxValidator({
		rules: [
			...
			{input: '#requiredByDateAdd', message : '${uiLabelMap.DArequiredValueGreaterThanFromDate}', action: 'blur,change', rule : function(input,commit){
				if($('#requiredByDateAdd').jqxDateTimeInput('getDate').getTime() < $('#requirementStartDateAdd').jqxDateTimeInput('getDate').getTime()){
					return false;
				}
				return true;
			}}
