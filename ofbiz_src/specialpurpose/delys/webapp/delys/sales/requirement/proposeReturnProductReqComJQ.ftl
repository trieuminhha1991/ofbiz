...
<script type="text/javascript">
	...
	<#list statusList as statusItem>
		<#if isSalesAdmin>
			<#assign statusIdVar = "REREQCOM_APPROVED"/>
			<#if ("REREQCOM_APPROVED" == statusItem.statusId || "REREQCOM_PROPOSED" == statusItem.statusId || "REREQCOM_REJECTED" == statusItem.statusId)>
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListRequirementAndItemDetail&requirementTypeId=RETURN_PRODCOM_REQ&statusId=${statusIdVar?if_exists}" dataField=dataField columnlist=columnlist filterable="true" clearfilteringbutton="true"
		 ...
		 customcontrol1="fa fa-arrow-left@${uiLabelMap.DABack}@listReturnProductReqCom" 
		 />
<br/>
<div class="row-fluid">
