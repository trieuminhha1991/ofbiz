...
<div>
   	<ul class="unstyled spaced">
		<li style="display: inline-block;"><a class="btn btn-mini btn-primary" href="<@ofbizUrl>emptyCartPayPromo</@ofbizUrl>">${uiLabelMap.DAClearOrder}</a></li>
      	...
      	<#else>
	        <#if shoppingCart.size() = 0>
	        	<li style="display: inline-block;" class="disabled"><a class="btn btn-mini dislink" href="#">${uiLabelMap.DAFinalizeOrder}</a></li>
	          	...
	          	-->
	        <#else>
	          	<li style="display: inline-block;"><a class="btn btn-mini btn-primary" href="<@ofbizUrl>quickCheckoutPayPromo</@ofbizUrl>">${uiLabelMap.DAQuickFinalizeOrder}</a></li>
