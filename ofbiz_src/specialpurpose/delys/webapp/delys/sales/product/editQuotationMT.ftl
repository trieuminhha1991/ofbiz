			...
			<div class="step-content row-fluid position-relative">
				...
				<div class="step-pane" id="step2">
					<form class="form-horizontal basic-custom-form form-decrease-padding" id="createQuotationRule" name="createQuotationRule" method="post" action="<@ofbizUrl>createQuotationRule</@ofbizUrl>">
						<div class="row" id="addQuotationItemToList">
							<div class="span6">
								...
								<div class="control-group">
									<label class="control-label" for="priceToDist">${uiLabelMap.DAPriceToCustomer} <span style="color:red">*</span>:</label>
									<div class="controls">
										<div class="span12">
							...
							<div class="span6">
								...
								<div class="control-group">
									<label class="control-label" for="priceToConsumer">${uiLabelMap.DAPriceToConsumer}:</label>
									<div class="controls">
										<div class="span12">
							...
							<#--
							Gia ban den khach hang *:
							Gia ban cho nguoi tieu dung:
							-->
					...
					<div id="list-product-price-rules">
						${screens.render('component://delys/widget/sales/ProductScreens.xml#ViewQuotationRuleAjaxMT')}
					</div>
				</div><!--.step2-->
			</div>
			...
			<div class="row-fluid" id="updateQuotationItemToList">
				<div class="span12">
					<div class="control-group" style="margin:0 !important; font-size:9pt;">
						...
						<div class="control-group">
							<label class="control-label" for="update_priceToDist">${uiLabelMap.DAPriceToCustomer} <span style="color:red">*</span>:</label>
							<div class="controls">
								<div class="span12">
						...
						<div class="control-group">
							<label class="control-label" for="update_priceToConsumer">${uiLabelMap.DAPriceToConsumer}:</label>
							<div class="controls">
								<div class="span12">
...
function addProductPriceRule() {
	if(!$('#createQuotationRule').valid()) {
		...
		var param = 'productQuotationId=' + $('#productQuotationId').val() + '&inputCategory=' + $('#inputCategory').val() + '&productId=' + $('input[name="productId"]').val() + '&priceToDist='
					 + $('#priceToDist').val() + '&priceToConsumer=' + $('#priceToConsumer').val();
		jQuery.ajax({
			url: 'createQuotationRuleAjaxMT',
			data: param,
			type: 'post',
			async: false,
			success: function(data) {
