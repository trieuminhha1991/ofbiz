...
<div class="row-fluid">				
					...
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th class="center" style="width:65px">${uiLabelMap.DAMateBy}</th>
								<th class="center">${uiLabelMap.DATax}</th>
								<th class="center" style="width:100px">${uiLabelMap.DAPacking}</th>
								<th class="center" style="width:20px">${uiLabelMap.DAQC}</th>
								...
								<th class="center" style="width:80px">${uiLabelMap.DAPriceToConsumer}</th>
							</tr>
						</thead>
						<tbody>
						<#list listProductQuotationRuleData as quotationRule>
							<tr>
								...
								<td>${quotationRule.barcode?if_exists}</td>
								<td>${quotationRule.productName?if_exists}</td>
								<td>${quotationRule.brandName?if_exists}</td>
								<td style="text-align:right"><#if quotationRule.taxPercentage?exists>${quotationRule.taxPercentage}%</#if></td>
								<td class="center"><#if quotationRule.productWeightStr?exists>${quotationRule.productWeightStr}</#if></td>
								<td><#if quotationRule.productQC?exists>${quotationRule.productQC}</#if></td>
								<td class="center"><#if quotationRule.productQuantityPerTray?exists>${quotationRule.productQuantityPerTray}</#if></td>
			...
			<div style="text-align:right">
				...
				<#if security.hasEntityPermission("QUOTATION", "_THRUDATE", session)>
