<script type="text/javascript">
	...
	var returnHeaderTypeData = [
	<#if returnHeaderTypeList?exists>
...
<#assign columnlist= columnlist + "
				 ...
				 "/>
<#--
//				 	{text: '${uiLabelMap.Receiver}', dataField: 'toPartyId', width: '13%', filterable: false, sortable: false, align: 'center', 
//				 		cellsrenderer: function(row, column, value){
//							var data = $('#jqxgrid').jqxGrid('getrowdata', row);
//							return '<span title='+data.toPartyName+'>'+data.toPartyName+'</span>';
//						}	
//				 	},
-->
