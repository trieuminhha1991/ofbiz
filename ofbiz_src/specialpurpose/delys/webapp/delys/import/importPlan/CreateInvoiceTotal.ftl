...
<div class="row-fluid">
		<div class="span12 no-left-margin">
 			...
 			<div class="span2"><img src="/delys/images/logo/3D_Zott_Logo_en.png"></div>
		</div>
</div>
...
Singapore 228208
Delys Trading Development
Investment Joint Stock Company
N6E Trung Hoa Nhan Chinh
Thanh Xuan District
00000 HANOI
VIETNAM
</textarea>
			...
			<div class="span11 no-left-margin">
					<div class="row-fluid">
						<div class="span12 no-left-margin">
								...
								<div class="span2"><span>Delys Trading Development Investment Joint Stock Company N6E Trung Hoa Nhanh Chinh Thanh Xuan District, 00000 HANOI VIETNAM</span></div>
...
<input type="button" name='CreatePDF' value="CreatePDF" >
</form>
<style>
.hr-no-margin {
	  margin: 0px 0;
...
//		locale = '${locale}';
	...
	$("input[name='CreatePDF']").click(function(){
		...
		$("input[name='CreatePDF']").hide( "slow", function() {
