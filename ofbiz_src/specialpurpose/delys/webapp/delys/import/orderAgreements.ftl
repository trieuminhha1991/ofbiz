...
<form method="post" name="agreementForm" action="<@ofbizUrl>${parameters.actionForm}</@ofbizUrl>">
<div class="widget-box no-border-bottom transparent">
		<div class="widget-header widget-header-small header-color-blue2">
  			<h4>${uiLabelMap.CommonEdit} ${uiLabelMap.OrderInfo}</h4>
  	        </div>
        </div>
  <div class="">
    <table>
      ...
      <tr>
        ...
        <td align='right' valign='top' nowrap="nowrap">
          <div class='tableheadtext margin-top-nav-10'>
      ...
      <tr>
        ...
        <td align='right' valign='middle' class='tableheadtext' nowrap="nowrap">
           <div class="margin-top-nav-10">${uiLabelMap.OrderOrderName}</div>
        </td>
        <td>&nbsp;</td>
        <td align='left'>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align='right' valign='middle' class='tableheadtext' nowrap="nowrap">
          <div class=" margin-top-nav-10">${uiLabelMap.OrderPONumber}</div>
        </td>
        <td>&nbsp;</td>
        <td align='left'>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="right">
          <div class="margin-top-nav-5">${uiLabelMap.WorkEffortWorkEffortId}</div>
        </td>
        <td>&nbsp;</td>
        <td>
      ...
      <#if cart.getOrderType() == "PURCHASE_ORDER">
		...
		<tr>
         ...
         <td>
          ...
          <td>&nbsp;</td>
          <td>
          	<a class="btn btn-small btn-primary" style="margin-bottom: 5px" href="javascript:document.agreementForm.submit()">${uiLabelMap.CommonContinue}
