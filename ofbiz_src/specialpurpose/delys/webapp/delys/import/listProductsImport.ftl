...
<#assign columnlist="
		...
		{ text: '${StringUtil.wrapString(uiLabelMap.FormFieldTitle_minimumOrderQuantity)}', dataField: 'minimumOrderQuantity', editable: false, align: 'center', width: 120, columntype:'numberinput', cellsalign: 'right', filtertype: 'number',
		...
		{ text: '${StringUtil.wrapString(uiLabelMap.FormFieldTitle_lastPrice)}', dataField: 'lastPrice', align: 'center', width: 120, columntype:'numberinput', cellsalign: 'right', filtertype: 'number',
			createeditor: function(row, column, editor){
				...
				return { result: false, message: '${uiLabelMap.PriceNotValid}' };
			}
		},
...
<@jqGrid filtersimplemode="true" addType="popup" dataField=dataField columnlist=columnlist clearfilteringbutton="true" viewSize="15"
		showtoolbar="true" addrow="true" deleterow="true" alternativeAddPopup="alterpopupWindow" editable="true" editrefresh="true"
		url="jqxGeneralServicer?sname=JQGetListProductsSupplier" addrefresh="true"
		updateUrl="jqxGeneralServicer?sname=updateSupplierProduct&jqaction=U"
...
<script>
	...
	$("#lastPrice1").jqxNumberInput({inputMode: 'simple', spinButtons: true, theme: "olbius", width: '200px', decimalDigits: 3, min: 0 });
	$("#shippingPrice1").jqxNumberInput({inputMode: 'simple', spinButtons: true, theme: "olbius", width: '200px', decimalDigits: 3, min: 0 });
	...
	$("#alterpopupWindow").jqxWindow({ theme:'olbius',
        width: 1150, maxWidth: 1000, height: 420, resizable: false,  isModal: true, autoOpen: false, cancelButton: $("#alterCancel"), modalOpacity: 0.7
    });
