...
<#if party != "IMPORT_ADMIN">
	<#assign heightDetail = 219 />
	<#assign heightRow = 237 />
</#if>
...
<#assign columnlist="	{
						...
						{ text: '${uiLabelMap.billId}', datafield: 'billId', width: '150px', editable: false, filterable: false},
					 ...
					 "/>
<@jqGrid filtersimplemode="true" addType="" initrowdetails = "true" rowsheight="30" dataField=dataField initrowdetailsDetail=initrowdetailsDetail editmode="selectedrow" editable="true" columnlist=columnlist clearfilteringbutton="false" showtoolbar="true" addrow="false"
		 	url="jqxGeneralServicer?sname=JQGetBillForAcc&party=${party}" rowdetailsheight = "${heightRow}"
		 />
