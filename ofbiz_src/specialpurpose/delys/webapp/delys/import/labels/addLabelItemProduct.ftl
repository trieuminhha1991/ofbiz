...
<div class="row-fluid">
				...
				<div class="step-content row-fluid position-relative">
					...
					<div class='span11'>
						...
						<div class="row-fluid">
			        		<div class="span12">
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.ProductProductId}<span style="color:red;"> *</span></div>
			    	 			<div class="span3"><input type="text" name="txtProductId" id="txtProductId" /></div>
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.productCategoryIdAdd}<span style="color:red;"> *</span></div>
		    	 		...
		    	 		<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.ProductInternalName}<span style="color:red;"> *</span></div>
			    	 			<div class="span3"><input type="text" name="txtInternalName" id="txtInternalName" /></div>
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.ProductProductName}<span style="color:red;"> *</span></div>
		    	 		...
		    	 		<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.ProductBrandName}<span style="color:red;"> *</span></div>
		    	 		...
		    	 		<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.ProductAvailableFromDate}<span style="color:red;"> *</span></div>
			    	 			<div class="span3"><div id="txtFromDate" ></div></div>
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.ProductAvailableThruDate}</div>
		    	 		...
		    	 		<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.description}</div>
					...
					<div class="step-pane" id="step2">
						<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.Weight}<span style="color:red;"> *</span></div>
			    	 			<div class="span3"><div id="txtWeight"></div></div>
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.NetWeight}<span style="color:red;"> *</span></div>
		    	 		...
		    	 		<div class="row-fluid">
			    	 		<div class="span12" style="margin-top:8px;">
				    	 		<div class="span3" style="text-align: right;">${uiLabelMap.ProductWeightUomId}<span style="color:red;"> *</span></div>
			    	 			<div class="span3"><div id="txtWeightUomId"></div></div>
			    	 			<div class="span3" style="text-align: right;">${uiLabelMap.UnitLess}<span style="color:red;"> *</span></div>
				...
				<hr />
				<div class="row-fluid">
					<button class="btn btn-prev" id="btnPreveiw"><i class="icon-arrow-left"></i> Prev</button>
					<button class="btn btn-success btn-next" data-last="Finish " id="btnNext">Next <i class="icon-arrow-right icon-on-right"></i></button>
				</div>
			</div>
...
$("#txtWeight").jqxNumberInput({ theme: 'olbius', width: 218, height: 30, inputMode: 'simple', spinButtons: true, decimalDigits: 6 });
$("#txtProductWeight").jqxNumberInput({ theme: 'olbius', width: 218, height: 30, inputMode: 'simple', spinButtons: true, decimalDigits: 6 });
...
$('#step2').jqxValidator({
    rules: [
				{ input: '#txtWeight', message: '${StringUtil.wrapString(uiLabelMap.NotAllowEmpty)}', action: 'valueChanged', 
					rule: function (input, commit) {
				...
				{ input: '#txtProductWeight', message: '${StringUtil.wrapString(uiLabelMap.NotAllowEmpty)}', action: 'valueChanged', 
					rule: function (input, commit) {
