...
<#assign columnlist="{ text: '${uiLabelMap.description}', datafield: 'description', width:250},
					...
					"/>	
<@jqGrid url="jqxGeneralServicer?organizationPartyId=${parameters.organizationPartyId}&sname=JQGetListGLAccountItemTypeSale" dataField=dataField columnlist=columnlist showtoolbar="true" editable="false"
