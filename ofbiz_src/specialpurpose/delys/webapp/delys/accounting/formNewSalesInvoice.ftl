...
<script src="/delys/images/js/generalUtils.js"></script>
    <form method="post" action="<@ofbizUrl>accArcreateInvoice</@ofbizUrl>" id="NewPurchaseInvoice" class="basic-form form-horizontal"  name="NewPurchaseInvoice" novalidate="novalidate">
        <div class="row-fluid">
            ...
            <input type="hidden" name="partyIdFrom"  id="NewPurchaseInvoice_organizationPartyId">
            <input type="hidden" name="partyId"  id="NewPurchaseInvoice_partyIdTo">
			...
			<div class="span12">
				...
				<div class="row-fluid margin-bottom10">
					<div class="span5 align-right ">
						 <label class="asterisk" for="NewPurchaseInvoice_organizationPartyIdShow" id="NewPurchaseInvoice_organizationPartyIdShow_title">${uiLabelMap.CompanyAndUnit}</label>  
					</div>
					<div class="span7">
				...
				<div class="row-fluid margin-bottom10">
					<div class="span5 align-right" >
						  <label class="asterisk" for="NewPurchaseInvoice_partyIdFromdShow" id="NewPurchaseInvoice_partyIdFromdShow_title">${uiLabelMap.Customer}</label> 
					</div>
					<div class="span7">
						<@htmlTemplate.lookupField name="partyIdFromdShow" id="partyIdFromdShow" value='' width="900" height="600"
							formName="NewPurchaseInvoice" fieldFormName="LookupJQPartyName" title="${uiLabelMap.CommonSearch} ${uiLabelMap.Customer}" />
					</div>
				</div>
			</div>
...
<script type="text/javascript">
    <#assign invoiceType= delegator.findList("InvoiceType", Static["org.ofbiz.entity.condition.EntityCondition"].makeCondition("parentTypeId","SALES_INVOICE"),null,null,null,false)/>
	...
	$("#commSave").click(function(){
		...
		var partyIdTo = $('#0_lookupId_partyIdFromdShow').val();
		if(partyIdTo){
			$('#NewPurchaseInvoice_partyIdTo').val(partyIdTo);
		};
