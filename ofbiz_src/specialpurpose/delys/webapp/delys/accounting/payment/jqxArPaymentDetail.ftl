					...
					<div class="row-fluid">
						...
						<div class="span2" style="height:34px; text-align:right">
							<#if payment.statusId == 'PMNT_NOT_PAID'>
								<a href="javascript:document.PaymentReceive.submit()" data-rel="tooltip" title="" data-placement="bottom" class="button-action" data-original-title="${StringUtil.wrapString(uiLabelMap.CommonReceive)}"><i class="fa fa-gift"></i></a>
							  	<form name="PaymentReceive" method="post" action="accApsetPaymentStatus" style="position:absolute;">
							...
							<#elseif payment.statusId == 'PMNT_RECEIVED'>
								<a href="javascript:document.PaymentConfirm.submit()" data-rel="tooltip" title="" data-placement="bottom" class="button-action" data-original-title="${StringUtil.wrapString(uiLabelMap.CommonConfirm)}"><i class="fa fa-check-circle"></i></a>
