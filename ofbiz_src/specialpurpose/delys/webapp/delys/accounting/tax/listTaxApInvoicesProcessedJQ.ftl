...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListTaxAPInvoiceProcessed" dataField=dataField columnlist=columnlist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup" editable="true" editmode="singlecell" defaultSortColumn ="invoiceDate" sortdirection="desc" selectionmode="checkbox"
		 updateUrl="jqxGeneralServicer?sname=updateTaxAPInvoiceProcessed&jqaction=U" editColumns="invoiceId" ulistname="listInvoiceId" updatelist="true"
