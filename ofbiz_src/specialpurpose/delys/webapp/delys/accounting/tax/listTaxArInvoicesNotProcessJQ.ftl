...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListTaxARInvoiceNotProcess" dataField=dataField columnlist=columnlist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup" editable="true" editmode="singlecell" defaultSortColumn ="invoiceDate" sortdirection="desc" selectionmode="checkbox"
		 updateUrl="jqxGeneralServicer?sname=updateTaxARInvoiceNotProcess&jqaction=U" editColumns="invoiceId"  editColumns="invoiceId" ulistname="listInvoiceId" updatelist="true"
