...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListTaxARInvoiceProcessed" dataField=dataField columnlist=columnlist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup" editable="true" editmode="singlecell" defaultSortColumn ="invoiceDate" sortdirection="desc" selectionmode="checkbox"
		 updateUrl="jqxGeneralServicer?sname=updateTaxARInvoiceProcessed&jqaction=U" editColumns="invoiceId" ulistname="listInvoiceId" updatelist="true"
