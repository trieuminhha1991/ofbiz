...
<#assign columnlist="{ text: '${uiLabelMap.accSTT}', width:100, datafield: 'invoiceSeqId'},
					 ...
					 { text: '${uiLabelMap.accFromParty}', width:500, datafield: 'partyId', cellsrenderer:
					 	function(row, colum, value){
					 		var data = $('#jqxgrid').jqxGrid('getrowdata', row);
					 ...
					 { text: '${uiLabelMap.accApPartyTaxId}', width:150, datafield: 'partyTaxId'},
					 { text: '${uiLabelMap.accProduct}', width:400, datafield: 'productId', cellsrenderer:linkProductrenderer},
					  { text: '${uiLabelMap.accTotalNoTax}', width:250, datafield: 'totalNoTax'},
					   { text: '${uiLabelMap.accTaxPercentage}', width:100, datafield: 'taxPercentage'},
					    { text: '${uiLabelMap.accTotalTax}', width:250, datafield: 'totalTax'},
					 { text: '${uiLabelMap.accTaxDescription}', width:200, datafield: 'description'},
					 { text: '${uiLabelMap.accConditionType}', width:200, datafield: 'conditionType'}"
					 />	
<#assign columngrouplist = "{ text: '${uiLabelMap.accApInvoice}', align: 'center', name: 'InvoiceDetails' }" />					 	
<@jqGridMinimumLib/>
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListTaxAPInvoice" dataField=dataField columnlist=columnlist columngrouplist=columngrouplist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup" groupable="true" groups="conditionType" groupsexpanded="true" defaultSortColumn ="conditionType;taxPercentage"
