 <#assign columnlist="{ text: '${uiLabelMap.acctgTransId}', dataField: 'acctgTransId', width: 150},
		     		 ...
		     		 { text: '${uiLabelMap.accountName}', dataField: 'accountName', width: 250 },
                     ...
                     { text: '${uiLabelMap.paymentId}', dataField: 'paymentId', width: 150, 
                     	cellsrenderer: function(row, colum, value){
                    		return \"<div class='custom-cell-grid'><a href='accAppaymentOverview?paymentId=\" + value + \"'>\" + value + \"</div>\";
	                    }},
...
<@jqGrid url="jqxGeneralServicer?invoiceId=${parameters.invoiceId}&sname=JQListAPAcctgTransAndEntries" dataField=dataField columnlist=columnlist filterable="true" filtersimplemode="false"
		 id="tranentry" customTitleProperties="${uiLabelMap.AccountingTransactions}"/>
