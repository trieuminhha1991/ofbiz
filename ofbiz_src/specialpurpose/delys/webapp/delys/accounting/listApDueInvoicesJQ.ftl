...
<#assign columnlist="{ text: '${uiLabelMap.FormFieldTitle_invoiceId}', width:100, datafield: 'invoiceId', cellsrenderer:
                     	 function(row, colum, value)
                        {
                        	...
                        	return \"<span><a href='accApinvoiceOverviewGlobal?invoiceId=\" + data.invoiceId + \"'>\" + data.invoiceId + \"</a></span>\";
                        }},
					 ...
					 { text: '${uiLabelMap.FormFieldTitle_amountToApply}', filterable: false, width:200, datafield: 'amountToApply', cellsrenderer:
					 	function(row, colum, value){
					 		var data = $('#jqxgrid').jqxGrid('getrowdata', row);
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListAPDueInvoice" dataField=dataField columnlist=columnlist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup"
		 ...
		 addColumns="invoiceId" showtoolbar="false" alternativeAddPopup="alterpopupWindow" usecurrencyfunction="true" autorowheight="true" viewSize="5"/>
