...
<@jqGrid  filterable="true" filtersimplemode="true" addrefresh="true" addType="popup" dataField=dataField columnlist=columnlist clearfilteringbutton="true" showtoolbar="true" addrow="true" deleterow="true" alternativeAddPopup="alterpopupWindow" editable="false" jqGridMinimumLibEnable="false"
