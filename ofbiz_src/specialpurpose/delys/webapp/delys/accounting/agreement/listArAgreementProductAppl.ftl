...
<#assign columnlist="{ text: '${uiLabelMap.accProductName}', datafield: 'productId', width: '60%', editable: false, 
					 ...
					 "/>
<@jqGrid filtersimplemode="false" addType="popup" dataField=dataField columnlist=columnlist addrefresh="true" clearfilteringbutton="true" showtoolbar="true" addrow="true" deleterow="true" alternativeAddPopup="alterpopupWindow" editable="true"
