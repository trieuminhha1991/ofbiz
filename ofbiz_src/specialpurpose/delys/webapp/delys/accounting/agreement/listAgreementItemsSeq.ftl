...
<#assign columnlist="{ text: '${uiLabelMap.SequenceId}', datafield: 'agreementItemSeqId', editable: false, width: '10%',
					 	cellsrenderer: function(row, colum, value){
        					...
        					return '<a style = \"margin-left: 10px\" href=' + 'EditAgreementItem?agreementId=' + data.agreementId + '&agreementItemSeqId=' + data.agreementItemSeqId +  '>' +  data.agreementItemSeqId + '</a>'
					 	}
					 },
