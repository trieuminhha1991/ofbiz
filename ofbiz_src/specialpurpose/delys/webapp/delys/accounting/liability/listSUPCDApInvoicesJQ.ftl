...
<div id="jqxwindowpartyIdFrom" class='hide'>
	<div>${uiLabelMap.accList} ${uiLabelMap.accSuppliers}</div>
...
<script type="text/javascript">
    ...
    var sourceF =
    {
        ...
        url: 'jqxGeneralServicer?sname=getPartySupplier',
    };
...
<#assign columnlist="{ text: '${uiLabelMap.FormFieldTitle_invoiceId}', width:150, filtertype:'input', datafield: 'invoiceId', cellsrenderer:
					 ...
					 { text: '${uiLabelMap.accSuppliers}',filtertype: 'olbiusdropgrid', width:500, datafield: 'partyIdFrom', cellsrenderer:
					 	function(row, colum, value){
					 		var data = $('#jqxgrid').jqxGrid('getrowdata', row);
					 ...
					 { text: '${uiLabelMap.FormFieldTitle_total}', width:200, sortable: false, filterable: false, datafield: 'total', aggregates: ['sum'],
					 	aggregatesrenderer: 
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListSUPCDAPInvoice" dataField=dataField columnlist=columnlist sortdirection="desc" defaultSortColumn="invoiceDate" jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addType="popup" showstatusbar="true"  alternativeAddPopup="alterpopupWindow"  showtoolbar="false"
