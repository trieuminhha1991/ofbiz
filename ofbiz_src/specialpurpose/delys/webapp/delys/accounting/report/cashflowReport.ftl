...
<div style="margin-top:5px;margin-bottom:5px;">
	...
	|<a href="CashflowReport.pdf?organizationPartyId=company">>>PDF</a>
	...
	<form action="FinancialStatement" method="POST" name="BalanceSheetReport" id="BalanceSheetReport">
		...
		<input type="hidden" id="reportTypeId" name="reportTypeId" value="9002"/>
		<input type="hidden" id="mType" name="mType" value="cashflowFS"/>
	</form>
</div>
<script type="text/javascript">
