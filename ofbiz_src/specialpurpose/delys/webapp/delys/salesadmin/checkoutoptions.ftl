    ...
    <tr valign="top">
        ...
        <div class="screenlet" style="height: 100%;">
            <div class="screenlet-title-bar">
                <div class="row-fluid" style="width:95%;">
					<div class="span12 label label-large label-info arrowed-in arrowed-right"><b>
						<#if shipping == true>
                ...
                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <a href="javascript:submitForm(document.checkoutInfoForm, 'NA', '');" class="btn btn-primary btn-mini">${uiLabelMap.PartyAddNewAddress}</a>
                    </td>
                  </tr>
                  <#if (shoppingCart.getTotalQuantity() > 1) && !shoppingCart.containAllWorkEffortCartItems()> <#-- no splitting when only rental items -->
                    ...
                    <tr>
                      <td colspan="2" align="center">
                        <a href="<@ofbizUrl>splitship</@ofbizUrl>" class="btn btn-primary btn-mini">${uiLabelMap.OrderSplitIntoMultipleShipments}</a>
                     ...
                     <#list shippingContactMechList as shippingContactMech>
                       ...
                       <tr>
                         <td valign="top" width="1%">
                         	<label>
								<input type="radio" name="shipping_contact_mech_id" value="${shippingAddress.contactMechId}" checked onclick="javascript:submitForm(document.checkoutInfoForm, 'SA', null);"<#if shoppingCart.getShippingContactMechId()?default("") == shippingAddress.contactMechId> checked="checked"</#if>/><span class="lbl"></span>
							</label>
                         </td>
                  ...
                  <#list carrierShipmentMethodList as carrierShipmentMethod>
                    ...
                    <tr>
                      <td width="1%" valign="top">
                      	<label>
                      		<#if shippingMethod == "NO_SHIPPING@_NA_">
                      			<input type="radio" checked="checked" name="shipping_method" value="${shippingMethod}" <#if shippingMethod == chosenShippingMethod?default("N@A")>checked="checked"</#if>/><span class="lbl"></span>
                      		<#else>
                      			<input type="radio" name="shipping_method" value="${shippingMethod}" <#if shippingMethod == chosenShippingMethod?default("N@A")>checked="checked"</#if>/><span class="lbl"></span>
                      		</#if>
                 ...
                 <#if shipping == true>
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <div>${uiLabelMap.OrderUpdateEmailAddress} <a class="btn btn-primary btn-mini" href="<#if customerDetailLink?exists>${customerDetailLink}${shoppingCart.getPartyId()}" target="partymgr"
                        <#else><@ofbizUrl>viewprofile?DONE_PAGE=quickcheckout</@ofbizUrl>"</#if> class="btn btn-primary btn-mini">${uiLabelMap.PartyProfile}</a>.</div>
                      <br />
      ...
      <td height="100%">
        ...
        <div class="screenlet" style="height: 100%;">
            <div class="screenlet-title-bar">
                <div class="row-fluid">
					<div class="span12 label label-large label-info arrowed-in arrowed-right"><b>3)${uiLabelMap.OrderHowShallYouPay}?</b></div>
				</div>
            </div>
            <div class="screenlet-body" style="height: 100%;">
                <table width="100%" cellpadding="1" cellspacing="0" border="0">
                  <tr>
                    <td colspan="2">
                      ...
                      <#if productStorePaymentMethodTypeIdMap.CREDIT_CARD?exists>
                        <a href="javascript:submitForm(document.checkoutInfoForm, 'NC', '');" class="btn btn-primary btn-mini">${uiLabelMap.AccountingCreditCard}</a>
                      </#if>
                      <#if productStorePaymentMethodTypeIdMap.EFT_ACCOUNT?exists>
                        <a href="javascript:submitForm(document.checkoutInfoForm, 'NE', '');" class="btn btn-primary btn-mini">${uiLabelMap.AccountingEFTAccount}</a>
                      </#if>
                    </td>
                  </tr>
                  <tr><td colspan="2"><hr /></td></tr>
                  <tr>
                    <td colspan="2" align="center">
                      <a href="javascript:submitForm(document.checkoutInfoForm, 'SP', '');" class="btn btn-primary btn-mini">${uiLabelMap.AccountingSplitPayment}</a>
                    </td>
                  </tr>
                  <tr><td colspan="2"><hr /></td></tr>
                  ...
                  <tr>
                    <td width="1%">
                    	<label>
							<input type="radio" name="checkOutPaymentId" value="EXT_OFFLINE" checked="checked"/><span class="lbl"></span>
						</label>
                    </td>
                    <td width="50%">
                     ...
                     <#if productStorePaymentMethodTypeIdMap.CREDIT_CARD?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.checkoutInfoForm, 'EC', '${paymentMethod.paymentMethodId}');" class="btn btn-primary btn-mini">${uiLabelMap.CommonUpdate}</a>
                     ...
                     <#if productStorePaymentMethodTypeIdMap.EFT_ACCOUNT?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.checkoutInfoForm, 'EE', '${paymentMethod.paymentMethodId}');" class="btn btn-primary btn-mini">${uiLabelMap.CommonUpdate}</a>
                          <#if paymentMethod.description?has_content><br /><span>(${paymentMethod.description})</span></#if>
                        </td>
                      </tr>
                     </#if>
                     ...
                     <#if productStorePaymentMethodTypeIdMap.GIFT_CARD?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.checkoutInfoForm, 'EG', '${paymentMethod.paymentMethodId}');" class="btn btn-primary btn-mini">[${uiLabelMap.CommonUpdate}]</a>
                          <#if paymentMethod.description?has_content><br /><span>(${paymentMethod.description})</span></#if>
                        </td>
                      </tr>
                     </#if>
...
<table width="100%">
  <tr valign="top">
    <td>
      &nbsp;<a href="javascript:submitForm(document.checkoutInfoForm, 'CS', '');" class="btn btn-primary btn-mini">${uiLabelMap.OrderBacktoShoppingCart}</a>
    </td>
    <td align="right">
      <a href="<@ofbizUrl>neworderFinalize</@ofbizUrl>" class="btn btn-primary btn-mini">${uiLabelMap.OrderContinueToFinalOrderReview}</a>
    </td>
  </tr>
</table>
...
<script type="text/javascript">
	$(function() {
		...
		//window.location.replace("<@ofbizUrl>neworderFinalize</@ofbizUrl>");
	})
</script>