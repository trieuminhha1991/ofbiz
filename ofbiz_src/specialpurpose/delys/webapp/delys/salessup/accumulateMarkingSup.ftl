...
<@jqGrid filtersimplemode="true" filterable="true" initrowdetails="true" addrefresh="true" rowdetailstemplateAdvance=rowdetailstemplateAdvance  dataField=dataField columnlist=columnlist  clearfilteringbutton="true" initrowdetailsDetail=initrowdetail 
		 url="jqxGeneralServicer?sname=JQgetListAccumulateMarking"
		/>	 
...
<script type="text/javascript">
	...
	function displayFormMark(partyId){
			...
			tmpS._source.url = 'jqxGeneralServicer?sname=JQgetListAccumulateForMark&customerId=' + partyId;
