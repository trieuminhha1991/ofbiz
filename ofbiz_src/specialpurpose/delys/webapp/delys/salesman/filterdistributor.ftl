<form name="filterdistributorform" id="filterdistributorform" action="<@ofbizUrl>filterdistributorform</@ofbizUrl>">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <tr>
			 <td></td>
			 <td>
			 	<a style="margin-left:7px;" class="btn btn-primary btn-small margin-left3" onclick="ajaxUpdateArea('distributorList', 'filterdistributorform', jQuery('#filterdistributorform').serialize());"> 
