<form name="filtercustomerform" id="filtercustomerform" action="<@ofbizUrl>filtercustomerform</@ofbizUrl>">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <#if parameters.routeRole>
		  <tr>
			<td align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>${uiLabelMap.Route}</div></td>
			<td valign='middle'>
				<div style="margin-left:7px;" id="routeId">
					 <select name="routeID">
					 		<option value="">&nbsp</option>
		  ...
		  <tr>
			 <td></td>
			 <td>
			 	<a style="margin-left:7px;" class="btn btn-primary btn-small margin-left3" onclick="ajaxUpdateArea('customerList', 'filtercustomerform', jQuery('#filtercustomerform').serialize());"> 
