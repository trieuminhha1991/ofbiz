...
<@jqGrid filtersimplemode="false" addType="popup" dataField=dataField columnlist=columnlist clearfilteringbutton="false"
			...
			url="jqxGeneralServicer?sname=JQGetListProductConfigPacking&productId=${productId?if_exists}" updateUrl="jqxGeneralServicer?sname=UpdateProductConfigPacking&jqaction=U"
			createUrl="jqxGeneralServicer?sname=UpdateProductConfigPacking&jqaction=C"
			customcontrol1="icon-tasks open-sans@${uiLabelMap.ProductListProduct}@getListProducts"
			...
			removeUrl="jqxGeneralServicer?sname=removeConfigPacking&jqaction=D"
			deleteColumn="productId;uomFromId;uomToId"
			/>
	...
	<div class='row-fluid'>
		<div class='span6'>
			<div class='row-fluid margin-bottom10'>
				<div class='span5'><label class='text-right asterisk'>${uiLabelMap.uomFromId}</label></div>
				<div class='span7'><div id="uomFromId1"></div></div>
			</div>
			<div class='row-fluid margin-bottom10'>
				<div class='span5'><label class='text-right asterisk'>${uiLabelMap.QuantityConvert}</label></div>
				<div class='span7'><div id="quantityConvert1"></div></div>
			</div>
			<div class='row-fluid margin-bottom10'>
				<div class='span5'><label class='text-right asterisk'>${uiLabelMap.AvailableFromDate}</label></div>
		...
		<div class='span5'>
			<div class='row-fluid margin-bottom10'>
				<div class='span5'><label class='text-right asterisk'>${uiLabelMap.uomToId}</label></div>
			...
			<div class='row-fluid margin-bottom10'>
				<div class='span5'><label class='text-right'>${uiLabelMap.AvailableThruDate}&nbsp;&nbsp;&nbsp;</label></div>
...
<script>
        ...
        $("#alterSave").click(function () {
            if ($('#alterpopupWindow').jqxValidator('validate')) {
				...
				row.productId = "${productId?if_exists}";
