...
<script>
    ...
    $("#countryCode").jqxInput({width: 195});
    $("#areaCode").jqxInput({width: 195});
    $("#contactNumber").jqxInput({width: 195});
    $("#extension").jqxInput({width: 195});
	...
	$('#alterpopupWindow').jqxValidator({
        rules: [
               { input: '#countryCode', message: '${uiLabelMap.DSCheckIsEmptyCreateLocationFacility}', action: 'keyup, blur', rule: 'required' },
               { input: '#countryCode', message: '${uiLabelMap.DSCheckCharacterValidate2To10}', action: 'keyup, blur', rule: 'length=2,10' },
               { input: '#areaCode', message: '${uiLabelMap.DSCheckIsEmptyCreateLocationFacility}', action: 'keyup, blur', rule: 'required' },
               { input: '#areaCode', message: '${uiLabelMap.DSCheckCharacterValidate2To10}', action: 'keyup, blur', rule: 'length=2,10' },
               { input: '#contactNumber', message: '${uiLabelMap.DSCheckIsEmptyCreateLocationFacility}', action: 'keyup, blur', rule: 'required' },
