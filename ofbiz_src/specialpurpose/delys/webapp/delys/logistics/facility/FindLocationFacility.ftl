...
<div class="widget-box transparent no-bottom-border">
   ...
   <span class="widget-toolbar none-content">
      ...
      <a href="<@ofbizUrl>EditLocationFacility?facilityId=${facilityId?if_exists}</@ofbizUrl>" class="icon-plus-sign open-sans">${uiLabelMap.ProductNewFacilityLocation}</a>
    </span>
    </div>

    <form action="<@ofbizUrl>FindLocationFacility</@ofbizUrl>" method="get" name="findFacilityLocation" class="basic-form">
