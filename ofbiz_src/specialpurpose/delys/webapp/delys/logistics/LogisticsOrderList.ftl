...
<#macro pagination>
	<form method="post" id="paging" style="margin: -12px !important" action="<@ofbizUrl>findOrderDis</@ofbizUrl>">
        ...
        <table class="table table-striped table-bordered table-hover dataTable" cellspacing='0' style="width: 100%; margin-bottom: 2%;">
          ...
          <#list orderHeaderList as orderHeader>
            ...
            <tr>
              ...
              <td>
                <a href="<@ofbizUrl>DelysEditShipment?orderId=${orderHeader.orderId}</@ofbizUrl>" class="btn btn-primary btn-mini">${uiLabelMap.Shipments} - ${orderHeader.orderId}</a>
              </td>
