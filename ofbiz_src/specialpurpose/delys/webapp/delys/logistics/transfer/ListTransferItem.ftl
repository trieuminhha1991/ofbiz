...
<#assign columnlist1="
					...
					{ text: '${uiLabelMap.ProductProductId}', dataField: 'productId', width: 150, filtertype:'input', editable: false, pinned: true},
					 { text: '${uiLabelMap.ProductName}', dataField: 'productName', minwidth: 150, filtertype:'input', editable: false, 
					 },
					 { text: '${uiLabelMap.QuantityNeedToTransfer}', dataField: 'quantity', width: 120, editable: false, cellsalign: 'right'
					 },
					 { text: '${uiLabelMap.Unit}', dataField: 'quantityUomId', width: 70, editable: false,
						 cellsrenderer: function (row, column, value){
					 ...
					 { text: '${uiLabelMap.QuantityToTransfer}', dataField: 'quantityToDelivery', width: 150, align: 'center', cellsalign: 'right', columntype: 'numberinput', editable: true,
					 ...
					 { text: '${uiLabelMap.SummaryATP}', dataField: 'availableToPromiseTotal', minwidth: 150, editable: false, align: 'center',
		 				cellsrenderer: function(row, column, value){
		 					var baseUomDes;
		 					var data = $('#jqxgridProduct').jqxGrid('getrowdata', row);
		 					for (var i=0; i < packingUomData.length; i++){
					 ...
					 { text: '${uiLabelMap.SummaryQOH}', dataField: 'quantityOnHandTotal', minwidth: 150, editable: false, align: 'center', 
		 				cellsrenderer: function(row, column, value){
		 					var baseUomDes;
		 					var data = $('#jqxgridProduct').jqxGrid('getrowdata', row);
		 					for (var i=0; i < packingUomData.length; i++){
					 ...
					 "/>
<@jqGrid filtersimplemode="true" width="890" selectionmode="checkbox" customLoadFunction="true" id="jqxgridProduct" usecurrencyfunction="true" addType="popup" dataField=dataField1 
         columnlist=columnlist1 clearfilteringbutton="true" showtoolbar="true" addrow="false" filterable="true" editmode="dblclick" editable="true" rowselectfunction="rowselectfunctionProduct(event);"
		 ...
		 customTitleProperties="DeliveryItemList" autoheight="false" height="290"
		 otherParams="quantityOnHandTotal,availableToPromiseTotal:S-getDetailQuantityInventory(originFacilityId,productId,expireDate)<quantityOnHandTotal,availableToPromiseTotal>;convertNumber:S-getConvertPackingNumber(productId,uomFromId{quantityUomId},uomToId{baseQuantityUomId})<convertNumber>"
/>
