...
<a  class="btn btn-small btn-primary" href="<@ofbizUrl>DelysEditShipment</@ofbizUrl>">${uiLabelMap.ProductNewShipment}</a>
<div id="findOrders" class="widget-box olbius-extra">
    ...
    <div class="widget-main">
        ...
        <form method="post" name="lookupShipmentForm" action="<@ofbizUrl>DelysFindShipment</@ofbizUrl>">
        ...
        <#if shipmentList?has_content>
          ...
          <#list shipmentList as shipment>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              <td><a href="<@ofbizUrl>ViewShipment?shipmentId=${shipment.shipmentId}</@ofbizUrl>" class="btn btn-info btn-mini">${shipment.shipmentId}</a></td>
              ...
              <td align="right">
                <a href="<@ofbizUrl>ViewShipment?shipmentId=${shipment.shipmentId}</@ofbizUrl>" class="btn btn-info btn-mini">${uiLabelMap.CommonView}</a>
              </td>
            </tr>
