...
<script language="JavaScript" type="text/javascript">
    function setNow(field) { eval('document.selectAllForm.' + field + '.value="${nowTimestamp}"'); }
        ...
        <div class="button-bar button-style-1">
          <a href="<@ofbizUrl>EditFacility</@ofbizUrl>" class="btn btn-primary btn-small margin-top8">${uiLabelMap.ProductNewFacility}</a>
        </div>
        <#-- Receiving Results -->
          ...
          <table class="table table-striped table-hovered dataTable" cellspacing="0">
            ...
            <#list receivedItems as item>
              <form name="cancelReceivedItemsForm_${item_index}" method="post" action="<@ofbizUrl>cancelReceivedItems</@ofbizUrl>">
                ...
                <tr>
                  <td><a href="<@ofbizUrl>ViewShipment?shipmentId=${item.shipmentId?if_exists}</@ofbizUrl>" class="btn btn-small btn-info">${item.shipmentId?if_exists} ${item.shipmentItemSeqId?if_exists}</a></td>
                  <td>${item.receiptId}</td>
                  <td>${item.getString("datetimeReceived").toString()}</td>
                  <td><a href="/ordermgr/control/orderview?orderId=${item.orderId}" class="btn btn-small btn-info">${item.orderId}</a></td>
                  ...
                  <td>
                    <#if (item.quantityAccepted?int > 0 || item.quantityRejected?int > 0)>
                      <a href="javascript:document.cancelReceivedItemsForm_${item_index}.submit();" class="btn btn-small btn-info">${uiLabelMap.CommonCancel}</a>
                    </#if>
                  </td>
                </tr>
              </form>
        ...
        <#if requestParameters.initialSelected?exists && product?has_content>
          <form method="post" action="<@ofbizUrl>DelysReceiveSingleInventoryProduct</@ofbizUrl>" name="selectAllForm">
            <table class="table table-striped table-hovered dataTable" cellspacing="0">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductPurchaseOrder}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductProductId}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductProductName}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <a href="/catalog/control/EditProduct?productId=${product.productId}${externalKeyParam?if_exists}" target="catalog" class="btn btn-small btn-info">${product.internalName?if_exists}</a>
                </td>
              </tr>
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductProductDescription}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductItemDescription}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductInventoryItemType}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductFacilityOwner}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductSupplier}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <select name="partyId">
                    <option value=""></option>
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductDateReceived}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <input type="text" name="datetimeReceived" size="24" value="${nowTimestamp}" />
                  <#-- <a href="#" onclick="setNow("datetimeReceived")" class="btn btn-small btn-info">[Now]</a> -->
                </td>
              </tr>
              
              
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.lotId}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductFacilityLocation}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductRejectedReason}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductQuantityRejected}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductQuantityAccepted}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductPerUnitPrice}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td colspan="1">&nbsp;</td>
                <td colspan="2"><input type="submit" class="btn btn-small btn-primary" value="${uiLabelMap.CommonReceive}" /></td>
              </tr>
            </table>
            <script language="JavaScript" type="text/javascript">
        ...
        <#elseif requestParameters.initialSelected?exists && !requestParameters.shipmentId?exists>
          ...
          <form method="post" action="<@ofbizUrl>DelysReceiveInventory</@ofbizUrl>" name="selectAllForm">
            <#-- general request fields -->
            <input type="hidden" name="facilityId" value="${requestParameters.facilityId?if_exists}"/>
            <input type="hidden" name="purchaseOrderId" value="${requestParameters.purchaseOrderId?if_exists}"/>
              ...
              <#else/>
                <tr>
                  ...
                  <td align="right">
                    ...
                    <input type="checkbox" style="opacity: 1; margin-left:5px; margin-top: 1px" name="selectAll" value="Y" onclick="javascript:toggleAll(this, 'selectAllForm');"/>
                  </td>
                </tr>
                      ...
                      <table class="table table-striped table-hovered dataTable" cellspacing="0">
                        <tr>
                          <#if orderItem.productId?exists>
                            ...
                            <td width="45%">
                                ${orderItem.orderItemSeqId}:&nbsp;<a href="/catalog/control/EditProduct?productId=${product.productId}${externalKeyParam?if_exists}" target="catalog" class="btn btn-small btn-info">${product.productId}&nbsp;-&nbsp;${orderItem.itemDescription?if_exists}</a> : ${product.description?if_exists}
                            </td>
                          <#else>
                            <td width="45%">
                                ...
                                <a href="/catalog/control/EditProduct?${StringUtil.wrapString(externalKeyParam)}" target="catalog" class="btn btn-small btn-info">${uiLabelMap.ProductCreateProduct}</a>
                            </td>
                          </#if>
                ...
                <#if rowCount == 0>
                  ...
                  <tr>
                    <td colspan="2" align="right">
                      <a href="<@ofbizUrl>DelysReceiveInventory?facilityId=${requestParameters.facilityId?if_exists}</@ofbizUrl>" class="btn btn-small btn-info">${uiLabelMap.ProductReturnToReceiving}</a>
                    </td>
                  </tr>
                <#else>
                  <tr>
                    <td colspan="2" align="right">
                      <a href="javascript:document.selectAllForm.submit();" class="btn btn-info btn-small">${uiLabelMap.ProductReceiveSelectedProduct}</a>
                    </td>
                  </tr>
                </#if>
              </#if>
        ...
        <#else>
          ...
          <form name="selectAllForm" method="post" action="<@ofbizUrl>DelysReceiveInventory</@ofbizUrl>">
            <input type="hidden" name="facilityId" value="${requestParameters.facilityId?if_exists}"/>
            <input type="hidden" name="initialSelected" value="Y"/>
            <table class="table table-striped table-hovered dataTable" cellspacing="0">
              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>
                  <a href="javascript:document.selectAllForm.submit();" class="btn btn-info btn-small">${uiLabelMap.ProductReceiveProduct}</a>
                </td>
              </tr>
            </table>
          </form>
