	...
	<div class="span12">
    	...
    	<table width="100%" border="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable">
  			...
  			<tbody>
  				...
  				-->
  				<tr>
		            <td align="right" colspan="6" class="align-right"><div><b>${uiLabelMap.DATotal}</b></div></td>
		        ...
		        <#list headerAdjustmentsToShow?if_exists as orderHeaderAdjustment>
	          	...
	          	<tr>
		            <td align="right" colspan="6" class="align-right"><div><b>${uiLabelMap.DAAbbValueAddedTax}</b></div></td>
	          	...
	          	<tr>
		            <td align="right" colspan="6" class="align-right"><div><b>${uiLabelMap.DAGrandTotalOrder}</b></div></td>
		            <td align="right" nowrap="nowrap" class="align-right">
