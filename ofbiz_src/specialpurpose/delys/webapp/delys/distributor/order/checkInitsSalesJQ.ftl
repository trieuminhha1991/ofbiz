			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="span12">
						...
						-->
						<#--
						<select name="productStoreId" id="productStoreId" class="span12 input-small" disabled="disabled" style="width: 130px; background:#fafafa">
			                <#list productStores as productStore>
						...
						-->
						<input type="hidden" name="productStoreId" id="productStoreId" class="span12 input-small" maxlength="20" value="${productStores[0].productStoreId?if_exists}"/>
