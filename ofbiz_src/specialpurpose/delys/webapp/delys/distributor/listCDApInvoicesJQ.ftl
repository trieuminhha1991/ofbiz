...
<#assign columnlist="{ text: '${uiLabelMap.FormFieldTitle_invoiceId}', width:150, datafield: 'invoiceId', cellsrenderer:
					 ...
					 { text: '${uiLabelMap.FormFieldTitle_invoiceDate}', filtertype: 'range',cellsformat: 'd', width:150, datafield: 'invoiceDate', cellsrenderer:
                     	 function(row, colum, value)
                        {
					 ...
					 { text: '${uiLabelMap.accSuppliers}', width:150, datafield: 'partyId', cellsrenderer:
					 	function(row, colum, value){
					 		var data = $('#jqxgridap').jqxGrid('getrowdata', row);
