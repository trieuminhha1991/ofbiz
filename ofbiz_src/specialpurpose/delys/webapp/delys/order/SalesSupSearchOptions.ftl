...
<#macro pagination>
	<form method="post" id="paging" style="margin: -12px !important" action="<@ofbizUrl>salessup</@ofbizUrl>">
...
<div id="orderLookup" class="widget-box transparent no-bottom-border" style="margin-top:30px;">
    ...
    <div class="widget-main">
      <form method="post" name="findorder" style="margin: -12px !important" action="<@ofbizUrl>salessup</@ofbizUrl>">
