...
<div id="shippinginfo-tab" class="tab-pane">
	<h4 class="smaller lighter green" style="display:inline-block">
		<#-- <i class="fa-file"></i> -->
		${uiLabelMap.OrderActions} - ${uiLabelMap.OrderShipmentInformation}
	</h4>
		        				...
		        				<#if security.hasEntityPermission("FACILITY", "_CREATE", session) && ((orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
		          					...
		          					<#if orderHeader.orderTypeId == "SALES_ORDER">
		            					<li>
		            						...
		            						<a href="javascript:document.quickShipOrder.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderQuickShipEntireOrder}</a>
	            						</li>
		          					<#else> <#-- PURCHASE_ORDER -->
