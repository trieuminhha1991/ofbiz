...
<#macro pagination>
	<form method="post" id="paging" style="margin: -12px !important" action="<@ofbizUrl>salesAdmin</@ofbizUrl>">
...
<div id="orderLookup" class="widget-box transparent no-bottom-border" style="margin-top:30px;">
    ...
    <div class="widget-main">
      <form method="post" name="findorder" style="margin: -12px !important" action="<@ofbizUrl>salesAdmin</@ofbizUrl>">
        <input type="hidden" name="changeStatusAndTypeState" value="Y" />
        <table cellspacing='0'>
        <tr>
        	<td width="30%" style="font-weight:bold;">${uiLabelMap.listStore}</td>
        	<td width="30%" style="font-weight:bold;">${uiLabelMap.CommonType}</td>
        </tr>
        <tr>  
	        <td width="30%">
