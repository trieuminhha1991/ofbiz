      ...
      <ul class="unstyled spaced">
        <#if security.hasEntityPermission("FACILITY", "_CREATE", session) && ((orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
          ...
          <#if orderHeader.orderTypeId == "SALES_ORDER">
            <li>
            <form name="quickShipOrder" method="post" action="/ordermgr/control/quickShipOrder">
              <input type="hidden" name="orderId" value="${orderId}"/>
            </form>
            <a href="javascript:document.quickShipOrder.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderQuickShipEntireOrder}</a></li>
          <#else> <#-- PURCHASE_ORDER -->
              ...
              <#if !allShipments?has_content>
                  ...
                  <li>
                    <form name="receivePurchaseOrderForm" action="/facility/control/quickShipPurchaseOrder?externalLoginKey=${externalLoginKey}" method="post">
                      ...
                      <i class="icon-caret-right blue"></i><a href="javascript:document.receivePurchaseOrderForm.submit()" class="btn btn-mini btn-primary">${uiLabelMap.CommonReceive}</a>
                  </li>
              <#else>
                  <li>
                    ...
                    <i class="icon-caret-right blue"></i><a href="javascript:document.receiveInventoryForm.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderQuickReceivePurchaseOrder}</a>
                  </li>
                  <li>
                    ...
                    <i class="icon-caret-right blue"></i><a href="javascript:document.partialReceiveInventoryForm.submit()" class="btn btn-mini btn-primary">${uiLabelMap.CommonReceive}</a>
                  </li>
              </#if>
        ...
        <#if orderHeader.statusId != "ORDER_COMPLETED" && orderHeader.statusId != "ORDER_CANCELLED">
          <li><a href="/ordermgr/control/OrderDeliveryScheduleInfo?orderId=${orderId}" class="btn btn-mini btn-primary">${uiLabelMap.OrderViewEditDeliveryScheduleInfo}</a></li>
        </#if>
        <#if security.hasEntityPermission("ORDERMGR", "_RETURN", session) && orderHeader.statusId == "ORDER_COMPLETED">
          <#if returnableItems?has_content>
            <li>
            <form name="quickRefundOrder" method="post" action="/ordermgr/control/quickRefundOrder">
              <input type="hidden" name="orderId" value="${orderId}"/>
            ...
            <li>
            <form name="quickreturn" method="post" action="/ordermgr/control/quickreturn">
              <input type="hidden" name="orderId" value="${orderId}"/>
            ...
            <a href="javascript:document.quickreturn.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderCreateReturn}</a>
            </li>
          </#if>
        </#if>
        ...
        <#if orderHeader?has_content && orderHeader.statusId != "ORDER_CANCELLED">
          <#if orderHeader.statusId != "ORDER_COMPLETED">
            ...
            -->
            <li><a href="/ordermgr/control/editOrderItems?${paramString}" class="btn btn-mini btn-primary">${uiLabelMap.OrderEditItems}</a></li>
            <li>
            <form name="createOrderItemShipGroup" method="post" action="/ordermgr/control/createOrderItemShipGroup">
              <input type="hidden" name="orderId" value="${orderId}"/>
            </form>
            <a href="javascript:document.createOrderItemShipGroup.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderCreateShipGroup}</a>
            </li>
          </#if>
          <li><a href="/ordermgr/control/loadCartFromOrder?${paramString}&amp;finalizeMode=init" class="btn btn-mini btn-primary">${uiLabelMap.OrderCreateAsNewOrder}</a></li>
          <#if orderHeader.statusId == "ORDER_COMPLETED">
            <li><a href="/ordermgr/control/loadCartForReplacementOrder?${paramString}" class="btn btn-mini btn-primary">${uiLabelMap.OrderCreateReplacementOrder}</a></li>
          </#if>
        </#if>
        <li><a href="/ordermgr/control/OrderHistory?orderId=${orderId}" class="btn btn-mini btn-primary">${uiLabelMap.OrderViewOrderHistory}</a></li>
      </ul>
    </div>
     </div>
      </div>
...
<#list shipGroups as shipGroup>
 ...
 <div class="widget-box olbius-extra ">
    <div class="widget-header widget-header-small header-color-blue2">
         <h6>${uiLabelMap.OrderShipmentInformation} - ${shipGroup.shipGroupSeqId}</h6>
         <div class="widget-toolbar">
        	<a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a>
		</div>
    </div>
    ...
    <div class="widget-main">
         ...
         <a class="btn btn-mini btn-primary" target="_BLANK" href="/ordermgr/control/shipGroups.pdf?orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}">${uiLabelMap.OrderShipGroup} PDF</a>
        <form name="updateOrderItemShipGroup" method="post" action="/ordermgr/control/updateOrderItemShipGroup">
        ...
        <table class="table table-striped table-bordered table-hover dataTable" cellspacing='0'>
                ...
                <tr>
                    ...
                    <td valign="top" width="80%">
                        ...
                        <a class="btn btn-mini btn-primary" id="newShippingAddress" href="javascript:void(0);">${uiLabelMap.OrderNewShippingAddress}</a>
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
            ...
            <tr>
              <td colspan="3">
                <table>
                  ...
                  <form name="UpdateShippingMethod" method="post" action="/ordermgr/control/updateShippingMethodAndCharges">
        ...
        <tr>
          ...
          <td align="left" valign="top" width="80%">
            <#if (!orderHeader.statusId.equals("ORDER_COMPLETED")) && !(orderHeader.statusId.equals("ORDER_REJECTED")) && !(orderHeader.statusId.equals("ORDER_CANCELLED"))>
              <form id="updateShippingInstructionsForm_${shipGroup.shipGroupSeqId}" name="updateShippingInstructionsForm" method="post" action="setShippingInstructions">
                ...
                <#if shipGroup.shippingInstructions?has_content>
                  <table>
                    <tr>
                      ...
                      <td>
                        <a href="javascript:editInstruction('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary" id="editInstruction_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonEdit}</a>
                      </td>
                    </tr>
                  </table>
                <#else>
        ...
        <tr>
          ...
          <td>
            <form id="setGiftMessageForm_${shipGroup.shipGroupSeqId}" name="setGiftMessageForm" method="post" action="setGiftMessage">
              <input type="hidden" name="orderId" value="${orderHeader.orderId}"/>
              <input type="hidden" name="shipGroupSeqId" value="${shipGroup.shipGroupSeqId}"/>
              <#if shipGroup.giftMessage?has_content>
                <label>${shipGroup.giftMessage}</label>
                <a href="javascript:editGiftMessage('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary" id="editGiftMessage_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonEdit}</a>
              <#else>
         ...
         <tr>
            ...
            <td valign="top" width="80%">
              <form name="setShipGroupDates_${shipGroup.shipGroupSeqId}" method="post" action="/ordermgr/control/updateOrderItemShipGroup">
                ...
                <button type="submit" class="btn btn-primary btn-mini margin-top-nav-5" name="submitButton"><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
                </form>
            </td>
         </tr>
          ...
          <tr>
            ...
            <td valign="top" width="80%">
                <#list shipGroupShipments as shipment>
                    <div>
                      ${uiLabelMap.CommonNbr}<a href="/facility/control/ViewShipment?shipmentId=${shipment.shipmentId}${externalKeyParam}" class="btn btn-mini btn-primary">${shipment.shipmentId}</a>&nbsp;&nbsp;
                      <br /><br /><a target="_BLANK" href="/facility/control/PackingSlip.pdf?shipmentId=${shipment.shipmentId}${externalKeyParam}" class="btn btn-mini btn-primary">${uiLabelMap.ProductPackingSlip}</a>
                      <#if "SALES_ORDER" == orderHeader.orderTypeId && "ORDER_COMPLETED" == orderHeader.statusId>
                        ...
                        <#if shipmentRouteSegments?has_content>
                          ...
                          <form name="upsEmailReturnLabel${shipment_index}" method="post" action="/ordermgr/control/upsEmailReturnLabelOrder">
                            <input type="hidden" name="orderId" value="${orderId}"/>
            ...
            <td colspan="3" valign="top" width="100%" align="center">
             <#if orderHeader.orderTypeId == "SALES_ORDER">
               <#if !shipGroup.supplierPartyId?has_content>
                 ...
                 <a href="/facility/control/PackOrder?facilityId=${storeFacilityId?if_exists}&amp;orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}${externalKeyParam}" class="btn btn-mini btn-primary">${uiLabelMap.OrderPackShipmentForShipGroup}</a>
                 <br /><br />
                 </#if>
                 <a href="javascript:document.createShipment_${shipGroup.shipGroupSeqId}.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderNewShipmentForShipGroup}</a>
             ...
             <#else>
               ...
               <#else>
                   ...
                   <form name="quickDropShipOrder_${shipGroup_index}" method="post" action="/ordermgr/control/quickDropShipOrder">
                        <input type="hidden" name="orderId" value="${orderId}"/>
                        <input type="hidden" name="shipGroupSeqId" value="${shipGroup.shipGroupSeqId}"/>
                        <input type="hidden" name="externalLoginKey" value="${externalLoginKey}" />
                    </form>
