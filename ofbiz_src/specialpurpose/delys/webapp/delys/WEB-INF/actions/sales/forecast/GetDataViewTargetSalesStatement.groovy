		...
		if (listSalesItem) {
			for (GenericValue salesItem : listSalesItem) {
				if (UtilValidate.isNotEmpty(salesItem.getString("productId"))) {
					iHeader.put(salesItem.getString("productId"), salesItem.getBigDecimal("quantity"));
				} else if (UtilValidate.isNotEmpty(salesItem.getString("productCategoryId"))) {
					iHeader.put(salesItem.getString("productCategoryId"), salesItem.getBigDecimal("quantity"));
				}
			}
		}
