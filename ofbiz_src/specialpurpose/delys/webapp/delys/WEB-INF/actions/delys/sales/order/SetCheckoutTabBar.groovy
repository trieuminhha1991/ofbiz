...
// ----------------------------------
checkoutSteps.add([label : "DAShowCartAgain", uri : "newOrder", enabled : "Y", icon : "fa-arrow-left"])
...
//checkoutSteps.add([label : "DAReviewOrder", uri : "confirmOrder", enabled : "Y", icon : "fa-arrow-left"])
