...
productStores = EntityUtil.filterByDate(delegator.findByAnd("ProductStoreRoleDetail", ["partyId" : userLogin.partyId, roleTypeId : "SALES_ADMIN"], ["productStoreId", "storeName"], false));
currentStoreId = "NA";
...
if (shoppingCart != null) {
	...
	salesmanId = SalesPartyUtil.getSalesmanPersonIdByCustomer(delegator, partyId);
} else {
