...
List<GenericValue> listAssetGlAccount = delegator.findList("GlAccountOrganizationAndClass", assetGlAccountCond, null, UtilMisc.toList("accountCode ASC"), null, false);
