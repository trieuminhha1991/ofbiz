...
//			BigDecimal temp = new BigDecimal(-1);
			...
			//hi?n t?i thì dang c?ng thêm s? planImport(m?i ch? là plan thôi) nhung th?c nh?p s? khác, lúc dó khi có s? th?c nh?p thì s? c?ng s? th?c nhâp này m?i chính xác du?c các con s? d? báo
