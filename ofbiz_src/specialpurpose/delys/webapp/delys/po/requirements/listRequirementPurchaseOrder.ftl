...
<script>
	...
	<@jqGrid filtersimplemode="true" filterable="true" dataField=dataField columnlist=columnlist editable="false" showtoolbar="true"
		id="jqxgirdRequirement" addrow="true" alternativeAddPopup="alterpopupWindow"  addType="popup" addrefresh="true" addrow="true" filterable="true"
		url="jqxGeneralServicer?sname=JQGetListRequirementPurchaseOrderToPO"
		createUrl="jqxGeneralServicer?sname=createRequirementPurchaseOrderToPO&jqaction=C"  
        		...
        		<div class="span6">
					<div class="row-fluid margin-bottom10">	
	    				<div class="span5" style="text-align: right">
	    					<label> ${uiLabelMap.LogRequirePurchaseForFacility}: </label>
						</div>
						<div class="span7">
...
<#include "listProductRequirement.ftl" />
<script>
