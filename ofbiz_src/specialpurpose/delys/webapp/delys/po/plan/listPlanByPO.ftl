...
<@jqGrid filtersimplemode="true" filterable="true" dataField=dataField columnlist=columnlist editable="false" showtoolbar="true"
	...
	url="jqxGeneralServicer?sname=JQXGetListPlanByPO"
...
<script>
	...
	$("#viewDetailPlanByProductPlanId").on("click", function() {
		...
		window.location.href = "viewPlanDetailByPO?productPlanId="+productPlanId+"&productPlanName="+productPlanName+"&customTimePeriodId="+customTimePeriodId+"&internalPartyId="+internalPartyId;
	});
