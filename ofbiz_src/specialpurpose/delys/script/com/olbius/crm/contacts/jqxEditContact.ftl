		...
		<div class="row-fluid" >
    		<div class="span12">
    			<div class='row-fluid'>
					<div class="span6">
	    				<div class="row-fluid">
							<div class='span5  text-algin-right'>
								<label class="asterisk">${uiLabelMap.mobile}:</label>	
							</div>
							<div class='span7'>
					...
					<div class="span6">
						<div class="row-fluid">
							<div class='span5 text-algin-right'>${uiLabelMap.email}:</div>
							<div class='span7'><input id="email"></input></div>
						</div>
					</div>
    			</div>
			</div>
			<div class="span12" style="margin-top: 50px; margin-left: 0px;">
				<div class="span5" style="border: 1px solid #EEE; padding: 15px; border-radius: 5px; margin-left: 40px;">
					...
					<div class="control-group no-left-margin">
						<label class="control-label" style="width: 104px !important">${uiLabelMap.PartyAddressLine}:</label>
