...
public class WebPosSession {
    ...
    public GenericValue checkLogin(String username, String password, LocalDispatcher dispatcher) throws UserLoginFailure {
        ...
        if (UtilValidate.isEmpty(dispatcher)) {
            throw new UserLoginFailure(UtilProperties.getMessage("BasePosUiLabels", "WebPosUnableToLogIn", getLocale()));
        }
        ...
        if (ServiceUtil.isError(result)) {
            ...
            if (ul == null) {
                throw new UserLoginFailure(UtilProperties.getMessage("BasePosUiLabels", "WebPosUserLoginNotValid", getLocale()));
            }
            return ul;
        }
    }
