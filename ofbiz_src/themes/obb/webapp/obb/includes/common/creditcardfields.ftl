...
<#if !paymentMethod?has_content>
  ...
  <tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
      <input type="text" size="30" maxlength="60" class="input-text" name="companyNameOnCard" value="${creditCard.companyNameOnCard?if_exists}"/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
      <input type="text" size="20" class="input-text" maxlength="60" name="firstNameOnCard" value="${(creditCard.firstNameOnCard)?if_exists}"/>
  ...
  <tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
      <input type="text" size="15" class="input-text" maxlength="60" name="middleNameOnCard" value="${(creditCard.middleNameOnCard)?if_exists}"/>
    </td>
  </tr>
  <tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
      <input type="text" size="20" maxlength="60" name="lastNameOnCard" class="input-text" value="${(creditCard.lastNameOnCard)?if_exists}"/>
    <#if showToolTip?has_content><span class="tooltip">${uiLabelMap.CommonRequired}</span><#else>*</#if></td>
  </tr>
  <tr>
    ...
    <td width="74%">
        <#if creditCard?has_content>
            <#if cardNumberMinDisplay?has_content>
                ...
                <input type="text" class="required input-text" size="20" maxlength="30" name="cardNumber" onfocus="javascript:this.value = '';" value="${cardNumberDisplay?if_exists}" />
            <#else>
                <input type="text" size="20" class="input-text" maxlength="30" name="cardNumber" value="${creditCard.cardNumber?if_exists}"/>
            </#if>
        <#else>
            <input type="text" size="20" class="input-text" maxlength="30" name="cardNumber" value="${creditCard.cardNumber?if_exists}"/>
        </#if>
  ...
  <#--<tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
        <input type="text" size="5" maxlength="10" class="input-text" name="cardSecurityCode" value="${creditCard.cardSecurityCode?if_exists}" />
    </td>
  </tr>-->
  <tr>
  ...
  <tr>
    ...
    <td width="5">&nbsp;</td>
    <td width="74%">
      <input type="text" size="20" maxlength="30" class="input-text" name="description" value="${paymentMethod.description?if_exists}"/>
    </td>
  </tr>
