								...
								<#else>
								  <#if !creditCard?exists>
								    ...
								    <#else>
								      ...
								      <a href="<@ofbizUrl>${donePage}</@ofbizUrl>" class="button">${uiLabelMap.CommonGoBack}</a>
								      <span style="margin-left:10px;margin-right:10px;">|</span><a href="javascript:document.editcreditcardform.submit()" class="button">${uiLabelMap.CommonSave}</a>
								      <p/>
								      <table id="shopping-cart-table" class="data-table cart-table">
								        ...
								        -->
								          ...
								          <tr>
								            <td valign="top" colspan="2">
								              <div>${uiLabelMap.ObbMessage3}</div>
								            </td>
								          </tr>
								          -->
