...
(function(a) {
    ...
    a.extend(a.jqx._jqxComboBox.prototype, {defineInstance: function() {
            ...
            try {
                ...
                var j = true;
                m.listBoxContainer.jqxListBox({_checkForHiddenParent: false,allowDrop: false,allowDrag: false,checkboxes: m.checkboxes,emptyString: m.emptyString,autoBind: !m.remoteAutoComplete && m.autoBind,renderer: m.renderer,rtl: m.rtl,itemHeight: m.itemHeight,selectedIndex: m.selectedIndex,incrementalSearch: false,width: d,scrollBarSize: m.scrollBarSize,autoHeight: m.autoDropDownHeight,height: m.dropDownHeight,displayMember: m.displayMember,valueMember: m.valueMember,source: m.source,theme: m.theme,rendered: function() {
                ...
                m.listBoxContainer.css({position: "absolute",zIndex: m.popupZIndex,top: 0,left: 0});
                ...
                m.addHandler(m.listBoxContainer, "unselect", function(e) {
                    if (!m.multiSelect) {
                        m._raiseEvent("3", {index: e.args.index,type: e.args.type,item: e.args.item})
                    }
                });
                m.addHandler(m.listBoxContainer, "change", function(e) {
                    if (!m.multiSelect) {
                        m._raiseEvent("4", {index: e.args.index,type: e.args.type,item: e.args.item})
                    }
                });
                ...
                if (m.length >= t.minLength) {
                    if (!n.ctrlKey && !n.altKey) {
                        if (t.searchString != m) {
                            ...
                            if (l == null) {
                                t.listBoxContainer.jqxListBox({source: t.source})
                            }
                            if (e._searchTimer) {
                    ...
                    q();
                    t.searchString = "";
                    //t.listBoxContainer.jqxListBox({source: null})
                }
                return
            }
            var t = this;
		...
		var that = this;
            ...
            a.each(this.selectedItems, function(i) {
                ...
                if (m) {
                    var p = m.label;
                    //olbius fix multi select render selected
                    if(that.renderSelectedItem){
			p = that.renderSelectedItem(m.index, m.label);
                    }
                    if (o[0].innerHTML == "") {
            ...
            if (i > 0) {
                this.input[0].style.marginTop = parseInt(i) + "px"
            }
            if (this.rtl) {
