...
(function(b) {
	...
	b.extend(b.jqx._jqxGrid.prototype, {
		...
		createInstance : function(h) {
			...
			//olbius - add class to jqx grid content to specify it when set css
			var g = '<div class=\'jqx-clear jqx-border-reset jqx-overflow-hidden jqx-max-size jqx-position-relative\'><div tabindex=\'1\' class=\'jqx-clear jqx-max-size jqx-position-relative jqx-overflow-hidden jqx-background-reset\' id=\'wrapper' + this.element.id + '\'><div class=\'jqx-clear jqx-position-absolute\' id=\'toolbar\' style=\'visibility: hidden;\'></div><div class=\'jqx-clear jqx-position-absolute\' id=\'groupsheader\' style=\'visibility: hidden;\'></div><div class=\'jqx-clear jqx-overflow-hidden jqx-position-absolute jqx-border-reset jqx-background-reset jqx-grid-content\' id=\'content' + this.element.id + '\'></div><div class=\'jqx-clear jqx-position-absolute\' id=\'verticalScrollBar' + this.element.id + '\'></div><div class=\'jqx-clear jqx-position-absolute\' id=\'horizontalScrollBar' + this.element.id + '\'></div><div class=\'jqx-clear jqx-position-absolute jqx-border-reset\' id=\'bottomRight\'></div><div class=\'jqx-clear jqx-position-absolute\' id=\'statusbar\'></div><div class=\'jqx-clear jqx-position-absolute\' id=\'pager\' style=\'z-index: 20;\'></div></div></div>';
		...
		localizestrings : function(d, e) {
			...
			if (d != null) {
				...
				if (d.notificationfiltershortkey) {
					this.gridlocalization.notificationfiltershortkey = d.notificationfiltershortkey
				}
				if (e !== false) {
					if (this._initpager) {
						this._initpager()
		...
		_initmenu : function() {
			...
			if (this.host.jqxMenu) {
				...
				var y = 200;
				s = b.trim(s).replace(/\&nbsp\;/gi, '').replace(/\&#160\;/gi, '');
				var g = b('<span>' + s + '</span>');
		...
		_arrangemenu : function() {
			...
			var e = 200;
			d = b.trim(d).replace(/\&nbsp\;/gi, '').replace(/\&#160\;/gi, '');
			var f = b('<span>' + d + '</span>');
						...
						if (this.autorowheight && (this.autoheight || this.pageable)) {
							...
							for (var O = d; O < T; O++) {
								if (this.editable && this.editcell && this.editcell.column == this.columns.records[O].datafield && this.editcell.row == this.getboundindex(W)) {
									//olbius vu fix
									if ( typeof (this.editcell.editor) != 'undefined' && this.editcell.editor != null) {
				...
				if (this.table && this.table.length > 0 && this.table[0].rows && this.table[0].rows.length > 0) {
					...
					for (var f = 0; f < k.cells.length; f++) {
						...
						if (d.css('display') != 'none' && !l) {
							...
							l = true;
							d[0].innerHTML = '';
							var middle = this.host.width() / 2;
							var g = b('<span style=\'white-space: nowrap; float: left; margin-left: ' + middle + 'px; position: relative;\'></span>');
		...
		setcellvalue : function(s, z, E, l, w) {
			...
			if (this.source && this.source._knockoutdatasource && !this._updateFromAdapter && this.autokoupdates) {
				if (this.source._source._localdata) {
					...
					if (r[z] && r[z].subscribe) {
						...
						this.source._source._localdata.replace(D, b.extend({
						}, r))
					}
			...
			if (this.showfilterrow && this.filterable && this.filterrow) {
				...
				if (d == 'list' || d == 'checkedlist' || d == 'olbiusdropgrid') {
				...
				var e = function(o, n, s) {
					...
					if (o.source && o.source._knockoutdatasource && !o._updateFromAdapter && o.autokoupdates) {
						if (o.source._source._localdata) {
							...
							o.source._source._localdata.replace(l, b.extend({
							}, m));
		...
		_addHandlers : function() {
			...
			if (!d) {
				...
				e.addHandler(b(document), 'keydown.edit' + e.element.id, function(l) {
					...
					//olbius - cuong bui fix binding keyboad
