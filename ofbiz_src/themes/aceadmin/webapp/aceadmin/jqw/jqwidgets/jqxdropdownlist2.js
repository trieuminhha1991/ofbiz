    ...
    a.extend(a.jqx._jqxDropDownList.prototype, {defineInstance: function() {
            ...
            try {
                ...
                p.addHandler(p.listBoxContainer, "unselect", function(e) {
                    p._raiseEvent("3", {index: e.args.index,type: e.args.type,item: e.args.item})
                });
                p.addHandler(p.listBoxContainer, "change", function(e) {
                    if (e.args) {
                        if (e.args.type != "keyboard") {
                            p._raiseEvent("4", {index: e.args.index,type: e.args.type,item: e.args.item})
                        } else {
                            if (e.args.type == "keyboard") {
                                if (!p.isOpened()) {
                                    p._raiseEvent("4", {index: p.selectedIndex,type: "keyboard",item: p.getItem(p.selectedIndex)})
                                }
                            }
                        }
                    }
                ...
                if (f.keyCode == "13" || f.keyCode == "9") {
                    if (!c.isanimating) {
                        if (e) {
                            ...
                            if (f.keyCode == "13") {
                                c._raiseEvent("4", {index: c.selectedIndex,type: "keyboard",item: c.getItem(c.selectedIndex)})
                            }
                        }
                        if (e && f.keyCode != "9") {
                            return false
            ...
            if (c == "filterable") {
                b.listBoxContainer.jqxListBox({filterable: e})
            }
            if (c == "filterHeight") {
                b.listBoxContainer.jqxListBox({filterHeight: e})
            }
            if (c == "filterPlaceHolder") {
                b.listBoxContainer.jqxListBox({filterPlaceHolder: e})
            }
            if (c == "filterDelay") {
                b.listBoxContainer.jqxListBox({filterDelay: e})
            }
