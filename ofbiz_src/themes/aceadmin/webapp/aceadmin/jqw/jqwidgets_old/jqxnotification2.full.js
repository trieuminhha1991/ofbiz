...
(function(a) {
    ...
    a.extend(a.jqx._jqxNotification.prototype, {defineInstance: function() {
            ...
            if (c.host.hasClass("jqx-notification") == false) {
                ...
                c.host.css({zIndex: c.zIndex,display: "none",opacity: c.opacity});
            ...
            if (c.disabled == false) {
                ...
                c._addHandlers(b);
                b.fadeIn(c.animationOpenDelay, function() {
                    c._raiseEvent("0")
                });
                if (c.blink == true) {
                    b._blinkInterval = setInterval(function() {
                        b.fadeTo(400, c.opacity / 1.5, function() {
            ...
            if (c._instances[b._key]) {
                ...
                b.fadeOut(c.animationCloseDelay, function() {
                    c._removeHandlers(b);
                    b.remove();
                    c._raiseEvent("1")
                })
            ...
            var d = this;
            d.addHandler(b, "click.notification" + d.element.id, function(e) {
                d._raiseEvent("2");
                if (d.closeOnClick == true) {
                    d._close(b)
                }
            });
            d.addHandler(b, "mouseenter.notification" + d.element.id, function(e) {
                if (!b._blinkInterval) {
                    d.mouseenterFunction(b)
                }
            });
            d.addHandler(b, "mouseleave.notification" + d.element.id, function(e) {
            ...
            if (d.showCloseButton == true) {
                ...
                d.addHandler(c, "click.notification" + d.element.id, function(e) {
                    e.stopPropagation();
                    d._close(b)
                })
            }
            ...
            var b = j.host.html();
            if (!g) {
                e = j.host.find(".jqx-notification-content").detach()
            }
            if (g) {
            ...
            if (j.template) {
                ...
                if (j.icon) {
                    ...
                    k.css({width: (parseInt(j.icon.width) + j.icon.padding),height: j.icon.height,"background-image": "url('" + j.icon.url + "')"});
                    f()
                }
            }
            ...
            j.host.append(m);
            if (e.length > 0) {
                j.host.find(".jqx-notification-content").add(e)
            } else {
            ...
            b.css({left: g,right: d,top: f,bottom: c})
            ...
            if (!c.appendContainer) {
                ...
                if (b.length == 0) {
                    a("body").append("<div id='jqxNotificationDefaultContainer-" + c.position + "' class='jqx-notification-container'></div>");
                    b = a("#jqxNotificationDefaultContainer-" + c.position);
