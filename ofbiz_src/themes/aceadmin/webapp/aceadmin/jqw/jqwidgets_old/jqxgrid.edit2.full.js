...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {_handledblclick: function(t, n) {
            if (t.target == null) {
                return
            }
            if (n.disabled) {
                ...
                if (G == 32) {
                    if (w.editcell.columntype == "checkbox") {
                        ...
                        if (e.editable) {
                            ...
                            w._raiseEvent(18, {rowindex: w.editcell.row,row: j,datafield: w.editcell.column,oldvalue: !n,value: n,columntype: "checkbox"});
                            return false
                        }
                    }
                }
                    ...
                    if (f != null && f.length > 0) {
                        for (var p = 0; p < f.length; p++) {
                            ...
                            if (D !== "" && e.editable && w.enablekeyboarddelete) {
                                ...
                                w._raiseEvent(17, {rowindex: c.rowindex,row: j,datafield: c.datafield,value: D});
                                if (p == f.length - 1) {
                                ...
                                w._raiseEvent(18, {rowindex: c.rowindex,row: j,datafield: c.datafield,oldvalue: D,value: i})
                            }
                        }
                ...
                if (G == 32) {
                    ...
                    if (c != null) {
                        ...
                        if (e.columntype == "checkbox" && e.editable) {
                            ...
                            var j = w.getrowdata(c.rowindex);
                            w._raiseEvent(17, {rowindex: c.rowindex,row: j,datafield: c.datafield,value: !n,columntype: "checkbox"});
                            w.setcellvalue(c.rowindex, c.datafield, n, true);
                            w._raiseEvent(18, {rowindex: c.rowindex,row: j,datafield: c.datafield,oldvalue: !n,value: n,columntype: "checkbox"});
                            return false
                        }
                    }
                }
                ...
                if (this.editcell) {
                    ...
                    if (!this.editcell.editing) {
                        ...
                        if (f.columntype != "checkbox" && this.editmode != "selectedrow") {
                            ...
                            this._raiseEvent(17, {rowindex: n,row: h,datafield: f.datafield,value: this.editcell.value,columntype: f.columntype})
                        }
            ...
            var g = function(w) {
                ...
                if (d.displayfield != d.datafield) {
                    ...
                    oldvalue = {value: x,label: v}
                } else {
                    oldvalue = w.editcell.value
                }
                var y = w.getrowdata(h);
                w._raiseEvent(18, {rowindex: h,row: y,datafield: n,displayfield: d.displayfield,oldvalue: i,value: i,columntype: d.columntype});
            ...
            if (d.cellendedit) {
                ...
                if (s == false) {
                    this._raiseEvent(18, {rowindex: h,row: f,datafield: n,displayfield: d.displayfield,oldvalue: oldvalue,value: oldvalue,columntype: d.columntype});
                    g(this);
                    return false
                }
            }
            this._raiseEvent(18, {rowindex: h,row: f,datafield: n,displayfield: d.displayfield,oldvalue: oldvalue,value: i,columntype: d.columntype});
            ...
            a.each(this.columns.records, function(h, j) {
                if (d.editable && this.editable) {
                    ...
                    d._raiseEvent(17, {rowindex: e,row: i,datafield: this.datafield,value: g.value,columntype: this.columntype})
                }
            });
            if (d.editcell) {
            ...
            for (var B = 0; B < this.columns.records.length; B++) {
                ...
                var g = function(F) {
                    ...
                    F._raiseEvent(18, {rowindex: k,row: G,datafield: u,displayfield: e.displayfield,oldvalue: E,value: E,columntype: e.columntype});
                ...
                d[e.datafield] = {newvalue: l,oldvalue: n}
            }
            var y = {};
            var s = {};
            if (!h) {
                ...
                for (var B = 0; B < this.columns.records.length; B++) {
                    ...
                    if (e.columntype == "checkbox") {
                        ...
                        this._raiseEvent(18, {rowindex: k,row: f,datafield: e.datafield,displayfield: e.displayfield,oldvalue: l,value: l,columntype: e.columntype});
                        continue
                    }
                    if (!d[e.datafield]) {
                        continue
                    ...
                    if (e.cellendedit) {
                        ...
                        if (A == false) {
                            this._raiseEvent(18, {rowindex: k,row: f,datafield: u,displayfield: e.displayfield,oldvalue: n,value: n,columntype: e.columntype});
                            g(this);
                            continue
                        }
                    }
                    if (!this.source.updaterow) {
                        this._raiseEvent(18, {rowindex: k,row: f,datafield: e.datafield,displayfield: e.displayfield,oldvalue: n,value: l,columntype: e.columntype})
                    }
                    y[e.datafield] = l;
                    s[e.datafield] = n
                }
                ...
                if (this.source.updaterow) {
                    ...
                    var t = function(I) {
                        ...
                        for (var F = 0; F < D.columns.records.length; F++) {
                            ...
                            var E = H.datafield;
                            D._raiseEvent(18, {rowindex: k,datafield: H.datafield,row: f,displayfield: H.displayfield,oldvalue: s[H.datafield],value: f[H.displayfield],columntype: H.columntype})
                        }
                ...
                case "dropdownlist":
                    if (this.host.jqxDropDownList) {
                        ...
                        if (k == undefined) {
                            ...
                            var x = null;
                            if (!f) {
                                x = new a.jqx.dataAdapter(this.source, {autoBind: false,uniqueDataFields: [A],async: false,autoSort: true,autoSortField: A})
                            } else {
                                var p = {localdata: this.source.records,datatype: this.source.datatype,async: false};
                                x = new a.jqx.dataAdapter(p, {autoBind: false,async: false,uniqueDataFields: [A],autoSort: true,autoSortField: A})
                            }
                            var u = !G.createeditor ? true : false;
                            d.jqxDropDownList({enableBrowserBoundsDetection: true,keyboardSelection: false,source: x,rtl: this.rtl,autoDropDownHeight: u,theme: this.theme,width: g.width() - 2,height: g.height() - 2,displayMember: A,valueMember: E});
                ...
                case "combobox":
                    if (this.host.jqxComboBox) {
                        ...
                        if (r == undefined) {
                            ...
                            var u = !G.createeditor ? true : false;
                            d.jqxComboBox({enableBrowserBoundsDetection: true,keyboardSelection: false,source: x,rtl: this.rtl,autoDropDownHeight: u,theme: this.theme,width: g.width() - 2,height: g.height() - 2,displayMember: A,valueMember: E});
                ...
                case "datetimeinput":
                    if (this.host.jqxDateTimeInput) {
                        ...
                        if (v == undefined) {
                            ...
                            d.jqxDateTimeInput({enableBrowserBoundsDetection: true,localization: F,_editor: true,theme: this.theme,rtl: this.rtl,width: g.width(),height: g.height(),formatString: G.cellsformat});
                            ...
                            if (I != "" && I != null) {
                                ...
                                if (L == "Invalid Date") {
                                    if (this.source.getvaluebytype) {
                                        L = this.source.getvaluebytype(I, {name: G.datafield,type: "date"})
                                    }
                                }
                ...
                case "numberinput":
                    if (this.host.jqxNumberInput) {
                        ...
                        if (N == undefined) {
                            ...
                            d.jqxNumberInput({decimalSeparator: this.gridlocalization.decimalseparator,decimalDigits: M,inputMode: "simple",theme: this.theme,rtl: this.rtl,width: g.width() - 1,height: g.height() - 1,spinButtons: true,symbol: m,symbolPosition: y});
