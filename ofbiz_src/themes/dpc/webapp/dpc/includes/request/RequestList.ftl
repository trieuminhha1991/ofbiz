...
<div class="cartdiv">
    <h2>${uiLabelMap.EcommerceRequestHistory}</h2>
		...
		<thead>
            ...
            <#list requestList as custRequest>
                ...
                <tr>
                    ...
                    <td width="10">&nbsp;</td>
                    <td align="right">
                        <a href="<@ofbizUrl>/ViewRequest?custRequestId=${custRequest.custRequestId}</@ofbizUrl>" class="button">${uiLabelMap.CommonView}</a>
                    </td>
                    <td width="10">&nbsp;</td>
                </tr>
            </#list>
