	...
	<div class="box-heading">
		...
		<div class="pagers">
			<div class="btn-toolbar">
				<div class="btn-group">
					<button class="vNextSpecial btnc" type="button"><img src="/bigshop/images/previous.png"/></button>
					<button class="vPrevSpecial btnc" type="button"><img src="/bigshop/images/next.png"/></button>
				</div>
			</div>
		</div>
	</div>
