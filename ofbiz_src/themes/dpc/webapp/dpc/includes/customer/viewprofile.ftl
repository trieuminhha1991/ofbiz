...
${screens.render("component://ec_default/widget/CustomerScreens.xml#messagelist-include")}

${screens.render("component://ec_default/widget/CustomerScreens.xml#FinAccountList-include")}

<#-- Serialized Inventory Summary -->
${screens.render('component://ec_default/widget/CustomerScreens.xml#SerializedInventorySummary')}

<#-- Subscription Summary -->
${screens.render('component://ec_default/widget/CustomerScreens.xml#SubscriptionSummary')}

<#-- Reviews -->
${screens.render('component://ec_default/widget/CustomerScreens.xml#showProductReviews')}
