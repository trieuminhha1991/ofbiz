...
under the License.
-->
<script src="/bigshop/js/jquery-ui.js"></script>
...
<div class="cartdiv">
  ...
  <div class="screenlet-body">
    ...
    <div id="displayCreateAddressForm" style="display: none;" title="${uiLabelMap.EcommerceAddNewAddress}">
    ...
    <script type="text/javascript">
      //<![CDATA[
        jQuery("#displayCreateAddressForm").dialog({autoOpen: false,width:400, modal: true,
                buttons: {
  ...
  <#-- Default Addresses -->
  <div class="cartdiv">
    <h2>${uiLabelMap.EcommerceDefaultAddresses}</h2>
    <div class="screenlet-body">
      <#--===================================== Billing Address and Telecom number ===========================================-->
      <table>
	<thead>
		<tr>
			<td colspan="6">${uiLabelMap.EcommercePrimaryBillingAddress}</td>
		</tr>
	</thead>
	      <#if billToContactMechId?exists>
	        ...
	        <td><a id="updateBillToPostalAddress" href="javascript:void(0)" class="button popup_link">${uiLabelMap.CommonEdit}</a></td>
	      <#else>
    ...
    <#--===================================== Shipping Address and Telecom number ===========================================-->
      <h2>${uiLabelMap.EcommercePrimaryShippingAddress}</h2>
      <table>
	<tr>
		      <#if shipToContactMechId?exists>
		        ...
		        <td><a id="updateShipToPostalAddress" href="javascript:void(0)" class="button popup_link">${uiLabelMap.CommonEdit}</a></td>
		      <#else>
		        <td>${uiLabelMap.PartyPostalInformationNotFound}</td>
		      </#if>
	      </tr>
  ...
  <div class="cartdiv">
    <h2>${uiLabelMap.EcommerceAdditionalAddresses}</h2>
      ...
      <#list partyContactMechValueMaps as partyContactMechValueMap>
        ...
        <#if contactMech.contactMechTypeId?if_exists = "POSTAL_ADDRESS">
          ...
          <#if !(partyContactMechValueMap.partyContactMechPurposes?has_content)>
            ...
            <div id="displayEditAddressForm_${contactMech.contactMechId}" style="display: none;" title="${uiLabelMap.CommonEdit}">
              <div id="tmpdlg">
		<#include "EditPostalAddress.ftl" />
			...
			<tr>
		                      ...
		                      <#if postalAddress.address2?has_content><td>${postalAddress.address2}</td></#if>
		                    ...
		                    <#if postalAddress.countryGeoId?has_content><td>${postalAddress.countryGeoId}</td></#if>
		                    <td>
					<div>
					                <span>
					 ...
					 <form id="deletePostalAddress_${contactMech.contactMechId}" method= "post" action= "<@ofbizUrl>deletePostalAddress</@ofbizUrl>">
				                    ...
				                    <a onclick="document.getElementById('deletePostalAddress_${contactMech.contactMechId}').submit();" href="javascript:void(0);" class="button">Delete</a>
				                  </form>
		                    </td>
			</tr>
                    </table>
              ...
              <script type="text/javascript">
                //<![CDATA[
                jQuery("#displayEditAddressForm_${contactMech.contactMechId}").dialog({autoOpen: false,width:600, modal: true,
                    buttons: {
                    '${uiLabelMap.CommonSubmit}': function() {
