...
<#if cart?exists && 0 < cart.size()>
  ${screens.render("component://ec_default/widget/OrderScreens.xml#quickAnonOrderHeader")}
  <br />
  <div id="orderItemsSection">${screens.render("component://ec_default/widget/OrderScreens.xml#orderitems")}</div>
