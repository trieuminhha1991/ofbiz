...
<form method="post" name="checkoutInfoForm" style="margin:0;">
    ...
    <div class="screenlet" style="height: 100%;">
        <div class="screenlet-title-bar">
            <div class="h3"><hr /> <h2>${uiLabelMap.OrderMethod}</h2></div>
        </div>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="0">
              <tr>
                <td colspan="2">
                  ...
                  <a href="javascript:submitForm(document.checkoutInfoForm, 'NA', '');" class="button">${uiLabelMap.PartyAddNewAddress}</a>
               ...
               <#if shippingContactMechList?has_content>
                 ...
                 <#list shippingContactMechList as shippingContactMech>
                   ...
                   <tr>
                     <td valign="top" width="1%" nowrap="nowrap" style="padding-top:10px;">
                     ...
                     <td valign="top" width="99%" nowrap="nowrap" style="padding-top:10px;">
                       <div>
                         ...
                         <br /><a href="javascript:submitForm(document.checkoutInfoForm, 'EA', '${shippingAddress.contactMechId}');" class="button">${uiLabelMap.CommonUpdate}</a>
                       </div>
                     </td>
                   </tr>
...
<table width="100%">
  <tr valign="top">
    <td>
      &nbsp;<a href="javascript:submitForm(document.checkoutInfoForm, 'CS', '');" class="button">${uiLabelMap.OrderBacktoShoppingCart}</a>
    </td>
    <td align="right">
      <a href="javascript:submitForm(document.checkoutInfoForm, 'DN', '');" class="button">${uiLabelMap.CommonNext}</a>
    </td>
  </tr>
</table>
