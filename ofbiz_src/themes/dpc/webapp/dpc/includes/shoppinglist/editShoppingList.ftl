...
<div class="cartdiv">
    <div class="boxlink">
        <a href="<@ofbizUrl>createEmptyShoppingList?productStoreId=${productStoreId}</@ofbizUrl>" class="button">${uiLabelMap.CommonCreateNew}</a>
    </div>
    <hr />
    <h2>&nbsp;${uiLabelMap.EcommerceShoppingLists}</h2>
    <div class="screenlet-body">
        <#if shoppingLists?has_content>
          <form name="selectShoppingList" method="post" action="<@ofbizUrl>editShoppingList</@ofbizUrl>">
            ...
            &nbsp;&nbsp;
            <a href="javascript:document.selectShoppingList.submit();" class="button">${uiLabelMap.CommonEdit}</a>
          </form>
        <#else>
...
<div class="screenlet">
    <div class="boxlink">
      <form name= "createCustRequestFromShoppingList" method= "post" action= "<@ofbizUrl>createCustRequestFromShoppingList</@ofbizUrl>">
        ...
        <a href='javascript:document.createCustRequestFromShoppingList.submit()' class="button">${uiLabelMap.OrderCreateCustRequestFromShoppingList}</a>
      </form>
      <form name="createQuoteFromShoppingList" method="post" action="<@ofbizUrl>createQuoteFromShoppingList</@ofbizUrl>">
        <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}"/>
        <a href='javascript:document.createQuoteFromShoppingList.submit()' class="button">${uiLabelMap.OrderCreateQuoteFromShoppingList}</a>
      </form>
      <a href="javascript:document.updateList.submit();" class="button">${uiLabelMap.CommonSave}</a>
    </div>

    <hr />
    <h2>${uiLabelMap.EcommerceShoppingListDetail} - ${shoppingList.listName}</h2>
    <div class="screenlet-body">
            ...
            <table border="0" width="100%" cellspacing="10" cellpadding="0">
              ...
              <tr>
                ...
                <td>
                  ...
                  <#if parentShoppingList?exists>
                    <a href="<@ofbizUrl>editShoppingList?shoppingListId=${parentShoppingList.shoppingListId}</@ofbizUrl>" class="button">${uiLabelMap.CommonGotoParent} (${parentShoppingList.listName?default(parentShoppingList.shoppingListId)})</a>
                  </#if>
                </td>
              </tr>
              <tr>
...
<div class="cartdiv">
    ...
    <a href="javascript:document.reorderinfo.submit();" class="button">${uiLabelMap.CommonSave}</a>
    <div class="screenlet-body">
        <form name="reorderinfo" method="post" action="<@ofbizUrl>updateShoppingList</@ofbizUrl>">
            <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}"/>
            <table class="margin10" width="100%" cellspacing="10" cellpadding="1" border="0">
              <tr>
                ...
                <td>
                  ...
                  &nbsp;
                  <select name="frequency" class="selectBox margin10">
              ...
              <tr>
                <td align="right" colspan="9">
                  <div>
                    <a href="javascript:document.reorderinfo.submit();" class="button">${uiLabelMap.CommonSave}</a>
                    <a href="<@ofbizUrl>editcontactmech?preContactMechTypeId=POSTAL_ADDRESS&amp;contactMechPurposeTypeId=SHIPPING_LOCATION&amp;DONE_PAGE=editShoppingList</@ofbizUrl>" class="button">${uiLabelMap.PartyAddNewAddress}</a>
                    <a href="<@ofbizUrl>editcreditcard?DONE_PAGE=editShoppingList</@ofbizUrl>" class="button">${uiLabelMap.EcommerceNewCreditCard}</a>
                    <a href="<@ofbizUrl>editeftaccount?DONE_PAGE=editShoppingList</@ofbizUrl>" class="button">${uiLabelMap.EcommerceNewEFTAccount}</a>
                  </div>
                </td>
              </tr>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <div class="boxlink">
            <a href="<@ofbizUrl>addListToCart?shoppingListId=${shoppingList.shoppingListId}&amp;includeChild=yes</@ofbizUrl>" class="button">${uiLabelMap.EcommerceAddChildListsToCart}</a>
        </div>
        <h2>&nbsp;${uiLabelMap.EcommerceChildShoppingList} - ${shoppingList.listName}</h2>
    </div>
    <div class="screenlet-body">
...
<hr />
<div class="cartdiv">
	<h2>&nbsp;${uiLabelMap.EcommerceListItems} - ${shoppingList.listName}</h2>
    <a href="<@ofbizUrl>addListToCart?shoppingListId=${shoppingList.shoppingListId}</@ofbizUrl>" class="button">${uiLabelMap.EcommerceAddListToCart}</a>
    <div class="screenlet-body">
              ...
              <#list shoppingListItemDatas[lowIndex-1..highIndex-1] as shoppingListItemData>
                ...
                <#assign isVirtual = product.isVirtual?exists && product.isVirtual.equals("Y")/>
                  <tr>
                    <td>
                      <div>
                         <a href="<@ofbizUrl>product?product_id=${shoppingListItem.productId}</@ofbizUrl>" >${shoppingListItem.productId} -
                    ...
                    <td align="right">
                        <a href="#" onclick="javascript:TimestampSubmit(listform_${shoppingListItem.shoppingListItemSeqId});" class="button margin10">${uiLabelMap.CommonUpdate}</a>
                        <a href="<@ofbizUrl>removeFromShoppingList?shoppingListId=${shoppingListItem.shoppingListId}&amp;shoppingListItemSeqId=${shoppingListItem.shoppingListItemSeqId}</@ofbizUrl>" class="button margin10">${uiLabelMap.CommonRemove}</a>
                      <#if isVirtual && productVariantAssocs?has_content>
                        ...
                        <form method="post" action="<@ofbizUrl>${addToCartAction}</@ofbizUrl>" name="listreplform_${shoppingListItem.shoppingListItemSeqId}" style="margin: 0;">
                          ...
                          <br />
                          <a href="javascript:document.listreplform_${shoppingListItem.shoppingListItemSeqId}.action='<@ofbizUrl>${replaceItemAction}</@ofbizUrl>';document.listreplform_${shoppingListItem.shoppingListItemSeqId}.submit();" class="button margin10">${uiLabelMap.EcommerceReplaceWithVariation}</a>
                          <br />
        ...
        <#else>
            <h3 class="margintop5">${uiLabelMap.EcommerceShoppingListEmpty}.</h3>
        </#if>
    </div>
</div>

<div class="cartdiv">
    <h2>${uiLabelMap.EcommerceShoppingListPriceTotals} - ${shoppingList.listName}</h2>
    <div class="screenlet-body">
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td width="5%" nowrap="nowrap">
              <b>${uiLabelMap.EcommerceChildListTotalPrice}</b>
          </td>
        ...
        <tr>
          <td nowrap="nowrap">
              <b>${uiLabelMap.EcommerceListItemsTotalPrice}&nbsp;</b>
          </td>
        ...
        <tr>
          <td nowrap="nowrap">
              <b>${uiLabelMap.OrderGrandTotal}</b>
          </td>
          <td align="right" nowrap="nowrap">
...
<div class="cartdiv">
    <h2>${uiLabelMap.CommonQuickAddList}</h2>
    <div class="screenlet-body">
        <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
          ...
          <input type="submit" class="button" value="${uiLabelMap.OrderAddToShoppingList}"/>
        </form>
    </div>
</div>
    ...
    <#else>
        ...
        <h3 class="margintop5">${uiLabelMap.EcommerceShoppingListError} ${uiLabelMap.CommonId} ${shoppingList.shoppingListId}) ${uiLabelMap.EcommerceListDoesNotBelong}.</h3>
    </#if>
</#if>
