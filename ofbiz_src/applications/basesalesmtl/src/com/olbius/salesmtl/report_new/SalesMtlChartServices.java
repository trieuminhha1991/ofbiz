...
public class SalesMtlChartServices extends OlbiusOlapService {
    ...
    private OlbiusQuery init() {
        ...
        innerQuery.select("product_dimension.product_code")
                ...
                .groupBy("product_store_dimension.product_store_id").groupBy("pd.party_code")
                .groupBy("product_store_dimension.store_name").groupBy("category_dimension.category_name").groupBy("pd.description")
    ...
    public void prepareResultChart() {
        if(getOlapResult() instanceof OlapColumnChart) {
            addSeries("agency_name");
            addXAxis("internal_name");
            addYAxis("Total");
        }
    }
}
