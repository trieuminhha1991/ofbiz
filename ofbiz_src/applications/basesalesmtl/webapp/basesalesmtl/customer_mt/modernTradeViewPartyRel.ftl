...
<@jqGrid id="jqxPartyRelContact" isShowTitleProperty="false" 
		...
		url="jqxGeneralServicer?sname=JQGetListCustomerRelContact&partyId=${modernTradeInfo.partyId?if_exists}" 
...
<#include "modernTradeViewPartyRelNew.ftl">
<#include "modernTradeViewPartyRelEdit.ftl">
