...
<div class="widget-body" style="margin-top: -12px !important">
	<div class="widget-main padding-4">
		<div class="tab-content overflow-visible" style="padding:8px 0">
			...
			<#include "consigneeViewDetailInfo.ftl"/>

			<#include "consigneeCustomerMTview.ftl">
...
<script type="text/javascript">
	...
	$($(".breadcrumb").children()[2]).html("<span class='divider'><i class='icon-angle-right'></i></span>${StringUtil.wrapString(uiLabelMap.BSConsignee)}");
	$('[data-rel=tooltip]').tooltip();
	</#if>
