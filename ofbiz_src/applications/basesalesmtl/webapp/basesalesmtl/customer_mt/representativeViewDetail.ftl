	...
	<div class="span12">
		<div class="widget-box transparent" id="recent-box">
			<div class="widget-header" style="border-bottom:none">
					...
					<div class="row-fluid">
						<div class="span10">
							<div class="tabbable">
								...
								<a data-toggle="tab" href="#partyowner-tab">${uiLabelMap.BSListMember}</a>
							</li>
						</ul>
					</div><!--.tabbable-->
				</div>
				...
				<#if modernTradeInfo.partyId?exists && hasOlbPermission("MODULE", "${permission}", "VIEW")>
				<a href="<@ofbizUrl>${linkEdit}&partyId=${modernTradeInfo.partyId}&sub=${parameters.sub?if_exists}</@ofbizUrl>" data-rel="tooltip"
...
<div class="widget-body" style="margin-top: -12px !important">
	<div class="widget-main padding-4">
		<div class="tab-content overflow-visible" style="padding:8px 0">
			...
			<#include "representativeViewDetailInfo.ftl"/>

			<#include "representativeViewDetailOwner.ftl">
...
<script type="text/javascript">
	...
	$($(".breadcrumb").children()[2]).html("<span class='divider'><i class='icon-angle-right'></i></span>${StringUtil.wrapString(uiLabelMap.BSMTRepresentativeOfficeDetail)}");
	$('[data-rel=tooltip]').tooltip();
	</#if>
