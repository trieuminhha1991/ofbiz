<#assign representativeOfficeInfos = dispatcher.runSync("loadMTRepresentativeOfficeInfo", Static["org.ofbiz.base.util.UtilMisc"].toMap("partyId", "${endCustomerInfo.representativeOfficeId?if_exists}", "detail", "Y", "userLogin", userLogin))/>
