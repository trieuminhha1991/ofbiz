...
<div id="partyoverview-tab" class="tab-pane<#if !activeTab?exists || activeTab == "" || activeTab == "partyoverview-tab"> active</#if>">
    <div style="position:relative"><!-- class="widget-body"-->
		<#if endCustomerInfo.statusId?exists>
			<#assign statusItem = delegator.findOne("StatusItem", {"statusId" : "${endCustomerInfo.statusId}"}, false)!/>
        ...
        <div><!--class="widget-main"-->
            <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="row-fluid">
                                ...
                                <div class="div-inline-block">
                                    <span><i>${endCustomerInfo.partyCode?if_exists}</i></span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.groupName?if_exists}</span>
                                </div>
                            </div>

                            <div class="row-fluid margin-top10">
                                <div class="logo-company">
                                    <img width="300px" src="${endCustomerInfo.logoImageUrl?default("/salesmtlresources/logo/LOGO_demo.png")}"/>
                                </div>
                            </div>
                        </div><!--.span6-->
                        <div class="span6">
                            <div class="row-fluid">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.officeSiteName?if_exists}</span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.taxAuthInfos?if_exists}</span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.currencyUomId?if_exists}</span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.infoString?if_exists}</span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.contactNumber?if_exists}</span>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="div-inline-block">
                                ...
                                <div class="div-inline-block">
									<span>
										...
										<#assign conditionList = [Static["org.ofbiz.entity.condition.EntityCondition"].makeCondition("partyId", endCustomerInfo.partyId)]/>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="div-inline-block">
                                    <span>${endCustomerInfo.comments?if_exists}</span>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <#if endCustomerInfo.visitFrequencyTypeId?has_content>
								<div class="div-inline-block">
                                    <#list visitFrequencyTypes as item>
										<#if item.visitFrequencyTypeId == endCustomerInfo.visitFrequencyTypeId>
				...
				<#-- get info of supervisor department -->
                    <#if endCustomerInfo.supervisorId?has_content>
						<#assign supDepts = delegator.findByAnd("PartyFullNameDetailSimple", {"partyId" : endCustomerInfo.supervisorId}, null, false)!/>
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="row-fluid">
                                    <div class="div-inline-block">
                                ...
                                <#assign supPersonIds = Static["com.olbius.basesales.party.PartyWorker"].getPartyMgrByDept(delegator, endCustomerInfo.supervisorId)!/>
				...
				<#-- get ingo of sales executive -->
					<#if endCustomerInfo.salesmanId?has_content>
						<#assign salesExecutives = delegator.findByAnd("PartyFullNameDetailSimple", {"partyId" : endCustomerInfo.salesmanId}, null, false)!/>
						<div class="row-fluid">
                            <div class="span6">
                                <div class="row-fluid">
                                    <div class="div-inline-block">
					...
					<#if endCustomerInfo.representativeOfficeId?has_content>
						<#assign representativeOffices = delegator.findByAnd("Party", {"partyId" : endCustomerInfo.representativeOfficeId}, null, false)!/>
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="row-fluid">
                                    <div class="div-inline-block">
