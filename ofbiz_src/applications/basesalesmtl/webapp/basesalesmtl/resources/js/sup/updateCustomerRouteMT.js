	...
	var OlbCustomerRoute = (function($) {
		...
		var initElementComplex = function() {
			...
			var columns = [
				...
				{text: uiLabelMap.BSCustomerName, datafield: "fullName", editable: false},
				{text: uiLabelMap.BSSalesmanCode, datafield: "salesmanId", editable: false, width: 120},
                {text: uiLabelMap.BSAddress, datafield: "postalAddressName", editable: false, width: 250},
		...
		var updateSource = function (routeId) {
            gridListCustomerAssigned.updateSource("jqxGeneralServicer?sname=JQGetCustAssignedToRouteMT&routeId=" + routeId, null, null);
        };
	...
	var OlbAddCustRoute = (function($) {
		...
		var initElementComplex = function() {
            ...
            var columns = [
                ...
                {text: uiLabelMap.BSCustomerName, datafield: "fullName"},
                {text: uiLabelMap.BSAddress, datafield: "postalAddressName", width: 280},
        ...
        var updateSource = function (salesmanId,routeId) {
            gridListCustomerAvailable.updateSource("jqxGeneralServicer?sname=JQGetCustAvailableMT&salesmanId=" + salesmanId + "&routeId=" + routeId, null, null);
        };
