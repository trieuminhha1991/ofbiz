...
<@jqGridMinimumLib/>
<script src="/salesmtlresources/js/supervisor/addConsignee.js?v=0.0.2"></script>
			...
			<div class="row-fluid form-horizontal form-window-content-custom">
            	...
            	<div class="span4">
            		<div class="row-fluid margin-top10">
            			<div class="span5"><label class="text-right">${uiLabelMap.BSConsigneeId}&nbsp;&nbsp;&nbsp;</label></div>
            	...
            	<div class="span5 no-left-margin">
            		<div class="row-fluid margin-top10">
            			<div class="span5"><label class="text-right asterisk">${uiLabelMap.BSConsigneeName}</label></div>
...
<script>
	<#if parameters.partyId?exists>
	$($(".breadcrumb").children()[2]).html("<span class='divider'><i class='icon-angle-right'></i></span>${StringUtil.wrapString(uiLabelMap.BSUpdateConsigneeMT)}");
	$($(".widget-header").children("h4")).html("${StringUtil.wrapString(uiLabelMap.BSUpdateConsigneeMT)}");
	</#if>
