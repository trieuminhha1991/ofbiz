				...
				<div class="form-horizontal form-window-content-custom label-text-left content-description" style="margin:10px">
					<div class="row-fluid">
						<div class="span6">
							...
							<div class="row-fluid">
								<div class="div-inline-block">
									<label>${uiLabelMap.BSProductStore}:</label>
								</div>
								<div class="div-inline-block">
									<span>
						...
						<div class="span6">
							...
							<div class="row-fluid">
								...
								<div class="div-inline-block">
									<span>
										<#if orderHeader.priority?has_content>
											<#assign priorityGV = delegator.findOne("Enumeration", {"enumId": orderHeader.priority}, false)!/>
											<#if priorityGV?exists>${priorityGV.description?if_exists}</#if>
										</#if>
									</span>
								</div>
							</div>
