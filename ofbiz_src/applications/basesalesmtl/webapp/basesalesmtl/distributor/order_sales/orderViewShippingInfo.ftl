...
<div id="shippinginfo-tab" class="tab-pane<#if activeTab?exists && activeTab == "shippinginfo-tab"> active</#if>">
	<div class="row-fluid">
		<div class="span8">
								        	...
								        	<div class="span12">
										        ...
										        <#assign shipGroupShipments = shipGroup.getRelated("PrimaryShipment", null, null, false)>
										       	<#if shipGroupShipments?has_content>
										       		...
										       		<#-- shipment actions -->
											       	<#if hasOlbPermission("MODULE", "DIS_SALESORDER_EDIT", "") && ((orderHeader.statusId == "ORDER_CREATED") || (orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
			...
			<#if (!orderHeader.salesChannelEnumId?exists || orderHeader.salesChannelEnumId != "POS_SALES_CHANNEL")>
				<div>
	  				<ul class="unstyled spaced">
	    				...
	    				<#if hasPermission("SALESORDER_DIS", "_RETURN", session) && orderHeader.statusId == "ORDER_COMPLETED">
	    				...
	    				<li>
	    					<a href="<@ofbizUrl>orderHistory</@ofbizUrl>?orderId=${orderHeader.orderId}">
