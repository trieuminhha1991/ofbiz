<#-- REMOVE23 -->
<div id="DeleteLink" class="modal hide fade" tabindex="-1">
	<div class="modal-header no-padding">
		<div class="table-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			${uiLabelMap.DAConfirmation}
		</div>
	</div>
	<div class="modal-body no-padding">
		<div class="row-fluid"> 
			<div class="row-fluid margin-bottom10">
				${uiLabelMap.DAAreYouSureDelete}
			</div>
		</div>
		<div class="modal-footer">
			<button class="btn btn-danger form-action-button pull-right" data-dismiss="modal"><i class="icon-remove"></i>Close</button>
			<button id="alterSave" class='btn btn-primary form-action-button pull-right'><i class='fa-check'></i>OK</button>
		</div>
	</div>
</div>
<div class="row-fluid">
	...
	<div class="span1 align-right" style="padding-top:5px">
		<a href="#DeleteLink" data-rel="tooltip" role="button" data-toggle="modal" title="${uiLabelMap.DAClearOrder}" data-placement="bottom" class="no-decoration""><i class="icon-trash icon-only" style="font-size:16pt"></i></a>
	</div>
...
<script src="/aceadmin/assets/js/fuelux/fuelux.wizard.min.js"></script>
...
<script type="text/javascript">
	...
	$("#alterSave").on('click', function(){
		window.location.href = "<@ofbizUrl>emptyPurchaseCartDis</@ofbizUrl>";
	})
