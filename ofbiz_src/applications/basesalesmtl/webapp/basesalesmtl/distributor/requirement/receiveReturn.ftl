...
<div class="row-fluid">
    ...
    <div class="step-content row-fluid position-relative" id="step-container">
        ...
        <div class="margin-bottom10" id="containerWarehouse" style="position: absolute;z-index: 999;right: 135px;">
            <div class="pull-right" style="margin: 0px 2px;">
                <div id="facilityId"></div>
            </div>
            <div class="pull-right" style="margin: 3px 10px;">
                <label class="asterisk text-right">${uiLabelMap.LOGEnterWarehouses}</label>
            </div>
        </div><!--row-fluid-->
