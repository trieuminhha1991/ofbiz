<#include 'component://baselogistics/webapp/baselogistics/requirement/script/reqNewRequirementTotalScript.ftl'/>
<div class="row-fluid">
	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "component://baselogistics/webapp/baselogistics/requirement/reqNewRequirementInfo.ftl"/>
					</div> 
				</div>
			</div>
			<div style="position:relative" class="form-window-content-custom">
				${screens.render("component://baselogistics/widget/ProductScreens.xml#ListProducts")}
			</div>
		</div>

		<div class="step-pane" id="step2">
			<#include "component://baselogistics/webapp/baselogistics/requirement/reqNewRequirementConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
