...
<@jqGridMinimumLib/>
<script src="/salesmtlresources/js/distributor/DistributorDetails.js"></script>
<style>
	.row-fluid {
	    min-height: 30px;
	}
...
<div class="form-horizontal form-window-content-custom label-text-left content-description" style="margin:10px;position:relative;">
	<div class="row-fluid">
			...
			<div class="span6" style="padding-left: 15px;">
				<div class="row-fluid">
					<div class="div-inline-block">
						<label>${uiLabelMap.DADistributorName}:</label>
					</div>
					<div class="div-inline-block">
	...
	<#if hasOlbPermission("MODULE", "PARTY_DISTRIBUTOR_APPROVE", "")>
