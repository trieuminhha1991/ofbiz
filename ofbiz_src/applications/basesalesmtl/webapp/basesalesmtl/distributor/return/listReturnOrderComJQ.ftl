<script type="text/javascript">
	...
	var statusData = [<#if statusList?exists><#list statusList as statusItem>{	statusId: '${statusItem.statusId}',
	...
	<#assign columnlist="
			{text: '${uiLabelMap.DAReturnOrderId}', dataField: 'returnId', width: '8%', align: 'center', 
				cellsrenderer: function(row, colum, value) {
	            	...
	            	return \"<span><a href='/delys/control/viewDetailReturnOrder?returnId=\" + data.returnId + \"'>\" + data.returnId + \"</a></span>\";
	            }
			},">
<#else>
	<#assign columnlist="
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListReturnOrderToCompany" dataField=dataField columnlist=columnlist filterable="true"
		 showtoolbar="true" alternativeAddPopup="alterpopupWindow" filtersimplemode="true" addType="popup"
		 deleterow="false" defaultSortColumn="entryDate" sortdirection="desc" 
		 mouseRightMenu="true" contextMenuId="contextMenu" clearfilteringbutton="true"
		 otherParams="fromPartyName:S-getPartyName(partyId{fromPartyId})<partyName>;toPartyName:S-getPartyName(partyId{toPartyId})<partyName>;"
		 />
