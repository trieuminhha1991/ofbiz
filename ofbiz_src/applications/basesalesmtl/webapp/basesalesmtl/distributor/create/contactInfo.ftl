...
<div class="row-fluid form-horizontal form-window-content-custom">
	<div class="span6">
		...
		<div class="row-fluid margin-top10">
			...
			<div class="span7"><input type="text" id="tarAddress" tabindex="9"/></div>
		</div>
		<div class="row-fluid margin-top10">
			<div class="span5"><label class="text-right">${uiLabelMap.EmailAddress}&nbsp;&nbsp;&nbsp;</label></div>
			<div class="span7"><input type="email" id="txtEmailAddress" tabindex="11"/></div>
		</div>
	</div>
	<div class="span6">
		<div class="row-fluid margin-top10">
		...
		<div class="row-fluid margin-top10">
			...
			<div class="span7"><input type="tel" id="txtPhoneNumber" tabindex="10"/></div>
		</div>
	</div>
</div>
