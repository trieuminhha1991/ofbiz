...
<div class="row-fluid margin-bottom20">
	<div class="span12">
		...
		<#if security.hasEntityPermission("PROMOSETTLEMENT_RESULT", "_APPROVE", session)>
		...
		<#if security.hasEntityPermission("PROMOSETTLEMENT_RESULT", "_ACCEPT", session)>
		...
		<#assign dataFieldResult = "[
					...
					{name: 'amountApprove', type: 'string'}, 
					{name: 'quantityAccept', type: 'string'}, 
					{name: 'amountAccept', type: 'string'}, 
		...
		<#assign columnlistResult = "
					...
					{text: '${uiLabelMap.BSPromoLevel}', dataField: 'productPromoRuleId', width: '12%', editable: false},
					{text: '${uiLabelMap.BSAction}', dataField: 'productPromoActionSeqId', width: '12%', editable: false},
					{text: '${uiLabelMap.BSPartyId}', dataField: 'partyId', width: '12%', editable: false},
					{text: '${uiLabelMap.BSProductId}', dataField: 'productCode', width: '12%', editable: false},
					{text: '${uiLabelMap.BSQuantity}', dataField: 'quantity', width: '12%', editable: false, cellsalign: 'right', 
					...
					{text: '${uiLabelMap.BSAmount}', dataField: 'amount', width: '12%', editable: false, cellsalign: 'right', cellsformat: 'c', 
		         		cellsrenderer: function(row, column, value){
					 		var returnVal = '<div class=\"innerGridCellContent align-right\">';
			   				returnVal += formatnumber(value);
			   				returnVal += '</div>';
...
<div class="row-fluid">
	<div class="span12">
		...
		<#assign columnlist = "
					...
					{text: '${uiLabelMap.BSQuantity}', dataField: 'quantity', width: '10%', cellsalign: 'right', cellsformat: 'd'},
					{text: '${uiLabelMap.BSQuantityApprove}', dataField: 'quantityApprove', width: '10%', cellsalign: 'right', cellsformat: 'd'},
					...
					{text: '${uiLabelMap.BSPromoLevel}', dataField: 'productPromoRuleId', width: '12%'},
					{text: '${uiLabelMap.BSAction}', dataField: 'productPromoActionSeqId', width: '12%'},
					{text: '${uiLabelMap.BSRegisterDate}', dataField: 'fromDate', width: '12%', cellsformat: 'dd/MM/yyyy', filtertype:'range',
						cellsrenderer: function(row, colum, value) {
							return \"<span>\" + jOlbUtil.dateTime.formatFullDate(value) + \"</span>\";
						}
					},
					{text: '${uiLabelMap.BSCreatedDate}', dataField: 'createdDate', width: '12%', cellsformat: 'dd/MM/yyyy', filtertype:'range',
						cellsrenderer: function(row, colum, value) {
							return \"<span>\" + jOlbUtil.dateTime.formatFullDate(value) + \"</span>\";
						}
					},
...
<div style="text-align:right">
	<#if hasOlbPermission("MODULE", "PROMOSETTLEMENT_APPROVED", "") && ("PSETTLE_CANCELLED" != promoSettlement.statusId)>
...
<#include "promotionSettlementAddItemPopup.ftl"/>
...
<script type="text/javascript">
	var OlbPromoSettleView = (function(){
			...
			$.each(data, function (key, value){
				if (typeof(value) != 'undefined' && typeof(value.promoSettlementResultId) != 'undefined') {
					var prodItem = {
						...
						amountApprove: typeof(value.amountApprove) != 'undefined' ? value.amountApprove : 0,
		...
		var getListProductAll2 = function(){
			...
			$.each(data, function (key, value){
				if (typeof(value) != 'undefined' && typeof(value.promoSettlementResultId) != 'undefined') {
					var prodItem = {
						promoSettlementResultId: value.promoSettlementResultId,
						quantityAccept: typeof(value.quantityAccept) != 'undefined' ? value.quantityAccept : 0,
						amountAccept: typeof(value.amountAccept) != 'undefined' ? value.amountAccept : 0,
						comment: typeof(value.comment) != 'undefined' ? value.comment : "",
					};
					listProd.push(prodItem);
				}
		...
		var processProductPromo = function(){
			jOlbUtil.confirm.dialog("${uiLabelMap.BSAreYouSureToDoProcessPermission}", function() {
