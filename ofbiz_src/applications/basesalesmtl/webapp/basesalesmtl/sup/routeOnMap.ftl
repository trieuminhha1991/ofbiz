    ...
    if (typeof (OlbRouteOnMap) == "undefined") {
        var OlbRouteOnMap = (function() {
            ...
            self.processData = function(data){
                ...
                //console.log("listRouteWithLatLon", self.listRouteWithLatLon);
                //console.log("listRouteAll", self.listRouteAll);
            ...
            self.open = function(row) {
                ...
                if (OlbCore.isNotEmpty(rowData)) {
                    ...
                    url = 'jqxGeneralServicer?sname=JQGetListRouteSimple&pagesize=0' + '&salesmanId=' + rowData.salesmanId;
                }
                self.updateSource(url);
                if (OlbCore.isNotEmpty(rowData)) {
