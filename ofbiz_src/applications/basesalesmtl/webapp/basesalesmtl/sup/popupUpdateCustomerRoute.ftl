<div id="jqxwindowListCustToRoute" class='hide'>
    <div>${uiLabelMap.BSListAgents}</div>
...
<div id="jqxwindowAddCust" class='hide'>
    ...
    <div style="overflow: hidden;">
        <div class='form-window-content' style="height: 380px;">
            <div class="pull-left" style="font-size: 16px;"><div class="jqxwindowTitle">${uiLabelMap.BSAddCustomerToRoute}:</div> <div class="customerInfo jqxwindowTitle"></div></div>
...
<script type="text/javascript" src="/salesmtlresources/js/sup/updateCustomerRoute.js?v=1.0.12"></script>