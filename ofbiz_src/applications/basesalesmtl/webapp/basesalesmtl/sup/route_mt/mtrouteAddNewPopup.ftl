<div id="alterpopupWindowAdd" class='hide'>
	...
	<div class="form-window-container">
		...
		<div class="form-action">
			<button id="cancelCreateRouteMT" class='btn btn-danger form-action-button pull-right'><i class='fa-remove'></i> ${uiLabelMap.CommonCancel}</button>
			<button id="createRouteMT" class='btn btn-primary form-action-button pull-right'><i class='fa-check'></i>${uiLabelMap.CommonSave}</button>
		</div>
	</div>
</div>
        ...
        var AddRouteObj = (function () {
            ...
            var initElement = function () {
                $("#alterpopupWindowAdd").jqxWindow({
                    ...
                    isModal: true,
                    autoOpen: false,
                    cancelButton: $("#cancelCreateRouteMT"),
                    modalOpacity: 0.7,
                    theme: theme
                });
            ...
            var initEvent = function () {
                ...
                $("#createRouteMT").on("click", function (event) {
                    ...
                    if(!flagUpdate){
                        ...
                        if(salemanOldId !== salesmanDDB.getValue() ) {
                            salemanId=salesmanDDB.getValue();
                            routeId=currentData.routeId;
                            setTimeout(function(){
                                $.ajax({
                                    url: "jqxGeneralServicer?sname=JQGetListRouteCustomerChangeSaleman&salemanId="+salemanId+"&routeId="+routeId,
                                    type: "POST",
                                    async: false,
                                    ...
                                    success: function (data){
                                        if(data.TotalRows=="0"){
                                            ...
                                            OlbCustomerRouteChangeSalesman.updateSource(routeId,salemanId);
                                        }
            ...
            var getData = function () {
                ...
                mapResult["salesmanId"] = salesmanDDB.getValue();
                if (flagUpdate) {
            ...
            var salemanOldId=null;
            var initDataUpdate = function (row) {
                salemanOldId=row.salesmanId;
            ...
            var updateRoute = function (isPartyChange) {
                if (!currentData) return;
                changeRow['isPartyChange'] = isPartyChange;
                currentGrid.jqxGrid('updaterow', currentRow, changeRow);
                $("#alterpopupWindowAdd").jqxWindow('close');
            };
