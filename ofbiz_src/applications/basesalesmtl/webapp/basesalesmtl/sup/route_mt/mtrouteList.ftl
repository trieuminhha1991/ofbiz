...
<#assign dataField="[{ name: 'routeId', type: 'string'},
					...
					{ name: 'isPartyChange', type: 'string'},
...
<#assign columnlist="{ text: '${StringUtil.wrapString(uiLabelMap.BsRouteId)}', datafield: 'routeCode', width: '16%'},
					...
					{ text: '${StringUtil.wrapString(uiLabelMap.BSDescription)}', datafield: 'isPartyChange', width: '20%',hidden: true},
					{ text: '${StringUtil.wrapString(uiLabelMap.BSScheduleDescription)}' , datafield: 'scheduleRoute', 'minWidth' : 250, width: '25%', sortable: false, cellsalign: 'left', filtertype: 'checkedlist',
						cellsrenderer: function(row, column, value, a, b, data){
							...
							if(scheduleRoute==null) scheduleRoute=[];
...
url="jqxGeneralServicer?sname=JQGetListRouteMT" contextMenuId="Context${id}" mouseRightMenu="true"
deleterow=deleterow removeUrl="jqxGeneralServicer?jqaction=D&sname=deleteRouteMT" deleteColumn="routeId"
addColumns="routeCode;routeName;description;scheduleRoute;salesmanId;weeks"
addrow=addrow createUrl="jqxGeneralServicer?jqaction=C&sname=createRouteMT"
updateUrl="jqxGeneralServicer?jqaction=U&sname=updateRouteMT"
editColumns="routeCode;routeName;description;scheduleRoute;salesmanId;routeId;weeks;isPartyChange"
customcontrol1=customcontrol1
/>
<#include "../../loader/loader.ftl"/>
<#include "mtpopupListCustomerRouteChangeSalesman.ftl"/>
<#include "mtrouteAddNewPopup.ftl"/>
<#include "mtrouteContextMenu.ftl"/>
<#include "mtrouteListOfCustomer.ftl"/> <#--map-->
<#include "mtpopupUpdateCustomerRoute.ftl"/> <#--grid-->
<#include "mtpopupUpdateCustomerLocation.ftl"/>
<#include "mtgenScheduleRoute.ftl"/>
<#include "mtrouteOnMap.ftl"/>
<#include "mtgenCustomerSequenceOfRoute.ftl"/>
