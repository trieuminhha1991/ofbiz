...
if (partyId == null) {
	currentPartyId = context.get("currentPartyId");
	partyId = currentPartyId;
	if (partyId) {
		parameters.preContactMechTypeId = "POSTAL_ADDRESS";
		parameters.contactMechPurposeTypeId = "SHIPPING_LOCATION";
		request.setAttribute("preContactMechTypeId", "POSTAL_ADDRESS");
		request.setAttribute("contactMechPurposeTypeId", "SHIPPING_LOCATION");
	}
}
...
context.preContactMechTypeId = parameters.preContactMechTypeId; //"POSTAL_ADDRESS"
context.paymentMethodId = parameters.paymentMethodId;

cmNewPurposeTypeId = parameters.contactMechPurposeTypeId; //SHIPPING_LOCATION
