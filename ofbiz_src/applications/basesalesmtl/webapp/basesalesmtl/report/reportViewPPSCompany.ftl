...
<script type="text/javascript">
	...
	var gFromDateC; var gThruDateC; var gProductStoreC; var gLimitNumberC; var gCategoryC; var gOrderStatusC; var gGridC; var gChart1C; 
	var gChart2C; var gCustomTimeC;
		...
		$(function(){
	        ...
	        gGridC.init(function () {
	        	...
	        	if(dataAll.length != 0){
	            	...
	            	window.location.href = "exportTurnoverProProStoReportToExcel?fromDate=" + dateFrom + "&thruDate=" + thruFrom +  "&productStore=" + productStoreInput + "&orderStatus=" + orderStatus + "&category=" + categoryInput;
	        	}else{
...
<div class="chart1C">
	<script type="text/javascript" id="PPSAreaChart">
		$(function(){
	        ...
	        gChart1C = OLBIUS.oLapChart('PPSAreaChart', config, null, 'evaluateSalesPPSAreaChart', true, true, OLBIUS.defaultColumnFunc);
	...
	<script type="text/javascript" id="PPSPieChartTotal">
	    $(function () {
	        ...
	        gChart2C = OLBIUS.oLapChart('PPSPieChartTotal', config, null, 'evaluateTurnoverPPSPieChart2', true, true, OLBIUS.defaultPieFunc);
