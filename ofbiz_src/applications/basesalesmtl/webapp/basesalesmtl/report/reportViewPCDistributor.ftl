...
<script type="text/javascript">
	...
	<#if categoryList?exists>
     ...
     var gFromDateD; var gThruDateD; var gSortD; var gOrderStatusD; var gCategoryD; var gChannelD; var gGridD; var gChart1D; var gChart2D; var gCustomTimeD;
		...
		$(function(){
	        ...
	        gGridD.init(function () {
	        	...
	        	if(dataAll.length != 0){
	            	...
	            	window.location.href = "exportTurnoverProChaReportDisToExcel?fromDate=" + dateFrom + "&thruDate=" + thruFrom + "&channel=" + channelInput + "&orderStatus=" + orderStatus + "&category=" + categoryInput;
	        	}else{
...
<div class="chartD">
	...
	<script type="text/javascript" id="PCDPieChartTotal">
	    $(function () {
	        var config = {
	            chart: {
	        ...
	        gChart2D = OLBIUS.oLapChart('PCDPieChartTotal', config, null, 'evaluateTurnoverPCPCMTL', true, true, OLBIUS.defaultPieFunc);
