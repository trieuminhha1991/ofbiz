...
<script type="text/javascript" id="salesmanOrderTotal">
    $(function () {
        ...
        var saleOrderOLap = OLBIUS.oLapChart('salesmanOrderTotal', config, configPopup, 'salesmanOrderTotalDis', true, true, OLBIUS.defaultLineFunc);
