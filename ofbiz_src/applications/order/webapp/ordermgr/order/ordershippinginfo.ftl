...
<span class="span6" style="margin-top:-42px">

<div class="widget-box olbius-extra">
 <div class="widget-box collapsed">
    <div class="widget-header widget-header-small header-color-blue2">
   
      <h4>${uiLabelMap.OrderActions}</h4>
      ...
      <ul class="unstyled spaced">
        <#if security.hasEntityPermission("FACILITY", "_CREATE", session) && ((orderHeader.statusId == "ORDER_APPROVED") || (orderHeader.statusId == "ORDER_SENT"))>
          ...
          <#if orderHeader.orderTypeId == "SALES_ORDER">
            ...
            <a href="javascript:document.quickShipOrder.submit()" class="btn btn-mini btn-primary open-sans icon-forward">${uiLabelMap.OrderQuickShipEntireOrder}</a></li>
          <#else> <#-- PURCHASE_ORDER -->
            ...
            <#if ownedFacilities?has_content>
              <#if !allShipments?has_content>
                  <li>
                     <form action="/facility/control/quickShipPurchaseOrder?externalLoginKey=${externalLoginKey}" method="post">
                      ...
                      <button type="submit" class="btn btn-small btn-primary open-sans icon-forward">
                  ...
                  <li>
                    <form name="receivePurchaseOrderForm" action="/facility/control/quickShipPurchaseOrder?externalLoginKey=${externalLoginKey}" method="post">
                      ...
                      <i class="icon-caret-right blue"></i><a href="javascript:document.receivePurchaseOrderForm.submit()" class="btn btn-mini btn-primary icon-foward">${uiLabelMap.CommonReceive}</a>
                  </li>
              <#else>
                  <li>
                    ...
                    <i class="icon-caret-right blue"></i><a href="javascript:document.receiveInventoryForm.submit()" class="btn btn-mini btn-primary icon-foward">${uiLabelMap.OrderQuickReceivePurchaseOrder}</a>
                  </li>
                  <li>
                    ...
                    <i class="icon-caret-right blue"></i><a href="javascript:document.partialReceiveInventoryForm.submit()" class="btn btn-mini btn-primary icon-foward">${uiLabelMap.CommonReceive}</a>
                  </li>
              </#if>
              <#if orderHeader.statusId != "ORDER_COMPLETED">
                  <li>
                    ...
                    <button type="submit" class="btn btn-small btn-primary icon-foward">
        ...
        <#if orderHeader.statusId != "ORDER_COMPLETED" && orderHeader.statusId != "ORDER_CANCELLED">
          <li><a href="<@ofbizUrl>OrderDeliveryScheduleInfo?orderId=${orderId}</@ofbizUrl>" style="width:auto;" class="icon-eye-open open-sans">${uiLabelMap.OrderViewEditDeliveryScheduleInfo}</a></li>
        </#if>
        <#if security.hasEntityPermission("ORDERMGR", "_RETURN", session) && orderHeader.statusId == "ORDER_COMPLETED">
          <#if returnableItems?has_content>
            ...
            <a href="javascript:document.quickRefundOrder.submit()" class="btn btn-mini btn-primary">${uiLabelMap.OrderQuickRefundEntireOrder}</a>
            </li>
            <li>
            ...
            <a href="javascript:document.quickreturn.submit()" class="btn btn-mini btn-primary open-sans icon-plus-sign">${uiLabelMap.OrderCreateReturn}</a>
            </li>
          </#if>
        </#if>
        ...
        <#if orderHeader?has_content && orderHeader.statusId != "ORDER_CANCELLED">
          <#if orderHeader.statusId != "ORDER_COMPLETED">
            ...
            -->
            <li><a href="<@ofbizUrl>editOrderItems?${paramString}</@ofbizUrl>" style="width:auto;" class="icon-edit open-sans">${uiLabelMap.OrderEditItems}</a></li>
            <li>
            <form name="createOrderItemShipGroup" method="post" action="<@ofbizUrl>createOrderItemShipGroup</@ofbizUrl>">
              <input type="hidden" name="orderId" value="${orderId}"/>
            </form>
            <a href="javascript:document.createOrderItemShipGroup.submit()" style="width:auto;" class="icon-plus-sign open-sans">${uiLabelMap.OrderCreateShipGroup}</a>
            </li>
          </#if>
          <li><a href="<@ofbizUrl>loadCartFromOrder?${paramString}&amp;finalizeMode=init</@ofbizUrl>" style="width:auto;" class="icon-plus-sign open-sans">${uiLabelMap.OrderCreateAsNewOrder}</a></li>
          <#if orderHeader.statusId == "ORDER_COMPLETED">
            <li><a href="<@ofbizUrl>loadCartForReplacementOrder?${paramString}</@ofbizUrl>" class="btn btn-mini btn-primary open-sans icon-plus-sign">${uiLabelMap.OrderCreateReplacementOrder}</a></li>
          </#if>
        </#if>
        <li><a href="<@ofbizUrl>OrderHistory?orderId=${orderId}</@ofbizUrl>" style="width:auto;" class="icon-eye-open open-sans icon-eye-open">${uiLabelMap.OrderViewOrderHistory}</a></li>
      </ul>
    </div>
     </div>
      </div>
...
<#list shipGroups as shipGroup>
 ...
 <div class="widget-box collapsed">
    <div class="widget-header widget-header-small header-color-blue2">
         <h4>${uiLabelMap.OrderShipmentInformation} - ${shipGroup.shipGroupSeqId}</h4>
         <div class="widget-toolbar">
        	<a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a>
		</div>
    </div>
    ...
    <div class="widget-main">
         ...
         <a class="open-sans btn-pdf" target="_BLANK" href="<@ofbizUrl>shipGroups.pdf?orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}</@ofbizUrl>">${uiLabelMap.OrderShipGroup} PDF</a>
        ...
        <table class="table table-striped table-bordered table-hover dataTable" cellspacing='0'>
                ...
                <tr>
                    ...
                    <td valign="top" width="80%">
                        <button type="submit" class="btn btn-primary btn-mini open-sans" name="submitButton"><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
                        <a class="btn btn-mini btn-primary icon-plus-sign open-sans" id="newShippingAddress" href="javascript:void(0);">${uiLabelMap.OrderNewShippingAddress}</a>
              ...
              <td colspan="3">
                <table>
                  ...
                  <form name="UpdateShippingMethod" method="post" action="<@ofbizUrl>updateShippingMethodAndCharges</@ofbizUrl>">
                    ...
                    <tr>
                      <td valign="top" width="80%">
                        <button type="submit" class="btn btn-primary btn-small open-sans" name="submitButton"><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
                      </td>
                    </tr>
                  </form>
                </table>
                ...
                <#if shipGroup.maySplit?upper_case == "N">
                    ...
                    <#if security.hasEntityPermission("ORDERMGR", "_UPDATE", session)>
                      <#if orderHeader.statusId != "ORDER_COMPLETED" && orderHeader.statusId != "ORDER_CANCELLED">
                        ...
                        <a href="javascript:document.allowordersplit_${shipGroup.shipGroupSeqId}.submit()" class="btn btn-mini btn-primary open-sans">${uiLabelMap.OrderAllowSplit}</a>
                      </#if>
                    </#if>
                <#else>
                ...
                <#if shipGroup.shippingInstructions?has_content>
                  <table>
                    <tr>
                      ...
                      <td>
                        <a href="javascript:editInstruction('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary icon-edit" id="editInstruction_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonEdit}</a>
                      </td>
                    </tr>
                  </table>
                <#else>
                  <a href="javascript:addInstruction('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary open-sans icon-plus-sign" id="addInstruction_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonAdd}</a>
                </#if>
                <a href="javascript:saveInstruction('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary icon-save open-sans" id="saveInstruction_${shipGroup.shipGroupSeqId}" style="display:none">${uiLabelMap.CommonSave}</a>
          ...
          <td>
            <form id="setGiftMessageForm_${shipGroup.shipGroupSeqId}" name="setGiftMessageForm" method="post" action="<@ofbizUrl>setGiftMessage</@ofbizUrl>">
              ...
              <#if shipGroup.giftMessage?has_content>
                ...
                <a href="javascript:editGiftMessage('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary icon-edit" id="editGiftMessage_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonEdit}</a>
              <#else>
                <a href="javascript:addGiftMessage('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary  open-sans icon-plus-sign" id="addGiftMessage_${shipGroup.shipGroupSeqId}">${uiLabelMap.CommonAdd}</a>
              </#if>
              ...
              <a href="javascript:saveGiftMessage('${shipGroup.shipGroupSeqId}');" class="btn btn-mini btn-primary open-sans icon-save" id="saveGiftMessage_${shipGroup.shipGroupSeqId}" style="display:none">${uiLabelMap.CommonSave}</a>
            </form>
          </td>
        </tr>
        </#if>
          ...
          <tr>
            ...
            <td valign="top" width="80%">
                <#list shipGroupShipments as shipment>
                    <div>
                      ${uiLabelMap.CommonNbr}<a href="/facility/control/ViewShipment?shipmentId=${shipment.shipmentId}${externalKeyParam}" class="btn btn-mini btn-primary open-sans">${shipment.shipmentId}</a>&nbsp;&nbsp;
                      <br /><br /><a target="_BLANK" href="/facility/control/PackingSlip.pdf?shipmentId=${shipment.shipmentId}${externalKeyParam}" class="btn btn-mini btn-primary open-sans">${uiLabelMap.ProductPackingSlip}</a>
                      <#if "SALES_ORDER" == orderHeader.orderTypeId && "ORDER_COMPLETED" == orderHeader.statusId>
                        ...
                        <#if shipmentRouteSegments?has_content>
                          ...
                          <#if "UPS" == (shipmentRouteSegment.carrierPartyId)?if_exists>
                            <a href="javascript:document.upsEmailReturnLabel${shipment_index}.submit();" class="btn btn-mini btn-primary icon-plus-sign">${uiLabelMap.ProductEmailReturnShippingLabelUPS}</a>
                          </#if>
            ...
            <td colspan="3" valign="top" width="100%" align="center">
             <#if orderHeader.orderTypeId == "SALES_ORDER">
               <#if !shipGroup.supplierPartyId?has_content>
                 ...
                 <a href="/facility/control/PackOrder?facilityId=${storeFacilityId?if_exists}&amp;orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}${externalKeyParam}" class="btn btn-mini btn-primary open-sans">${uiLabelMap.OrderPackShipmentForShipGroup}</a>
                 <br /><br />
                 </#if>
                 <a href="javascript:document.createShipment_${shipGroup.shipGroupSeqId}.submit()" class="btn btn-mini btn-primary open-sans icon-plus-sign">${uiLabelMap.OrderNewShipmentForShipGroup}</a>
               ...
               <#if facilities?has_content>
                   <div>
                    <form name="createShipment2_${shipGroup.shipGroupSeqId}" method="post" action="/facility/control/createShipment">
                       ...
                       ${uiLabelMap.OrderNewShipmentForShipGroup} [${shipGroup.shipGroupSeqId}]
                       </button>
                    </form>
                    </div>
               <#else>
