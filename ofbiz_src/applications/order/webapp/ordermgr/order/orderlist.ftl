         ...
         <tr>
	        <td>
	          <#if state.hasPrevious()>
	            <a href="<@ofbizUrl>orderlist?viewIndex=${state.getViewIndex() - 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}</@ofbizUrl>" class="btn btn-primary btn-mini margin-top20 open-sans"><i class="icon-arrow-left  icon-on-left"></i>&nbsp;${uiLabelMap.CommonPrevious}</a>
	          </#if>
	        </td>
	        <td align="right">
	          <#if state.hasNext()>
	            <a href="<@ofbizUrl>orderlist?viewIndex=${state.getViewIndex() + 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}</@ofbizUrl>" class="btn btn-primary btn-mini margin-top20 open-sans">${uiLabelMap.CommonNext}&nbsp;<i class="icon-arrow-right  icon-on-right"></i></a>
	          </#if>
	        </td>
      </tr>
    </table>
						          ...
						          <tr>
						            ...
						            <td nowrap="nowrap">
						                <div>
						                    ...
						                    //comment: input type="checkbox" name="viewsent" value="Y" <#if state.hasStatus('viewsent')>checked="checked"</#if> />${uiLabelMap.CommonSent}
						                    <label>
