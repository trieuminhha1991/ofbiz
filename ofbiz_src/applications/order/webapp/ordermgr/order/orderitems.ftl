...
<div class="widget-box collapsed">
        <div class="widget-header widget-header-small header-color-blue2">
            <h4>${uiLabelMap.OrderOrderItems}</h4>
    	...
    	<div class="widget-main">
            <table class="table table-striped table-bordered table-hover dataTable" cellspacing='0' style="margin: -12px; width: auto;">
                                    ...
                                    <#if returns?has_content>
                                        <#list returns as returnItem>
                                            ...
                                            <#if returnHeader.statusId != "RETURN_CANCELLED">
                                                ...
                                                ${uiLabelMap.CommonNbr}<a href="<@ofbizUrl>returnMain?returnId=${returnItem.returnId}</@ofbizUrl>" class="btn btn-mini btn-primary">${returnItem.returnId}</a>
                                            </#if>
                                        </#list>
                                    </#if>
                                </td>
                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        ...
                                        <a href="/content/control/ViewSurveyResponses?surveyResponseId=${survey.surveyResponseId}&amp;surveyId=${survey.surveyId}${externalKeyParam}"
                                           class="btn btn-mini btn-primary open-sans">${survey.surveyId}</a>
                                    </td>
                                    <td colspan="5">&nbsp;</td>
                                </tr>
                            </#list>
                            ...
                            <#list orderItemShipGrpInvResList as orderItemShipGrpInvRes>
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        ...
                                        <a class="open-sans" href="/facility/control/EditInventoryItem?inventoryItemId=${orderItemShipGrpInvRes.inventoryItemId}${externalKeyParam}"
                ...
                <tr>
                    <td align="right" colspan="5">
                        <span >${uiLabelMap.OrderTotalOtherOrderAdjustments}</span>
                    </td>
                    <td align="right" nowrap="nowrap">
                ...
                <tr>
                    <td align="right" colspan="5">
                        <span >${uiLabelMap.OrderTotalShippingAndHandling}</span>
                    </td>
                    <td align="right" nowrap="nowrap">
                ...
                <tr>
                    <td align="right" colspan="5">
                        <span >${uiLabelMap.OrderTotalSalesTax}</span>
                    </td>
                    <td align="right" nowrap="nowrap">
                ...
                <tr>
                    <td align="right" colspan="5">
                        <span >${uiLabelMap.OrderTotalDue}</span>
                    </td>
                    <td align="right" nowrap="nowrap">
