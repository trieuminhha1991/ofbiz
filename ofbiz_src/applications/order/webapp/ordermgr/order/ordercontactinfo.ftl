...
<div class="row-fluid">
<span class="span6" style="margin-top:-3px" >

<div class="widget-box olbius-extra" >
<div class="widget-box collapsed">
    <div class="widget-header widget-header-small header-color-blue2">
     <h4>${uiLabelMap.OrderContactInformation}</h4>
        ...
        <tr>
          ...
          <td valign="top" width="80%">
            <div>
              ...
              <#if partyId?exists>
                &nbsp;(<a href="${customerDetailLink}${partyId}${externalKeyParam}" target="partymgr" class="">${partyId}</a>)
                <br/>
                <#if orderHeader.salesChannelEnumId != "POS_SALES_CHANNEL">
                <div>
                   <a href="<@ofbizUrl>/orderentry?partyId=${partyId}&amp;orderTypeId=${orderHeader.orderTypeId}</@ofbizUrl>" class="open-sans icon-plus-sign">${uiLabelMap.OrderNewOrder}</a>
                   <a href="javascript:document.searchOtherOrders.submit()" class="icon-slack open-sans">${uiLabelMap.OrderOtherOrders}</a>
                </div>
