...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      <li class="h3 btn btn-small btn-primary open-sans icon-plus-sign" >&nbsp;${uiLabelMap.OrderAddToOrder}</li>
    </ul>
    <br class="clear"/>
  </div>
        ...
        <form method="post" action="<@ofbizUrl>appendItemToOrder</@ofbizUrl>" name="appendItemForm">
            ...
            <table class="basic-table" cellspacing="0">
              ...
              <#if (shipGroups?size > 1)>
                ...
                <tr>
                  <td class="label">&nbsp;</td>
                  <td><input class=" btn btn-small btn-primary open-sans icon-plus-sign" type="submit" value="${uiLabelMap.OrderAddToOrder}"/></td>
                </tr>
            </table>
        </form>
    </div>
