        ...
        <#else>
            ...
            <table class="basic-table order-items" cellspacing="0">
                ...
                <tr>
                    <td colspan="7">&nbsp;</td>
                    <td>
                        <input type="submit" class="open-sans icon-ok btn btn-small btn-primary" value="${uiLabelMap.OrderUpdateItems}" class="buttontext"/>
                    </td>
                </tr>
                <tr><td colspan="8"><hr /></td></tr>
            </table>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap" width="15%">
                                <#if (allowPriceChange)>
                                   ...
                                   <input class="smallSubmit open-sans btn btn-small btn-primary icon-ok"  type="submit" value="${uiLabelMap.CommonUpdate}"/>
                                    <a href="javascript:document.deleteOrderAdjustment${orderAdjustmentId}.submit();" class="buttontext icon-trash open-sans btn btn-small btn-primary">${uiLabelMap.CommonDelete}</a>
                                <#else>
                ...
                <table class="basic-table" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="15%">
                            ...
                            <input class="smallSubmit btn btn-small btn-primary open-sans icon-plus-sign" type="submit" value="${uiLabelMap.CommonAdd}"/>
                        </td>
                    </tr>
                </table>
            </form>
