...
function submitForm(form, mode, value) {
    if (mode == "DN") {
        ...
        form.action="<@ofbizUrl>checkoutfinal</@ofbizUrl>";
        form.submit();
    } else if (mode == "CS") {
        // continue shopping
        form.action="<@ofbizUrl>updateCheckoutOptions/salesshowcart</@ofbizUrl>";
        form.submit();
    } else if (mode == "NA") {
        // new address
                     ...
                     <#list shippingContactMechList as shippingContactMech>
                       ...
                       <tr>
                         <td valign="top" width="1%">
                         	<label>
								<input type="radio" name="shipping_contact_mech_id" value="${shippingAddress.contactMechId}" <#if shoppingCart.getShippingContactMechId()?default("") == shippingAddress.contactMechId> checked="checked"</#if>/><span class="lbl"></span>
							</label>
                         </td>
...
<table width="100%">
  <tr valign="top">
    ...
    <td align="right">
      <a href="javascript:submitForm(document.checkoutInfoForm, 'DN', '');" class="btn btn-primary btn-mini">${uiLabelMap.OrderContinueToFinalOrderReview}</a>
    </td>
  </tr>
</table>
