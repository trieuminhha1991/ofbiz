        ...
        <table width="100%" border="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable">
          ...
          <#list orderItems?if_exists as orderItem>
                ...
                <td valign="top">
                  <div>
                    <#if orderItem.productId?exists>
                      <a href="<@ofbizUrl>product?product_id=${orderItem.productId}</@ofbizUrl>" class="btn btn-info btn-mini">${orderItem.productId} - ${orderItem.itemDescription}</a>
                    <#else>
           ...
           <#if !orderItems?has_content>
             <tr><td colspan="5"><font color="red">${uiLabelMap.checkhelpertotalsdonotmatchordertotal}</font></td></tr>
           </#if>
