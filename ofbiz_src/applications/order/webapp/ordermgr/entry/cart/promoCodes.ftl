...
<div class="widget-box olbius-extra no-border-bottom transparent">
	<div class="widget-header widget-header-small header-color-blue2">
    	<h4>${uiLabelMap.OrderPromotionCouponCodes}</h4>
    </div>
    ...
    <div class="widget-body-inner">
      ...
      <div>
        ...
        <table>
          ...
          <td>
          <button type="submit" class="btn btn-primary btn-small open-sans" name="submitButton"><i class="icon-ok"></i>${uiLabelMap.OrderAddCode}</button>
