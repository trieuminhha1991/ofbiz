...
<div class="widget-box olbius-extra">
    <div class="widget-header widget-header-small header-color-blue2">
        <h6>${uiLabelMap.OrderPromotionCategories}</h6>
    ...
    <div class="widget-main">
        <#if productPromoCategoryIncludeList?has_content>
          ...
          <#list productPromoCategoryIncludeList as productPromoCategory>
            ...
            <div>
                -&nbsp;<a href="<@ofbizUrl>category/~category_id=${productPromoCategory.productCategoryId}</@ofbizUrl>" class="btn btn-mini btn-info">${(productCategory.description)?default(productPromoCategory.productCategoryId)}</a>
