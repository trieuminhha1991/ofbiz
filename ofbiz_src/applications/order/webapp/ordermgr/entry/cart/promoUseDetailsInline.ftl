...
<div class="widget-header widget-header-small header-color-blue2">
    <h6>${uiLabelMap.OrderPromotionInformation}</h6>
...
<div class="widget-body">
   <div class="widget-body-inner">
   		<div class="widget-main">
    		<h3 class="blue smaller">${uiLabelMap.OrderPromotionsApplied}:</h3>
        		<ul>    
    	...
    	<h3 class="smaller blue">${uiLabelMap.OrderCartItemUseinPromotions}:</h3>
    	<ul>
