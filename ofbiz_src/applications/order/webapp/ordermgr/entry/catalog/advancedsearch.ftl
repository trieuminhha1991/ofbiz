...
<form name="advtokeywordsearchform" method="post" action="<@ofbizUrl>keywordsearch</@ofbizUrl>" style="margin: 0;">
  ...
  <table border="0" wdith="100%">
    ...
    <td></td>
      <td>
        <div>
          <a href="javascript:document.advtokeywordsearchform.submit()" class="btn btn-small btn-primary icon-search"> ${uiLabelMap.CommonFind}</a>
        </div>
      </td>
    </tr>
  </table>
  ...
  <#if searchOptionsHistoryList?has_content>
    ...
    <div>
      <a href="<@ofbizUrl>clearSearchOptionsHistoryList</@ofbizUrl>" class="btn btn-small btn-info">${uiLabelMap.OrderClearSearchHistory}</a>
    ...
    <#-- searchOptions type is ProductSearchSession.ProductSearchOptions -->
        <div>
          ...
          <a href="<@ofbizUrl>setCurrentSearchFromHistoryAndSearch?searchHistoryIndex=${searchOptions_index}&amp;clearSearch=N</@ofbizUrl>" class="btn btn-mini btn-info">${uiLabelMap.CommonSearch}</a>
          <a href="<@ofbizUrl>setCurrentSearchFromHistory?searchHistoryIndex=${searchOptions_index}</@ofbizUrl>" class="btn btn-mini btn-info">${uiLabelMap.CommonRefine}</a>
        </div>
