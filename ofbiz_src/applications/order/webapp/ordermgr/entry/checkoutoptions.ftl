                ...
                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <a href="javascript:submitForm(document.checkoutInfoForm, 'NA', '');" class="btn btn-primary btn-mini open-sans icon-plus-sign">${uiLabelMap.PartyAddNewAddress}</a>
                    </td>
                  </tr>
                  <#if (shoppingCart.getTotalQuantity() > 1) && !shoppingCart.containAllWorkEffortCartItems()> <#-- no splitting when only rental items -->
                    ...
                    <tr>
                      <td colspan="2" align="center">
                        <a href="<@ofbizUrl>splitship</@ofbizUrl>" class="btn btn-primary btn-mini open-sans">${uiLabelMap.OrderSplitIntoMultipleShipments}</a>
                       ...
                       <tr>
                         ...
                         <td valign="top" width="99%">
                           <div>
                             ...
                             <a href="javascript:submitForm(document.checkoutInfoForm, 'EA', '${shippingAddress.contactMechId}');" class="btn btn-primary btn-mini open-sans icon-ok">${uiLabelMap.CommonUpdate}</a>
                           </div>
                         </td>
                       </tr>
