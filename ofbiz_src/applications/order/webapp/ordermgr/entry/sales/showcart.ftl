            ...
            <form method="post" action="<@ofbizUrl>additem</@ofbizUrl>" name="quickaddform" style="margin: 0;">
              <table border="0">
                <tr>
                  ...
                  <td>
                    <span class='tabletext'>
                      ...
                      <a href="javascript:quicklookup(document.quickaddform.add_product_id)" class="btn btn-primary btn-mini margin-top-nav-10">${uiLabelMap.OrderQuickLookup}</a>
                      <a href="javascript:quicklookupGiftCertificate()" class="btn btn-primary btn-mini margin-top-nav-10">${uiLabelMap.OrderAddGiftCertificate}</a>
                      <#if "PURCHASE_ORDER" == shoppingCart.getOrderType()>
                        <a href="javascript:showQohAtp()" class="btn btn-primary btn-mini margin-top-nav-10">${uiLabelMap.ProductAtpQoh}</a>
                      </#if>
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  <td></td>
                  <td>
                  	<button class="btn btn-primary btn-small" type="submit"><i class="icon-ok"></i>${uiLabelMap.OrderAddToOrder}</button>
                  </td>
                </tr>
              </table>
            </form>
          ...
          <td>
            <form method="post" action="<@ofbizUrl>additem</@ofbizUrl>" name="bulkworkaddform" style="margin: 0;">
                ...
                <div>
                    ...
                    <button class="btn btn-primary btn-small margin-top-nav-10" type="submit"><i class="icon-ok"></i>${uiLabelMap.OrderAddToOrder}</button>
                </div>
            </form>
          </td>
        </tr>
