...
<div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
        <h4 class="smaller lighter blue">${uiLabelMap.OrderOrderQuoteId}&nbsp;${quote.quoteId}&nbsp;${uiLabelMap.CommonInformation}</h4>
    	<span class="widget-toolbar none-content">
    			${screens.render("component://order/widget/ordermgr/QuoteScreens.xml#QuoteSubTabBar")}
    	</span>
    </div>
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            ...
            <tr>
                <td align="right" valign="top" class="olbius-label">
