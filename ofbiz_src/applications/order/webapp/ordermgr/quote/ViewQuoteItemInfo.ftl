    ...
    <div class="screenlet-title-bar">
        <div class="boxlink">
            <#if maySelectItems?default("N") == "Y">
                <a href="javascript:document.addCommonToCartForm.add_all.value='true';document.addCommonToCartForm.submit()" class="btn btn-primary btn-mini">${uiLabelMap.OrderAddAllToCart}</a>
            </#if>
        </div>
                ...
                <tr <#if alt_row>class="alternate-row" </#if>>
                    <td >
                        ...
                        <#if showQuoteManagementLinks?exists && quoteItem.isPromo?default("N") == "N" && quote.statusId=="QUO_CREATED">
                            <a href="<@ofbizUrl>EditQuoteItem?quoteId=${quoteItem.quoteId}&amp;quoteItemSeqId=${quoteItem.quoteItemSeqId}</@ofbizUrl>" class="btn btn-mini btn-primary">${quoteItem.quoteItemSeqId}</a>
                        <#else>
                    ...
                    <td valign="top">
                        <div>
                            ...
                            <#if showQuoteManagementLinks?exists>
                                <a href="/catalog/control/EditProduct?productId=${quoteItem.productId?if_exists}" class="btn btn-mini btn-primary">
                                  <#if quoteItem.productId?exists>
                                    ${quoteItem.productId}
                                  <#else>
                            ...
                            <#else>
                                <a href="<@ofbizUrl>product?product_id=${quoteItem.productId?if_exists}</@ofbizUrl>" class="btn btn-mini btn-info">${quoteItem.productId?if_exists}</a>
                            </#if>
                        </div>
                    </td>
                    <td></td>
