...
//    get pharmaFeature of Product
    def productSpecifications = ProductContentUtils.loadProductSpecifications(delegator, webSiteId, productId);
    context.productSpecifications = productSpecifications;
    
    def slideOfProduct = ContentUtils.slideOfProduct(delegator, productId, false);
    context.slideOfProduct = slideOfProduct;
}
