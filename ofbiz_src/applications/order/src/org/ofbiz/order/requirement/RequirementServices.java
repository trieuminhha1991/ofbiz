    ...
    public static Map<String, Object> getRequirementsForSupplier(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            for (GenericValue requirement : requirementAndRoles) {
                ...
                if (gid == null) {
                    gid = EntityUtil.getFirst(delegator.findByAnd("GoodIdentification", UtilMisc.toMap("goodIdentificationTypeId", "UPCA", "productId", requirement.get("productId")), null, false));
