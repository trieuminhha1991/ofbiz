...
<div class="widget-header"><h4>${uiLabelMap.SfaMergingFollowing} ${uiLabelMap.SfaMergeLeads}</h4></div>
  ...
  <table border="0" width="100%" >
    <tr>
      <td>
        ...
        <#else>
        <div class="alert alert-info padding-top8">
          <span>${uiLabelMap.SfaNoLeadsSelectedToMerged}</span>
        </#if>
      </td>
    </tr>
  </table>
