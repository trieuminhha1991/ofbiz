            ...
            while ((vcard = vCardReader.readNext()) != null) {
                ...
                if (formattedName != null) {
                    ...
                    if (partyIdentification != null) {
                    	Map<String, String> partyExist = UtilMisc.toMap("partyId", (String) partyIdentification.get("partyId"));
                        partiesExist.add(partyExist);
                        continue;
                    }
                    //TODO manage update
                }
                ...
                Map<String, String> partyCreated = UtilMisc.toMap("partyId", (String) resp.get("partyId"));
                partiesCreated.add(partyCreated);
