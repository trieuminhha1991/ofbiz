...
public class MinusFunctionFunction implements IFunctionVR {
	...
	public double evaluateOrOptMove1(Point x1, Point x2, Point y) {
		// TODO Auto-generated method stub
		return f1.evaluateOrOptMove1(x1, x2, y)
				- f2.evaluateOrOptMove1(x1, x2, y);
	}

	@Override
	public double evaluateOrOptMove2(Point x1, Point x2, Point y) {
		// TODO Auto-generated method stub
		return f1.evaluateOrOptMove2(x1, x2, y)
				- f2.evaluateOrOptMove2(x1, x2, y);
	}

	@Override
	public double evaluateThreeOptMove1(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove1(x, y, z)
				- f2.evaluateThreeOptMove1(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove2(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove2(x, y, z)
				- f2.evaluateThreeOptMove2(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove3(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove3(x, y, z)
				- f2.evaluateThreeOptMove3(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove4(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove4(x, y, z)
				- f2.evaluateThreeOptMove4(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove5(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove5(x, y, z)
				- f2.evaluateThreeOptMove5(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove6(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove6(x, y, z)
				- f2.evaluateThreeOptMove6(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove7(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove7(x, y, z)
				- f2.evaluateThreeOptMove7(x, y, z);
	}

	@Override
	public double evaluateThreeOptMove8(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateThreeOptMove8(x, y, z)
				- f2.evaluateThreeOptMove8(x, y, z);
	}
	...
	public double evaluateCrossExchangeMove(Point x1, Point y1, Point x2,
			Point y2) {
		// TODO Auto-generated method stub
		return f1.evaluateCrossExchangeMove(x1, y1, x2, y2)
				- f2.evaluateCrossExchangeMove(x1, y1, x2, y2);
	}

	@Override
	public double evaluateTwoPointsMove(Point x1, Point x2, Point y1, Point y2) {
		// TODO Auto-generated method stub
		return f1.evaluateTwoPointsMove(x1, x2, y1, y2)
				- f2.evaluateTwoPointsMove(x1, x2, y1, y2);
	}
	...
	public double evaluateThreePointsMove(Point x1, Point x2, Point x3,
			Point y1, Point y2, Point y3) {
		// TODO Auto-generated method stub
		return f1.evaluateThreePointsMove(x1, x2, x3, y1, y2, y3)
				- f2.evaluateThreePointsMove(x1, x2, x3, y1, y2, y3);
	}
	...
	public double evaluateFourPointsMove(Point x1, Point x2, Point x3,
		...
		// TODO Auto-generated method stub
		return f1.evaluateFourPointsMove(x1, x2, x3, x4, y1, y2, y3, y4)
				- f2.evaluateFourPointsMove(x1, x2, x3, x4, y1, y2, y3, y4);
	}
	...
	public double evaluateAddRemovePoints(Point x, Point y, Point z) {
		// TODO Auto-generated method stub
		return f1.evaluateAddRemovePoints(x, y, z)
				- f2.evaluateAddRemovePoints(x, y, z);
	}
