<script type="text/javascript" id="bestSellerQuantityChart">
    $(function () {
    	var config = {
    		service: 'salesOrderPOS',
                ...
                title: {
                    text: '${StringUtil.wrapString(uiLabelMap.ChartBestSellerQuantity)}',
                    x: -20 //center
                },
                xAxis: {
                    type: 'category',
    	...
    	var configPopup = [
	            ...
	            },
	            {
	                ...
	                params : [{
	                    ...
	                    data : [{text: '${StringUtil.wrapString(uiLabelMap.olap_asc)}', value: false}, {text: '${StringUtil.wrapString(uiLabelMap.olap_desc)}', value: true}],
	                    index: 0
	                }]
	            },
   			];
    	
    	var bestSellerQuantityOLap = OLBIUS.oLapChart('bestSellerQuantityChart', config, configPopup, 'bestSellerChartOlapVer2', true, true, function(data, chart, datetype, removeSeries, flagFunc, olap){
        	var tmp = {
                labels: {
                    enabled: false
                },
    	...
    	bestSellerQuantityOLap.funcUpdate(function (oLap) {
            oLap.update({
    	...
    	bestSellerQuantityOLap.init(function () {
    		bestSellerQuantityOLap.runAjax();
        });
    });
</script>