<script type="text/javascript" id="bestSellerPriceChart">
    $(function () {
    	var config = {
    		service: 'salesOrderPOS',
                ...
                title: {
                    text: '${StringUtil.wrapString(uiLabelMap.ChartBestSellerPrice)}',
                    x: -20 //center
                },
                xAxis: {
                    type: 'category',
    	...
    	var bestSellerPriceOLap = OLBIUS.oLapChart('bestSellerPriceChart', config, configPopup, 'bestSellerChartOlapVer2', true, true, function(data, chart, datetype, removeSeries, flagFunc, olap){
        	var tmp = {
                labels: {
                    enabled: false
                },
    	...
    	bestSellerPriceOLap.funcUpdate(function (oLap) {
            oLap.update({
    	...
    	bestSellerPriceOLap.init(function () {
    		bestSellerPriceOLap.runAjax();
        });
    });
</script>