...
<h3 class="header smaller lighter blue">${survey.description?if_exists}</h3>
<br />
...
<div class="widget-box">
	<div class="widget-header widget-header-small header-color-blue2">
		<h6>${survey.description?if_exists}</h6>
	</div>
...
<table border="0" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="submit" class="btn btn-small btn-primary " value="<#if survey.submitCaption?has_content> ${survey.submitCaption}<#else/>Submit</#if>"/></td>
  </tr>
</table>
</div>
</div>