...
<table border="0" width='100%' cellspacing='0' cellpadding='0' class='boxoutside'>
  <tr>
    <td width='100%'>
      ...
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='table table-bordered table-hover table-striped dataTable'>
        <tr>
          ...
          <td valign="middle" align="right">
            <a href="javascript:document.userform.submit()" class="btn btn-info btn-small open-sans icon-refresh">Refresh</a>
          </td>
        </tr>
      </table>
      </form>
  ...
  <tr>
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
        ...
        <tr>
         <td >
            <a class="btn btn-info btn-small" href="<@ofbizUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${rootForumId}</@ofbizUrl>" >Add Top Level Forum</a>
         </td >
        </tr>
...
<@loopSubContent contentId=forumId viewIndex=0 viewSize=9999 contentAssocTypeId="SUBSITE" returnAfterPickWhen="1==1";>
       <tr>
         ...
         <td >
            <a class="btn btn-info btn-small" href="<@ofbizUrl>CMSSites?rootForumId=${rootForumId}&amp;moderatedSiteId=${content.contentId}</@ofbizUrl>">Moderate</a>
         </td >
       
         <td >
            <a class="btn btn-info btn-small" href="<@ofbizUrl>CMSSites?rootForumId=${rootForumId}&amp;permRoleSiteId=${content.contentId}</@ofbizUrl>">User Roles</a>
         </td >
        
         <td >
            <a class="btn btn-info btn-small" href="<@ofbizUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${content.contentId}</@ofbizUrl>" >Add Child Forum</a>
         </td >
         
         <td >
            <a class="btn btn-info btn-small" href="<@ofbizUrl>removeSite?rootForumId=${rootForumId}&amp;contentId=${content.contentId}&amp;contentIdTo=${forumId}&amp;contentAssocTypeId=SUBSITE</@ofbizUrl>">RemoveSite</a>
         </td >
       </tr>
    ...
    <td width='100%'>
      ...
      <#assign rowCount=0/>
        ...
        <tr>
          ...
          <tr>
            <td>
            <button class="btn btn-small btn-info" type="submit" name="submitBtn" >
            <i class="icon-ok">
            </i>
