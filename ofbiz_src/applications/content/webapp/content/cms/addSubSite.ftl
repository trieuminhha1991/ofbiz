...
<form id="form-sub-site" name="addSubSite" method="post" action="<@ofbizUrl>postNewSubSite?rootForumId=${requestParameters.rootForumId}</@ofbizUrl>">
<table cellspacing="8">
  <tr>
  ...
  <tr>
    <td colspan="2"><button id="btn-sub-site" class="btn btn-small btn-info" type="submit" name="submitBtn">
    	<i class="icon-ok" ></i>
    	Create
    	</button>
    </td>
