...
<div class="widget-box transparent no-bottom-border">
  ...
  <div class="widget-body form-padding">
      ...
      <table class="basic-table" cellspacing="0">
        ...
        <tr>
          <td colspan="2" align="center">
            <div>
              <a href="javascript:document.advToKeyWordSearchForm.submit()" class="btn btn-primary btn-small icon-search open-sans">&nbsp${uiLabelMap.CommonFind}</a>
            </div>
          </td>
        </tr>
      </table>
