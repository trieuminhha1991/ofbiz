...
<script>
	...
	uiLabelMap.BIEListDeclarations = "${StringUtil.wrapString(uiLabelMap.BIEListDeclarations)}";
...
<script type="text/javascript" src="/imexresources/js/declaration/listDeclarationEvents.js"></script>
