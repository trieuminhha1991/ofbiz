...
$('#popupWindowContainer').jqxValidator({
    rules: [
				...
				{ input: '#orderPurchaseId', message: '${StringUtil.wrapString(uiLabelMap.NotAllowEmpty)}', action: 'change', 
					rule: function () {
				...
				{ input: '#orderTypeSupp', message: '${StringUtil.wrapString(uiLabelMap.NotAllowEmpty)}', action: 'change', 
					rule: function () {
