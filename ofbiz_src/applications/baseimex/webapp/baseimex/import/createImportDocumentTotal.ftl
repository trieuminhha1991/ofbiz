<#include 'script/createImportDocumentTotalScript.ftl'/>
<h4 class="smaller lighter blue" style="margin: 5px 0px 10px 0px !important;font-weight:500;line-height:20px;font-size:18px;">
	${uiLabelMap.BIECreateImportDocument}
</h4>
<div class="row-fluid">
	<div id="fuelux-wizard" class="row-fluid" data-target="#step-container">
		<ul class="wizard-steps wizard-steps-square">
			<li data-target="#step1" class="active">
				<span class="step">1. ${uiLabelMap.BIEBillOfLading}</span>
			</li>
			<li data-target="#step2">
				<span class="step">2. ${uiLabelMap.BIEContainer}</span>
			</li>
			<li data-target="#step3">
				<span class="step">3. ${uiLabelMap.BIEPackingList}</span>
			</li>
	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "createImportDocBillOfLading.ftl"/>
					</div> 
				</div>
			</div>
		</div>
		...
		<div class="step-pane" id="step2">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "createImportDocContainer.ftl"/>
					</div> 
				</div>
			</div>
		</div>
		...
		<div class="step-pane" id="step3">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "createImportDocPackingList.ftl"/>
					</div> 
				</div>
			</div>
		</div>
		...
		<div class="step-pane" id="step4">
			<#include "createImportDocumentConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
