...
<table width="100%">
	...
	<tr>
		...
		<td width="20%" style="text-align: left;">EAN-No</td>
...
<input type="button" name='AddField' value="Add" style="margin-left: 62.4%; margin-top: 5px;" class="btn btn-primary btn-mini">
<#if listOrder?exists>
...
<table width="100%" style="margin-top: 32px;" border= "1px solid #8470FF;">
	<#list listOrder as order>
				...
				<td width="10%"><input type="text" class="input40" id="txtPrice_${order_index}" value="${order.unitPrice}"/><label id="lblCurrencyUom_${order_index}">${order.currencyUom?if_exists}</label></td>
...
<hr class="hr-no-margin" width="100%" style="border: 1px solid black" size="1">
<div class="row-fluid">
	<div class="span12 no-left-margin" style="margin-top: 5px;">
		<div class="span2"></div>
...
<div class="row-fluid">
	<div class="span12 no-left-margin">
		...
		<div class="span2" style="text-align:right"><span>${currencyUom?if_exists}<span></div>
	</div>
</div>
<hr class="hr-no-margin" width="100%" style="border: 1px solid black" size="1">
<div class="row-fluid">
	<div class="span12 no-left-margin" style="margin-top: 5px;">
		...
		<div class="span2">${weightUomId?if_exists}</div>
...
<div class="row-fluid">
	<div class="span12 no-left-margin" style="margin-top: 5px;">
		...
		<div class="span2">x <input class="input40 numbers" type="text" onchange="txtXChange()" id="txtX" name="txtX" /> ${weightUomId?if_exists}</div>
