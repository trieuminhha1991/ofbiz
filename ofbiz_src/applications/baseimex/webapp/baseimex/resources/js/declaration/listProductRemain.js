...
var ObjProduct = (function() {
	...
	var initGridProduct = function (grid) {
		...
		var rendertoolbarProduct = function (toolbar){
			...
			var id = "ProductList";
			var me = this;
			var jqxheader = $("<div id='toolbarcontainer" + id +"' class='widget-header'><h4>" + uiLabelMap.BIEProductDeclarationRemain + "</h4><div id='toolbarButtonContainer" + id + "' class='pull-right'></div></div>");
		...
		var config = {
				...
				rowdetails: false,
				useUrl: true,
				url: 'JQGetListProductRemainDeclaration',                
				source: {pagesize: 10},
		};
