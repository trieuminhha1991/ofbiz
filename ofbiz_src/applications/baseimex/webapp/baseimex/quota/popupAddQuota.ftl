...
<div id="popupWindowQuota" class="hide popup-bound">
	...
	<div class='form-window-container'>
		<div class='form-window-content'>
			<div class="row-fluid">
				<div class="span6">
					<div class="row-fluid margin-top10">
						<div class="span3 align-right asterisk">${uiLabelMap.BIEQuotaId}</div>
						<div class="span7">	
							<input id="quotaCode"></input>
						</div>
					</div>
					<div class="row-fluid margin-top10">
						<div class="span3 align-right">${uiLabelMap.BIEQuotaName}</div>
						<div class="span7">	
							<input id="quotaName"></input>
						</div>
					</div>
	        ...
	        <div class="form-action popup-footer">
		        <button id="alterCancelQuota" class='btn btn-danger form-action-button pull-right'><i class='fa-remove'></i> ${uiLabelMap.CommonCancel}</button>
		    	<button id="alterSaveQuota" class='btn btn-primary form-action-button pull-right'><i class='fa-check'></i> ${uiLabelMap.CommonSave}</button>
			</div>
		</div>
	</div>
</div>
<script type="text/javascript" src="/imexresources/js/quota/addImexQuota.js"></script>