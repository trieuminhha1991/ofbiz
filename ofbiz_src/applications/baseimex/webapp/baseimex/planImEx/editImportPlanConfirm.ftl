	...
	<div class="span6">
		...
		<table width="100%" border="0" cellpadding="1" class="table table-striped table-hover table-bordered dataTable">
			...
			<tr>
				...
				<td valign="top" width="70%">
					<span id="customTimePeriodDT">
						<#if period?has_content>
							${period.periodName?if_exists}
						</#if>
					</span>
				</td>
			</tr>
	...
	<div class="span6">
		...
		<table width="100%" border="0" cellpadding="1" class="table table-striped table-hover table-bordered dataTable margin-top15">
				...
				<td valign="top" width="70%">
					<span id="partyDT">
						<#if supplier?has_content>
							${supplier.partyCode?if_exists} - ${supplier.fullName?if_exists}
						</#if>
					</span>	
				</td>
			</tr>
			<tr>
				...
				<td valign="top" width="70%">
					<span id="currencyUomIdDT">
						${productPlanHeader.currencyUomId?if_exists}
					</span>	
				</td>
			</tr>
			<tr>
