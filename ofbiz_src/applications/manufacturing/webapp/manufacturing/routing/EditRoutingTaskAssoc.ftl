...
<form method="post" action="<@ofbizUrl>AddRoutingTaskAssoc</@ofbizUrl>" name="addtaskassocform">
    ...
    <table class="basic-table" cellspacing="0" style="margin-top: 10px;">
        <tr>
            <td align="center">
        ...
        <tr>
            <td colspan="3">
                <a href="javascript:addRoutingTask();" class="btn btn-small btn-info icon-ok open-sans">&nbsp${uiLabelMap.ManufacturingAddExistingRoutingTask}</a>
                &nbsp;-&nbsp;
                <a href="javascript:copyAndAddRoutingTask();" class="btn btn-small btn-info icon-copy open-sans">&nbsp${uiLabelMap.ManufacturingCopyAndAddRoutingTask}</a>
            </td>
        </tr>
    </table>
</form>
