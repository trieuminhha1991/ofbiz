 ...
 *
 */
public class PurchaseOrder extends AbstractOlbiusReceiveEvent {
	...
	public void receiveHandle(MessageData messageData) throws Exception {
		...
		createCustomer(order.getGroupFrom().getOwnId(), order.getProductStore());
		...
		map.put("partyId", order.getGroupFrom().getOwnId());
