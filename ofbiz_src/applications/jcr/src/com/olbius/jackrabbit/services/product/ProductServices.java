package com.olbius.jackrabbit.services.product;
...
public class ProductServices {
	...
	public static final String resource = "JcrWrapperProductUiLabels";
	public static final String resourceError = "JcrWrapperProductErrorUiLabels";

	public static Map<String, Object> addAdditionalViewForProduct(DispatchContext dctx, Map<String, ?> context) throws GenericServiceException {
		...
		if (UtilValidate.isNotEmpty(fileName)) {
			...
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("userLogin", context.get("userLogin"), "_uploadedFile_fileName",
					context.get("_uploadedFile_fileName"), "_uploadedFile_contentType", context.get("_uploadedFile_contentType"), "uploadedFile",
					context.get("uploadedFile"), "folder", "/catalog/products/" + productId + "/" + productContentTypeId, "pathType",
					Node.JCR_PATH, "public", isPublic);
			...
			if (isPublic.equals("Y")) {
				result = addImageResource(dispatcher, delegator, context, Constant.getUrl() + OlbiusRepository.WSP_DEFAULT + path, productContentTypeId);
			}
			if (isPublic.equals("N")) {
				result = addImageResource(dispatcher, delegator, context, Node.WEBDAV_URL + OlbiusRepository.WSP_SECURITY + path, productContentTypeId);
			}
			...
			dataResourceCtx = UtilMisc.toMap("userLogin", context.get("userLogin"), "nodePath", path, "public", context.get("isPublic"),
	...
	public static Map<String, Object> addImageOverrideFields(DispatchContext dctx, Map<String, ? extends Object> context)
		...
		if (product != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("userLogin", context.get("userLogin"), "_uploadedFile_fileName", fileName,
					"_uploadedFile_contentType", context.get("_uploadedFile_contentType"), "uploadedFile", context.get("uploadedFile"), "folder",
					"/catalog/products/" + productId, "public", isPublic, "pathType", Node.JCR_PATH);
			...
			String path = (String) result.get("path");
			if (isPublic.equals("Y")) {
				product.put(map.get(fileType), Constant.getUrl() + OlbiusRepository.WSP_DEFAULT + path);
			} else {
				if (isPublic.equals("N")) {
					product.put(map.get(fileType), Node.WEBDAV_URL + OlbiusRepository.WSP_SECURITY + path);
				}
			}
	...
	public static Map<String, Object> addImageForProductPromo(DispatchContext dctx, Map<String, ? extends Object> context) throws IOException,
			JDOMException {
		LocalDispatcher dispatcher = dctx.getDispatcher();
		Delegator delegator = dctx.getDelegator();
		GenericValue userLogin = (GenericValue) context.get("userLogin");
		...
		if (UtilValidate.isNotEmpty(context.get("_uploadedFile_fileName"))) {
			...
			String filePathPrefix = "/catalog/promos/" + productPromoId + "/" + productPromoContentTypeId;
			...
			dataResourceCtx.put("folder", filePathPrefix);
	...
	public static Map<String, Object> uploadProductAdditionalViewImages(DispatchContext dctx, Map<String, ?> context) throws GenericServiceException {
		...
		if(fileName1 != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("productId", productId,"userLogin", context.get("userLogin"), "_uploadedFile_fileName",
					context.get("_additionalImageOne_fileName"), "_uploadedFile_contentType", context.get("_additionalImageOne_contentType"), "uploadedFile",
					context.get("additionalImageOne"), "public", context.get("isPublic"), "productContentTypeId", "ADDITIONAL_IMAGE_1");
			try {
		...
		if(fileName2 != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("productId", productId,"userLogin", context.get("userLogin"), "_uploadedFile_fileName",
					context.get("_additionalImageTwo_fileName"), "_uploadedFile_contentType", context.get("_additionalImageTwo_contentType"), "uploadedFile",
					context.get("additionalImageTwo"), "public", context.get("isPublic"), "productContentTypeId", "ADDITIONAL_IMAGE_2");
			try {
				result = dispatcher.runSync("jackrabbitAddAdditionalViewForProduct", dataResourceCtx);
			} catch (GenericServiceException e) {
				throw new GenericServiceException(e);
		...
		if(fileName3 != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("productId", productId,"userLogin", context.get("userLogin"), "_uploadedFile_fileName",
					context.get("_additionalImageThree_fileName"), "_uploadedFile_contentType", context.get("_additionalImageThree_contentType"), "uploadedFile",
					context.get("additionalImageThree"), "public", context.get("isPublic"), "productContentTypeId", "ADDITIONAL_IMAGE_3");
			try {
				result = dispatcher.runSync("jackrabbitAddAdditionalViewForProduct", dataResourceCtx);
			} catch (GenericServiceException e) {
				throw new GenericServiceException(e);
		...
		if(fileName4 != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("productId", productId,"userLogin", context.get("userLogin"), "_uploadedFile_fileName",
					context.get("_additionalImageFour_fileName"), "_uploadedFile_contentType", context.get("_additionalImageFour_contentType"), "uploadedFile",
					context.get("additionalImageFour"), "public", context.get("isPublic"), "productContentTypeId", "ADDITIONAL_IMAGE_4");
			try {
				result = dispatcher.runSync("jackrabbitAddAdditionalViewForProduct", dataResourceCtx);
			} catch (GenericServiceException e) {
				throw new GenericServiceException(e);
	...
	public static Map<String, Object> uploadImageCategory(DispatchContext dctx, Map<String, ? extends Object> context)
		...
		if (productCategory != null) {
			Map<String, Object> dataResourceCtx = UtilMisc.toMap("userLogin", context.get("userLogin"), "_uploadedFile_fileName", fileName,
					"_uploadedFile_contentType", context.get("_uploadedFile_contentType"), "uploadedFile", context.get("uploadedFile"), "folder",
					"/catalog/category/" + productCategoryId, "public", isPublic, "pathType", Node.JCR_PATH);
			...
			String path = (String) result.get("path");
			if (isPublic.equals("Y")) {
				productCategory.put(map.get(fileType), Constant.getUrl() + OlbiusRepository.WSP_DEFAULT + path);
			} else {
				if (isPublic.equals("N")) {
					productCategory.put(map.get(fileType), Node.WEBDAV_URL + OlbiusRepository.WSP_SECURITY + path);
				}
			}
			try {
