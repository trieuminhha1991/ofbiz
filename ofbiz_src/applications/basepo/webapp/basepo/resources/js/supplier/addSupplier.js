if (typeof (AddSupplier) == "undefined") {
	var AddSupplier = (function() {
		...
		var getValue = function() {
			...
			if(OlbCore.isNotEmpty($("#finAccountName").val()) && OlbCore.isNotEmpty($("#finAccountCode").val())){
		...
		var clean = function() {
            ...
            $("#finLabel").removeClass("hide");
            $("#finDiv").removeClass("hide");
		...
		var open = function(data) {
			if (data) {
                ...
                $("#finLabel").addClass("hide");
                $("#finDiv").addClass("hide");
			}
			var wtmp = window;
