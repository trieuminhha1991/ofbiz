var OlbPromoRules = (function(){
	...
	var addNewCondition = function(rule_seq_id, cond_seq_id){
		...
		content2.append('<div class="span5"><label>' + uiLabelMap.BSCondition + '</label></div>');
		...
		content2.append('</div>');
		content2.append('<div class="row-fluid">');
		content2.append('<div class="span5"><label>' + uiLabelMap.BSProductName + '</label></div>');
		content2.append('<div class="span7">');
		...
		content2.append('</div>');
		content2.append('<div class="row-fluid">');
		content2.append('<div class="span5"><label>' + uiLabelMap.BSCategoryName + '</label></div>');
		content2.append('<div class="span7">');
		...
		content2.append('<div class="span5"><label>' + uiLabelMap.BSParty + '</label></div>');
		content2.append('<div class="span7">');
		...
		content2.append('</div>');
		content2.append('<div class="row-fluid" style="display:none">');
		content2.append('<div class="span5"><label>' + uiLabelMap.BSPartyGroup + '</label></div>');
		content2.append('<div class="span7">');
		...
		content2.append('</div>');
		content2.append('<div class="row-fluid" style="display:none">');
		content2.append('<div class="span5"><label>' + uiLabelMap.BSRoleType + '</label></div>');
		content2.append('<div class="span7">');
		...
		/*
		content2.append('<div class="row-fluid" style="display:none">');
		content2.append('<div class="span5">');
		 ...
		 */
		content2.append('<div class="row-fluid">');
		content2.append('<div class="span5"><label>' + uiLabelMap.ProductConditionValue + '</label></div>');
		content2.append('<div class="span7">');
		...
		content2.append('</div>');
		content2.append('<div class="row-fluid">');
		content2.append('<div class="span5"><label>' + uiLabelMap.BSUsePriceWithTax + '</label></div>');
		content2.append('<div class="span7">');
	...
	var addNewAction = function(rule_seq_id, action_seq_id){
		...
		content3.append('<div class="span5"><label>' + uiLabelMap.BSAction + '</label></div>');
		...
		content3.append('</div>');
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.BSProductName + '</label></div>');
		content3.append('<div class="span7">');
		...
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.BSCategoryName + '</label></div>');
		content3.append('<div class="span7">');
		content3.append('<div class="container-add-minus">');
		...
		content3.append('</div>');
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.ProductQuantity + '</label></div>');
		content3.append('<div class="span7">');
		...
		content3.append('</div>');
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.BSAmountOrPercent + '</label></div>');
		content3.append('<div class="span7">');
		...
		content3.append('</div>');
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.BSOperator + '</label></div>');
		content3.append('<div class="span7">');
		...
		/*
		content3.append('<div class="row-fluid">');
		content3.append('<div class="span5"><label>' + uiLabelMap.BSCheckInventoryItem + '</label></div>');
		content3.append('<div class="span7">');
	...
	var actionScriptBuildAction = function(rule_seq_id, cond_seq_id, config){
		...
		$("#quantityTmp" + thisSuffix).jqxNumberInput({height: 25, width: '100%', spinButtons:true, decimalDigits: 0, digits: 11, max: 99999999999, min: 0, theme: OlbCore.theme});
	...
	var initProductIdList = function(comboBox, selectArr, notVirtual){
		...
		var configProductIdList = {
			...
			useUrl: true,
			url: 'jqxGeneralServicer?sname=JQGetListProductOfCompany&pagesize=0' + otherParam,
		};/*prodCatalogId=${currentCatalogId?if_exists} TH2: JQGetListProductSellAll*/
