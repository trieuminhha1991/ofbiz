	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "supReturnNewSupReturnInfo.ftl"/>
					</div>
				</div>
			</div>
			<div style="position:relative" class="form-window-content-custom">
				<#include "supReturnNewSupReturnProduct.ftl"/>
			</div>

            <div style="position:relative" class="form-window-content-custom">
               <#include "supReturnNewSupReturnProductPromo.ftl"/>
            </div>
		</div>

		<div class="step-pane" id="step2">
			<#include "supReturnNewSupReturnConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
