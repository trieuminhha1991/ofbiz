		...
		<div class="wizard-steps-steps">
			<ul class="wizard-steps wizard-steps-square">
				<li data-target="#step1" class="active">
					<span class="step">1. ${uiLabelMap.BPEditInformation}</span>
				</li>
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid margin-top10">
					<div class="span12">
						<#include "supReturnEditSupReturnInfo.ftl"/>
					</div>
				</div>
			</div>
			<div style="position:relative" class="form-window-content-custom">
				<#include "supReturnEditSupReturnProduct.ftl"/>
			</div>
		</div>

		<div class="step-pane" id="step2">
			<#include "supReturnEditSupReturnConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
