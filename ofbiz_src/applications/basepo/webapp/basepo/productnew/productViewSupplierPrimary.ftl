	...
	var SupplierProduct = (function() {
		...
		grid.jqxGrid({
			...
			columns: [
					...
					{ text: "${StringUtil.wrapString(uiLabelMap.BSMinOrderQty)}", dataField: "minimumOrderQuantity", width: 100, columntype: "textbox", cellClassName: cellClassjqxSupplierProd,
						cellsrenderer: function (row, column, value) {
					...
					-->
					{ text: "${StringUtil.wrapString(uiLabelMap.ProductCurrencyUom)}", datafield: "currencyUomId", columntype: "dropdownlist", filtertype: "checkedlist", width: 120, cellClassName: cellClassjqxSupplierProd},
					{ text: "${StringUtil.wrapString(uiLabelMap.DmsQuantityUomId)}", datafield: "quantityUomId", columntype: "dropdownlist", filtertype: "checkedlist", width: 100, cellClassName: cellClassjqxSupplierProd,
					...
					{ text: "${StringUtil.wrapString(uiLabelMap.FormFieldTitle_canDropShip)}", dataField: "canDropShip", width: 100, columntype: "textbox", cellClassName: cellClassjqxSupplierProd },
					{ text: "${StringUtil.wrapString(uiLabelMap.POAccComments)}", dataField: "comments", width: 100, columntype: "textbox", cellClassName: cellClassjqxSupplierProd },
					{ text: "${StringUtil.wrapString(uiLabelMap.FormFieldTitle_availableFromDate)}", datafield: "availableFromDate", width: 160, cellClassName: cellClassjqxSupplierProd,
						cellsrenderer: function(row, colum, value) {
							return "<span>" + jOlbUtil.dateTime.formatFullDate(value) + "</span>";
						}
					},
					{ text: "${StringUtil.wrapString(uiLabelMap.FormFieldTitle_availableThruDate)}", datafield: "availableThruDate", width: 160, cellClassName: cellClassjqxSupplierProd,
						cellsrenderer: function(row, colum, value) {
							return "<span>" + jOlbUtil.dateTime.formatFullDate(value) + "</span>";
						}
					}]
