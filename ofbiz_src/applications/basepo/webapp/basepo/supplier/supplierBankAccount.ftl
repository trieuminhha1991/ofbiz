...
<div id="finAccount-tab" class="tab-pane">
	<div class="row-fluid">
		...
		<@jqGrid filtersimplemode="true" filterable="true" dataField=datafieldFinAcc columnlist=columnlistFinAcc editable="false" showtoolbar="true"
							...
							url="jqxGeneralServicer?sname=JQGetListSupplierFinAccount&partyId=${parameters.partyId?if_exists}" customTitleProperties="ListSupplierFinAccount"/>														
	</div>
</div>
...
<script type="text/javascript" src="/poresources/js/supplier/supplierFinAccount.js"></script>