		...
		<div style="border: 1px solid #ccc;"><#--border: 1px solid #dcebf7;-->
			<#if orderNotes?has_content>
				...
				<#list orderNotes as note>
					...
					<div style="<#if hasColor> </#if>padding:5px 10px 10px"><#--background-color:#edf3f4; -->
						<div class="row-fluid">
							<div class="span7" style="min-height:0px">
			...
			<#else>
				<div><p style="color:#3a87ad; padding-left:5px">${uiLabelMap.BSDoNotHaveAnyNotesYet}.</p></div>
			</#if>
			<#if security.hasEntityPermission("PURCHASEORDER", "_VIEW", session)>
				<div style="padding-left:5px"><#--background-color:#edf3f4-->
								...
								<div class="row-fluid">
									...
									<div class="span5">
										<div style="margin-top:10px">
											<button id="createOrderNote" type="button" class="btn btn-small btn-primary pull-right fa-paper-plane-o">
												${uiLabelMap.BSSend}
											</button>
										</div>
									</div>
...
//										$("#order-notes-container").html(data);
								...
								bootbox.dialog("${uiLabelMap.PONoteContentCannotEmpty}", [{
									"label" : "OK",
