		...
		<div class="form-horizontal form-window-content-custom label-text-left content-description" style="margin:10px">
			<div class="row-fluid">
				...
				<div class="span6">
					...
					<div class='row-fluid'>
						<div class='div-inline-block'>
							<label>${uiLabelMap.BPAbbSupplier}/${uiLabelMap.BPAbbSupplierGroup}:</label>
						</div>
						<div class="div-inline-block">
...
<script type="text/javascript" src="/poresources/js/quotation/quotationNewConfirm.js?v=0.0.1"></script>
