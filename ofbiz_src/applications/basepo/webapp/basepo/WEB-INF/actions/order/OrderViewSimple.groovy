...
Map<String, Object> mapX = FastMap.newInstance();
mapX.put("orderId", orderId);
mapX.put("userLogin", userLogin);
Boolean checkReceived = false;
Map<String, Object> mapCheck = dispatcher.runSync("checkOrderReceived", mapX);
...
context.checkReceived = checkReceived;
