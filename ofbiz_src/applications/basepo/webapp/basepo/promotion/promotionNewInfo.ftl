		...
		<div class="row-fluid">
			<div class="span6">
				...
				<div class='row-fluid' style="margin-top: -8px;">
					<div class='span5'>
						<label for="promoText" style="margin-top: 4px;">${uiLabelMap.BSContent}</label>
					</div>
					<div class="span7">
						<textarea id="promoText" data-maxlength="50" rows="2" style="resize: vertical;margin-bottom:0" class="span12">${promotionPO?if_exists.promoText?if_exists}</textarea>
			   		</div>
				</div>
			</div><!--.span6-->
			<div class="span6">
				<div class='row-fluid'>
					<div class='span5'>
						<label class="required">${uiLabelMap.POSupplier}</label>
					</div>
			   		<div class="span7">
			   			<div id="supplierIds">
						...
						<div class="container-add-minus">
							<div id="supplierIds"></div>
						</div>
						<a id="btnShowSupplierList" href="javascript:void(0)" class="btn btn-mini"><i class="fa fa-bars"></i></a>-->
			   		</div>
				</div>
				<div class='row-fluid'>
					<div class='span5'>
				...
				<div class='row-fluid'>
					<div class='span5'>
						<label>${uiLabelMap.POAbbUseLimitPerSupplier}</label>
					</div>
					<div class="span7">
						<div class="container-add-plus">
...
<#-- change to allow select only one supplier
<div id="alterpopupWindowSupplier" style="display:none">
	<div>${uiLabelMap.POSupplierManager}</div>
