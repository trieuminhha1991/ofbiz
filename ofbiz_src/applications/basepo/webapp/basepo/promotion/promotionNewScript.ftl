...
<#assign inputParamEnumIds = ["PPIP_ORDER_TOTAL", "PPIP_PRODUCT_TOTAL", "PPIP_PRODUCT_AMOUNT", "PPIP_PRODUCT_QUANT", "PPIP_EACH_ORDER_TOTA", "PPIP_EACH_PROD_QUANT", "PPIP_PROD_QUANT_TOTA"]/>
<#assign inputParamEnums = delegator.findList("Enumeration", Static["org.ofbiz.entity.condition.EntityCondition"].makeCondition("enumId", Static["org.ofbiz.entity.condition.EntityOperator"].IN, inputParamEnumIds), null, null, null, false)!/>
...
<script type="text/javascript" src="/poresources/js/promotion/promotionNewRule.js"></script>