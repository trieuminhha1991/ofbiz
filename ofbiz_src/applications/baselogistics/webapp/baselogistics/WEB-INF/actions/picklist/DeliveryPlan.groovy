...
List<GenericValue> plans = delegator.findList("PlanHeader",
		EntityCondition.makeCondition("statusId", EntityOperator.NOT_EQUAL, "PLAN_CREATED"), null, UtilMisc.toList("-createdDate"), null, false);
if (!plans.isEmpty()) {
	context.planId = plans.get(0).get("planId");
}