<script type="text/javascript">
	...
	<#list departments as depId>
		...
		<#assign drivers = Static["com.olbius.basehr.util.PartyUtil"].getEmployeeHasRoleInDepartment(delegator, depId, "LOG_DRIVER", "EMPLOYEE", nowTimestamp)!/>;
...
<script type="text/javascript" src="/logresources/js/deliveryentry/newDeliveryEntryInfo.js"></script>
