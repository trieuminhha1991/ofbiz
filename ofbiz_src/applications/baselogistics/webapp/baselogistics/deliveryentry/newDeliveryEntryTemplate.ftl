<#include 'script/deliveryEntryTemplateScript.ftl'/>
	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						${screens.render("component://baselogistics/widget/DeliveryScreens.xml#NewDeliveryEntryInfo")}
					</div>
				</div>
			</div>
			<div style="position:relative" class="form-window-content-custom">
				${screens.render("component://baselogistics/widget/DeliveryScreens.xml#ListShipmentDetail")}
			</div>
		</div>

		<div class="step-pane" id="step2">
			<#include "newDeliveryEntryConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
