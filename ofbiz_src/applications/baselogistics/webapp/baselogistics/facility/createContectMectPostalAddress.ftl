...
<script>
	...
	$("#contactMechPurposeTypeId").jqxDropDownList('setContent', "${uiLabelMap.PleaseSelectTitle}");
	$("#contactMechPurposeTypeId").jqxDropDownList({ disabled: false, placeHolder: "${uiLabelMap.PleaseSelectTitle}"}); 
			...
			var request = $.ajax({
				  ...
				  success: function(data) {
					  ...
					  if(contactMechTypeId == "IP_ADDRESS"){
						  $("#contactMechPurposeTypeId").jqxDropDownList({placeHolder: "${uiLabelMap.PleaseSelectTitle}"});
						  $("#contactMechPurposeTypeId").jqxDropDownList('setContent', "${uiLabelMap.NoDataToDisplay}");
					  ...
					  if(contactMechTypeId == "DOMAIN_NAME"){
						  ...
						  $("#contactMechPurposeTypeId").jqxDropDownList({ selectedIndex: 0,  source: dataTest, displayMember: 'value', valueMember: 'id'});
						  $("#contactMechPurposeTypeId").jqxDropDownList('setContent', "${uiLabelMap.PleaseSelectTitle}");
