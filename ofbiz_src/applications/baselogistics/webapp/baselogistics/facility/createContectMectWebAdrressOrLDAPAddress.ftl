<#if contactMechTypeIdCheck == "WEB_ADDRESS">
	...
	<script>
		...
		$('#alterpopupWindow').jqxValidator({
		    rules: [
						{ input: '#webURLAddress', message: '${uiLabelMap.CheckIsEmptyInfo}', action: 'keyup, blur', rule: 'required' },
		...
		$("#alterCreateWebURLAddress").click(function (){
			...
			if(validate != false){
				if(contactMechTypeId == "" || contactMechPurposeTypeId == "" || infoString == ""){
					$("#notificationCreateWebURLAddressError").text('${StringUtil.wrapString(uiLabelMap.CheckIsEmptyInfo)}');
...
<#else>
	...
	<script>
		...
		$('#alterpopupWindow').jqxValidator({
		    rules: [
						{ input: '#LDAPAddress', message: '${uiLabelMap.CheckIsEmptyInfo}', action: 'keyup, blur', rule: 'required' },
		...
		$("#alterCreateLDAPAddress").click(function (){
			...
			if(validate != false){
				...
				if(contactMechTypeId == "" || contactMechPurposeTypeId == "" || infoString == ""){
					$("#notificationCreateLDAPAddressError").text('${StringUtil.wrapString(uiLabelMap.CheckIsEmptyInfo)}');
