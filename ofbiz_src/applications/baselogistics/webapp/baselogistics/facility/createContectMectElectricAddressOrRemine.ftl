		...
		$(document).ready(function(){
			...
			$("#alterCreateElectronicAddress").click(function (){
				...
				if(contactMechTypeId == "" || infoString == ""){
					$("#notificationCreateElectronicAddressError").text('${StringUtil.wrapString(uiLabelMap.CheckIsEmptyInfo)}');
...
<#else>
	...
	$(document).ready(function(){
		...
		$("#alterCreateInternalNoteviaPartyIdAddress").click(function (){
			...
			if(contactMechTypeId == "" || infoString == ""){
				$("#notificationCreateInternalNoteviaPartyError").text('${StringUtil.wrapString(uiLabelMap.CheckIsEmptyInfo)}');
