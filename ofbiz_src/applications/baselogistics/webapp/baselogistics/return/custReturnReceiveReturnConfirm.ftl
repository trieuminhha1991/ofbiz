	...
	<div class="row-fluid">
			...
			<table width="100%" border="0" cellpadding="1" class="table table-striped table-hover table-bordered dataTable">
				<tr>
					...
					<td valign="top" width="70%">
						<span>${returnHeader.fromGroupName?if_exists}</span>
					</td>
				</tr>
				<tr>
					<td align="right" valign="top" width="30%">
					...
					<td valign="top" width="70%">
						<span>${returnHeader.toGroupName?if_exists}</span>
					</td>
				</tr>
			</table>
		</div><!--.span6-->
		<div class="span6">
			...
			<table width="100%" border="0" cellpadding="1" class="table table-striped table-hover table-bordered dataTable margin-top15">
				...
				<tr>
					<td align="right" valign="top" width="30%">
						<div><b>${uiLabelMap.ReceiveToFacility}</b></div>
					</td>
					<td valign="top" width="70%">
						<span id="facilityDT">
						</span>	
				...
				<table id="tableProduct" width="100%" border="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable">
					<thead>
						<tr valign="bottom" style="height: 40px">
							...
							<th width="8%" class="align-center"><span><b>${uiLabelMap.LOGActualExportedQuantity}</b></span></th>
							<th width="8%" class="align-center <#if !hasOlbPermission("MODULE", "RETURN_PRICE_SO", "VIEW")> hide </#if>"><span><b>${uiLabelMap.UnitPrice}</b></span></th>
							<th width="10%" class="align-center <#if !hasOlbPermission("MODULE", "RETURN_PRICE_SO", "VIEW")> hide </#if>"><span><b>${uiLabelMap.BPOTotal} </br></span></th>
						</tr>
					</thead>
					<tbody>
