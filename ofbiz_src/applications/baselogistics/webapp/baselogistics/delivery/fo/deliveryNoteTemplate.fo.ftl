...
>
    <fo:layout-master-set>
        ...
        <#if numInstance?exists && numInstance &gt; 1>
        	<#if numInstance?exists && numInstance == 2>
		        <fo:simple-page-master master-name="main-page2" page-width="21.0cm" page-height="29.7cm" 
			    		margin-top="0cm" margin-bottom="2cm" margin-left="1cm" margin-right="0cm">
			        <#-- main body -->
		    ...
		    <#elseif numInstance == 3>
			    ...
			    <fo:simple-page-master master-name="main-page3" page-width="21.0cm" page-height="29.7cm" 
			    		margin-top="0cm" margin-bottom="2cm" margin-left="1cm" margin-right="0cm">
			        <#-- main body -->
			        <fo:region-body margin-top="1.5cm" margin-bottom="1cm"/>
			        <#-- the header -->
			...
			<#elseif numInstance == 4>
					...
					<fo:simple-page-master master-name="main-page4" page-width="21.0cm" page-height="29.7cm"
                                           margin-top="0cm" margin-bottom="2cm" margin-left="1cm" margin-right="0cm">
					<#-- main body -->
                        <fo:region-body margin-top="1.5cm" margin-bottom="1cm"/>
					<#-- the header -->
			 ...
			 <fo:table-body>
				<fo:table-row>
					<fo:table-cell>
			           	...
			           	<fo:block font-size="10pt">
			           		${StringUtil.wrapString(uiLabelMap.BLTaxId)}: ${StringUtil.wrapString(taxIdCompany?if_exists)}
			           	</fo:block>
		           	</fo:table-cell>
		           	<fo:table-cell>
		           	</fo:table-cell>
    ...
    <#if numInstance?exists && numInstance &gt; 1>
		<#if numInstance?exists && numInstance == 2>
		    <fo:page-sequence master-reference="${pageLayoutName?default("main-page2")}">
			    <#-- Header -->
			    <#--
			    <fo:static-content flow-name="xsl-region-before">
			        <fo:table table-layout="fixed" width="100%">
			    ...
			    <fo:static-content flow-name="xsl-region-before" font-family="Arial">
					...
					<fo:table-column column-width="220pt"/>
					 <fo:table-body>
						<fo:table-row>
							<fo:table-cell>
					           	<fo:block font-size="10pt" margin-top="20pt">
					           		${StringUtil.wrapString(companyName?if_exists)}
					           	</fo:block>
					           	<fo:block font-size="10pt">
					           		${StringUtil.wrapString(uiLabelMap.Address)}: ${StringUtil.wrapString(companyAddress?if_exists)}
	...
	<#elseif numInstance == 3>
		...
		<fo:page-sequence master-reference="${pageLayoutName?default("main-page3")}">
		     <fo:static-content flow-name="xsl-region-before" font-family="Arial">
		    	<fo:table>
				<fo:table-column column-width="250pt"/>
				<fo:table-column column-width="220pt"/>
		...
		<#-- the body -->
        	...
        	<fo:page-sequence master-reference="${pageLayoutName?default("main-page4")}">
                <fo:static-content flow-name="xsl-region-before" font-family="Arial">
                    <fo:table>
                        <fo:table-column column-width="250pt"/>
                        <fo:table-column column-width="220pt"/>
			...
			<#-- the footer -->
			<#--   <fo:static-content flow-name="xsl-region-after">
               &lt;#&ndash;<fo:block font-size="10pt" text-align="center" space-before="10pt">
                   ${uiLabelMap.CommonPage} <fo:page-number/> ${uiLabelMap.CommonOf} <fo:page-number-citation ref-id="theEnd"/>
               </fo:block>&ndash;&gt;
                   ${sections.render("footer")}
               </fo:static-content>-->
