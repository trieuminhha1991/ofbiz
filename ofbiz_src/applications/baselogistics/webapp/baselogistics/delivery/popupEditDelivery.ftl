...
<script>
	...
	var uomData = [];
	var conversionFactor = "${delivery.conversionFactor?if_exists}";
    if (globalVar == undefined) var globalVar = {};
    globalVar.currencyUomId = "${currencyUomId?if_exists}";
                ...
                <div class="span4">
                    <div class="row-fluid margin-top10 margin-bottom5">
                        <div class="span5" style="text-align: right">
                            <div style="margin-right: 10px" class="asterisk"> ${uiLabelMap.BACCExchangedRate} </div>
                        </div>
                        <div class="span7">
...
<script type="text/javascript" src="/logresources/js/delivery/popupEditDelivery.js?v=1.1.1"></script>