...
<script type="text/javascript">	
	...
	uiLabelMap.QuantityNotEnoghForAssignLabel = "${StringUtil.wrapString(uiLabelMap.QuantityNotEnoghForAssignLabel)}";
...
<script type="text/javascript" src="/logresources/js/inventory/assignLabelInventoryTemplate.js"></script>