...
<div class="row-fluid">
	<div id="fuelux-wizard" class="row-fluid" data-target="#step-container">
		...
		<div class="wizard-steps-actions">
			<div>
				<span><a href="javascript:LabelInvTmpObj.reloadPages();" class="btn margin-left-2 btn-primary"><i class="icon-refresh icon-only"></i></a></span>
			</div>
		</div>
	</div><!--#fuelux-wizard-->
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative" class="form-window-content-custom">
				${screens.render("component://baselogistics/widget/InventoryScreens.xml#ListBasicLabelInventory")}
			</div>
		</div>

		<div class="step-pane" id="step2">
			<#include "assignLabelInventoryConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
