...
<#assign initrowdetailsDetail = "function (index, parentElement, gridElement, datarecord) {
	...
	<#assign columnlist="
					...
					{ text: '${uiLabelMap.ATP}', datafield: 'availableToPromiseTotal', hidden: true, align: 'left', width: 150, cellsalign: 'right', filtertype: 'number', filterable: false,
						cellsrenderer: function(row, colum, value){
							if(value){
								return '<span class=\"align-right\">' + formatnumber(value) + '</span>';
							}
...
<script type="text/javascript" src="/logresources/js/inventory/filterFacilityOfDistributor.js?v=1.1.2"></script>