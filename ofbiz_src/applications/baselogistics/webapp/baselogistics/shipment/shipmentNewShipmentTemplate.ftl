		...
		<div class="wizard-steps-steps">
			<ul class="wizard-steps wizard-steps-square">
				...
				<li data-target="#step2">
					<span class="step">2. ${uiLabelMap.ConfirmTransfer}</span>
				</li>
			</ul>
		</div>
		<div class="wizard-steps-actions">
			<div>
				<span><a href="<@ofbizUrl>refreshData</@ofbizUrl>" class="btn margin-left-2 btn-primary"><i class="icon-refresh icon-only"></i></a></span>
			</div>
		</div>
	</div><!--#fuelux-wizard-->
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						${screens.render("component://baselogistics/widget/ShipmentScreens.xml#NewShipmentInfo")}
					</div>
				</div>
			</div>
			<div style="position:relative" class="form-window-content-custom">
				${screens.render("component://baselogistics/widget/InventoryScreens.xml#ListInventoryDetail")}
			</div>
		</div>

		<div class="step-pane" id="step2">
			<#include "shipmentNewShipmentConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
