...
var OlbReqProduct = (function() {
	...
	var getColumns = function(grid){
		var columns = [
			...
			{ text: uiLabelMap.UnitPrice, datafield: 'unitCost', hidden: hidePrice, sortable: false,  width: 150, editable: false, filterable: false, sortable: false, cellclassname: productGridCellclass,
				cellsalign: 'right', columntype: 'numberinput',
				cellsrenderer: function(row, column, value) {
					if (value > 0) {
