...
var PackInfoObj = (function () {
    ...
    var initEvents = function () {
        customerDDB.getGrid().rowSelectListener(function (rowData) {
            ...
            updateProductGridData(customerIdMain);
        });
    }
    ...
    function updateProductGridData(customerId) {
        var element = $("#jqxGridProduct");
        var facId = null;
        var tmpS = element.jqxGrid('source');
        if (tmpS) {
            var curUrl = tmpS._source.url;
            var newUrl = "jqxGeneralServicer?sname=JQGetListDeliveryItemAndProductId&customerId=" + customerId;
            if (newUrl != curUrl) {
