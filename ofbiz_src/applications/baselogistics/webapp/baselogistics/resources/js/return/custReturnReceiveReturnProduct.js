$(function() { 
	OlbCustReturnProduct.init();
});
     
var OlbCustReturnProduct = (function() {
	...
	var getColumns = function(grid){
		var columns = [
			...
			{ text: uiLabelMap.RequiredNumber, datafield: 'returnQuantity', sortable: false,  width: 150, editable: false, filterable: false, sortable: false, cellclassname: productGridCellclass,
			...
			{ text: uiLabelMap.UnitPrice, datafield: 'returnPrice', hidden: hidePrice, sortable: false,  width: 150, editable: false, filterable: false, sortable: false, cellclassname: productGridCellclass,
				cellsalign: 'right', columntype: 'numberinput',
				cellsrenderer: function(row, column, value) {
					if (value > 0) {
	...
	var getDataField = function(){
		var datafield = [
				...
				{ name: 'receiveAmount', type: 'number' },
