...
var SupReturnExp = (function() {
			...
			if (rowData){
				if (dataField == 'quantity'){
					if (value != oldvalue){
						...
						if (value >= 0 && value <= qoh && value <= returnQuantity){
	...
	var getColumns = function(grid){
		var columns = [
			...
			{ text: uiLabelMap.RequiredNumberSum, datafield: 'returnQuantity', sortable: false,  width: '15%', editable: false, filterable: false, sortable: false, cellclassname: productGridCellclass,
				cellsalign: 'right', columntype: 'numberinput',
				cellsrenderer: function(row, column, value) {
					if (value > 0) {
						return '<span class="align-right">' + formatnumber(value) +'</span>';
			...
			{ text: uiLabelMap.UnitPrice, datafield: 'returnPrice', sortable: false,  width: '15%', editable: false, filterable: false, sortable: false, cellclassname: productGridCellclass,
				cellsalign: 'right', columntype: 'numberinput',
				cellsrenderer: function(row, column, value) {
					if (value > 0) {
