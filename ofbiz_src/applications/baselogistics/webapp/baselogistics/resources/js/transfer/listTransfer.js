$(function(){
	ListTransferObj.init();
});
var ListTransferObj = (function(){
	var init = function(){
		initInputs();
		initElementComplex();
		initEvents();
	...
	var prepareCreateNewTransfer = function prepareCreateNewTransfer(value){
		href = "prepareCreateNewTransfer";
		window.location.href = href;
	}
	...
	return {
		...
		prepareCreateNewTransfer: prepareCreateNewTransfer,
	};
}());