<#include 'script/transferEditTransferScript.ftl' />
    ...
    <div class="step-content row-fluid position-relative" id="step-container">
        ...
        <div class="step-pane active" id="step1">
            <div style="position:relative">
                <div class="row-fluid">
                    <div class="span12">
                        <#include 'transferEditTransferInfo.ftl'/>
                    </div>
                </div>
            </div>
            <div style="position:relative" class="form-window-content-custom">
                <div id="jqxgridProductDetail"></div>
            </div>
        </div>

        <div id="addProductPopup" style="z-index: 1000000000000000 !important" class="hide popup-bound">
            ...
            <div class='form-window-container'>
                ...
                <div class="form-action popup-footer">
                    <button id="addProductCancel" class='btn btn-danger form-action-button pull-right'>
                        <i class='fa-remove'></i> ${uiLabelMap.CommonClose}</button>
                    <button id="addProductSave" class='btn btn-primary form-action-button pull-right'>
        ...
        <div class="step-pane" id="step2">
            <#include "transferEditTransferConfirm.ftl"/>
        </div>
    </div>
