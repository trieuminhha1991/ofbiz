<#include 'script/reqReceiveRequirementTotalScript.ftl'/>
<h4 class="smaller lighter blue" style="margin: 5px 0px 10px 0px !important;font-weight:500;line-height:20px;font-size:18px;">
	${uiLabelMap.BLReciveByRequirement} - ${uiLabelMap.RequirementId}: ${requirementId?if_exists}
</h4>
<div class="row-fluid">
	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include "reqReceiveRequirementProduct.ftl"/>
					</div> 
				</div>
			</div>
		</div>
		...
		<div class="step-pane" id="step2">
			<#include "reqReceiveRequirementConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
