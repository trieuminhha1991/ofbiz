		...
		<table id="tableProduct" width="100%" border="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable">
			<thead>
				<tr valign="bottom" style="height: 40px">
					...
					<th width="10%" class="align-center <#if !hasOlbPermission("MODULE", "REQUIREMENT_PRICE", "VIEW")>  </#if>"><span><b>${uiLabelMap.UnitPrice}</b></span></th>
					<th width="10%" class="align-center <#if !hasOlbPermission("MODULE", "REQUIREMENT_PRICE", "VIEW")> </#if>"><span><b>${uiLabelMap.BPOTotal} </br></span></th>
				</tr>
			</thead>
			<tbody>
