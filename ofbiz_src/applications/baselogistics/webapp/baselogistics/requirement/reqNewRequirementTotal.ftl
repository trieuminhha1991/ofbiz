	...
	<div class="step-content row-fluid position-relative" id="step-container">
		...
		<div class="step-pane active" id="step1">
			<div style="position:relative">
				<div class="row-fluid">
					<div class="span12">
						<#include 'reqNewRequirementInfo.ftl'/>
					</div> 
				</div>
			</div>
		...
		<div class="step-pane" id="step2">
			<#include "reqNewRequirementConfirm.ftl"/>
		</div>
	</div><!--.step-content-->
...
<script type="text/javascript" src="/logresources/js/requirement/reqNewRequirementProduct.js?v=1.1.1"></script>