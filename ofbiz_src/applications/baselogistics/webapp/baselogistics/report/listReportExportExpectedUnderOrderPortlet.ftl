...
<#assign dataField="[
				...
				{ name: 'exportFacility', type: 'string'},
			]"/>
<#assign columnlist="
				{
				...
				{ text: '${uiLabelMap.OrderId}', datafield: 'orderId', align: 'left', width: 120,
				},
				{ text: '${uiLabelMap.EstimatedDeliveryDate}', dataField: 'estimatedDeliveryDate', width: 130, cellsformat: 'dd/MM/yyyy', filtertype:'range',
				},
				...
				{ text: '${StringUtil.wrapString(uiLabelMap.StockOut)}', datafield: 'exportFacility', filterable: false, sortable: false, cellsrenderer:
				       function(row, colum, value){
					        var data = $('#jqxgirdReport').jqxGrid('getrowdata', row);
			        		return '<span><a href=\"' + 'viewOrder?orderId=' + data.orderId + '\"><i class=\"fa fa-upload\"></i>' + '${uiLabelMap.StockOut}' + '</a></span>';
			           }
				},
			"/>
...
<@jqGrid filtersimplemode="true" filterable="true" dataField=dataField columnlist=columnlist editable="false" showtoolbar="true"
	id="jqxgirdReport" addrefresh="true" filterable="true" viewSize="5"
	url="jqxGeneralServicer?sname=JQGetReportExportExpectedUnderOrderPortlet"
	customTitleProperties="ListOrderExport" />	