...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLReceivedPurchaseReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusReceivedReport",
            olap: "olapReceivedPurchaseReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportReceivedPurchaseReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_NHAP_KHO_HANG_MUA_' + (new Date()).formatDate("ddMMyyyy")
        };
