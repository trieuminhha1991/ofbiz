...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLReceivedTransferReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusReceivedReport",
            olap: "olapReceivedTransferReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportReceivedTransferReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_NHAP_KHO_DIEU_CHUYEN_' + (new Date()).formatDate("ddMMyyyy")
        };
