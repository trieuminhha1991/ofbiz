...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLReceivedOtherReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusReceivedReport",
            olap: "olapReceivedOtherReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportReceivedOtherReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_NHAP_KHO_NHAP_KHAC_' + (new Date()).formatDate("ddMMyyyy")
        };
