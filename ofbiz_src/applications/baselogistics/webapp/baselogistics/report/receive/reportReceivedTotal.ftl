...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLReceivedReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusReceivedReport",
            olap: "olapReceivedTotalReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportReceivedReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_NHAP_KHO_' + (new Date()).formatDate("ddMMyyyy")
        };
