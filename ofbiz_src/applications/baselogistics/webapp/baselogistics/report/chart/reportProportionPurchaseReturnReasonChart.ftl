<script type="text/javascript" id="ReturnPurchaseReason">
	$(function () {
		var config = {
				chart: {
				...
				title: {
					text: "${StringUtil.wrapString(uiLabelMap.BLChartProportionReasonVendorReturn)}" 
				},
				tooltip: {
					formatter: function () { 
						if (this.point.name) {
		...
		var returnOLap = OLBIUS.oLapChart("ReturnPurchaseReason", config, configPopup, "olapChartPieProportionPurchaseReturnReason", true, true, OLBIUS.defaultPieFunc);
