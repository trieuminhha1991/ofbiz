...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${reportType}"=="DISTRIBUTOR"?"${StringUtil.wrapString(uiLabelMap.LogStatisticalReturnProductDistributorReport)}":"${StringUtil.wrapString(uiLabelMap.BLReceivedCustomerReturnReport)}",
