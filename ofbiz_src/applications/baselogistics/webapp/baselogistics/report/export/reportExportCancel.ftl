...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLExportedCancelReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusExportedReport",
            olap: "olapExportedCancelReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportExportedCancelReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_XUAT_KHO_HANG_HUY_' + (new Date()).formatDate("ddMMyyyy")
        };
