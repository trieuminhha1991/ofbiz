...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLExportedSalesReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusExportedReport",
            olap: "olapExportedSalesReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportExportedSalesReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_XUAT_KHO_HANG_BAN_' + (new Date()).formatDate("ddMMyyyy")
        };
