...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLExportedVendorReturnReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusExportedReport",
            olap: "olapExportedVendorReturnReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportExportedVendorReturnReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_XUAT_KHO_TRA_LAI_NCC_' + (new Date()).formatDate("ddMMyyyy")
        };
