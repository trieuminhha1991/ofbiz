<div id="olbiusExportedReport"></div>
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLExportedQuarantineReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusExportedReport",
            olap: "olapExportedQuarantineReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportExportedQuarantineReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_XUAT_KHO_HANG_KIEM_NGHIEM_KIEM_DICH_' + (new Date()).formatDate("ddMMyyyy")
        };
