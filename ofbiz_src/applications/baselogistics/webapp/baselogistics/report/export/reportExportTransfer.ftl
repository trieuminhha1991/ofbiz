...
<script type="text/javascript">
    $(function() {
        var config = {
            title: "${StringUtil.wrapString(uiLabelMap.BLExportedTransferReport)}",
            service: "facilityInventory",
            button: true,
            id: "olbiusExportedReport",
            olap: "olapExportedTransferReport",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            columns: [
            ...
            excel: function(obj){
				...
				window.open("exportExportedTransferReportExcel?" + otherParam, "_blank");
            },
            exportFileName: '[LOG]_BC_XUAT_KHO_DIEU_CHUYEN_' + (new Date()).formatDate("ddMMyyyy")
        };
