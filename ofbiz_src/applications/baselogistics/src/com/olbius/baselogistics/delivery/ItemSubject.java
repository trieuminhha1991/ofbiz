...
public abstract class ItemSubject {
	...
	public abstract void updateDeliveredAmount(Map<String, Object> parameters) throws GenericEntityException;
	public abstract void updateExportedAmount(Map<String, Object> parameters) throws GenericEntityException;
