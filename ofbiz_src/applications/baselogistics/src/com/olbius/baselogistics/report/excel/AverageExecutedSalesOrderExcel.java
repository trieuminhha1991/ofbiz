...
public class AverageExecutedSalesOrderExcel extends ExportExcelAbstract{
	...
	protected void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		setHeaderName(UtilProperties.getMessage(RESOURCE, "BLAverageTimeExecutedOrderSales", locale));
		setRunServiceName("olapAverageExecutedSalesOrder");
		setModuleExport("LOG");
		setDescriptionExport(UtilProperties.getMessage(RESOURCE, "BLAverageTimeExecutedOrderSales", locale));
