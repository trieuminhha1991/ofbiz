...
public class ExportInventoryTurnoverRatioExcel extends ExportExcelAbstract{
	...
	protected void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		String fileName = "[LOG]_BC_VONG_QUAY_TON_KHO";
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd_HHmmss");
		String dateTime = format.format(nowTimestamp);
		fileName += "_" + dateTime;
		setFileName(fileName);
		setHeaderName(UtilProperties.getMessage(RESOURCE, "InventoryTurnoverRatio", locale));
		setRunServiceName("olapInventoryTurnoverRatio");
		setModuleExport("LOG");
		setDescriptionExport(UtilProperties.getMessage(RESOURCE, "InventoryTurnoverRatio", locale));
		...
		addColumn(16, UtilProperties.getMessage(RESOURCE, "BLFacilityId", locale), "facility_code");
		addColumn(24, UtilProperties.getMessage(RESOURCE, "BLFacilityName", locale), "facility_name");
		...
		addColumn(16, UtilProperties.getMessage(RESOURCE, "BLCostInventoryBegin", locale), "inventoryBegin", ExportExcelStyle.STYLE_CELL_NUMBER);
		addColumn(16, UtilProperties.getMessage(RESOURCE, "BLCostOfGoodSold", locale), "cogs", ExportExcelStyle.STYLE_CELL_NUMBER);
		addColumn(16, UtilProperties.getMessage(RESOURCE, "BLCostInventoryEnd", locale), "inventoryEnd", ExportExcelStyle.STYLE_CELL_NUMBER);
		addColumn(16, UtilProperties.getMessage(RESOURCE, "BLTurnoverRatio", locale), "turnoverRatio", ExportExcelStyle.STYLE_CELL_CURRENCY);
	}
