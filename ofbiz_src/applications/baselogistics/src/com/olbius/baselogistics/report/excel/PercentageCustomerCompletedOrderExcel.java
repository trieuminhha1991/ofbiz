...
public class PercentageCustomerCompletedOrderExcel extends ExportExcelAbstract{
	...
	protected void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		String fileName = "[LOG]_BC_KHACH_HANG_HOAN_THANH_DON_HANG_BAN";
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd_HHmmss");
		String dateTime = format.format(nowTimestamp);
		fileName += "_" + dateTime;
		setFileName(fileName);
		setHeaderName(UtilProperties.getMessage(RESOURCE, "BLPercentageCustomerCompletedOrder", locale));
		setRunServiceName("olapPercentageCustomerCompletedOrder");
		setModuleExport("LOG");
		setDescriptionExport(UtilProperties.getMessage(RESOURCE, "BLPercentageCustomerCompletedOrder", locale));
