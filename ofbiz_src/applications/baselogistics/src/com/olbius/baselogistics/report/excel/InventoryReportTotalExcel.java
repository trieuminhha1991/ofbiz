...
public class InventoryReportTotalExcel extends ExportExcelAbstract{
	...
	protected void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		addColumn(15, UtilProperties.getMessage(RESOURCE, "BACCOpeningStock", locale), "openingQuantity", ExportExcelStyle.STYLE_CELL_CURRENCY);
		addColumn(15, UtilProperties.getMessage(RESOURCE, "BACCImportStock", locale), "importQuantity", ExportExcelStyle.STYLE_CELL_CURRENCY);
		addColumn(15, UtilProperties.getMessage(RESOURCE, "BACCExportStock", locale), "exportQuantity", ExportExcelStyle.STYLE_CELL_CURRENCY);
		addColumn(15, UtilProperties.getMessage(RESOURCE, "BACCEndingStock", locale), "endingQuantity", ExportExcelStyle.STYLE_CELL_CURRENCY);
	}
