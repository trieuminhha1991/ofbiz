...
public class ReceivedPurchaseReport extends OlbiusOlapService{
	...
	private OlbiusQuery init() {
		...
		if (facilities.isEmpty()){
			...
			Boolean hasPORole = com.olbius.basehr.util.SecurityUtil.hasRole("PO_MANAGER", userLogin.getString("partyId"), delegator);
			if (!hasRole){
				hasRole = com.olbius.basehr.util.SecurityUtil.hasRole("ACC_EMPLOYEE", userLogin.getString("partyId"), delegator);
			}
			if (hasRole || hasPORole){ 
