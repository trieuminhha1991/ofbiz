...
public class ReceivedOtherReport extends OlbiusOlapService{
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "BLReceivedReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		tmp.select(new Sum("CASE WHEN prd.require_amount = 'Y' THEN iif.amount_on_hand_total ELSE iif.quantity_on_hand_total END"), "quantity")
				...
				.join(Join.INNER_JOIN, "enumeration_dimension", "en", "iif.enumeration_dim_id = en.dimension_id")
				.where(Condition
						...
						.andEQ("en.enum_id", "RECEIVE_OTHER")
