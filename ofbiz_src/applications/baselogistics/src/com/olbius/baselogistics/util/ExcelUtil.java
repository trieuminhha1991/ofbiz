...
public class ExcelUtil {
	...
	public static void responseWrite(HttpServletResponse response, Workbook wb, String workbookName)
			throws IOException {
		...
		try {
			...
			response.setHeader("content-disposition",
					"attachment;filename=" + workbookName + format.format(new Date()) + ".xls");
	...
	public static Map<String, CellStyle> createStylesNormal(Workbook wb) {
		...
		style = initCellStyleNormalCellContentNumber(wb, null, null, Font.BOLDWEIGHT_BOLD);
	...
	public static Map<String, Object> company(Delegator delegator, GenericValue userLogin, Locale locale) {
