...
public class InsBenefitHealthImprovementImpl extends OlbiusBuilder{
	
	private OlbiusQuery query;
	private Locale locale;
	
	public InsBenefitHealthImprovementImpl(Delegator delegator, Locale locale) {
		super(delegator);
		this.locale = locale;
	}
	...
	private void initQuery(){
		...
		.select("pif.day_leave_concentrate")
		.select("pif.day_leave_family")
		...
		cond.and("dd.date_value", "<=", getSqlDate(thruDate));
		cond.and("dd1.date_value", ">=", getSqlDate(fromDate));
	...
	public void prepareResultGrid() {
		...
		addDataField("dayLeaveConcentrate", "day_leave_concentrate");
		addDataField("dayLeaveFamily", "day_leave_family");
