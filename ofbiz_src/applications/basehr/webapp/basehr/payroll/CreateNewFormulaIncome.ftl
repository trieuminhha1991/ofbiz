<div id="createIncomeFormulaWindow" class="hide">
	<div>${uiLabelMap.AddNewIncomeFormula}</div>
...
<script type="text/javascript" src="/hrresources/js/payroll/CreateNewFormulaIncome.js"></script>	