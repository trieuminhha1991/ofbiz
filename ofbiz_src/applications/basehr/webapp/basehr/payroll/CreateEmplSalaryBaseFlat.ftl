...
<div id="CreateSalaryBaseFlatWindow" class="hide">
	 <div id="windowHeader">
     	${uiLabelMap.CreateEmpPosTypeSalary}
     </div>
     <div class="form-window-container">
     	...
     	<div class="form-action">
			<button type="button" class='btn btn-danger form-action-button pull-right'id="cancelAdd"><i class='icon-remove'></i>&nbsp;${uiLabelMap.CommonCancel}</button>	
			<button type="button" class='btn btn-success form-action-button pull-right'id="saveAndContinueAdd"><i class='fa-plus'></i>&nbsp;${uiLabelMap.SaveAndContinue}</button>	
			<button type="button" class='btn btn-primary form-action-button pull-right' id="saveAdd"><i class='fa fa-check'></i>&nbsp;${uiLabelMap.CommonSave}</button>
     	</div>
     </div>
</div>			
<div class="row-fluid">
...
<script type="text/javascript" src="/hrresources/js/payroll/CreateEmplSalaryBaseFlat.js"></script>