   		...
   		insuranceContentTypeArr: [
			<#if insuranceContentTypeList?has_content>
	   			<#list insuranceContentTypeList as insuranceContentType>
	   			{
	   				...
	   				description: "${StringUtil.wrapString(insuranceContentType.contentTypeName?if_exists)}: ${StringUtil.wrapString(insuranceContentType.description?if_exists)}"
	   			},
	   			</#list>
			</#if>
   		]
...
uiLabelMap.InsuranceSocialSalaryBenefit = "${StringUtil.wrapString(uiLabelMap.InsuranceSocialSalaryBenefit)}";
uiLabelMap.InsuranceParticipatePeriod = "${StringUtil.wrapString(uiLabelMap.InsuranceParticipatePeriod)}";
uiLabelMap.AllowanceAmountInPeriod = "${StringUtil.wrapString(uiLabelMap.AllowanceAmountInPeriod)}";
uiLabelMap.wgdeleteconfirm = "${StringUtil.wrapString(uiLabelMap.wgdeleteconfirm)}";
uiLabelMap.HRCommonInPeriod = "${StringUtil.wrapString(uiLabelMap.HRCommonInPeriod)}";
uiLabelMap.HRCommonAmount = "${StringUtil.wrapString(uiLabelMap.HRCommonAmount)}";
uiLabelMap.HRNumberDayLeave = "${StringUtil.wrapString(uiLabelMap.HRNumberDayLeave)}";
uiLabelMap.DayGenerate = "${StringUtil.wrapString(uiLabelMap.DayGenerate)}";
...
uiLabelMap.HRRegulation = "${StringUtil.wrapString(uiLabelMap.HRRegulation)}";
