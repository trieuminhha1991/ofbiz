<div id="ExportInsBenefitExcelWindow" class="hide">
	...
	<div class='form-window-container'>
		<div class="form-window-content" style="position: relative;">
			<div class='row-fluid margin-bottom10'>
				...
				<div class="span8">
					<div id="insuranceTypeReport"></div>
				</div>
			</div>
			<div class='row-fluid margin-bottom10'>
				<div class="span4 text-algin-right">
...
<script type="text/javascript" src="/hrresources/js/insurance/ExportSocialInsuranceBenefitsExcel.js"></script>