...
var monthSort = [
              	...
              	{text : '${StringUtil.wrapString(uiLabelMap.CommonSeptember)}', value : 'sep'},
              	{text : '${StringUtil.wrapString(uiLabelMap.CommonOctober)}', value : 'oct'},
...
var typeOfView = [
              {text : '${StringUtil.wrapString(uiLabelMap.Synthetic)}', value : 'syn'},
              {text : '${StringUtil.wrapString(uiLabelMap.Detail)}', value : 'det'}
  ];
</script>