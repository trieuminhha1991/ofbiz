<#include "script/ViewApproveKPIEmplScript.ftl">
<#assign datafield = "[
...
<div class="row-fluid">
	...
	<div class="tab-content overflow-visible" style="border: none !important">
		<#include "ViewApproveKPIEmplPeriod.ftl" >
		<#include "ViewApproveKPIEmplWeek.ftl"> 
		<#include "ViewApproveKPIEmplMonth.ftl">
		<#include "ViewApproveKPIEmplQuarter.ftl">
		<#include "ViewApproveKPIEmplYear.ftl">
	</div>
</div>
<div class="row-fluid">
	<div id="approveKPIWindow" class='hide'>
			...
			<div class="form-action">
				<div class='row-fluid'>
					<div class="span12 margin-top10">
						<button id="cancelApprKpiType" class='btn btn-danger form-action-button pull-right'><i class='fa-remove'></i> ${uiLabelMap.Cancel}</button>
						<button id="saveApprKpiType" class='btn btn-primary form-action-button pull-right'><i class='fa-check'></i>${uiLabelMap.Save}</button>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="/hrresources/js/keyPerfIndicator/ApproveKPI.js"></script>