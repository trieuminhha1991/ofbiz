<div id="weekly_tab" class="tab-pane">
		...
		<div class="widget-body">
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="span6">
						<div class='row-fluid margin-bottom10'>
							<div class="pull-right" id="dateTimeInput_Weekly"></div>
						</div>
					</div>
				</div>
			</div>
			<div class="row-fluid">
				<@jqGrid filtersimplemode="true" filterable="true" addrefresh="true" showtoolbar="false" dataField=datafield columnlist=columnlist
					clearfilteringbutton="true" editable="true" deleterow="false" id="jqxgrid_weekly"
...
<script type="text/javascript" src="/hrresources/js/profile/profileViewListEmplKPIWeekly.js"></script>