var week_li = (function(){
    ...
    var initGridEvent = function(){
        $("#jqxgrid_weekly").on('rowdoubleclick', function(event){
            var index = event.args.rowindex;
            var date =new Date();
            var data = $('#jqxgrid_weekly').jqxGrid('getrowdata', index);
	...
	var refreshGridData = function(fromDate, thruDate){
		...
		tmpS._source.url = "jqxGeneralServicer?sname=getListKPIResultEmpl&periodTypeId=" + periodTypeId + "&fromDate=" + fromDate + "&thruDate=" + thruDate;
