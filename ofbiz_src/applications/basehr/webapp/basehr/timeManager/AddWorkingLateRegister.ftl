<#if !addNewWindow?has_content>
	<#assign addNewWindow = "AddWorkLateRegisterWindow"/>
</#if>
<script type="text/javascript">
globalVar.addNewWindow = "${addNewWindow}";
</script>
<div id="${addNewWindow}" class="hide">
	<div>${uiLabelMap.AddWorkingLateRegister}</div>
	<div class='form-window-container' style="position: relative;">
		<div class="form-window-content">
			...
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="row-fluid">
						<div class="span12">
							<div class="span4">
								<div id="lateInStartShift${addNewWindow}"></div>
							</div>
							<div class="span8">
								<div class='row-fluid'>
									<div class='span5 text-algin-right'>
									...
									<div class="span7">
										<div id="earlyOutShiftBreak${addNewWindow}"></div>
									</div>
								</div>							
							</div>				
						</div>
			...
			<div class="row-fluid margin-bottom10">
				...
				<div class="span9">
					<div class="row-fluid">
						<div class="span12">
							<div class="span4">
								<div id="lateInShiftBreak${addNewWindow}"></div>
							</div>
							<div class="span8">
								<div class='row-fluid'>
									<div class='span5 text-algin-right'>
									...
									<div class="span7">
										<div id="earlyOutEndShift${addNewWindow}"></div>
									</div>
								</div>							
							</div>				
						</div>
			...
			<div class='row-fluid margin-bottom10'>
				<div class='span3 text-algin-right'>
					<label class="">${uiLabelMap.ReasonRegisterWorkOvertime}</label>
				</div>
				<div class="span9">
...
<script type="text/javascript" src="/hrresources/js/timeManager/AddWorkingLateRegister.js"></script>