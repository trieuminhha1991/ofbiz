<script type="text/javascript" id="CUSTIGColumnChart">
	$(function(){
		var config = {
            chart: {
                type: 'column'
            ...
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BACCCustIncomeGrowthColumnChart)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
        ...
        var columnChart = OLBIUS.oLapChart('CUSTIGColumnChart', config, configPopup, 'evaluateCIGColumnChart', true, true, OLBIUS.defaultColumnFunc);
