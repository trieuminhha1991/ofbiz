...
<@jqGrid filtersimplemode="true" filterable="true" id="purchaseInvoiceTaxPaymentReport" dataField=dataField columnlist=columnlist
	...
	url="jqxGeneralServicer?sname=JQVoucherTaxPaymentReport"/>

<script	type="text/javascript">
	var exportExcel = function(){
		var dataGrid = $("#purchaseInvoiceTaxPaymentReport").jqxGrid('getrows');
		...
		form.setAttribute("action", "exportVoucherTaxPaymentReport");
