<script type="text/javascript" id="grid">
	...
	function bindingDataToReport(){
		var config = {
                title: ' ${uiLabelMap.BACCCustomerIncomeGrowthStm}',
                service: 'acctgTransTotal',
                columns: [
                          { text: '${uiLabelMap.BACCCustomerId}', datafield: 'partyId', width: '28%',
        ...
        var grid = OLBIUS.oLapGrid('grid', config, configPopup, 'getCustIncomeGrowthStm', true);
