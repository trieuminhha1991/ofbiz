<script type="text/javascript" id="CIGColumnChart">
	$(function(){
		var config = {
            chart: {
                type: 'column'
            ...
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BACCCategoryIncomeGrowthColumnChart)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
        ...
        var columnChart = OLBIUS.oLapChart('CIGColumnChart', config, configPopup, 'evaluateCAIGColumnChart', true, true, OLBIUS.defaultColumnFunc);
