        ...
        var filter = function(){
            var initFilter = function(){
                var configGlAccount = {
                    ...
                    url: "JqxGetListGlAccountsLiabilityReceivable",
                    useUtilFunc: true,
                ...
                accutils.setValueDropDownButtonOnly($("#glAccountId"), '${receipGlAccount.glAccountId}', '${receipGlAccount.accountName}');
                ...
                var configParty = {
                    ...
                    url: "JqxGetParties&enumId=EMPLOYEE_PTY_TYPE",
                    useUtilFunc: true,
                ...
                accutils.createJqxDropDownList($("#enumPartyTypeId"), enumPartyTypeArr, {valueMember: 'enumId', displayMember: 'description', width: '80%', height: 25});
                $("#enumPartyTypeId").val("EMPLOYEE_PTY_TYPE");
            }
            ...
            var bindEvent = function(){
                $("#enumPartyTypeId").on('select', function(event){
                    ...
                    if (args) {
                        ...
                        var grid = $("#partyGrid");
                        $("#partyId").val("");
                        accutils.setAttrDataValue('partyId', "");
                ...
                $('#alterSave').on('click', function(){
                    var _gridObj = $('#liabilityReceivableGrid');
                    ...
                    var url = "jqxGeneralServicer?sname=JqxGetLiabilityReceivable&glAccountId=" + $("#glAccountId").attr('data-value') + '&fromDate=' + fromDate + '&thruDate=' + thruDate;
                    var partyId = $('#partyId').attr('data-value');
                    if(typeof(partyId) != 'undefined' && OlbCore.isNotEmpty(partyId)) {
