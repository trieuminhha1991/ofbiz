...
<script type="text/javascript">
    if (typeof(moneyFilter) == "undefined") {
        var moneyFilter = function () {
            var initFilter = function () {
                ...
                accutils.setValueDropDownButtonOnly($("#glAccountId"), '${glAccount.glAccountId}', '${glAccount.glAccountId}');
            ...
            var bindEvent = function () {
                ...
                $('#alterSave').on('click', function () {
                    ...
                    if (typeof(tmpSource) != 'undefined') {
                        tmpSource._source.url = "jqxGeneralServicer?sname=JqxGetMoneyInBank&glAccountId=" + $("#glAccountId").attr('data-value') + '&fromDate=' + fromDate + '&thruDate=' + thruDate;
