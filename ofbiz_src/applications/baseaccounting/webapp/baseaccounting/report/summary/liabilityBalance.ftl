...
<#include "liabilityBalanceFilter.ftl">
...
<#assign columnlist="{ text: '${uiLabelMap.SequenceId}', sortable: false, filterable: false, editable: false, pinned: true,
					 ...
					 { text: '${uiLabelMap.BACCDebitAmount}', dataField: 'openingDebitAmount', width: 150, columngroup: 'openingAmount',
						 cellsrenderer: function(row, column, value){
							...
							var data = $('#liabilityBalGrid').jqxGrid('getrowdata',row);
					 ...
					 { text: '${uiLabelMap.BACCDebitAmount}', dataField: 'postingDebitAmount', width: 150, columngroup: 'postingAmount',
						 ...
						 aggregatesrenderer: function (aggregates, column, element) {
                        	...
                        	var data = $('#liabilityBalGrid').jqxGrid('getrows');
...
<@jqGrid id="liabilityBalGrid" filtersimplemode="true" filterable="false" addrefresh="true" editable="false" addType="popup" showtoolbar="true" clearfilteringbutton="false"
		 url="jqxGeneralServicer?sname=JqxGetLiabilityBalance&glAccountId=${liabilityGlAccount.glAccountId}&fromDate=${fromDate}&thruDate=${thruDate}" sortable="false"
...
<script>
	...
	$('#liabilityBalGrid').on("bindingcomplete", function (event) {
	...
	var exportExcel = function(){
		var allData = $('#liabilityBalGrid').jqxGrid('getrows');
		if(allData.length > 0){
			var glId = $("#glAccountId").attr('data-value');			
			var partyId = $("#partyId").attr('data-value');			
			glId = glId != null && glId !== undefined && glId ? glId : '${liabilityGlAccount.glAccountId?if_exists}';
            ...
            var url = "exportLiabilityBalanceExcel?glAccountId=" + glId + "&fromDate=" + fromDate + "&thruDate=" + thruDate;
