        ...
        var filter = function(){
            ...
            var bindEvent = function(){
                ...
                $('#alterSave').on('click', function(){
                    var _gridObj = $('#liabilityReceivableTotalGrid');
                    ...
                    if(typeof(tmpSource) != 'undefined'){
                        tmpSource._source.url = "jqxGeneralServicer?sname=JqxGetLiabilityReceivableTotal&glAccountId=" + $("#glAccountId").attr('data-value') + '&fromDate=' + fromDate + '&thruDate=' + thruDate;
