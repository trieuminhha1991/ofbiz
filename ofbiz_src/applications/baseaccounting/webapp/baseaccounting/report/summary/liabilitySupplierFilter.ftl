        ...
        var filter = function(){
            ...
            var bindEvent = function(){
                ...
                $('#alterSave').on('click', function(){
                    var _gridObj = $('#liabilitySupplierGrid');
                    ...
                    if(typeof(tmpSource) != 'undefined'){
                        tmpSource._source.url = "jqxGeneralServicer?sname=JqxGetLiabilitySupplier&glAccountId=" + $("#glAccountId").attr('data-value') + '&fromDate=' + fromDate + '&thruDate=' + thruDate;
