<script type="text/javascript" id="CGGColumnChart">
	$(function(){
		var config = {
            chart: {
                type: 'column'
            ...
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BACCCustGroupIncomeGrowthColumnChart)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
        ...
        var columnChart = OLBIUS.oLapChart('CGGColumnChart', config, configPopup, 'evaluateCGGColumnChart', true, true, OLBIUS.defaultColumnFunc);
