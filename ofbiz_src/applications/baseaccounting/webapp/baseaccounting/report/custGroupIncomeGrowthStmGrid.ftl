<script type="text/javascript" id="grid">
	...
	function bindingDataToReport(){
		var config = {
                title: ' ${uiLabelMap.BACCCustGroupIncomeGrowthStm}',
                service: 'acctgTransTotal',
                columns: [
                          { text: '${uiLabelMap.BACCCustomerGroupId}', datafield: 'groupId', width: '28%',
        ...
        var grid = OLBIUS.oLapGrid('grid', config, configPopup, 'getCustGroupIncomeGrowthStm', true);
