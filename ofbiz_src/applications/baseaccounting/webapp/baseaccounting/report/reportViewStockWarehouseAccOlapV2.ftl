...
<div id="stockWarehouseAccV2"></div>
<script type="text/javascript">
	$(function () {
		var config = {
			title: '${StringUtil.wrapString(uiLabelMap.BACCStockWarehouseAccReport)}',
			button: false,
			id: 'stockWarehouseAccV2',
			olap: 'olbiusReportStockWarehouseAccV2',  
			sortable: true,
			filterable: true,
			showfilterrow: true,
			columns: [
			...
			excel: function(obj){
				...
				window.location.href = "exportReportStockWarehouseAccExcelV2?" + otherParam;
            },
