...
<script>	
	...
	globalVar.partyIdToArr = [
   		{
   			partyId : "${userLogin.lastOrg}",
   			fullName : "${StringUtil.wrapString(organizationParty.get("groupName", locale))}"
		}
	];
	...
	uiLabelMap.BACCNotifyTakeMoneyFromBank = "${StringUtil.wrapString(uiLabelMap.BACCNotifyTakeMoneyFromBank)}";
	...
	uiLabelMap.BPOSReceiptId = "${StringUtil.wrapString(uiLabelMap.BPOSReceiptId)}";
	uiLabelMap.BACCOrderId = "${StringUtil.wrapString(uiLabelMap.BACCOrderId)}";
	uiLabelMap.BSOrderDate = "${StringUtil.wrapString(uiLabelMap.BSOrderDate)}";
	uiLabelMap.BACCBankId = "${StringUtil.wrapString(uiLabelMap.BACCBankId)}";
	uiLabelMap.BACCBankName = "${StringUtil.wrapString(uiLabelMap.BACCBankName)}";
	uiLabelMap.BACCListOrder = "${StringUtil.wrapString(uiLabelMap.BACCListOrder)}";
	uiLabelMap.BACCFeeNoTax = "${StringUtil.wrapString(uiLabelMap.BACCFeeNoTax)}";
	uiLabelMap.BACCTaxFee = "${StringUtil.wrapString(uiLabelMap.BACCTaxFee)}";
	uiLabelMap.BACCCreatePaymentForBankNote = "${StringUtil.wrapString(uiLabelMap.BACCCreatePaymentForBankNote)}";
	uiLabelMap.BACCTotalExcessMoney1 = "${StringUtil.wrapString(uiLabelMap.BACCTotalExcessMoney1)}";
	uiLabelMap.BACCTotalExcessMoney2 = "${StringUtil.wrapString(uiLabelMap.BACCTotalExcessMoney2)}";
	uiLabelMap.BACCFieldRequiredAccounting = "${StringUtil.wrapString(uiLabelMap.BACCFieldRequiredAccounting)}";
	uiLabelMap.BACCThruDateValidate = "${StringUtil.wrapString(uiLabelMap.BACCThruDateValidate)}";
	uiLabelMap.BACCPleaseChooseBank = "${StringUtil.wrapString(uiLabelMap.BACCPleaseChooseBank)}";
	uiLabelMap.BACCHasErrorWhenProcess = "${StringUtil.wrapString(uiLabelMap.BACCHasErrorWhenProcess)}";
	uiLabelMap.BACCAreyouSureProcessExcessMoney = "${StringUtil.wrapString(uiLabelMap.BACCAreyouSureProcessExcessMoney)}";
	uiLabelMap.BPOSCancel = "${StringUtil.wrapString(uiLabelMap.BPOSCancel)}";
	uiLabelMap.BPOSOK = "${StringUtil.wrapString(uiLabelMap.BPOSOK)}";
