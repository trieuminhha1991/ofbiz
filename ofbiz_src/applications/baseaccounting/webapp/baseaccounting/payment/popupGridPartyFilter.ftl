	...
	var filter = (function(){
		...
		var initWindow = function(){
			$("#jqxwindowpartyIdTo").jqxWindow({
		        theme: theme, isModal: true, autoOpen: false, resizable: false, cancelButton: $("#cancelPartyTo"), modalOpacity: 0.7, width: '80%', maxWidth: '90%', height: 500     
		    });
		...
		var initPartyGrid = function(){
            ...
            var config = {
        	        ...
        	        filterable: true,
        	        editable: false,
        	        source: {url: "getFromParty"}
    	   	};
			Grid.initGrid(config, datafields, columns, null, $('#jqxgridpartyidto'));
		...
		var bindEvent = function(){
			...
			$("#savePartyTo").click(function () {
				filter.saveFilter($("#jqxwindowpartyIdTo"), $('#jqxgridpartyidto'), $('#' + $('#jqxwindowpartyIdTokey').val()));
			});
