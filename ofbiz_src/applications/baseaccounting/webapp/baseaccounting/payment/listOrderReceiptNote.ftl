<#include "script/listOrderReceiptNoteScript.ftl">
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListOrderReceiptNote" dataField=dataField columnlist=columnlist filterable="true" filtersimplemode="true" showtoolbar="true"
		 customcontrol1=customcontrol1 id="jqxgridListOrderReceiptNote" clearfilteringbutton="true" isSaveFormData="true" formData="filterObjData"
		 selectionmode="checkbox" mouseRightMenu="true" contextMenuId="contextMenu" sourceId="orderId"
/>
...
<#include "createPaymentForBank.ftl"/>
<script>
	var filterObjData = new Object();
	var exportExcel = function(){
		var dataGrid = $("#jqxgridListOrderReceiptNote").jqxGrid('getrows');
...
<script type="text/javascript" src="/accresources/js/payment/listOrderReceiptNote.js?v=0.0.2"></script>