<div id="editPopupWindow" style="display:none;">
    <div>${uiLabelMap.BACCEditBankConversion}</div>
...
<script src="/accresources/js/setting/popup/editBankConversion.js"></script>