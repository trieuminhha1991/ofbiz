...
lastTimePeriodHistory.each{ period->
	...
	cash = Fomular.evalueTargetValue(delegator, "9656", reportId1, reportId1, reportIdT1, period.get("customTimePeriodId"), period.getString("isClosed"), parameters.organizationPartyId);
