...
lastTimePeriodHistory.each{ period->
	...
	longTermDebt = Fomular.evalueTargetValue(delegator, "9732", reportId1, reportIdM1, reportId1, period.get("customTimePeriodId"), period.getString("isClosed"), parameters.organizationPartyId);
