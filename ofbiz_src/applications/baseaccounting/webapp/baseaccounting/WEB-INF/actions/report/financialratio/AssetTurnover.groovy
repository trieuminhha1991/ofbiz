...
lastTimePeriodHistory.each{ period->
	...
	asset = Fomular.evalueTargetValue(delegator, "9653", reportId1, reportIdM1, reportId1, period.get("customTimePeriodId"), period.getString("isClosed"), parameters.organizationPartyId);
