...
lastTimePeriodHistory.each{ period->
	...
	currentAsset = Fomular.evalueTargetValue(delegator, "9654", reportId1, reportId1, reportIdT1, period.get("customTimePeriodId"), period.getString("isClosed"), parameters.organizationPartyId);
	...
	shortTermDebt = Fomular.evalueTargetValue(delegator, "9717", reportId1, reportId1, reportIdT1, period.get("customTimePeriodId"), period.getString("isClosed"), parameters.organizationPartyId);
