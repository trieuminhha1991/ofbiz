...
List<GenericValue> listPaymentType = FastList.newInstance();
EntityCondition paymentTypeCond = EntityCondition.makeCondition("paymentTypeId", EntityOperator.NOT_IN, paymentTypeIds);println("123" + paymentTypeCond.toString());
if(paymentTypeIds.size() > 0 ){
	 listPaymentType = delegator.findList("PaymentType",paymentTypeCond, null, null, null, false);
}
