...
List<GenericValue> listPaymentMethodType = FastList.newInstance();
if(paymentMethodTypeIds.size() > 0){
	listPaymentMethodType = delegator.findList("PaymentMethodType",paymentMethodCond, null, null, null, false);
}
