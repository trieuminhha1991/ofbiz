									...
									<div class="span12">
										...
										<div class="span6">
											...
											<div class="taxCodeContainer hide">
												<div class='row-fluid'>
													<div class='span5'>
														<label class="asterisk">${uiLabelMap.accTaxAuthorityRateTypeId}</label>
													</div>
													<div class='span7'>
...
<script type="text/javascript" src="/accresources/js/invoice/createPaymentForVoucherInvoice.js?v=0.0.5"></script>