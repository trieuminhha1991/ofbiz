...
public class SaleInvoiceTaxReport extends OlbiusOlapService{
	private static final String invoiceType = "SALES_INVOICE";
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("productCategoryId", context.get("productCategoryId"));
	...
	private OlbiusQuery init() {
		...
		String productCategoryId = (String)getParameter("productCategoryId");
		...
		if(productCategoryId != null){
			Condition productCategoryCond = null;
			if("TAX_VAT_KCT".equals(productCategoryId)){
				productCategoryCond = Condition.orCondition(Condition.makeEQ("tax_dim.product_category_id", productCategoryId), 
						Condition.make("tax_dim.product_category_id is null"));
			}else{
				productCategoryCond = Condition.makeEQ("tax_dim.product_category_id", productCategoryId);
			}
			condition.and(productCategoryCond);
		}
		query.select("tax.*")
