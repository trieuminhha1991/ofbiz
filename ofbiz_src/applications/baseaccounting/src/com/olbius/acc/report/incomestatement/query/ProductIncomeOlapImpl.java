...
public class ProductIncomeOlapImpl extends OlbiusOlapService{
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("productId", (String) context.get(IncomeOlapConstant.PRODUCT_ID));
	...
	private void initQuery(){
		...
		productId = (String) getParameter(IncomeOlapConstant.PRODUCT_ID);
