<script type="text/javascript" src="/deliresources/js/supplier/addSupplier.js"></script>
<script type="text/javascript" src="/aceadmin/jqw/jqwidgets/jqxcombobox.js"></script>

<div id="alterpopupWindow" style="display:none;">
    <div id="addSupplierPopupTitle">${uiLabelMap.BDAddSupplierManager}</div>
        ...
        <div class="row-fluid form-window-content-custom">
            <div class="row-fluid">
                <div class="span12">
                    <div class="span6">
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDSupplierId}&nbsp;&nbsp;&nbsp;</label></div>
                            <div class="span8"><input type="text" id="txtSupplierId" tabindex="5"/></div>
                        </div>

                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDTaxCode}&nbsp;&nbsp;&nbsp;</label></div>
                    ...
                    <div class="span6">
                        ...
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right asterisk">${uiLabelMap.BDAddress}</label></div>
                            <div class="span8">
                        ...
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDTelecomNumber}&nbsp;&nbsp;&nbsp;</label></div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="span6">
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDAccountNumber}&nbsp;&nbsp;&nbsp;</label></div>
                            <div class="span8"><input type="text" id="finAccountCode" tabindex="13"/></div>
                        </div>
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDAtTheBank}&nbsp;&nbsp;&nbsp;</label></div>
                            <div class="span8"><input type="text" id="finAccountName" tabindex="14"/></div>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDCountry}&nbsp;&nbsp;&nbsp;</label></div>
                            <div class="span8"><div id="finAccountCountry" tabindex="15"></div></div>
                        </div>
                        <div class="row-fluid">
                            <div class="span4"><label class="text-right">${uiLabelMap.BDStateProvince}&nbsp;&nbsp;&nbsp;</label></div>
