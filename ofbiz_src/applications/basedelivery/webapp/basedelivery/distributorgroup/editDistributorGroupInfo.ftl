<div style="position:relative">
    <form class="form-horizontal form-window-content-custom" id="initRequirementEntry"
          name="initRequirementEntry" method="post" action="#">
                    ...
                    <div class='row-fluid'>
                        ...
                        <div class="span9">
                            <textarea id="description" name="description"
                                      value="${productStoreGroup.description?if_exists}"
                                      class="autosize-transition span12"
                                      style="resize: vertical; margin-top:0;margin-bottom:0"></textarea>
                        </div>
                    </div>
                </div>
            </div><!--.row-fluid-->
...
showtoolbar="true" alternativeAddPopup="alterpopupWindow" editmode="click" selectionmode="checkbox" filtersimplemode="true" addType="popup"
...
<#include "script/editDistributorGroupInfoScript.ftl"/>
