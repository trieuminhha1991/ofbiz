<script src="/crmresources/js/crmsetting/addCommunicationResult.js"></script>

<div id="addCommunicationResult" style="display:none;">
	<div>${uiLabelMap.CommonAdd}</div>
	<div class="form-window-content-custom">
		<div class="row-fluid margin-top10">
			<div class="span4"><label class="text-right asterisk">${uiLabelMap.KReasonTypeId}</label></div>
			<div class="span8"><input type="text" id="ReasonTypeId" tabindex="6" /></div>
		</div>
		<div class="row-fluid margin-top10">
			<div class="span4"><label class="text-right asterisk">${uiLabelMap.BSStatus}</label></div>
			<div class="span8"><div id="Status" tabindex="7"></div></div>
		</div>
		<div class="row-fluid margin-top10">
