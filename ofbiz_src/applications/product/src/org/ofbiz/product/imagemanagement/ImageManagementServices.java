...
public class ImageManagementServices {
    ...
    private static List<Object> josonMap = null;
    ...
    public static void toJsonObject(Map<String,Object> attrMap, HttpServletResponse response){
        ...
        String jsonStr = null;
		try {
			json = JSONConverters.MapToJSON.convert(attrMap);
    ...
    public static void toJsonObjectList(List<Object> list, HttpServletResponse response) throws EventHandlerException {
        if (list != null) {
            
            String jsonStr = null;
			try {
				jsonStr = JSONConverters.ListToJSON.convert(list).toString();
			} catch (ConversionException e) {
				Debug.logError(e,module);
			}
            if (jsonStr == null) {
