...
public class SubscriptionServices {
    ...
    public static Map<String, Object> processExtendSubscription(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        // TRUNGNT Always create new Subscription, sometime one customer can subscribe a product more than 1 time
/*        
        try {
			Map<String, String> subscriptionFindMap = UtilMisc.toMap("partyId",
					partyId, "subscriptionResourceId", subscriptionResourceId,
    ...
    public static Map<String, Object> processExtendSubscriptionByOrder(DispatchContext dctx, Map<String, ? extends Object> context) throws GenericServiceException{
        ...
        try {
            ...
            for (GenericValue orderItem: orderItemList) {
                ...
                // Using AGGREGATED product for ProductSubscription, not instance
                String aggregatedId = ProductWorker.getInstanceAggregatedId(delegator, productId);
                if (aggregatedId != null) {
                	productId = aggregatedId; 
                }
                // END TRUNG added
