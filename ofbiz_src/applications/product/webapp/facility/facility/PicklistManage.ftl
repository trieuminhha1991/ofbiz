...
<div class="widget-box transparent no-bottom-border">
  ...
  <h3>${uiLabelMap.ProductPicklistManage}</h3>
  ...
  <div class="screenlet-body">
    <#if picklistInfoList?has_content>
      <#list picklistInfoList as picklistInfo>
        ...
        <div>
          ...
          <a href="<@ofbizUrl>PicklistReport.pdf?picklistId=${picklist.picklistId}</@ofbizUrl>" target="_blank" class="btn btn-info btn-mini">${uiLabelMap.ProductPick}/${uiLabelMap.ProductPacking} ${uiLabelMap.CommonReports}</a>
          <hr />
        </div>
        ...
        <#list picklistInfo.picklistBinInfoList?if_exists as picklistBinInfo>
          ...
          <#if (!isBinComplete)>
            <div style="margin-left: 15px;">
              ...
              <#if !picklistBinInfo.picklistItemInfoList?has_content><a href="javascript:document.DeletePicklistBin_${picklistInfo_index}_${picklistBinInfo_index}.submit()" class="btn btn-info btn-mini">${uiLabelMap.CommonDelete}</a></#if>
                      ...
                      <#if !picklistItemInfo.itemIssuanceList?has_content>
                        <td>
                          <form name="deletePicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}" method="post" action="<@ofbizUrl>deletePicklistItem</@ofbizUrl>">
                            ...
                            <input type="hidden" name="facilityId" value="${facilityId?if_exists}"/>
                            <a href='javascript:document.deletePicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}.submit()' class='btn btn-info btn-mini'>&nbsp;${uiLabelMap.CommonDelete}&nbsp;</a>
                          </form>
                        </td>
                      </#if>
                      <td>
                          ...
                          <form name="editPicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}" method="post" action="<@ofbizUrl>editPicklistItem</@ofbizUrl>">
                            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                              ...
                              <td>
                                ...
                                <a href='javascript:document.editPicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}.submit()' class='btn btn-info btn-mini'>&nbsp;${uiLabelMap.CommonEdit}&nbsp;</a>
                              </td>
                            </tr>
                          </form>
                          <#-- toggle the row color -->
    ...
    <#else/>
      <p class="alert alert-info">${uiLabelMap.ProductNoPicksStarted}.</p>
    </#if>
  </div>
</div>
