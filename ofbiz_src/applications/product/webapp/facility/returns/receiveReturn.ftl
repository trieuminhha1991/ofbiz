...
<div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
        <h4>${uiLabelMap.DetailInfoForReturn} [${returnId?if_exists}]. ${uiLabelMap.ReturnToFacility} "<#if facility?has_content>${facility.facilityName?default("Not Defined")}</#if>" [${facilityId?if_exists}] <#if shipmentId?exists> ${uiLabelMap.CommonBy} ${uiLabelMap.Shipment} ${shipmentId?if_exists}</#if></h4>
   		<!-- 
            ...
            <table cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
              ...
              <#else>
                ...
                <#list returnItems as returnItem>
                  ...
                  <!-- <td>${uiLabelMap.ReturnItemSeqId}</td> -->
              	 ...
              	 <!-- 	<td>${uiLabelMap.ProductLocation}</td> -->
		              	...
		              	<td>${uiLabelMap.DatetimeManufactured}</td>
		              	<td>${uiLabelMap.Batch}</td>
		           <!--   	<td>${uiLabelMap.InventoryItemType}</td> -->
                      ...
                      <#if orderItem.productId?exists>
                        ...
                        <#assign productId = product.productId>
                            ...
                            <input type="hidden" name="inventoryItemTypeId_o_${rowCount}" value="NON_SERIAL_INV_ITEM" />
                          ...
                          <td align="right">
	                          <@htmlTemplate.renderDateTimeField name="expireDate_o_${rowCount}" id="expireDate_o_${rowCount}" value="" event="" action="" className="" alert="" 
									title="Format: yyyy-MM-dd" size="25" maxlength="25" dateType="date" shortDateInput=false 
                          ...
                          <td align="right" class="width200px">
                          <@htmlTemplate.renderDateTimeField name="datetimeManufactured_o_${rowCount}" id="datetimeManufactured_o_${rowCount}" value="" event="" action="" className="" alert="" 
								title="Format: yyyy-MM-dd" size="25" maxlength="25" dateType="date" shortDateInput=false 
								timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" 
								classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" 
								pmSelected="" compositeType="" formName=""/>
	                      ...
	                      <td align="right">
	                          <input type="text" class="width100px" name="lotId_o_${rowCount}" size="6" value="" />
                          </td>
                          <!--  
                          <td width='10%'>
                          ...
                          -->
                          <td width="20%">
                            <select name="statusId_o_${rowCount}" size='1' id = "statusId_o_${rowCount}" class="width100px">
                          ...
                          <td align="right">
                          	<#if unitCost?has_content>
                          		<input type='text' class="width100px" name='unitCost_o_${rowCount}' size='6' value='${unitCost}' />	
                          	<#else>
                          		<#assign unitCost = 0>
                          		<input type='text' class="width100px" name='unitCost_o_${rowCount}' size='6' value='0' />
                          	</#if>
                ...
                <#if rowCount == 0>
                  ...
                  <tr>
                    <td colspan="9" class="label">${uiLabelMap.ProductNoItemsReturn} #${returnHeader.returnId} ${uiLabelMap.ProductToReceive}.</td>
                  </tr>
                  <tr>
                ...
                <#else>
                  <tr>
                    <td colspan="9" align="right">
                      <a href="javascript:document.selectAllForm.submit();" class="btn btn-small btn-info"><i class="fa-download"></i>${uiLabelMap.ProductReceiveSelectedProduct}</a>
                    </td>
                  </tr>
                </#if>
              </#if>
