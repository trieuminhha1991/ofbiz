...
if (returnHeader) {
	// TODOCHANGE out of the box is "ShipmentReceipt"
    context.receivedItems = delegator.findList("ShipmentReceiptAndItem", EntityCondition.makeCondition("returnId", returnId), null, null, null, false);
}
