...
if (shipmentPlans) {
    shipmentPlans.each { shipmentPlan ->
        ...
        orderedQuantity = orderItem.getBigDecimal("quantity");
        ...
        oneRow.totOrderedQuantity = orderedQuantity;
		...
		oneRow.reservedQuantity = reservedQuantity;
...
if (!addRows.isEmpty()){
	for (Map<String, Object> map : addRows){
		if (map.quantity != 0){
			checkQuantity = true;
		}
	}
}
context.checkQuantity = checkQuantity;
