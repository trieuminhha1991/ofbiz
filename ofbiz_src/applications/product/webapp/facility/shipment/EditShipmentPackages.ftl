...
<div class="widget-box">
    <div class="widget-header">
            <h3>${uiLabelMap.PageTitleEditShipmentPackages}</h3>
        <br class="clear"/>
    </div>
    <div class="widget-body">
        ...
        <#list shipmentPackageDatas as shipmentPackageData>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td><a href="javascript:document.updateShipmentPackageForm${shipmentPackageData_index}.submit();" class="btn btn-mini btn-info">${uiLabelMap.CommonUpdate}</a></td>
                <td><a href="javascript:document.deleteShipmentPackage_${shipmentPackageData_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a></td>
            </tr>
            </form>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td colspan="2">
                    <div>
                        ...
                        <a href="javascript:document.deleteShipmentPackageContent${shipmentPackageData_index}${shipmentPackageContent_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                    </div>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td colspan="2">
                    <div>
                        ...
                        <a href="javascript:document.createShipmentPackageContentForm${shipmentPackageData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.CommonAdd}</a>
                    </div>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
        ...
        <#list shipmentPackageRouteSegs as shipmentPackageRouteSeg>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td colspan="2">
                    <div>
                        ...
                        <a href="javascript:document.updateShipmentPackageRouteSegForm${shipmentPackageData_index}${shipmentPackageRouteSeg_index}.submit();" class="btn btn-mini btn-info">${uiLabelMap.CommonUpdate}</a>
                        <a href="javascript:document.deleteShipmentPackageRouteSeg${shipmentPackageData_index}${shipmentPackageRouteSeg_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                    </div>
                </td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td><a href="javascript:document.createShipmentPackageRouteSegForm${shipmentPackageData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.CommonAdd}</a></td>
                <td>&nbsp;</td>
                </form>
            </tr>
            -->
        ...
        <form action="<@ofbizUrl>createShipmentPackage</@ofbizUrl>" name="createShipmentPackageForm">
            ...
            <tr>
                ...
                <td><a href="javascript:document.createShipmentPackageForm.submit();" class="btn btn-mini btn-info">${uiLabelMap.CommonCreate}</a></td>
                <td>&nbsp;</td>
            </tr>
        </form>
        -->
