...
<div class="widget-box transparent no-bottom-border">
    ...
    <h3>${uiLabelMap.PageTitleEditShipmentRouteSegments}</h3>
        ...
        <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            <td valign="top">
                <div>
                    ...
                    <br />
                    <a href="javascript:document.updateShipmentRouteSegmentForm${shipmentRouteSegmentData_index}.submit();" class="btn btn-mini btn-info icon-ok open-sans">${uiLabelMap.CommonUpdate}</a>
                    <br />
                    <a href="javascript:document.duplicateShipmentRouteSegment_${shipmentRouteSegmentData_index}.submit();" class="btn btn-mini btn-info icon-copy open-sans">${uiLabelMap.CommonDuplicate}</a>
                    <br />
                    <a href="javascript:document.deleteShipmentRouteSegment_${shipmentRouteSegmentData_index}.submit();" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
                </div>
            </td>
            <td valign="top">
                <div>
                ...
                <div>
                    <#if "UPS" == shipmentRouteSegment.carrierPartyId?if_exists>
                        <#if !shipmentRouteSegment.carrierServiceStatusId?has_content || "SHRSCS_NOT_STARTED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            <a href="javascript:document.upsShipmentConfirm_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductConfirmShipmentUps}</a>
                            <br />
                        ...
                        <#elseif "SHRSCS_CONFIRMED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            <a href="javascript:document.upsShipmentAccept_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductAcceptUpsShipmentConfirmation}</a>
                            <br />
                            <a href="javascript:document.upsVoidShipment_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductVoidUpsShipmentConfirmation}</a>
                        <#elseif "SHRSCS_ACCEPTED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            <a href="javascript:document.upsTrackShipment_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductTrackUpsShipment}</a>
                            <br />
                            <a href="javascript:document.upsVoidShipment_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductVoidUpsShipment}</a>
                        </#if>
                    </#if>
                    <#if "DHL" == shipmentRouteSegment.carrierPartyId?if_exists>
                        <#if !shipmentRouteSegment.carrierServiceStatusId?has_content || "SHRSCS_NOT_STARTED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            <a href="javascript:document.dhlShipmentConfirm_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductConfirmShipmentDHL}</a>
                        </#if>
                    </#if>
                    <#if "FEDEX" == shipmentRouteSegment.carrierPartyId?if_exists>
                        <#if !shipmentRouteSegment.carrierServiceStatusId?has_content || "SHRSCS_NOT_STARTED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            <a href="javascript:document.fedexShipmentConfirm_${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.ProductConfirmShipmentFedex}</a>
                            <br />
    ...
    <#list shipmentPackageRouteSegs as shipmentPackageRouteSeg>
        ...
        <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <td valign="top">
                <div>
                    ...
                    <#if shipmentPackageRouteSeg.labelImage?exists>
                        <a href="javascript:document.viewShipmentPackageRouteSegLabelImage_${shipmentRouteSegmentData_index}_${shipmentPackageRouteSeg_index}.submit();" class="btn btn-mini btn-info">${uiLabelMap.ProductViewLabelImage}</a>
                    </#if>
            ...
            <td valign="top">
                <div>
                    <a href="javascript:document.updateShipmentPackageRouteSegForm${shipmentRouteSegmentData_index}${shipmentPackageRouteSeg_index}.submit();" class="btn btn-mini btn-info">${uiLabelMap.CommonUpdate}</a>
                    <a href="javascript:document.deleteRouteSegmentShipmentPackage_${shipmentRouteSegmentData_index}_${shipmentPackageRouteSeg_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                </div>
            </td>
        </tr>
        </form>
        ...
        <tr>
            ...
            <td><a href="javascript:document.createShipmentPackageRouteSegForm${shipmentRouteSegmentData_index}.submit()" class="btn btn-mini btn-info">${uiLabelMap.CommonAdd}</a></td>
            <td>&nbsp;</td>
            </form>
        </tr>
        -->
...
<div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
            <h3>${uiLabelMap.PageTitleAddShipmentRouteSegment}</h3>
        <br class="clear"/>
    </div>
    <div class="widget-body">
        <table cellspacing="0" class="table-bordered table table-striped table-hover dataTable">
            ...
            <tr>
                <td valign="top">
                    <div>
                        ...
                        <br />
                        <a href="javascript:document.createShipmentRouteSegmentForm.submit();" style="margin-left:8px" class="btn btn-mini btn-info">${uiLabelMap.CommonCreate}</a>
                    </div>
                </td>
                <td valign="top">
                    <div>
