...
<#if security.hasEntityPermission("FACILITY", "_VIEW", session)>
    ...
    <div class="widget-box transparent no-bottom-border">
        ...
        <h3>${uiLabelMap.ProductPackOrder}&nbsp;in&nbsp;${facility.facilityName?if_exists} [${facilityId?if_exists}]</h3>
        ...
        <div class="widget-body">
            <#if invoiceIds?has_content>
                <div>
                ${uiLabelMap.CommonView} <a href="<@ofbizUrl>/PackingSlip.pdf?shipmentId=${shipmentId}</@ofbizUrl>" target="_blank" class="btn btn-info btn-mini">${uiLabelMap.ProductPackingSlip}</a> ${uiLabelMap.CommonOr}
                ${uiLabelMap.CommonView} <a href="<@ofbizUrl>/ShipmentBarCode.pdf?shipmentId=${shipmentId}</@ofbizUrl>" target="_blank" class="btn btn-info btn-mini">${uiLabelMap.ProductBarcode}</a> ${uiLabelMap.CommonFor} ${uiLabelMap.ProductShipmentId} <a href="<@ofbizUrl>/ViewShipment?shipmentId=${shipmentId}</@ofbizUrl>" class="btn btn-info btn-mini">${shipmentId}</a>
                </div>
                ...
                <div>
                    ...
                    <#list invoiceIds as invoiceId>
                      <li>
                        ${uiLabelMap.CommonNbr}<a href="/accounting/control/invoiceOverview?invoiceId=${invoiceId}${externalKeyParam}" target="_blank" class="btn btn-info btn-mini">${invoiceId}</a>
                        (<a href="/accounting/control/invoice.pdf?invoiceId=${invoiceId}${externalKeyParam}" target="_blank" class="btn btn-info btn-mini">PDF</a>)
                      </li>
                    </#list>
                    </ul>
                </div>
            ...
            <form name="selectOrderForm" method="post" action="<@ofbizUrl>PackOrder</@ofbizUrl>">
              ...
              <table cellspacing="0" class="table table-hover table-striped table-bordered dataTable">
                <tr>
                  <td width="25%" align="right"><span style="margin:8px">${uiLabelMap.ProductOrderId}</span></td>
                  <td width="50%">
                  ...
                  <td><span class="">${uiLabelMap.ProductHideGrid}</span>&nbsp;<input type="checkbox" name="hideGrid" value="Y" <#if (hideGrid == "Y")>checked=""</#if> /></td>
                </tr>
                <tr>
                  <td colspan="3">
                    ...
                    <a href="javascript:document.selectOrderForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductPackOrder}</a>
                    <a href="javascript:document.selectOrderForm.action='<@ofbizUrl>WeightPackageOnly</@ofbizUrl>';document.selectOrderForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductWeighPackageOnly}</a>
                  </td>
                </tr>
              </table>
            </form>
            ...
            <form name="selectPicklistBinForm" method="post" action="<@ofbizUrl>PackOrder</@ofbizUrl>" style="margin: 0;">
              ...
              <table cellspacing="0" class="table table-hover table-striped table-bordered dataTable">
                <tr>
                  <td width="25%" align='right'><span style="margin:8px;">${uiLabelMap.FormFieldTitle_picklistBinId}</span></td>
                  <td width="50%">
                ...
                <tr>
                  <td colspan="3">
                    ...
                    <a href="javascript:document.selectPicklistBinForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductPackOrder}</a>
                    <a href="javascript:document.selectPicklistBinForm.action='<@ofbizUrl>WeightPackageOnly</@ofbizUrl>';document.selectPicklistBinForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductWeighPackageOnly}</a>
                  </td>
                </tr>
              </table>
            </form>
    ...
    <div class="widget-box transparent no-bottom-border">
        <div class="widget-header">
        <h3>${uiLabelMap.ProductOrderId} ${uiLabelMap.CommonNbr}<a href="/ordermgr/control/orderview?orderId=${orderId}">${orderId}</a> / ${uiLabelMap.ProductOrderShipGroupId} #${shipGroupSeqId}</h3>
            <span class="widget-toolbar">
            </span>
            <br class="clear"/>
        </div>
        <div class="wiget-body">
              <#if orderItemShipGroup?has_content>
                ...
                <table cellpadding="4" cellspacing="4" class="table table-hover table-striped table-bordered dataTable">
                  <tr>
                    <td valign="top">
              ...
              <#if showInput != "N">
                ...
                <form name="singlePackForm" method="post" action="<@ofbizUrl>ProcessPackOrder</@ofbizUrl>">
                  ...
                  <table cellpadding="2" cellspacing="0" class="table table-hover table-striped table-bordered dataTable">
                    <tr>
                      <td>
                        <div>
                            <span class="label">${uiLabelMap.ProductProductNumber}</span>
                            <input type="text" class="" name="productId" size="20" maxlength="20" value=""/>
                            @
                            <input type="text" class="" name="quantity" size="6" maxlength="6" value="1"/>
                            <a href="javascript:document.singlePackForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductPackItem}</a>
                        </div>
                      </td>
                      <td>
                          <span class="label">${uiLabelMap.ProductCurrentPackageSequence}</span>
                          ${packingSession.getCurrentPackageSeq()}
                          <button onclick="javascript:document.incPkgSeq.submit();" class="btn btn-small btn-info">
                          	<i class="btn-ok"></i>
                          	${uiLabelMap.ProductNextPackage}
                          </button>
                      </td>
                    </tr>
                  </table>
              ...
              <#if showInput != "N" && hideGrid != "Y" && itemInfos?has_content>
                <br />
                <form name="multiPackForm" style="overflow-x: scroll" method="post" action="<@ofbizUrl>ProcessBulkPackOrder</@ofbizUrl>">
                  <input type="hidden" name="facilityId" value="${facilityId?if_exists}" />
                  <input type="hidden" name="orderId" value="${orderId?if_exists}" />
                  <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}" />
                  ...
                  <table class="table table-hover table-striped table-bordered dataTable" cellspacing='0'>
                    <tr class="header-row">
                      ...
                      <td align="right">${uiLabelMap.CommonSelect}</td>
                    </tr>
                    ...
                    <#if (itemInfos?has_content)>
                      ...
                      <#-- <#list itemInfos as orderItem>  -->
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="/catalog/control/EditProduct?productId=${orderProduct.productId?if_exists}${externalKeyParam}" class="btn btn-info btn-mini" target="_blank">${(orderProduct.internalName)?if_exists}</a>
                              <#if orderProduct.productId != product.productId>
                                  &nbsp;[<a href="/catalog/control/EditProduct?productId=${product.productId?if_exists}${externalKeyParam}" class="btn btn-info btn-mini" target="_blank">${(product.internalName)?if_exists}</a>]
                              </#if>
                          </td>
                          ...
                          <td align="center">
                            <input type="text" size="7" name="qty_${rowKey}" value="${inputQty}" style="width: 100px;"/>
                          </td>
                          <td align="center">
                            <input type="text" size="7" name="wgt_${rowKey}" value="" style="width: 100px;"/>
                          </td>
                          <#if carrierShipmentBoxTypes?has_content>
                            <td align="center">
                          ...
                          <td align="center">
                            <select name="pkg_${rowKey}" style="width: 140px;">
                          ...
                          <td align="right">
                            <input type="text" size="7" name="numPackages_${rowKey}" value="1" style="width: 100px;"/>
                          </td>
                    ...
                    <tr>
                      <td colspan="12" align="right">
                        ...
                        <i class="icon-ok"></i>
                        ${uiLabelMap.ProductPackItem}
                        </button>
                        &nbsp;
                        <button class="btn btn-danger btn-small" onclick="javascript:document.clearPackForm.submit();">
                        	<i class="icon-trash"></i>
                        	${uiLabelMap.CommonClear} (${uiLabelMap.CommonAll})
                        </button>
                      </td>
                    </tr>
                  </table>
              ...
              <#if showInput != "N">
                <form name="completePackForm" method="post" action="<@ofbizUrl>CompletePack</@ofbizUrl>">
                  ...
                  <hr/>
                  <table class="table table-hover table-striped table-bordered dataTable" cellpadding="2" cellspacing='0'>
                    <tr>
                        ...
                        <#if packageSeqIds?has_content>
                            <td>
                                ...
                                <#list packageSeqIds as packageSeqId>
                                    ...
                                    <input style="margin-bottom:0px" type="text" size="7" name="packageWeight_${packageSeqId}" value="${packingSession.getPackageWeight(packageSeqId?int)?if_exists}" />
                                    <br />
                                </#list>
                                <#if orderItemShipGroup?has_content>
                        ...
                        <td nowrap="nowrap">
                            ...
                            <br />
                            <input type="text" name="additionalShippingCharge" style="margin-bottom: 0px;" value="${packingSession.getAdditionalShippingCharge()?if_exists}" size="20"/>
                            <#if packageSeqIds?has_content>
                                <a href="javascript:document.completePackForm.action='<@ofbizUrl>calcPackSessionAdditionalShippingCharge</@ofbizUrl>';document.completePackForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductEstimateShipCost}</a>
                                <br />
                            </#if>
                        </td>
                      <td>
                    ...
                    <tr>
                    	...
                    	<div>
                          ...
                          <button class="btn btn-info btn-small" onclick="javascript:document.completePackForm.submit();">
                          	<i class="icon-ok"></i>
                          	${buttonName}
                          </button>
                        </div>
    ...
    <#if ((packageMap?has_content) && (sortedKeys?has_content))>
      <div class="widget-box">
        <div class="widget-header">
        <h3>${uiLabelMap.ProductPackages} : ${sortedKeys.size()?if_exists}</h3>
            <span class="widget-toolbar">
            </span>
            <br class="clear"/>
        </div>
                ...
                <table class="table table-hover table-striped table-bordered dataTable" cellspacing='0'>
                  ...
                  <#list packedLines as line>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="/catalog/control/EditProduct?productId=${line.getProductId()?if_exists}${externalKeyParam}" class="btn btn-info btn-mini" target="_blank">${product.internalName?if_exists?default("[N/A]")}</a>
                      </td>
                      ...
                      <td align="right"><a href="javascript:clearLine('${facilityId}', '${line.getOrderId()}', '${line.getOrderItemSeqId()}', '${line.getProductId()?default("")}', '${line.getShipGroupSeqId()}', '${line.getInventoryItemId()}', '${line.getPackageSeq()}')" class="btn btn-info btn-mini">${uiLabelMap.CommonClear}</a></td>
                    </tr>
                  </#list>
                </table>
              </#if>
    ...
    <#if packedLines?has_content>
      <div class="widget-box">
          <div class="widget-header">
            <h3>${uiLabelMap.ProductItems} (${uiLabelMap.ProductPackages}): ${packedLines.size()?if_exists}</h3>
              <span class="widget-toolbar">
...
<#else>
  <p class="alert alert-info">${uiLabelMap.ProductFacilityViewPermissionError}</p>
</#if>