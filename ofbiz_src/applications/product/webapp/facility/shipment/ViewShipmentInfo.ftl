...
<div class="widget-box transparent no-bottom-border">
    ...
    <h3>${uiLabelMap.PageTitleViewShipment}</h3>
    ...
    <div class="widget-body">
        <table border="0" cellpadding="2" cellspacing="0" class="basic-table">
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductShipmentId}</td>
            <td width="80%">${shipment.shipmentId}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductShipmentType}</td>
            <td width="80%">${(shipmentType.get("description",locale))?default(shipment.shipmentTypeId?if_exists)}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.CommonStatus}</td>
            <td width="80%">${(statusItem.get("description",locale))?default(shipment.statusId?if_exists)}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductPrimaryOrderId}</td>
            <td width="80%"><#if shipment.primaryOrderId?exists><a href="/ordermgr/control/orderview?orderId=${shipment.primaryOrderId}" class="btn btn-info btn-mini">${shipment.primaryOrderId}</a></#if></td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductPrimaryReturnId}</td>
            <td width="80%"><#if shipment.primaryReturnId?exists><a href="/ordermgr/control/returnMain?returnId=${shipment.primaryReturnId}" class="btn btn-info btn-mini">${shipment.primaryReturnId}</a></#if></td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductPrimaryShipGroupSeqId}</td>
            <td width="80%">${shipment.primaryShipGroupSeqId?if_exists}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductEstimatedDates}</td>
            <td width="80%">
              <span>
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductLatestCancelDate}</td>
            <td width="80%">${(shipment.latestCancelDate.toString())?if_exists}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductEstimatedShipCost}</td>
            <td width="80%">${(shipment.estimatedShipCost)?if_exists}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductAdditionalShippingCharge}</td>
            <td width="80%">
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductHandlingInstructions}</td>
            <td width="80%">${shipment.handlingInstructions?if_exists}</td>
          </tr>
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductFacilities}</td>
            <td width="80%">
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.PartyParties}</td>
            <td width="80%">
              <span>
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductAddresses}</td>
            <td width="80%">
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.ProductPhoneNumbers}</td>
            <td width="80%">
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.CommonCreated}</td>
            <td width="80%">
          ...
          <tr>
            <td width="80%" align="right" class="olbius-label">${uiLabelMap.CommonLastUpdated}</td>
            <td width="80%">
