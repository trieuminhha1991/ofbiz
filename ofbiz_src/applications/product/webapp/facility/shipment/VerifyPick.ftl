...
<#if security.hasEntityPermission("FACILITY", "_VIEW", session)>
  ...
  <div class="widget-box transparent no-bottom-border">
    ...
    <h3>${uiLabelMap.ProductVerify}&nbsp;${uiLabelMap.OrderOrder}&nbsp;${uiLabelMap.CommonIn}&nbsp;${facility.facilityName?if_exists} [${facility.facilityId?if_exists}]</h3>
    ...
    <#if shipmentId?has_content>
      <div>
        <span class="label">${uiLabelMap.ProductShipmentId}</span><a href="<@ofbizUrl>/ViewShipment?shipmentId=${shipmentId}</@ofbizUrl>" class="btn btn-info btn-mini">${shipmentId}</a>
      </div>
    ...
    <div class="screenlet-body">
      <form name="selectOrderForm" method="post" action="<@ofbizUrl>VerifyPick</@ofbizUrl>">
        ...
        <table cellspacing="0" class="basic-table">
          <tr>
            <td width="25%" align="right"><span style="font-size: 14px; margin-top: 5px; font-weight: normal; line-height: 20px;">${uiLabelMap.ProductOrderId}</span></td>
            <td width="1">&nbsp;</td>
            <td width="75%">
              <#if shipmentId?has_content>
          ...
          <tr>
            ...
            <td colspan="2">
              ...
              <i class="icon-ok"></i>
              ${uiLabelMap.ProductVerify}&nbsp;${uiLabelMap.OrderOrder}
              </button>
            </td>
          </tr>
        </table>
      ...
      <form name="selectPicklistBinForm" method="post" action="<@ofbizUrl>VerifyPick</@ofbizUrl>" style="margin: 0;">
        ...
        <table cellspacing="0" class="basic-table">
          <tr>
            <td width="25%" align='right'><span style="font-size: 14px; margin-top: 5px; font-weight: normal; line-height: 20px;">${uiLabelMap.FormFieldTitle_picklistBinId}</span></td>
            <td width="1">&nbsp;</td>
            <td width="75%">
            ...
            <tr>
              <td>
                <div>
                  ...
                  <button class="btn btn-small btn-primary" type="submit">
                  <i class="icon-ok"></i>
                  ${uiLabelMap.ProductVerify}&nbsp;${uiLabelMap.OrderItem}
                  </button>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td colspan="12" align="right">
                <#if isShowVerifyItemButton == "true">
                  <button class="btn btn-small btn-primary" type="submit">
                  <i class="icon-ok"></i>
                  ${uiLabelMap.ProductVerify}&nbsp;${uiLabelMap.OrderItems}
                  </button>
                </#if>
                &nbsp;
                <#if rowKey != counter>
      ...
      <#if pickRows?has_content>
        <div class="screenlet">
          ...
          <div class="screenlet-body">
            ...
            <div align="right">
              <a href="javascript:document.completePickForm.submit()" class="btn btn-info btn-mini">${uiLabelMap.ProductComplete}</a>
            </div>
          </div>
        </div>
      </#if>
