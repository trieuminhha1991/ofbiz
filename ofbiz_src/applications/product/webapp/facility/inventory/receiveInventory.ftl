...
<script language="JavaScript" type="text/javascript">
    function setNow(field) { eval('document.selectAllForm.' + field + '.value="${nowTimestamp}"'); }
       ...
       <#-- <div class="button-bar button-style-1">
          <a href="<@ofbizUrl>EditFacility</@ofbizUrl>" class="btn btn-small btn-info">${uiLabelMap.ProductNewFacility}</a>
        </div>-->
        <#-- Receiving Results -->
          ...
          <table class="table table-striped table-hovered dataTable" cellspacing="0"">
            ...
            <#list receivedItems as item>
              <form name="cancelReceivedItemsForm_${item_index}" method="post" action="<@ofbizUrl>cancelReceivedItems</@ofbizUrl>">
                ...
                <tr>
                  <td><a href="<@ofbizUrl>ViewShipment?shipmentId=${item.shipmentId?if_exists}</@ofbizUrl>" class="btn btn-mini btn-info">${item.shipmentId?if_exists} ${item.shipmentItemSeqId?if_exists}</a></td>
                  <td>${item.receiptId}</td>
                  <td>${item.getString("datetimeReceived").toString()}</td>
                  <td><a href="/ordermgr/control/orderview?orderId=${item.orderId}" class="btn btn-mini btn-info">${item.orderId}</a></td>
          ...
          <form method="post" action="<@ofbizUrl>receiveSingleInventoryProduct</@ofbizUrl>" name="selectAllForm">
            <table class="table table-striped table-hovered dataTable" cellspacing="0">
              ...
              <tr>
                ...
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <a href="/catalog/control/EditProduct?productId=${product.productId}${externalKeyParam?if_exists}" target="catalog" class="btn btn-mini btn-info">${product.internalName?if_exists}</a>
                </td>
              </tr>
              <tr>
			  ...
			  <!--<#if VarianceReasonList?has_content>
			 	<#list VarianceReasonList as varianceReasonList>
			 		<tr>
			 			<td align="right" nowrap="nowrap">${varianceReasonList.description}</td>
			 		</tr>
			 		<tr>
			 			<input type="text" name="${varianceReasonList.description}_quantity" size="5" value="0" />
			 		</tr>
				</#list>
			  </#if> -->   
              ...
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductQuantityQualityAssurance}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <input type="text" name="quantityQualityAssurance" size="5" value="0" />
                </td>
              </tr>
              <tr>
                <td width="20%" align="right" nowrap="nowrap">${uiLabelMap.ProductQuantityExcess}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <input type="text" name="quantityExcess" size="5" value="0" />
                </td>
              </tr>                               
              <tr>
                    ...
                    <td>
                      <table class="table table-striped table-hovered dataTable" cellspacing="0">
                        ...
                        <tr>
						  ...
						  <!--<#if VarianceReasonList?has_content>
						 	<#list VarianceReasonList as varianceReasonList>
						 		<tr>
						 		  ...
						 		  <td align="right" nowrap="nowrap">${varianceReasonList.description}</td>
		                          <td align="right">
		                          	<input type="hidden" name ="rejectionId_o_${rowCount}" value = "${varianceReasonList.varianceReasonId}"/>
						 ...
						 <tr>
                            <td>&nbsp;</td>                            
                              <td align="right">${uiLabelMap.ProductQuantityQualityAssurance}</td>
                              <td align="right">
                                <input type="text" name="quantityQualityAssurance_o_${rowCount}" value="0" size="6"/>
                              </td>                            
                            <td align="right">${uiLabelMap.ProductQuantityExcess} :</td>
                            <td align="right">
                              <input type="text" name="quantityExcess_o_${rowCount}" value="0" size="6"/>
                            </td>
                          </tr>
                        </tr>
          ...
          <form name="selectAllForm" method="post" action="<@ofbizUrl>ReceiveInventory</@ofbizUrl>">
            ...
            <table class="table table-striped table-hovered dataTable" cellspacing="0">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>
                  <a href="javascript:document.selectAllForm.submit();" class="btn btn-info btn-mini">${uiLabelMap.ProductReceiveProduct}</a>
                </td>
              </tr>
            </table>
          </form>
