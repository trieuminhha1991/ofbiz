...
<table>
    <#if partyRoles?has_content>
                    ...
                    <#if userLoginAndPartyDetails?has_content>
                        ...
                        <#else>
                            ...
                            <#else>
                                <td>
                                    <div>
                                        <b><a class="btn btn-mini btn-primary" href="<@ofbizUrl>ListPeopleApproved?createdByUserLogin=${userLoginAndPartyDetails.userLoginId}</@ofbizUrl>" class="text">${userLoginAndPartyDetails.firstName?if_exists} ${userLoginAndPartyDetails.middleName?if_exists} ${userLoginAndPartyDetails.lastName?if_exists} (${imageApproveSize})</a></b>&nbsp;&nbsp;|&nbsp;&nbsp;
                                    </div>
                                </td>
                            </#if>
                        </#if>
        ...
        <#else>
            <td>
                <div><b><a href="<@ofbizUrl>ListPeopleRejected</@ofbizUrl>" class="btn btn-mini btn-inverse"><i class="icon-lock"></i>Rejected</a></b></div>
            </td>
        </#if>
    </#if>
</table>
