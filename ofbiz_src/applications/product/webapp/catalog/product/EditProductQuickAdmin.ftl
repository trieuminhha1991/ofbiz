...
<div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
        <h4 >${uiLabelMap.PageTitleEditProductQuickAdmin}</h4>
    ...
    <div class="screenlet-body">
        <!-- Name update section -->
        <form action="<@ofbizUrl>updateProductQuickAdminName</@ofbizUrl>" method="post" style="margin: 0;" name="editProduct" id="editProduct">
            ...
            <table cellspacing="0" class="basic-table">
                <tr>
                    <td><h4>${productId?if_exists}</h4></td>
                    <td>&nbsp;</td>
                    <td><input type="text" name="productName" size="40" maxlength="40" value="${product.productName?if_exists}"/></td>
                    <td><button class="btn btn-primary btn-mini" onclick="editProduct.submit();" type="submit"><i class="icon-ok"></i>${uiLabelMap.ProductUpdateName}</button></td>
                </tr>
            </table>
        </form>
    </div>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductSelectableFeatures}</h3>
    </div>
    <div class="screenlet-body">
        ...
        <div style="overflow:scroll;">
	        ...
	        <#list productAssocs as productAssoc>
	            ...
	            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
	                ...
	                <a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProduct?productId=${assocProduct.productId}</@ofbizUrl>">${assocProduct.productId?if_exists}</a></td>
	                <td width="100%"><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProduct?productId=${assocProduct.productId}</@ofbizUrl>">${assocProduct.internalName?if_exists}</a></td>
	                <td colspan="2">
	                ...
	                <td>
	                	<label>
	                    	<input ${checked} type="radio" name="useImages" value="${assocProduct.productId}"/>
	                    </label>
	                </td>
	                <#assign fromDate = Static["org.ofbiz.base.util.UtilFormatOut"].encodeQueryValue(productAssoc.getTimestamp("fromDate").toString())/>
	                <td><a class="btn btn-mini btn-danger" href="javascript:removeAssoc('${productAssoc.productIdTo}','${fromDate}');">x</a></td>
	            </tr>
	            <#assign idx = idx + 1/>
	            ...
	            <tr>
	                ...
	                <td>
	                    <table cellspacing="0" class="basic-table">
	                        ...
	                        <tr><td><a class="btn btn-mini btn-primary" href="javascript:removeSelectable('${(selectableFeatureType.get("description",locale))?if_exists}','${selectableFeatureType.productFeatureTypeId}','${product.productId}')">x</a>
	                            <a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProductQuickAdmin?productFeatureTypeId=${(selectableFeatureType.productFeatureTypeId)?if_exists}&amp;productId=${product.productId?if_exists}</@ofbizUrl>">${(selectableFeatureType.get("description",locale))?if_exists}</a></td></tr>
	                        </#list>
	                    </table>
	                </td>
	                <td align="right">
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductDistinguishingFeatures}</h3>
    </div>
    <div class="screenlet-body">
        <form action="<@ofbizUrl>updateProductQuickAdminDistFeat</@ofbizUrl>" method="post" style="margin: 0;" name="distFeature">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    <td><a href="<@ofbizUrl>quickAdminRemoveProductFeature?productId=${productId}&amp;productFeatureId=${distinguishingFeature.productFeatureId}</@ofbizUrl>" class="btn btn-mini btn-primary">x</a>&nbsp;
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductShippingDimensionsAndWeights}</h3>
    </div>
    <div class="screenlet-body">
        <!-- ***************************************************** Shipping dimensions section -->
        <form action="<@ofbizUrl>updateProductQuickAdminShipping</@ofbizUrl>" method="post" name="updateShipping" id="updateShipping">
            <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
	        ...
	        <#if (product.isVirtual)?if_exists == "Y">
	            ...
	            <#list assocProducts as assocProduct>
	                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
	                    ...
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProductFeatures?productId=${assocProduct.productId}</@ofbizUrl>">${StringUtil.wrapString(featureHazmat.get(assocProduct.productId)?if_exists)}</a></td>
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProduct?productId=${assocProduct.productId}</@ofbizUrl>">${StringUtil.wrapString(featureSalesThru.get(assocProduct.productId)?if_exists)}</a></td>
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProductAssoc?productId=${assocProduct.productId}</@ofbizUrl>">${StringUtil.wrapString(featureThruDate.get(assocProduct.productId)?if_exists)}</a></td>
	                </tr>
	                <#assign idx = idx + 1/>
	                <#-- toggle the row color -->
	                <#if rowClass == "2">
	        ...
	        <#else>
	                <tr>
	                    ...
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProductFeatures?productId=${product.productId}</@ofbizUrl>">${StringUtil.wrapString(hazmat?if_exists)}</a></td>
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProduct?productId=${product.productId}</@ofbizUrl>">${StringUtil.wrapString(salesthru?if_exists)}</a></td>
	                    <td><a class="btn btn-mini btn-primary" href="<@ofbizUrl>EditProductAssoc?productId=${product.productId}</@ofbizUrl>">${StringUtil.wrapString(thrudate?if_exists)}</a></td>
	                </tr>
	                <tr>
	                    <td colspan="10" align="right"><button onclick="updateShipping.submit();" type="submit" class="btn btn-primary btn-mini"><i class="icon-ok"></i>${uiLabelMap.ProductUpdateShipping}</button></td>
	                </tr>
	        </#if>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductStandardFeatures}</h3>
    </div>
    <div class="screenlet-body">
        ...
        <td>
            ...
            <form method="post" action="<@ofbizUrl>quickAdminApplyFeatureToProduct</@ofbizUrl>" name="addFeatureById" id="addFeatureById">
            <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <tr><td colspan="2" align="right"><button onclick="addFeatureById.submit();" type="submit" class="btn btn-primary btn-mini"><i class="icon-ok"></i>${uiLabelMap.ProductAddFeatures}</button></td></tr>
            </table>
            </form>
            </#if>
        </td>
        ...
        <td valign="top">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <#list standardFeatureAppls as standardFeatureAppl>
                    ...
                    <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                        <td colspan="2"><a href='<@ofbizUrl>quickAdminRemoveFeatureFromProduct?productId=${standardFeatureAppl.productId?if_exists}&amp;productFeatureId=${featureId?if_exists}&amp;fromDate=${(standardFeatureAppl.fromDate)?if_exists}</@ofbizUrl>' class="btn btn-mini btn-primary">x</a>
        ...
        <form action="<@ofbizUrl>EditProductQuickAdmin</@ofbizUrl>" id="EditProductQuickAdminob1">
        <input type="hidden" name="productFeatureTypeId" value="${(productFeatureTypeId)?if_exists}"/>
        <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
        <table cellspacing="0" class="basic-table">
            <tr>
                ...
                <td><button onclick="EditProductQuickAdminob1.submit();" type="submit" class="btn btn-primary btn-mini"><i class="icon-ok"></i>${uiLabelMap.ProductAddFeatureType}</button></td>
            </tr>
        </table>
        </form>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductCategories}</h3>
    </div>
    <div class="screenlet-body">
        <!--  **************************************************** Categories section -->
        <form action="<@ofbizUrl>quickAdminAddCategories</@ofbizUrl>" id="quickAdminAddCategoriesob2">
            <input type="hidden" name="fromDate" value="${nowTimestampString}"/>
            <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
            <table cellspacing="0" class="basic-table">
              <tr>
              ...
              <tr>
                  <td colspan="2"><button onclick="quickAdminAddCategoriesob2.submit();" type="submit" class="btn btn-primary btn-mini"><i class="icon-ok"></i> ${uiLabelMap.ProductUpdateCategories}</button></td>
              </tr>
            </table>
        </form>
        <table>
                        ...
                        <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                            <td colspan="2">
                              <form name="quickAdminRemoveProductFromCategory_${prodCatMemb_index}" action="<@ofbizUrl>quickAdminRemoveProductFromCategory</@ofbizUrl>" method="post">
                                ...
                                <a href="javascript:document.quickAdminRemoveProductFromCategory_${prodCatMemb_index}.submit();" class="btn btn-primary btn-mini">x</a>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductPublishAndView}</h3>
    </div>
    <div class="screenlet-body">
    <!--  **************************************************** publish section -->
    <#if (showPublish == "true")>
        <form action="<@ofbizUrl>quickAdminAddCategories</@ofbizUrl>" name="publish" id="quickAdminAddCategoriesob3">
        <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
        ...
        <table cellspacing="0" class="basic-table">
            <tr>
                <td>
                    ...
                    <button type="button" onclick="doPublish();" class="btn btn-primary btn-mini"><i class="icon-circle-arrow-up"></i>${uiLabelMap.ProductPublishAndView}</button>
                </td>
            </tr>
        </table>
        </form>
    <#else>
        <form action="<@ofbizUrl>quickAdminUnPublish</@ofbizUrl>" name="unpublish" id="unpublish">
        <input type="hidden" name="productId" value="${product.productId?if_exists}"/>
        ...
        <table cellspacing="0" class="basic-table">
            <tr>
                <td>
                    ...
                    <button onclick="unpublish.submit();" type="submit" class="btn btn-primary btn-small"><i class="icon-ok"></i>${uiLabelMap.ProductRemoveFromSite}</button>
                </td>
            </tr>
        </table>
        </form>
  ...
  <#else>
    <h3 class="header smaller lighter blue">${uiLabelMap.ProductProductNotFound} ${productId?if_exists}</h3>
  </#if>
