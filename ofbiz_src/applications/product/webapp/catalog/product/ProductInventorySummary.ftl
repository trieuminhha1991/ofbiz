...
<div class="widget-box transparent no-bottom-border">
  <#if product?exists>
    <div class="widget-header">
        <h4>${uiLabelMap.ProductInventorySummary}</h4>
        <span class="widget-toolbar none-content">
			...
			<a href="EditProductInventoryItems?productId=${productId}" class="icon-list-ul open-sans">${uiLabelMap.ProductShowProductFacilities}</a>
			<#else>
			<a href="EditProductInventoryItems?productId=${productId}&amp;showAllFacilities=Y" class="icon-list-ul open-sans">${uiLabelMap.ProductShowAllFacilities}</a>
			</#if>
        </span>
    </div>
            ...
            <#list quantitySummaryByFacility.values() as quantitySummary>
                <#if quantitySummary.facilityId?exists>
                    ...
                    <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                        ...
                        <a href="/facility/control/ReceiveInventory?facilityId=${facilityId}&amp;productId=${productId}&amp;externLoginKey=${externalLoginKey}" class="">${uiLabelMap.ProductInventoryReceive}</a></td>
