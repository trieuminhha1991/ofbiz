...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.PageTitleEditProductStoreSurveys}</h3>
    </div>
        ...
        <table cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
            ...
            <#list productStoreSurveys as storeSurvey>
              ...
              <tr valign="middle"<#if alt_row>class="alternate-row"</#if>>
                ...
                <td><a href="/content/control/EditSurvey?surveyId=${storeSurvey.surveyId}" class="">${survey.description?default("[" + survey.surveyId + "]")}</a></td>
                ...
                <td>
                  <form name="deleteProductStoreSurveyAppl_${storeSurvey_index}" method="post" action="<@ofbizUrl>deleteProductStoreSurveyAppl</@ofbizUrl>">
                    ...
                    <a href="javascript:document.deleteProductStoreSurveyAppl_${storeSurvey_index}.submit()" class="btn btn-mini btn-danger icon-trash open-sans">&nbsp${uiLabelMap.CommonDelete}</a>
                  </form>
                </td>
              </tr>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.PageTitleAddProductStoreSurveys}</h3>
    </div>
    <div class="screenlet-body">
