...
<div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
        <h4>${uiLabelMap.PageTitleEditProductStoreWebSites}</h3>
        <span class="widget-toolbar none-content"><a style="margin-bottom:5px;" href="/content/control/EditWebSite?productStoreId=${productStoreId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}" class="icon-plus-sign open-sans">&nbsp${uiLabelMap.ProductCreateNewProductStoreWebSite}</a></span>
    </div>
            ...
            <#if storeWebSites?has_content>
              ...
              <#list storeWebSites as webSite>
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                  <td><a href="/content/control/EditWebSite?webSiteId=${webSite.webSiteId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}">${webSite.siteName?if_exists} [${webSite.webSiteId}]</a></td>
                  <td>${webSite.httpHost?default('&nbsp;')}</td>
                  <td>${webSite.httpPort?default('&nbsp;')}</td>
                  <td align="center">
                    <a href="javascript:document.storeUpdateWebSite_${webSite_index}.submit();" class="btn btn-mini btn-danger icon-trash open-sans">&nbsp${uiLabelMap.CommonDelete}</a>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductSetStoreOnWebSite}</h3>
    </div>
    <div class="screenlet-body">
