...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.PageTitleEditProductPromoRules}</h3>
  </div>
  <#-- ======================= Rules ======================== -->
  ...
  <#list productPromoRules as productPromoRule>
    ...
    <#assign productPromoActions = productPromoRule.getRelated("ProductPromoAction", null, null, false)>
      ...
      <tr valign="middle" class="row-level-one<#if ruleClass == "1"> alternate-row</#if>">
        <td><b> ${uiLabelMap.ProductRule} ${(productPromoRule.productPromoRuleId)?if_exists}</b></td>
        <td>
    ...
    <#if (productPromoConds.size() == 0 && productPromoActions.size() == 0)>
          <form name="deleteProductPromoRule_${productPromoRule_index}" method="post" action="<@ofbizUrl>deleteProductPromoRule</@ofbizUrl>">
            <input type="hidden" name="productPromoId" value="${(productPromoRule.productPromoId)?if_exists}" />
            <input type="hidden" name="productPromoRuleId" value="${(productPromoRule.productPromoRuleId)?if_exists}" />
            <a href="javascript:document.deleteProductPromoRule_${productPromoRule_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
          </form>
    </#if>
        </td>
      </tr>
      ...
      <tr valign="top" class="row-level-one<#if ruleClass == "1"> alternate-row</#if>">
        <td align="right">${uiLabelMap.ProductConditionsForRule} ${(productPromoRule.productPromoRuleId)?if_exists} :</td>
        <td colspan="2">
          <table cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
    ...
    <#list productPromoConds as productPromoCond>
      ...
      <#list carrierShipmentMethods as carrierShipmentMethod>
        <#assign shipmentMethodType = carrierShipmentMethod.getRelatedOne("ShipmentMethodType", true)>
                ...
                <form name="deleteProductPromoCondition_${productPromoRule_index}_${productPromoCond_index}" method="post" action="<@ofbizUrl>deleteProductPromoCond</@ofbizUrl>">
                  ...
                  <input type="hidden" name="productPromoRuleId" value="${(productPromoCond.productPromoRuleId)?if_exists}" />
                  <input type="hidden" name="productPromoCondSeqId" value="${(productPromoCond.productPromoCondSeqId)?if_exists}" />
                  <a href="javascript:document.deleteProductPromoCondition_${productPromoRule_index}_${productPromoCond_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
                </form>
      <#-- ======================= Categories ======================== -->
                <div>${uiLabelMap.ProductConditionsCategoriesForCondition} ${(productPromoCond.productPromoCondSeqId)?if_exists}:</div>
        ...
        <#assign condApplEnumeration = condProductPromoCategory.getRelatedOne("ApplEnumeration", true)>
                <div>
                  ...
                  <form name="deleteProductPromoCategoryCondition_${productPromoRule_index}_${condProductPromoCategory_index}_${productPromoCond_index}" method="post" action="<@ofbizUrl>deleteProductPromoCategory</@ofbizUrl>">
                    ...
                    <a href="javascript:document.deleteProductPromoCategoryCondition_${productPromoRule_index}_${condProductPromoCategory_index}_${productPromoCond_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
                  </form>
                </div>
      </#list>
      <#else>
      ...
      <#list productPromoApplEnums as productPromoApplEnum>
                    ...
                    ${uiLabelMap.CommonAnd} ${uiLabelMap.CommonGroup}: <input type="text" size="10" maxlength="20" name="andGroupId" value="_NA_"/>*
                  	<button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductAddConditionCategory}</button>
                  </form>
                </div>
      <#-- ======================= Products ======================== -->
                <div>${uiLabelMap.ProductConditionsProductsForCondition} ${(productPromoCond.productPromoCondSeqId)?if_exists}:</div>
        ...
        <#assign condApplEnumeration = condProductPromoProduct.getRelatedOne("ApplEnumeration", true)>
                <div>
                  ...
                  <form name="deleteProductPromoProductCondition_${productPromoRule_index}_${productPromoCond_index}_${condProductPromoProduct_index}" method="post" action="<@ofbizUrl>deleteProductPromoProduct</@ofbizUrl>">
                    ...
                    <a href="javascript:document.deleteProductPromoProductCondition_${productPromoRule_index}_${productPromoCond_index}_${condProductPromoProduct_index}.submit()" class="btn btn-mini btn-danger icon-trash open-sans">${uiLabelMap.CommonDelete}</a>
                  </form>
                </div>
      </#list>
      <#else>
      ...
      <#list productPromoApplEnums as productPromoApplEnum>
                    ...
                    <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductAddConditionProducts}</button>
                  </form>
                </div>
              </td>
              <td></td>
    ...
    <#list carrierShipmentMethods as carrierShipmentMethod>
      <#assign shipmentMethodType = carrierShipmentMethod.getRelatedOne("ShipmentMethodType", true)>
                  ...
                  <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductCreateCondition}</button>
                </form>
              </td>
            </tr>
          </table>
      ...
      <tr><td><hr /></td><td colspan="2"></td></tr>
      <tr valign="top" class="row-level-one<#if ruleClass == "1"> alternate-row</#if>">
        <td align="right">${uiLabelMap.ProductActionForRule} ${(productPromoRule.productPromoRuleId)?if_exists} :</td>
        <td colspan="2">
    ...
    <#list productPromoActions as productPromoAction>
      ...
      <#else>
                  ...
                  <form name="deleteProductPromoAction_${productPromoRule_index}_${productPromoAction_index}" method="post" action="<@ofbizUrl>deleteProductPromoAction</@ofbizUrl>">
                    ...
                    <input type="hidden" name="productPromoRuleId" value="${(productPromoAction.productPromoRuleId)?if_exists}" />
                    <input type="hidden" name="productPromoActionSeqId" value="${(productPromoAction.productPromoActionSeqId)?if_exists}" />
                    <a href="javascript:document.deleteProductPromoAction_${productPromoRule_index}_${productPromoAction_index}.submit()" class="btn btn-mini btn-danger icon-trash open-sans">${uiLabelMap.CommonDelete}</a>
                  </form>
                </div>
      <#-- ======================= Categories ======================== -->
                <div>${uiLabelMap.ProductActionsCategoriesForAction} ${(productPromoAction.productPromoActionSeqId)?if_exists}:</div>
        ...
        <#assign actionApplEnumeration = actionProductPromoCategory.getRelatedOne("ApplEnumeration", true)>
                <div>
                  ...
                  <form name="deleteProductPromoCategoryAction_${productPromoRule_index}_${productPromoAction_index}_${actionProductPromoCategory_index}" action="<@ofbizUrl>deleteProductPromoCategory</@ofbizUrl>" method="post">
                    ...
                    <a href="javascript:document.deleteProductPromoCategoryAction_${productPromoRule_index}_${productPromoAction_index}_${actionProductPromoCategory_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
                  </form>
                </div>
      </#list>
      <#else>
      ...
      <#list productPromoApplEnums as productPromoApplEnum>
                    ...
                    ${uiLabelMap.CommonAnd} ${uiLabelMap.CommonGroup}: <input type="text" size="10" maxlength="20" name="andGroupId" value="_NA_"/>*
                    <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductAddActionCategory}</button>
                  </form>
                </div>
      <#-- ======================= Products ======================== -->
                 <div>${uiLabelMap.ProductActionsProductsForAction} ${(productPromoAction.productPromoActionSeqId)?if_exists}:</div>
        ...
        <#assign actionApplEnumeration = actionProductPromoProduct.getRelatedOne("ApplEnumeration", true)>
                <div>
                  ...
                  <form name="deleteProductPromoProductAction_${productPromoRule_index}_${productPromoAction_index}_${actionProductPromoProduct_index}" method="post" action="<@ofbizUrl>deleteProductPromoProduct</@ofbizUrl>"> 
                    ...
                    <a href="javascript:document.deleteProductPromoProductAction_${productPromoRule_index}_${productPromoAction_index}_${actionProductPromoProduct_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
                  </form>
                </div>
      </#list>
      <#else>
      ...
      <#list productPromoApplEnums as productPromoApplEnum>
                    ...
                    <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductAddActionProducts}</button>
                  </form>
                </div>
              </td>
              <td></td>
    ...
    <#list productPromoActionEnums as productPromoActionEnum>
                    ...
                    <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductCreateAction}</button>
                  </form>
                </div>
              </td>
            </tr>
...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.ProductAddPromoRule}</h3>
  </div>
  <div class="screenlet-body">
    <form method="post" action="<@ofbizUrl>createProductPromoRule</@ofbizUrl>">
      ...
      <button type="submit" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.CommonAdd}</button>
    </form>
  </div>
</div>
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.ProductPromotion} ${uiLabelMap.ProductCategories}</h3>
  </div>
  <#-- ======================= Categories ======================== -->
  <div class="screenlet-body">
  <#list promoProductPromoCategories as promoProductPromoCategory>
    ...
    <div>
      ...
      <form name="deleteProductPromoCategoryAction_${promoProductPromoCategory_index}" method="post" action="<@ofbizUrl>deleteProductPromoCategory</@ofbizUrl>">
        ...
        <a href="javascript:document.deleteProductPromoCategoryAction_${promoProductPromoCategory_index}.submit()" class="btn btn-mini btn-danger open-sans icon-trash">${uiLabelMap.CommonDelete}</a>
      </form>
    </div>
  </#list>
    <div>
...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.ProductPromotionProducts}</h3>
  </div>
  <#-- ======================= Products ======================== -->
  <div class="screenlet-body">
