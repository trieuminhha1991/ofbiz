...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.ProductAdvancedSearchInCategory}</h3>
  </div>
      ...
      <table cellspacing="0" class="table table-striped table-bordered table-hover">
        <#if searchCategory?has_content>
            <tr style="border-top:1px solid #ddd">
              ...
              <td>
              	  <label>
						<input name="SEARCH_SUB_CATEGORIES" type="radio" value="Y" checked="checked"><span class="lbl">${uiLabelMap.CommonYes}</span>
				  </label>
				  <label>
						<input name="SEARCH_SUB_CATEGORIES" type="radio" value="N" checked="checked"><span class="lbl">${uiLabelMap.CommonNo}</span>
				  </label>
              </td>
            </tr>
        <#else>
            ...
            <tr style="border-top:1px solid #ddd">
              ...
              <td>
				   ...
				   <label>
						<input name="SEARCH_SUB_CATEGORIES" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonNo}</span>
				  </label>
				   <label>
						<input name="SEARCH_CATEGORY_EXC" type="radio"  value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}</span>
				  </label>
				   <label>
						<input name="SEARCH_CATEGORY_EXC" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}</span>
				  </label>
				  <label>
						<input name="SEARCH_CATEGORY_EXC" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}</span>
				  </label>
              </td>
            </tr>
        </#if>
        ...
        <tr style="border-top:1px solid #ddd">
          ...
          <td valign="middle" colspan="2">
          	  <label>
					<input name="SEARCH_OPERATOR" type="radio" value="OR" <#if searchOperator == "OR">checked="checked"</#if>><span class="lbl">${uiLabelMap.CommonAny}</span>
			  </label>
			  <label>
					<input name="SEARCH_OPERATOR" type="radio" value="AND" <#if searchOperator == "AND">checked="checked"</#if>><span class="lbl">${uiLabelMap.CommonAll}</span>
			  </label>
          </td>
        </tr>
        <tr style="border-top:1px solid #ddd">
          ...
          <td>
          	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px;">
					<input name="SEARCH_PROD_FEAT_CAT_EXC1" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT_EXC1" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT_EXC1" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div><hr/>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT_EXC2" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT_EXC2" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT_EXC2" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div><hr/>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT3" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT3" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_CAT3" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div>
          </td>
        </tr>
        <tr style="border-top:1px solid #ddd">
          ...
          <td>
          	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC1" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC1" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC1" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div><hr/>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC2" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC2" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC2" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div><hr style="10px"/>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC3" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC3" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_PROD_FEAT_GRP_EXC3" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div>
          </td>
        </tr>
        ...
        <tr style="border-top:1px solid #ddd">
          ...
          <td>
          	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC1" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC1" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC1" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC2" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC2" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC2" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div>
		  	<div style="float:left;width:100%;">
          	  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC3" type="radio" value="" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC3" type="radio" value="Y"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			  </label>
			  <label style="float:left;height:30px">
					<input name="SEARCH_FEAT_EXC3" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonAlwaysInclude}&nbsp;</span>
			  </label>
		  	</div>
          </td>
        </tr>
        ...
        <tr style="border-top:1px solid #ddd">
          ...
          <td>
          	<label style="float:left;height:30px">
					<input name="sortAscending" type="radio" value="Y" checked="checked"><span class="lbl">${uiLabelMap.ProductLowToHigh}&nbsp;</span>
			</label>
			<label style="float:left;height:30px">
					<input name="sortAscending" type="radio" value="N"><span class="lbl">${uiLabelMap.ProductHighToLow}&nbsp;</span>
			</label>
          </td>
        </tr>
        <tr style="border-top:1px solid #ddd">
        ...
        <tr style="border-top:1px solid #ddd">
          ...
          <td>
          	<label style="float:left;height:30px">
					<input name="SEARCH_GOOD_IDENTIFICATION_INCL" type="radio" value="Y" checked="checked"><span class="lbl">${uiLabelMap.CommonInclude}&nbsp;</span>
			</label>
			<label style="float:left;height:30px">
					<input name="SEARCH_GOOD_IDENTIFICATION_INCL" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonExclude}&nbsp;</span>
			</label>
          </td>
        </tr>
        <#if searchConstraintStrings?has_content>
          <tr style="border-top:1px solid #ddd">
            ...
            <td>
	          	<label style="float:left;height:30px">
						<input name="clearSearch" type="radio" value="Y" checked="checked"><span class="lbl">${uiLabelMap.ProductNewSearch}&nbsp;</span>
				</label>
				<label style="float:left;height:30px">
						<input name="clearSearch" type="radio" value="N"><span class="lbl">${uiLabelMap.CommonRefineSearch}&nbsp;</span>
				</label>
	        </td>
          </tr>
        </#if>
        <tr style="border-top:1px solid #ddd;">
          <td align="center" colspan="3">
            <hr />
            <a href="javascript:document.advtokeywordsearchform.submit()" class="btn btn-small btn-primary"><i class="icon-search"></i>${uiLabelMap.CommonFind}</a>
          </td>
        </tr>
      </table>
    </form>
