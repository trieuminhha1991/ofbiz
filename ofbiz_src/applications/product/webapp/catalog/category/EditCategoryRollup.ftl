...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductCategoryRollupParentCategories}</h3>
    </div>
    <div class="screenlet-body">
        ...
        <#else>        
           <form method="post" action="<@ofbizUrl>updateProductCategoryToCategory</@ofbizUrl>" name="updateProductCategoryForm" id="updateProductCategoryForm">
                ...
                <td><b>&nbsp;</b></td>
                    ...
                    <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                        <td><#if curCategory?has_content>
                                <a href="<@ofbizUrl>EditCategory?productCategoryId=${curCategory.productCategoryId}</@ofbizUrl>" class="btn btn-mini btn-primary">
                        ...
                        <td>
                            <a href="javascript:document.removeProductCategoryFromCategory_${productCategoryRollup_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                        </td>
                    </tr>
                    ...
                    <tr valign="middle">
                        <td colspan="4" align="center">
                            <button onclick="updateProductCategoryForm.submit();" type="submit" style="font-size: x-small;" class="btn btn-small btn-primary"><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductAddCategoryParent} ${uiLabelMap.ProductCategorySelectCategoryAndEnterFromDate}:</h3>
    </div>
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            <tr><td>
                <form method="post" action="<@ofbizUrl>addProductCategoryToCategory</@ofbizUrl>" style="margin: 0;" name="addParentForm" id="addProductCategoryToCategoryob1">
                    ...
                    <button class="btn btn-mini btn-primary" onclick="addProductCategoryToCategoryob1.submit();" type="submit" ><i class="icon-ok"></i>${uiLabelMap.CommonAdd}</button>
                </form>
            </td></tr>
        </table>
    </div>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductCategoryRollupChildCategories}</h3>
    </div>
    <div class="screenlet-body">
        ...
        <#else>
            <form method="post" action="<@ofbizUrl>updateProductCategoryToCategory</@ofbizUrl>" name="updateProductCategoryToCategoryChild" id="updateProductCategoryToCategoryChildob1">
            <input type="hidden" name="showProductCategoryId" value="${productCategoryId}" />
            <table cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
                <tr class="header-row">
                    <td><b>${uiLabelMap.ProductChildCategoryId}</b></td>
                    ...
                    <#if productCategoryRollup.thruDate?exists && nowTimestamp.after(productCategoryRollup.getTimestamp("thruDate"))><#assign hasExpired = true></#if>
                        <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                            ...
                            <td>
                                <a href="javascript:document.removeProductCategoryFromCategory_1_${productCategoryRollup_index}.submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                            </td>
                        </tr>
                        <#-- toggle the row color -->
                        <#if rowClass == "2">
                    ...
                    <tr valign="middle">
                        <td colspan="4" align="center">
                            <button class="btn btn-mini btn-primary" onlick="updateProductCategoryToCategoryChildob1.submit();" type="submit"  style="font-size: x-small;" ><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3 class="header smaller lighter blue">${uiLabelMap.ProductAddCategoryChild} ${uiLabelMap.ProductCategorySelectCategoryAndEnterFromDate}:</h3>
    </div>
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            <tr><td>
                <form method="post" action="<@ofbizUrl>addProductCategoryToCategory</@ofbizUrl>" style="margin: 0;" name="addChildForm" id="addChildForm">
                    <input type="hidden" name="showProductCategoryId" value="${productCategoryId}" />
                    ...
                    <button class="btn btn-mini btn-primary" onlick="addChildForm.submit();" type="submit" ><i class="icon-ok"></i>${uiLabelMap.CommonAdd}</button>
                </form>
            </td></tr>
        </table>
    </div>
