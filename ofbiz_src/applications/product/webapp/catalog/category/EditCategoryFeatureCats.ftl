...
<#if productCategoryId?exists && productCategory?exists>
  <div class="widget-box transparent no-bottom-border">
    <div class="widget-header">
      <h4>${uiLabelMap.PageTitleEditCategoryFeatureCategories}</h4>
      <span class="widget-toolbar none-content">
      	<a href="javascript:document.attachProductFeaturesToCategory.submit()" class="open-sans"><i class="icon-check"></i>${uiLabelMap.ProductFeatureCategoryAttach}</a>
      </span>
    </div>
        <div class="screenlet-body">
            ...
            <table cellspacing="0" class="table table-striped table-bordered table-hover dataTable">
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    <td><a href="<@ofbizUrl>EditFeatureGroupAppls?productFeatureGroupId=${(productFeatureCatGrpAppl.productFeatureGroupId)?if_exists}</@ofbizUrl>" class="btn btn-mini btn-primary"><#if productFeatureGroup?exists>${(productFeatureGroup.description)?if_exists}</#if> [${(productFeatureCatGrpAppl.productFeatureGroupId)?if_exists}]</a></td>
                    ...
                    <td align="center">
                        <form method="post" action="<@ofbizUrl>updateProductFeatureCatGrpAppl</@ofbizUrl>" name="lineFormGrp${line}">
                            ...
                            <button class="btn btn-mini btn-primary" type="submit" style="font-size: x-small;" ><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
                        </form>
                    </td>
                    <td align="center">
                        <a href="javascript:document.removeProductFeatureCatGrpApplForm_${productFeatureCatGrpAppl_index}.submit()" class="btn btn-mini btn-danger margin-top8">${uiLabelMap.CommonDelete}</a>
    ...
    <div class="screenlet">
        <div class="screenlet-title-bar">
            <h3 class="header smaller lighter blue">${uiLabelMap.ProductApplyFeatureGroupFromCategory}</h3>
        </div>
        <div class="screenlet-body">
            ...
            <table cellspacing="0" class="basic-table">
                <tr><td>
                    ...
                    <@htmlTemplate.renderDateTimeField name="fromDate" event="" action="" value="" className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="fromDate2" dateType="date" shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
                    	<button class="btn btn-mini btn-primary" type="submit" style="font-size: x-small;" ><i class="icon-ok"></i>${uiLabelMap.CommonAdd}</button>
                    </form>
                </td></tr>
            </table>
            <#else>
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    ...
                    <td align="center">
                        <form method="post" action="<@ofbizUrl>updateProductFeatureCategoryAppl</@ofbizUrl>" name="lineForm${line}">
                        	...
                        	<button class="btn btn-mini btn-primary margin-top-nav-10" type="submit" style="font-size: x-small;" ><i class="icon-ok"></i>${uiLabelMap.CommonUpdate}</button>
                        </form>
                    </td>
                    <td align="center">
                    <a href="javascript:document.removeProductFeatureCategoryApplForm_${productFeatureCategoryAppl_index}.submit()" class="btn btn-mini btn-danger margin-top8">${uiLabelMap.CommonDelete}</a>
    ...
    <div class="screenlet">
        <div class="screenlet-title-bar">
            <h3 class="header smaller lighter blue">${uiLabelMap.ProductApplyFeatureGroupToCategory}</h3>
        </div>
        <div class="screenlet-body">
            <table cellspacing="0" class="basic-table">
                <tr><td>
