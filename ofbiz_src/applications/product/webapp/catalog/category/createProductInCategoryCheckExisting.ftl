    ...
    <div class="screenlet-body">
        ...
        <table cellspacing="0" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td width="10%"><a href="<@ofbizUrl>EditProduct?productId=${product.productId}</@ofbizUrl>" class="btn btn-mini btn-primary">[${uiLabelMap.ProductThisIsIt}]</a></td>
            </tr>
        </#list>
        </table>
        <#else>
        ...
        <form name="createProductInCategoryForm" method="post" action="<@ofbizUrl>createProductInCategory</@ofbizUrl>" style="margin: 0;">
            ...
            <table cellspacing="0" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td colspan="3">
                        <div>
                            ${uiLabelMap.ProductNewProductId}: <input style="margin-top:10px;" type="text" name="productId" value=""/>
                            <input type="submit" value="${uiLabelMap.ProductCreateNewProduct}" class="btn btn-mini btn-primary"/>
                        </div>
                    </td>
                </tr>
            </table>
