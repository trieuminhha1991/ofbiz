...
<#if productCategoryId?has_content>
    <a href="<@ofbizUrl>EditCategory?productCategoryId=${productCategoryId}</@ofbizUrl>" class="btn btn-mini btn-primary"><i class="icon-share-alt"></i>[${uiLabelMap.ProductBackToEditCategory}]</a>
</#if>
<div class="screenlet">
    <div class="screenlet-body" style="margin-top:5px;">
        <form name="createProductInCategoryCheckExistingForm" method="post" action="<@ofbizUrl>CreateProductInCategoryCheckExisting</@ofbizUrl>" style="margin: 0;">
            ...
            <#list productFeaturesByTypeMap.keySet() as productFeatureTypeId>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <label>
								<input name="pftsel_${productFeatureTypeId}" type="checkbox" value="Y" checked="checked"><span class="lbl">${uiLabelMap.ProductSelectable}</span>
							</label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <a href="javascript:document.createProductInCategoryCheckExistingForm.submit()" class="btn btn-mini btn-primary"><i class="icon-ok"></i>${uiLabelMap.ProductCheckExisting}</a>
                    </td>
                </tr>
            </table>
        </form>
