...
<div class="widget-box">
    ...
    <div class="widget-body">
        <table cellspacing="0" class="table table-striped table-bordered table-hovered dataTable">
        ...
        <tr><td colspan="11" align="center"><button type="submit" class="btn btn-info btn-mini">
        	<i class="icon-ok"></i>
