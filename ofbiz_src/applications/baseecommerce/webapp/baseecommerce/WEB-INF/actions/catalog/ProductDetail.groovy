...
//    reviews = product.getRelated("ProductReview", reviewByAnd, ["-postedDateTime"], true);
        ...
        if ("VV_FEATURETREE".equals(ProductWorker.getProductVirtualVariantMethod(delegator, productId))) {
            ...
            if (featureSet) {
                ...
                if (variantTree && imageMap) {
                    ...
                    jsBuf.append("</script>");
					jsBuf.append("<script language=\"JavaScript\" type=\"text/javascript\">");
					jsBuf.append("	ja3 = jQuery.noConflict();");
                    jsBuf.append("	ja3(document).ready(function() {");
    ...
    commonProductFeatureAndAppls = delegator.findByAnd("ProductFeatureAndAppl", [productId : productId, productFeatureTypeId : commonProductFeatureId], ["sequenceNum", "defaultSequenceNum"], true);
