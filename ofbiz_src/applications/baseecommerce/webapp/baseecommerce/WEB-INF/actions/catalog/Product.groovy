...
if (productId) {
    ...
    if (product) {
        viewProductCategoryId = NewCatalogWorker.getCatalogViewAllowCategoryId(delegator, currentCatalogId);
    ...
    if (product) {
        ...
        if (product.productTypeId && ("AGGREGATED".equals(product.productTypeId) || "AGGREGATED_SERVICE".equals(product.productTypeId) || "AGGR_DIGSERV".equals(product.productTypeId)) && context.configproductdetailScreen) {
