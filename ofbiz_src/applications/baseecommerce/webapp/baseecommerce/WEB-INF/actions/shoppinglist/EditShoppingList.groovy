...
if (shoppingListId) {
    shoppingList = delegator.findOne("ShoppingList", [shoppingListId : shoppingListId], true);
    ...
    if (shoppingList) {
        ...
        shoppingListType = shoppingList.getRelatedOne("ShoppingListType", true);
        ...
        parentShoppingList = shoppingList.getRelatedOne("ParentShoppingList", true);
        ...
        if ("SLT_AUTO_REODR".equals(shoppingListType?.shoppingListTypeId)) {
            recurrenceVo = shoppingList.getRelatedOne("RecurrenceInfo", true);
            ...
            if (userLogin.partyId.equals(shoppingList.partyId)) {
                ...
                shipAddress = delegator.findOne("PostalAddress", ["contactMechId" : shoppingList.contactMechId], true);
