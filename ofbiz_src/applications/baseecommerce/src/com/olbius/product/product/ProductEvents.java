...
public class ProductEvents {
    ...
    public static String tellAFriend(HttpServletRequest request, HttpServletResponse response) {
        ...
        String defaultScreenLocation = "component://obb/widget/EmailProductScreens.xml#TellFriend";
    ...
    public static String setNewLocation(HttpServletRequest request, HttpServletResponse response) {
    	String productStoreId = request.getParameter("productStoreId");
    	if ("ECOMMERCE_01".equals(productStoreId) || "ECOMMERCE_02".equals(productStoreId)) {
    		setCookie(response, "productStoreId", productStoreId, 60 * 60 * 24 * 365);
		} else {
			setCookie(response, "productStoreId", "", 0);
		}
        return "success";
    }
    public static String getProductStoreId(HttpServletRequest request) {
    	String productStoreId = getCookie(request, "productStoreId");
    	return (productStoreId!=""?productStoreId:"ECOMMERCE_01");
    }
