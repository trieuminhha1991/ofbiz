...
<fo:block font-size="9" margin-top="${margin_top}" font-family="Arial">
			...
			<fo:table-column column-width="400pt"/>
			 <fo:table-body>
				<fo:table-row height="15pt">
					<fo:table-cell>
						<fo:block margin-top="0px">${uiLabelMap.BSCustomer}: <#if fromParty?has_content> ${fromParty.fullName?if_exists}</#if></fo:block>
					</fo:table-cell>
				</fo:table-row>
				<fo:table-row height="15pt">
					<fo:table-cell>
	...
	<fo:table table-layout="fixed" space-after.optimum="10pt"> 
		...
		<#else>	
			<fo:table-column border="solid 0.2mm black" column-width="330pt"/>
		</#if>
