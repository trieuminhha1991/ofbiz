...
var OlbPromoView = (function(){
	...
	var initValidateForm = function(){
		setUiLabelMap("validFieldRequire", uiLabelMap.validFieldRequire);
		var extendRules = [
				{input: '#thruDate_i18n', message: uiLabelMap.BSRequiredValueGreatherOrEqualToDay, action: 'valueChanged', 
		...
		validatorThruDateVAL = new OlbValidator($('#updatePromoThruDate'), mapRules, extendRules);
	};
