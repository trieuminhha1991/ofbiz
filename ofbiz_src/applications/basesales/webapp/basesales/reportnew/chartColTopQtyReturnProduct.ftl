<div id="olbiusChartColTopQtyReturnProduct"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTopQtyReturnProduct = {
			service: "returnSalesOrderNew",
            id: "olbiusChartColTopQtyReturnProduct",
            olap: "olapChartColTopQtyReturnProduct",
            
            chart: {
                type: 'column'
            },
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BSChartTopQtyReturnProduct)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
		...
		OlbiusUtil.chart(configOlbiusChartColTopQtyReturnProduct);
	});
</script>
