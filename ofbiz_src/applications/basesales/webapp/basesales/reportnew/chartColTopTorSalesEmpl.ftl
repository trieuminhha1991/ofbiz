<div id="olbiusChartColTopTorSalesEmpl"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTopTorSalesEmpl = {
			service: "salesOrderNew",
            id: "olbiusChartColTopTorSalesEmpl",
            olap: "olapChartColTopTorSalesEmpl",
            
            chart: {
                type: 'column'
            },
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BSChartTopTurnoverSalesEmployee)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
		...
		OlbiusUtil.chart(configOlbiusChartColTopTorSalesEmpl);
	});
</script>
