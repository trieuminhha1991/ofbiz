        ...
        <div class="form-horizontal form-window-content-custom">
            <div class="row-fluid">
                <div class="span6">
                    <div class='row-fluid'>
                        <div class='span5'>
                            <label>${uiLabelMap.BSAgentsMT}</label>
                        </div>
                        <div class="span7">
                            <div id="agentChainMTId"><div id="agentChainMTGrid"></div></div>
                        </div>
                    </div>
                    <div class='row-fluid'>
                        <div class='span5'>
                ...
                <div class="span6">
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="pull-left">
                                <button type="button" id="btnFindInventoryAgentMT" class="btn btn-small btn-primary"><i class="fa fa-search"></i>&nbsp;${uiLabelMap.BSActionFind}</button>
                            </div>
                        </div>
                        <#--<div class="span10">-->
...
<div class="row-fluid">
    <div class="span12">
		<#include "viewInventoryCustomerMTDetailGrid.ftl"/>
    </div>
</div><!-- .row-fluid -->
...
<script type="text/javascript">
    ...
    $(function(){
        OlbInventoryCustomerMTFind.init();
    });
    var OlbInventoryCustomerMTFind = (function(){
        ...
        var initComplexElement = function(){
            ...
            var configAgentsMT = {
                ...
                columns: [
                    { text: '${uiLabelMap.BSAgentsChainId}', datafield: 'partyId', hidden: true},
                    {text: "${uiLabelMap.BSAgentsChainCode}", datafield: 'partyCode', width: '30%'},
                    {text: "${uiLabelMap.BSAgentsChainName}", datafield: 'description', width: '70%'},
                ],
                url: 'JQGetListAgentChain',
                useUtilFunc: true,
            ...
            agentsChainDDB = new OlbDropDownButton($("#agentChainMTId"), $("#agentChainMTGrid"), null, configAgentsMT, []);
        ...
        var initEvent = function(){
            $("#btnFindInventoryAgentMT").on("click", function(){
                var changeDateTypeId = changeDateTypeDDL.getValue();
                var agentChainMTId = agentsChainDDB.getValue();
                var fromDate;
                var thruDate;
                ...
                if (OlbCore.isNotEmpty(agentChainMTId)) infoCustomerAndDate += "&agentChainMTId=" + agentChainMTId;
        ...
        var updateGridInventCusSource = function (datafieldListEdit, productIdsStr, infoCustomerAndDate) {
            ...
            if (tmpSource) {
                ...
                var urlNew = "jqxGeneralServicer?sname=JQGetListInventoryCusAndProdMT";
