<div id="olbiusChartColTopTorCategoryMini"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTopTorCategoryMini = {
			service: "salesOrderNew",
            id: "olbiusChartColTopTorCategoryMini",
            olap: "olapChartColTopTorCategoryMini",
            
            chart: {
                type: 'column'
            },
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BSChartTopTurnoverByCategory)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
            ...
            chartRender: chartRenderTypeColumn({color: 9}),
		...
		OlbiusUtil.chart(configOlbiusChartColTopTorCategoryMini);
	});
</script>
