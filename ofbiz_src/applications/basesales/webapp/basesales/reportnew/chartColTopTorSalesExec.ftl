<div id="olbiusChartColTopTorSalesExec"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTopTorSalesExec = {
			service: "salesOrderNew",
            id: "olbiusChartColTopTorSalesExec",
            olap: "olapChartColTopTorSalesExec",
            ...
            chartRender: chartRenderTypeColumn({color: 3}),
		...
		OlbiusUtil.chart(configOlbiusChartColTopTorSalesExec);
	});
</script>
