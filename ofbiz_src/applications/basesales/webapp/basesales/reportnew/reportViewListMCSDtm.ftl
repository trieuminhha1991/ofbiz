			...
			<div class="widget-body body1">
				<div class="widget-main main1">
					<ul class="list-unstyled spaced2">
						<#if hasOlbEntityPermission("ETTDASHBOARD_CHART_DTM", "VIEW")>
						<li>
							<a href="dashboardChartDtm" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TOR_PRODSTORE", "VIEW")>
							<li>
								<a href="reportTorProductStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TORPRODUCT_PRODSTORE", "VIEW")>
							<li><#-- href="viewReportTurnoverProProstoLink" -->
								<a href="reportTorProductProdStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TORPRODUCT_SALESCHANNEL", "VIEW")>
							<li><#-- href="viewReportTurnoverProChaLink" -->
								<a href="reportTorProductSalesChannel<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TORPRODUCT_REGION", "VIEW")>
							<li><#-- href="viewReportProRegLink" -->
								<a href="reportTorProductRegion<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TORPRODUCT_CUSTOMER", "VIEW")>
							<li><#-- href="viewReportTurnoverCusLink" -->
								<a href="reportTorCustomer<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<li>
						<a href="viewReportGrowthLink<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
					...
					<ul class="list-unstyled spaced2">
						<#if hasOlbEntityPermission("REPORTSA_SYNTORPRODUCT_PRODSTORE", "VIEW")>
							<li><#-- href="viewReportSynTurStoLink" -->
								<a href="reportSynTorProductProdStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_SYNTORSALESEMPL_PROD", "VIEW")>
							<li>
								<a href="reportSynTorSalesEmpl<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
							...
							<li><#-- href="viewReportSynTurCaCeLink" -->
								<a href="reportSynTorSalesEmplProduct<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_SYNTORSALESEXEC_PROD", "VIEW")>
							<li>
								<a href="reportSynTorSalesExec<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_SYNTORSALESEXEC_BYPROD", "VIEW")>
							<li><#-- href="viewReportSynTurSaExLink" -->
								<a href="reportSynTorSalesExecProduct<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TOR_PRODSTORE", "VIEW")>
							<li>
								<a href="reportQtyOrderProductStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_PERCKHTT_PRODSTORE", "VIEW")>
							<li>
								<a href="reportPercKhttProductStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
					...
					<ul class="list-unstyled spaced2">
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_SALESORDER", "VIEW")>
							<li><#-- href="salesDetailReport" -->
								<a href="reportOtherTorSalesOrder<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_CUSTLOYALTY", "VIEW")>
							<li><#-- href="viewReportCustomerSatisfactionLink" -->
								<a href="reportTorProductCustomerLoyalty<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("SSAEXREPORT_SALES_REPORT", "VIEW")>
							<li>
								<a href="reportOtherUsePromoCode<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_CATEGORY", "VIEW")>
							<li><#-- href="departmentSummaryReport" -->
								<a href="reportOtherTorCategory<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_PRODUCT", "VIEW")>
							<li><#-- href="itemSummaryReport" -->
								<a href="reportOtherTorProduct<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_CUSTOMER", "VIEW")>
							<li><#-- href="customerSummaryReport" -->
								<a href="reportOtherTorCustomer<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("POS_SALES_REPORT", "VIEW")>
							...
							<li>
								<a href="returnReport<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_TORRETURN_PRODSTORE", "VIEW")>
							<li>
								<a href="reportTorReturnByProductStore<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
						...
						<#if hasOlbEntityPermission("REPORTSA_OTHERTOR_SALESDATA", "VIEW")>
							<li>
								<a href="reportStatisticSalesData<#if viewPartner?exists && viewPartner == "A">?viewPartner=A</#if>" target="_blank" class="content-link content-link-turnover">
