<div id="olbiusChartColTorLoyaltyCustomer"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTorLoyaltyCustomer = {
			service: "salesOrderNew",
            id: "olbiusChartColTorLoyaltyCustomer",
            olap: "olapChartColTorLoyaltyCustomer",
            
            chart: {
                type: 'column'
            },
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BSChartTopCustomerLoyaltyByTurnover)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
		...
		OlbiusUtil.chart(configOlbiusChartColTorLoyaltyCustomer);
	});
</script>
