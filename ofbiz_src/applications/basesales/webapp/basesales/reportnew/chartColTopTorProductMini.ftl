<div id="olbiusChartColTopTorProductMini"></div>
<script type="text/javascript">
	$(function(){
		var configOlbiusChartColTopTorProductMini = {
			service: "salesOrderNew",
            id: "olbiusChartColTopTorProductMini",
            olap: "olapChartColTopTorProductMini",
            
            chart: {
                type: 'column'
            },
            title: {
                text: '${StringUtil.wrapString(uiLabelMap.BSChartTopProductByTurnover)}',
                x: -20 //center
            },
            xAxis: {
                type: 'category',
            ...
            chartRender: chartRenderTypeColumn({color: 6}),
		...
		OlbiusUtil.chart(configOlbiusChartColTopTorProductMini);
	});
</script>
