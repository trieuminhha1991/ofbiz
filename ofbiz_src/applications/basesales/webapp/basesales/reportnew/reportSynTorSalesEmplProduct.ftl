...
<div id="olbiusSynTorSalesEmplProduct"></div>
<script type="text/javascript">
    $(function() {
        var config = {
            ...
            id: "olbiusSynTorSalesEmplProduct",
            olap: "olapSynTorSalesEmplProduct",
            sortable: true,
            filterable: true,
            showfilterrow: true,
            showstatusbar: true,
...
<div id="olbiusSynTorSalesEmplProductByVolume" class="margin-top30"></div>
<script type="text/javascript">
    $(function() {
        var config = {
            ...
            service: "salesOrderNew",
            button: false,
            id: "olbiusSynTorSalesEmplProductByVolume",
            olap: "olapSynTorSalesEmplProduct",
            sortable: true,
            filterable: true,
            showfilterrow: true,
