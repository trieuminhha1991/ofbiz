...
<script type="text/javascript">
    ...
    $(function(){
        OlbInventoryCustomerGTNew.init();
    });
    var OlbInventoryCustomerGTNew = (function(){
        var grid;
        var init = function(){
            initElement();
            initElementComplex();
        ...
        var initElementComplex = function(){
            ...
            var configProductList = {
                ...
                rendertoolbarconfig: {
					<#assign customcontrol1 = "fa fa-file-excel-o@${uiLabelMap.BSExportExcel}@javascript: void(0);@OlbInventoryCustomerGTNew.exportExcelInventoryCus()">
        ...
        var exportExcelInventoryCus = function(){
            var url = OlbInventoryCustomerGTFind.getUrlExportExcel();
            ...
            form.setAttribute("action", "exportInventoryCustomerExcelGT");
