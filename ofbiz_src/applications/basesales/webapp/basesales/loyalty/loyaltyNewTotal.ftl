<div class="row-fluid">
	...
	<div class="step-content row-fluid position-relative" id="step-container" style="padding-top:15px">
		...
		<div class="step-pane active" id="step1">
			${screens.render("component://basesales/widget/LoyaltyScreens.xml#NewLoyaltyInfo")}
		</div>

		<div class="step-pane" id="step2">
			${screens.render("component://basesales/widget/LoyaltyScreens.xml#NewLoyaltyRules")}
		</div>
	</div><!--.step-content-->
...
<#include 'loyaltyNewTotalScript.ftl'>