...
<#assign columnListItemsProd = "
			...
			{text: '${StringUtil.wrapString(uiLabelMap.BSProductName)}', dataField: 'productName', minwidth: 120, width: 330, editable:false},
			...
			{ text: '${StringUtil.wrapString(uiLabelMap.OrderReturnReason)}', dataField: 'returnReasonId', width: 220, editable:true, columntype:'dropdownlist', filterable:false, sortable:false,  cellClassName: 'background-prepare',
		   		 	cellsrenderer: function(row, column, value){
...
<div id='jqxProductSearch' class='pull-right' style='margin-left: -10px !important; margin-top: 4px; padding: 0px !important'></div>

<#include "returnWithoutOrderNewProdSearch.ftl"/>
<#assign urlSName = ""/>	
<div id="jqxgridProd"></div>
<#include "returnWithoutOrderNewItemsAddPopup.ftl">
	...
	var OlbReturnAddProductItems = (function(){
		...
		var initElementComplex = function(){
			var rendertoolbar = function (toolbar) {
				toolbar.html("");
				var container = $("<div id='toolbarcontainerGridProduct' class='widget-header' style='height:33px !important;'></div>");
				toolbar.append(container);
				container.append($("#jqxProductSearch"));
				container.append('<div class="margin-top10">');
				container.append('<a href="javascript:OlbReturnNewItemsProdAddPop.openWindow()" data-rel="tooltip" data-placement="bottom" class="button-action"><i class="icon-plus open-sans" style="font-size: 14px;">${uiLabelMap.CommonAdd}</i></a>');
				container.append('<a href="javascript:OlbReturnAddProductItems.removeItemFromGrid()" data-rel="tooltip" data-placement="bottom" class="button-action"><i class="icon-minus open-sans" style="font-size: 14px;">${uiLabelMap.CommonDelete}</i></a>');
