...
<#assign tmpCreateUrl = ""/>
<#if hasOlbPermission("MODULE", "SALES_CUSGROUPST_NEW", "")>
	<#assign tmpCreateUrl = "icon-plus open-sans@${uiLabelMap.BSAddItem}@javascript:OlbCustomerGroupViewMember.addItem();"/>
</#if>
<#assign tmpDelete = false/>
<#if hasOlbPermission("MODULE", "SALES_CUSGROUPST_DELETE", "")>
...
<script type="text/javascript">
	$(function(){
		OlbCustomerGroupViewMember.init();
	});
	var OlbCustomerGroupViewMember = (function(){
		var init = function(){
			initElement();
			initEvent();
		};
