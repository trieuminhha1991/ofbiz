...
boolean isPrivateOrg = false;
isPrivateOrg = SecurityUtil.hasRole("SALES_EMPLOYEE", userLogin.getString("partyId"), delegator);
if (!isPrivateOrg) isPrivateOrg = SecurityUtil.hasRole("EMPLOYEE", userLogin.getString("partyId"), delegator);
