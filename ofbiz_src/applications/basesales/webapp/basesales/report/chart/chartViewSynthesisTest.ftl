...
<script type="text/javascript" id="saleOrderTotal">
	...
	<#assign salesRegion9 = delegator.findList("PartyRegion", Static["org.ofbiz.entity.condition.EntityCondition"].makeCondition(Static["org.ofbiz.base.util.UtilMisc"].toMap("partyId", ownerPartyId)), null, null, null, false)>
