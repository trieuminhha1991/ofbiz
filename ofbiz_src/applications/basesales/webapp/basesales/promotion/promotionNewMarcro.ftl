<#macro buildCondition ruleIndex=0 condIndex=0 promoCond="" sizeCond=0>
	...
	<div class="form-legend" id="form-legend_c_${promoCond_index}_o_${promoRule_index}">
		...
		<div class="contain">
			...
			<div class="row-fluid" style="display:none">
				<div class="span4">
					<label>${uiLabelMap.BSRecurrenceValue}</label>
				</div>
				<div class="span8">
					<div class="container-add-minus">
						<div id="ddbcrecurrenceInfoIdCond_c_${promoCond_index}_o_${promoRule_index}" class="close-box-custom">
							<div id="recurrenceInfoGridCond_c_${promoCond_index}_o_${promoRule_index}"></div>
						</div>
					</div>
					<a href="javascript:void(0)" class="btn btn-mini" onClick="OlbRecurrenceInfoNew.showWindowRecurrenceNew('ddbcrecurrenceInfoIdCond_c_${promoCond_index}_o_${promoRule_index}');"><i class="fa fa-plus"></i></a>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span4">
	...
	<div class="form-legend" id="form-legend_a_${promoAction_index}_o_${promoRule_index}">
		...
		<div class="contain">
			...
			<div class="row-fluid">
				...
				<div class="span8">
					<div id="isCheckInv_a_${promoAction_index}_o_${promoRule_index}" name="isCheckInv_a_${promoAction_index}_o_${promoRule_index}"></div>
				</div>
			</div>
			<#--
			<div class="row-fluid">
				<div class="span4">
					<label>${uiLabelMap.ProductItemId}</label>
				</div>
				<div class="span8">
