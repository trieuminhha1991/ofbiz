				...
				<div class="span12 form-window-content-custom">
					...
					<div class="row-fluid">
						...
						<div class='row-fluid'>
							...
							<div class='span7'>
								<div id="wn_prodsearch_listPriceVAT" class="div-input-important"></div>
					   		</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	var OlbQuotNewItemsProdSearch = (function(){
		...
		var initElementComplex = function(){
			var configComboBoxSearchProduct = {
		        ...
		        formatDataFuncItem: function(data, searchString) {
		            ...
		            data.isSelectAllProductStore = $("#isSelectAllProductStore").val() ? "Y" : null;
		            ...
		            data.productStoreIds = JSON.stringify(storeItems);
		            data.productStoreGroupIds = JSON.stringify(storeGroupItems);
		            return data;
		        },
		...
		function openWindowAdd(){
			...
			$("#wn_prodsearch_listPriceVAT").jqxNumberInput('focus');
		}
