...
public class ChartColTopTorCategoryMiniReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartColTopTorCategoryMiniReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		query.select("CATED.category_id")
			...
			.join(Join.INNER_JOIN, "product_category_member_rel", "PCR", "SOF.product_dim_id = PCR.product_dim_id AND PCR.depth = '1' AND ((PCR.thru_date_dim_id = '-1' AND SOF.order_date_dim_id > PCR.from_date_dim_id) OR (SOF.order_date_dim_id BETWEEN PCR.from_date_dim_id AND PCR.thru_date_dim_id))")
			.join(Join.INNER_JOIN, "category_dimension", "CATED", "PCR.category_dim_id = CATED.dimension_id")
