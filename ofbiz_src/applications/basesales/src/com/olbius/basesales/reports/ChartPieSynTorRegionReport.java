...
public class ChartPieSynTorRegionReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartPieSynTorRegionReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		query.select("ARESD.region_geo_id", "region_id")
