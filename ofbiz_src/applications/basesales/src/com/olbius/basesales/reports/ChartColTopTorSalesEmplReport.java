...
public class ChartColTopTorSalesEmplReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartColTopTorSalesEmplReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		query.select("EMPLD.party_id")
			...
			.where(Condition.makeBetween("SOF.entry_date_dim_id", getSqlTime(getFromDate()), getSqlTime(getThruDate()))
						...
						.and("EMPLD.party_id is not null")
