...
public class ChartPieSynTorCustomerLoyaltyReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartPieSynTorCustomerLoyaltyReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		query.select("CUSLOYD.party_classification_group_id", "loyalty_group_id")
