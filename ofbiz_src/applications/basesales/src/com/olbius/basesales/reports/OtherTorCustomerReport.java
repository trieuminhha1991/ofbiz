...
public class OtherTorCustomerReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "OtherTorCustomerReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		query.select("CUSTD.party_id", "customer_id")
