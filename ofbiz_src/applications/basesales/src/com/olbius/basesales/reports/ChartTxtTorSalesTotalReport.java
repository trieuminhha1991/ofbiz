...
public class ChartTxtTorSalesTotalReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartTxtTorSalesTotalReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		*/
		...
		//if (creatorCond == null) { // is manager
			query.select("SUM(SOF.total_amount)", "total_amount")
