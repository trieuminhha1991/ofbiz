...
public class TorProductStoreReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "TorProductStoreReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		innerQuery.select("SOF.product_store_dim_id")
			...
			.select("SUM(SOF.total_quantity)", "total_quantity", isFilterDateType)
			.select("SUM(SOF.total_selected_amount)", "total_selected_amount", isFilterDateType)
			.select("SUM(SOF.sub_total_amount)", "sub_total_amount", isFilterDateType)
			.select("SUM(SOF.total_amount)", "total_amount", isFilterDateType)
