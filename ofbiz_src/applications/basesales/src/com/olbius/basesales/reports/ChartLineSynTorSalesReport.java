...
public class ChartLineSynTorSalesReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartLineSynTorSalesReport"); // cache the specific file
		...
		*/
		...
		//if (creatorCond == null) {
			...
			.where(Condition.makeBetween("SOF.date_dim_id", getSqlTime(getFromDate()), getSqlTime(getThruDate()))
						...
						.andIn("SCHAND.enum_id", salesChannelIds, UtilValidate.isNotEmpty(salesChannelIds))
