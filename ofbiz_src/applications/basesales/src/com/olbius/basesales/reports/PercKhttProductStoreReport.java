...
public class PercKhttProductStoreReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "PercKhttProductStoreReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		innerQuery.select("SOF.product_store_dim_id")
			...
			.select("SOF.num_order_khtt", "num_order_khtt", isGrid && !isFilterDateType)
			.select("SUM(SOF.num_order)", "num_order", isFilterDateType)
			.select("SUM(SOF.num_order_khtt)", "num_order_khtt", isFilterDateType)
	...
	public void prepareResultGrid() {
		...
		addDataField("num_order_khtt", "num_order_khtt");
	}
