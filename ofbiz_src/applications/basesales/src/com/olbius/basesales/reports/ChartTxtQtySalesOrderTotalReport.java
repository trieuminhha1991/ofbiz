...
public class ChartTxtQtySalesOrderTotalReport extends OlbiusOlapService {
	...
	public void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
		...
		putParameter("fileName", "ChartTxtQtySalesOrderTotalReport"); // cache the specific file
	...
	private OlbiusQuery init() {
		...
		*/
		...
		//if (creatorCond == null) {
			query.select("SUM(SOF.num_order)", "total_qty_order")
		...
		/*} else {
			...
			query_inner.select("DISTINCT SOF.order_id")
			...
			query.select("COUNT(TOL.order_id)", "total_qty_order").from(query_inner, "TOL");
		}*/
	...
	public void prepareResultGrid() {
		addDataField("total_qty_order", "total_qty_order");
	}
}
