...
public class ExportInventoryCustomerExcelMT extends ExportExcelAbstract {
    ...
    protected void prepareParameters(DispatchContext dctx, Map<String, Object> context) {
        ...
        setHeaderName(UtilProperties.getMessage(RESOURCE, "BSViewInventoryCustomerMT", locale));
        setRunServiceName("JQGetListInventoryCusAndProdMT");
        setModuleExport("SALES");
        setDescriptionExport(UtilProperties.getMessage(RESOURCE, "BSViewInventoryCustomerMT", locale));
        setSplitSheet(false);
