...
public class ProductPromoEvents {
	...
	public static String createProductPromoAdvance(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!SecurityUtil.getOlbiusSecurity(security).olbiusHasPermission(session, null, "MODULE", "PRODPROMOTION_NEW")) {
        ...
        String productPromoTypeId = "SALES_PROMO"; //request.getParameter("productPromoTypeId");
	...
	public static String updateProductPromoAdvance(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!SecurityUtil.getOlbiusSecurity(security).olbiusHasPermission(session, null, "MODULE", "PRODPROMOTION_EDIT")) {
