...
under the License.
-->
  <div class="custom-header2" style="margin-top:10px">${uiLabelMap.WorkEffortAssignedTasks}</div>
    ...
    <table class="table table-striped table-bordered table-hover dataTable" cellspacing="0">
      ...
      <#list roleActivities as workEffort>
        <tr<#if alt_row> class="alternate-row"</#if>>
          ...
          <#-- <td>${workEffort.partyId}</td> -->
          <td>${workEffort.roleTypeId}</td>
          <td><a class="btn btn-primary btn-mini" href="<@ofbizUrl>WorkEffortSummary?workEffortId=${workEffort.workEffortId}</@ofbizUrl>">${workEffort.workEffortName}</a></td>
