...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3 class="header smaller lighter blue">${uiLabelMap.CommonAdvancedSearch}</h3>
  </div>
      ...
      <table class="basic-table" cellspacing="0">
        <tr>
          ...
          <td valign="middle">
            <div>
              ...
              <label>
				 <input type="radio" name="SEARCH_OPERATOR" value="OR" <#if searchOperator == "OR">checked="checked"</#if>/><span class="lbl">${uiLabelMap.CommonAny}</span>
			  </label>
              <label>
				 <input type="radio" name="SEARCH_OPERATOR" value="AND" <#if searchOperator == "AND">checked="checked"</#if>/><span class="lbl">${uiLabelMap.CommonAll}</span>
			  </label>
            </div>
          </td>
        </tr>
            ...
            <div>
              <select name="workEffortAssocTypeId">
                <option value="">- ${uiLabelMap.WorkEffortAnyAssocType} -</option>
                  ...
                  <label>
					 <input type="radio" name="SEARCH_SUB_WORK_EFFORTS" value="Y" checked="checked"/><span class="lbl">${uiLabelMap.CommonYes}</span>
				  </label>
                  <label>
					 <input type="radio" name="SEARCH_SUB_WORK_EFFORTS" value="N"/><span class="lbl">${uiLabelMap.CommonNo}</span>
				  </label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="middle">
            <div>
              ...
              <label>
				 <input type="radio" name="sortAscending" value="Y" checked="checked"/><span class="lbl">${uiLabelMap.ProductLowToHigh}</span>
			  </label>
              <label>
				 <input type="radio" name="sortAscending" value="N"/><span class="lbl">${uiLabelMap.ProductHighToLow}</span>
			  </label>
            </div>
          </td>
        </tr>
        <#if searchConstraintStrings?has_content>
          <tr>
            ...
            <td valign="top">
                ...
                <div>
                  <label>
					 <input type="radio" name="clearSearch" value="Y" checked="checked"/><span class="lbl">${uiLabelMap.ProductNewSearch}</span>
				  </label>
                  <label>
					 <input type="radio" name="clearSearch" value="N"/><span class="lbl">${uiLabelMap.CommonRefineSearch}</span>
				  </label>
                </div>
            </td>
          </tr>
        ...
        <tr>
          <td colspan="2" align="center">
            <div>
              <a href="javascript:document.advToKeyWordSearchForm.submit()" class="btn btn-primary btn-small">${uiLabelMap.CommonFind}</a>
            </div>
          </td>
        </tr>
      </table>
