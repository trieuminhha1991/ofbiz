...
-->
        ...
        <#if workEfforts?has_content>
          ...
          <#list workEfforts as calendarEntry>
            ...
            <tr<#if alt_row> class="alternate-row"</#if>>
              ...
              <td class="button-col"><a class="btn btn-info btn-mini" href="<@ofbizUrl>EditWorkEffort?workEffortId=${workEffort.workEffortId}${addlParam?if_exists}</@ofbizUrl>">${workEffort.workEffortName}</a></td>
            </tr>
  ...
  <#else>
    <div class="widget-body">${uiLabelMap.WorkEffortNoEventsFound}.</div>
  </#if>