            ...
            <#if paymentList?has_content>
                ...
                <table class="table table-hover table-striped table-bordered dataTable">
                    ...
                    <div align="right">
                        ...
                        <button class="btn btn-primary btn-small" id="submitButton" type="button"  onclick="javascript:document.depositWithdrawPaymentsForm.submit();" disabled="disabled">
                        	<i class="icon-ok"></i>
                        	${uiLabelMap.AccountingDepositWithdraw}
                        </button>
                    </div>
                </table>
            <#else>
