...
//listEftAccountsTmp = PaymentWorker.getPartyPaymentMethodValueMaps(delegator, partyId, showOld);
//listEftAccounts = new ArrayList<GenericValue>();
//if (!listEftAccountsTmp.isEmpty()){
//	for (Map<String, GenericValue> map : listEftAccountsTmp){
//		listEftAccounts.add(map.get("eftAccount"));
//	}
//}
//context.listEftAccounts = listEftAccounts;