  ...
  <#if !preContactMechTypeId?has_content>
    ...
    <form method="post" action="<@ofbizUrl>editcontactmech</@ofbizUrl>" name="createcontactmechform">
      ...
      <table class="basic-table" cellspacing="0">
        <tr>
          <td class="olbius-label">${uiLabelMap.PartySelectContactType}</td>
          <td>
            ...
            <a href="javascript:document.createcontactmechform.submit()" class="btn btn-small btn-info icon-ok open-sans">${uiLabelMap.CommonCreate}</a>
          </td>
        </tr>
      </table>
    </form>
...
<#if mechMap.contactMechTypeId?has_content>
          ...
          <td>
            <table class="basic-table" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                <a href="javascript:document.deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}.submit()" class="btn btn-small btn-info open-sans icon-trash">${uiLabelMap.CommonDelete}</a> 
                <a class="btn btn-small btn-info open-sans icon-plus-sign" href="javascript:document.newpurposeform.submit()">${uiLabelMap.PartyAddPurpose}</a></td>
              </tr>
            </table>
          </tr>
      </#if>
  ...
  <#elseif "EMAIL_ADDRESS" = mechMap.contactMechTypeId?if_exists>
    <tr>
      <td class="olbius-label">${mechMap.contactMechType.get("description",locale)}</td>
      <td>
  ...
  <tr>
    <td class="olbius-label">${uiLabelMap.PartyContactAllowSolicitation}?</td>
    <td>
  ...
  <div class="button-bar">
    ...
    <a href="javascript:document.editcontactmechform.submit()" class="btn btn-small btn-info icon-ok open-sans">${uiLabelMap.CommonSave}</a>
  </div>
<#else>
