...
<div class="widget-box no-bottom-border transparent">
  ...
  <div >
        <!--<div class="button-bar">
          <a href="<@ofbizUrl>${donePage}?partyId=${partyId}</@ofbizUrl>" class="btn btn-info btn-small margin-top8 margin-left8 margin-bottom8">${uiLabelMap.CommonCancelDone}</a>
          <a href="javascript:document.editeftaccountform.submit()" class="btn btn-info btn-small margin-top8 margin-left8 margin-bottom8">${uiLabelMap.CommonSave}</a>
        </div>-->
    <#if !eftAccount?exists>
    ...
    <#else>
      <form method="post" action='<@ofbizUrl>updateEftAccount?DONE_PAGE=${donePage}</@ofbizUrl>' name="editeftaccountform" style='margin: 0;'>
        ...
        <table class="basic-table" style="margin-top:30px" cellspacing="0">
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingNameAccount}</td>
          <td>
        ...
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingCompanyNameAccount}</td>
          <td>
            <input type="text" size="30" maxlength="60" name="companyNameOnAccount" value="${eftAccountData.companyNameOnAccount?if_exists}" />
          </td>
        </tr>
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingBankName}</td>
          <td>
        ...
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingRoutingNumber}</td>
          <td>
        ...
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingAccountType}</td>
          <td>
        ...
        <tr>
          <td class="olbius-label">${uiLabelMap.AccountingAccountNumber}</td>
          <td>
        ...
        <tr>
          <td class="olbius-label">${uiLabelMap.PartyBillingAddress}</td>
          <td>
      ...
      <div class="button-bar">
        <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn btn-info btn-small margin-top8 margin-left8 margin-bottom8 icon-remove">${uiLabelMap.CommonCancelDone}</a>
        <a href="javascript:document.editeftaccountform.submit()" class="btn btn-info btn-small margin-top8 margin-left8 margin-bottom8 icon-save">${uiLabelMap.CommonSave}</a>
      	</div>
