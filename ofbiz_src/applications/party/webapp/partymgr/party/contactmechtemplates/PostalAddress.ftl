...
-->
  <div>
    ...
    <#if postalAddress.wardGeoId?has_content>
    	<#assign geoWardName = delegator.findOne("Geo",Static["org.ofbiz.base.util.UtilMisc"].toMap("geoId",postalAddress.wardGeoId),false)>
    	${geoWardName.geoName?if_exists},
    </#if>
     <#if postalAddress.districtGeoId?has_content>
    	<#assign geoDistrictName = delegator.findOne("Geo",Static["org.ofbiz.base.util.UtilMisc"].toMap("geoId",postalAddress.districtGeoId),false)>
    	${geoDistrictName.geoName?if_exists},
    </#if>
