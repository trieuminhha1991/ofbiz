...
<body onload="load()" onunload="GUnload()" >
    <center>
        ...
        <form action="#" onsubmit="showAddress(this.address.value); return false">
            <input type="text" size="50" name="address" class="btn btn-small btn-info open-sans"/>
            <button type="submit">
            <i class="icon-ok">
            </i>
            Search
        ...
        <form id="updateMapForm" method="post" action="<@ofbizUrl>editGeoLocation</@ofbizUrl>">
            ...
            <button type="submit" id="createMapButton" class="btn btn-small btn-info">
            <i class="btn btn-info btn-small">
            </i>
