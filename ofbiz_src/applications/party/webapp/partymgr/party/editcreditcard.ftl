...
<div class="widget-box transparent no-bottom-border">
  ...
  <div >
     <!--   <div class="button-bar">
          ...
          <a href="javascript:document.editcreditcardform.submit()" class="btn btn-info btn-small margin-top8 margin-left8 margin-bottom8">${uiLabelMap.CommonSave}</a>
        </div>-->
    <#if !creditCard?exists>
    ...
    <#else>
      <form method="post" action="<@ofbizUrl>updateCreditCard?DONE_PAGE=${donePage}</@ofbizUrl>" name="editcreditcardform" >
        ...
        <table cellspacing="0" style="margin-top:50px ;margin-left:-150px">

        ${screens.render("component://accounting/widget/CommonScreens.xml#creditCardFields")}
        <tr>
          <td class="olbius-label" style="margin-left: 204px;">${uiLabelMap.AccountingBillingAddress}</td>
          <td width="5">&nbsp;</td>
          <td>
      ...
      <div class="button-bar">
        ...
        <a href="javascript:document.editcreditcardform.submit()" class="icon-save btn btn-info btn-small margin-top8 margin-left8 margin-bottom8">${uiLabelMap.CommonSave}</a>
      </div>
  </div>
</div>
