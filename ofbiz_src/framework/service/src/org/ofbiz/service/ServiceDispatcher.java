...
public class ServiceDispatcher {
        ...
        try {
            ...
            try {
                ...
                if (isError) {
                    ...
                    try {
                        TransactionUtil.rollback(beganTrans, ServiceUtil.getErrorMessage(result), null);
                    ...
                    try {
                        ...
                        throw new GenericServiceException(errMsg, e.getCause());
                    }
                }
    ...
    private Locale checkLocale(Map<String, Object> context) {
        ...
        if (newLocale == null) {
            newLocale = LocaleUtils.getLocale(context);
        }
