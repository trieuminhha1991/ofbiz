    ...
    public static Map<String, Object> purgeOldJobs(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            try {
                ...
                /* TODOCHANGE Olbius imporve code
                ...
                // Olbius
                List<String> listRuntimeDataIdDel = EntityUtil.getFieldListFromEntityList(delegator.findList("RuntimeDataAndJobSandbox", 
                		EntityCondition.makeCondition("jobId", EntityOperator.EQUALS, null), UtilMisc.toSet("runtimeDataId"), null, null, false), "runtimeDataId", true);
                if (UtilValidate.isNotEmpty(listRuntimeDataIdDel)) {
                	runtimeDataToDelete = delegator.findList("RuntimeData", EntityCondition.makeCondition("runtimeDataId", EntityOperator.IN, listRuntimeDataIdDel), null, null, null, false);
                }
                // End Olbius
                ...
                if (UtilValidate.isNotEmpty(runtimeDataToDelete)) delegator.removeAll(runtimeDataToDelete);
            } catch (GenericEntityException e) {
