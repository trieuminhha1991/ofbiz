...
public class GenericDelegator implements Delegator {
     ...
     * added by PQD
     */
    public GenericValue createIgnoreECA(GenericValue value) throws GenericEntityException {
        return this.createIgnoreECA(value, true);
    }
    ...
    /*
     * (non-Javadoc) added by PQD
     * @see org.ofbiz.entity.Delegator#create(org.ofbiz.entity.GenericValue, boolean)
     */
    public GenericValue createIgnoreECA(GenericValue value, boolean doCacheClear) throws GenericEntityException {
        boolean beganTransaction = false;
        try {
            if (alwaysUseTransaction) {
                beganTransaction = TransactionUtil.begin();
    ...
    public int removeValueIgnoreECA(GenericValue value) throws GenericEntityException {
        return this.removeValueIgnoreECA(value, true);
    }
    ...
    public int removeValueIgnoreECA(GenericValue value, boolean doCacheClear) throws GenericEntityException {
        // NOTE: this does not call the GenericDelegator.removeByPrimaryKey method because it has more information to pass to the ECA rule hander
        boolean beganTransaction = false;
        try {
            if (alwaysUseTransaction) {
    ...
    /*
     * added by PQD (non-Javadoc)
     * @see org.ofbiz.entity.Delegator#store(org.ofbiz.entity.GenericValue)
     */
    public int storeIgnoreECA(GenericValue value) throws GenericEntityException {
        return this.storeIgnoreECA(value, true);
    }
     ...
     * @see org.ofbiz.entity.Delegator#store(org.ofbiz.entity.GenericValue, boolean)
     */
    public int storeIgnoreECA(GenericValue value, boolean doCacheClear) throws GenericEntityException {
        boolean beganTransaction = false;
        try {
            if (alwaysUseTransaction) {
                beganTransaction = TransactionUtil.begin();
    ...
    public long findCountByCondition(String entityName, EntityCondition whereEntityCondition,
    	...
    	return findCountByCondition(entityName, whereEntityCondition, havingEntityCondition, null, findOptions);
    }
     ...
     */
    public long findCountByCondition(String entityName, EntityCondition whereEntityCondition,
            EntityCondition havingEntityCondition, Set<String> fieldsToSelect, EntityFindOptions findOptions) throws GenericEntityException {
        ...
        try {
            ...
            ecaRunner.evalRules(EntityEcaHandler.EV_RUN, EntityEcaHandler.OP_FIND, dummyValue, false);
            GenericHelper helper = getEntityHelper(modelEntity.getEntityName());
            long count = helper.findCountByCondition(modelEntity, whereEntityCondition, havingEntityCondition, fieldsToSelect, findOptions);
