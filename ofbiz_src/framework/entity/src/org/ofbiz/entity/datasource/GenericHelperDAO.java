...
public class GenericHelperDAO implements GenericHelper {
     ...
     * (non-Javadoc)
     * @see org.ofbiz.entity.datasource.GenericHelper#findCountByCondition(org.ofbiz.entity.model.ModelEntity, org.ofbiz.entity.condition.EntityCondition, org.ofbiz.entity.condition.EntityCondition, java.util.List, org.ofbiz.entity.util.EntityFindOptions)
     */
    public long findCountByCondition(ModelEntity modelEntity, EntityCondition whereEntityCondition, 
    		EntityCondition havingEntityCondition, Collection<String> fieldsToSelect, EntityFindOptions findOptions) throws GenericEntityException {
    	return genericDAO.selectCountByCondition(modelEntity, whereEntityCondition, havingEntityCondition, fieldsToSelect, findOptions);
    }
