...
public class MemoryHelper implements GenericHelper {
    ...
    public long findCountByCondition(ModelEntity modelEntity, EntityCondition whereEntityCondition, EntityCondition havingEntityCondition, Collection<String> fieldsToSelect, EntityFindOptions findOptions) throws GenericEntityException {
        return 0;
    }
