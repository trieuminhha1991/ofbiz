...
public class GenericEntity implements Map<String, Object>, LocalizedMap<Object>, Serializable, Comparable<GenericEntity>, Cloneable {
    ...
    public GenericPK getPrimaryKey() {
        ...
        GenericPK pk = GenericPK.create(this.getDelegator(), getModelEntity(), this.getFields(pkNames));
        pk.setIsFromEntitySync(this.getIsFromEntitySync());
        return pk;
    }
    ...
    public String toString() {
        ...
        for (String curKey: new TreeSet<String>(fields.keySet())) {
            ...
            if (field != null && field.getEncrypt() && curValue instanceof String) {
