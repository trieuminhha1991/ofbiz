...
public class ConfigXMLReader {
    ...
    //private static final UtilCache<String, ControllerConfig> controllerCache = UtilCache.createUtilCache("webapp.ControllerConfig");
    private static final ConcurrentHashMap<String, ControllerConfig> controllerCache = new ConcurrentHashMap<String, ConfigXMLReader.ControllerConfig>();
    ...
    public static ControllerConfig getControllerConfig(URL url) {
    	...
    	ControllerConfig controllerConfig = controllerCache.get(url.toString());
        //Debug.logInfo("getControllerConfig, url = " + url.toString() + ", controllerConfig = " + controllerConfig, module);
        
        if (controllerConfig == null) {
            //controllerConfig = controllerCache.putIfAbsentAndGet(url, new ControllerConfig(url));
        	//controllerConfig = controllerCache.putIfAbsentAndGet(url.toString(), new ControllerConfig(url));
        	controllerConfig = new ControllerConfig(url);
        	controllerCache.putIfAbsent(url.toString(), controllerConfig);
        	Debug.logInfo("getControllerConfig,  PUT url = " + url.toString() + ", controllerConfig = " + controllerConfig, module);
    ...
    public static class ControllerConfig {
        ...
        public void setViewMapMap(Map<String, ViewMap> viewMapMap) {
			this.viewMapMap = viewMapMap;
		}
    ...
    public static class ViewMap {
        ...
        public ViewMap(Element viewMapElement) {
            ...
            this.contentDisposition = viewMapElement.getAttribute("content-disposition");
            ...
            this.redirectViewName = viewMapElement.getAttribute("redirect-view-name");
