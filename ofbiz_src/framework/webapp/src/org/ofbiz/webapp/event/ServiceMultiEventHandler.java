        ...
        try {
            ...
            if (errorMessages.size() > 0) {
                if (eventGlobalTransaction) {
                    ...
                    try {
                    	// TODO rongnguyen: need to get from configuration
                        TransactionUtil.rollback(beganTrans, "Error in multi-service event handling: " + errorMessages.get(0).toString(), null);
                    } catch (GenericTransactionException e) {
