...
public class UtilFormatOut {
    ...
    /** Formats a String into a properly formatted currency string based on isoCode and Locale
     * @param price The price String to be formatted
     * @param isoCode the currency ISO code
     * @param locale The Locale used to format the number
     * @return A String with the formatted price
     */
    public static String formatCurrency(String price, String isoCode, Locale locale) {
    	BigDecimal priceBigD = BigDecimal.valueOf(Double.parseDouble(price));
        return formatCurrency(priceBigD, isoCode, locale, -1);
    }
