...
public class HttpsClient {
    ...
    /** Creates a new HttpClient object. */
    public HttpsClient(String url, Map<String, Object> parameters) {
        this.url = url;
        this.parameters = parameters;
    }

    /** Creates a new HttpClient object. */
    public HttpsClient(URL url, Map<String, Object> parameters) {
        this.url = url.toExternalForm();
        this.parameters = parameters;
    }

    /** Creates a new HttpClient object. */
    public HttpsClient(String url, Map<String, Object> parameters, Map<String, String> headers) {
        this.url = url;
        this.parameters = parameters;
    ...
    /** Creates a new HttpClient object. */
    public HttpsClient(URL url, Map<String, Object> parameters, Map<String, String> headers) {
        this.url = url.toExternalForm();
        this.parameters = parameters;
        this.headers = headers;
    }
    ...
    /** Invoke HTTPS request GET. */
    public String get() throws HttpClientException {
        return sendHttpsRequest("get");
    }

    /** Invoke HTTPS request GET. */
    public InputStream getStream() throws HttpClientException {
        return sendHttpsRequestStream("get");
    }

    /** Invoke HTTPS request POST. */
    public String post() throws HttpClientException {
        return sendHttpsRequest("post");
    }

    /** Invoke HTTPS request POST and pass raw stream. */
    ...
    public InputStream postStream() throws HttpClientException {
        return sendHttpsRequestStream("post");
    }
    ...
    public String sendHttpsRequest(String method) throws HttpClientException {
        InputStream in = sendHttpsRequestStream(method);
    ...
    private InputStream sendHttpsRequestStream(String method) throws HttpClientException {
        return sendHttpsRequestStream(method, false);
    }

    private InputStream sendHttpsRequestStream(String method, boolean overrideTrust) throws HttpClientException {
        ...
        try {
            ...
            if ((trustAny && !overrideTrust) && (ioe.getCause() instanceof CertificateException)) {
                ...
                return sendHttpsRequestStream(method, true);
            }
