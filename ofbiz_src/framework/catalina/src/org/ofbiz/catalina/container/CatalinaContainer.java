        ...
        if (UtilValidate.isNotEmpty(connectorProp.properties)) {
            ...
            try {
                ...
                if (protocol.equals("ajp")) {
                    connector = new com.olbius.catalina.connector.Connector("org.apache.coyote.ajp.AjpProtocol");
                } else if (protocol.equals("memory")) {
                    connector = new com.olbius.catalina.connector.Connector("org.apache.coyote.memory.MemoryProtocolHandler");
                } else if (protocol.equals("http")) {
                    connector = new com.olbius.catalina.connector.Connector();
