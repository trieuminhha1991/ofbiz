...
<div class="widget-box transparent no-bottom-border">
  <div class="widget-header">
    <h4>${uiLabelMap.WebtoolsCertsX509}</h4>
  </div>
...
-----END PUBLIC KEY HEX-----
    ...
    <#else>
      ...
      <p class="alert alert-info">${uiLabelMap.WebtoolsCertsNotFound}.</p></div>
    </#if>
  <#else>
    <div class="screenlet-body">
    <p class="alert alert-info">${uiLabelMap.WebtoolsCertsRequiresSSL}.</p></div>
  </#if>
</div>