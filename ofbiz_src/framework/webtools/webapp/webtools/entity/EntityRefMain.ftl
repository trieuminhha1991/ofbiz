    ...
    <body>
        ...
        <#list packagesList as package>
            ...
            <#list package.entitiesList as entity>
                <table width="95%" border="1" cellpadding='2' cellspacing='0' class="table table-striped table-hover table-bordered dataTable">
                    <tr class='header-row'>
                        <td colspan="5">
                            ...
                            <div>${entity.title}&nbsp;
                                <#if !forstatic>
                                    <a class="btn btn-mini btn-info" target='main' href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@ofbizUrl>">[${uiLabelMap.WebtoolsViewData}]</a>
                                </#if>
                                <#if !forstatic>
                                    <a class="btn btn-mini btn-info" target='main' href="<@ofbizUrl>ArtifactInfo?name=${entity.entityName}&amp;type=entity</@ofbizUrl>">[${uiLabelMap.WebtoolsArtifactInfo}]</a>
                                </#if>
                            </div>
