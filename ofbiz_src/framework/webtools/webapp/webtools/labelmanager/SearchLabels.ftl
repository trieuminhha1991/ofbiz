...
-->
  <form action="<@ofbizUrl>SearchLabels</@ofbizUrl>" method="post">
    <table class="basic-table" style="">
      <tr><td colspan="4" height="40">${uiLabelMap.WebtoolsLabelManagerTemporarySearchTitle}</td></tr>    
      <tr>
        <td class="olbius-label">
      ...
      <tr>
        ...
        <label style="display:inline;">
          <input type="checkbox" name="onlyNotUsedLabels" value="Y" >
          <span class="lbl"><#if parameters.onlyNotUsedLabels?exists && parameters.onlyNotUsedLabels == "Y">checked="checked"</#if></span>
          </input>
          </label>
        </td>
        <td class="olbius-label">
        ...
        <td>
        <label style="diplay:inline;">
          <input type="checkbox" name="onlyMissingTranslations" value="Y">
          <span class="lbl"><#if parameters.onlyMissingTranslations?exists && parameters.onlyMissingTranslations == "Y">checked="checked"</#if> </span>
          </input>
          </label>
        </td>
      </tr>
      <tr>
        <td colspan="4" height="80" align="center">
          ...
          <#else>
            <button type="submit" name="searchLabels" class="btn btn-purple btn-small">
