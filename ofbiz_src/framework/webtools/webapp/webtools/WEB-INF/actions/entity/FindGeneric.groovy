...
if ("true".equals(find)) {
    ...
    if ((highIndex - lowIndex + 1) > 0) {
        ...
        try {
			...
			efo.setLimit(highIndex - lowIndex + 1);
			efo.setOffset(lowIndex - 1);
			...
			resultPartialList = resultEli.getPartialList(1, highIndex - lowIndex + 1);
            ...
            if (!resultEli.closed) resultEli.close();
