...
<#if parameters.maxElements?has_content><#assign maxElements = parameters.maxElements?number/><#else><#assign maxElements = 10/></#if>
    ...
    <div class="smaller lighter blue"><h4 ${uiLabelMap.WebtoolsThisThread}</h4><h4> ${Static["java.lang.Thread"].currentThread().getName()} (${Static["java.lang.Thread"].currentThread().getId()})</h4></div>
    <br />
    <table class="table table-striped table-hover table-bordered dataTable" cellspacing="0">
      <tr class="header-row">
        <td style="font-weight: bold">${uiLabelMap.WebtoolsGroup}</td>
        <td style="font-weight: bold">${uiLabelMap.WebtoolsThreadId}</td>
        <td style="font-weight: bold">${uiLabelMap.WebtoolsThread}</td>
        <td style="font-weight: bold">${uiLabelMap.CommonStatus}</td>
        <td style="font-weight: bold">${uiLabelMap.WebtoolsPriority}</td>
        <td style="font-weight: bold">${uiLabelMap.WebtoolsDaemon}</td>
      </tr>
