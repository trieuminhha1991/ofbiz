...
<a href="javascript:document.${genericLinkName}.submit();" <#if genericLinkStyle?exists>class="btn btn-info btn-mini margin-top8"</#if>><i class="icon-print"></i> ${genericLinkText}</a>
</form>
</#if>
