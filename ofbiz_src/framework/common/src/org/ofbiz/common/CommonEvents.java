...
public class CommonEvents {
    ...
    public static String setSessionModule(HttpServletRequest request, HttpServletResponse response) {
        String newModule = request.getParameter("newModule");
        if (UtilValidate.isNotEmpty(newModule)) {
            UtilHttp.setModule(request, newModule);
            ...
            if (userLogin != null) {
                GenericValue ulUpdate = GenericValue.create(userLogin);
                ulUpdate.set("lastModule", newModule);
                try {
                    ulUpdate.store();
                    userLogin.refreshFromCache();
                } catch (GenericEntityException e) {
    ...
    public static String setSessionOrg(HttpServletRequest request, HttpServletResponse response) {
        String newOrg = request.getParameter("newOrg");
        if (UtilValidate.isNotEmpty(newOrg)) {
            UtilHttp.setCurrentOrg(request, newOrg);
    ...
    public static String getJSONuiLabelArray(HttpServletRequest request, HttpServletResponse response)
        ...
        writeJSONtoResponse(JSON.from(uiLabelMap), response);
        return "success";
    }
