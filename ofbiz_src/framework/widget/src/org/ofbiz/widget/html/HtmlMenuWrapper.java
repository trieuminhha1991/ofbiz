...
public class HtmlMenuWrapper {
    ...
    public void init(String resourceName, String menuName, HttpServletRequest request, HttpServletResponse response)
        ...
        this.renderer = getMenuRenderer(this.modelMenu.getModelMenuName());
    ...
    public MenuStringRenderer getMenuRenderer(String modelMenu) {
    	ModelMenuEnum mmEnum = ModelMenuEnum.valueOf(modelMenu);
    	return MenuStringRendererFactory.create(request, response, mmEnum);
    }
