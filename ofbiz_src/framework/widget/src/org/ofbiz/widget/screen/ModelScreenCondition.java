...
import com.olbius.widget.screen.condition.IfOlbiusHasPermission;
...
public class ModelScreenCondition implements Serializable {
    ...
    public static ScreenCondition readCondition(ModelScreen modelScreen, Element conditionElement) {
        ...
        if ("and".equals(conditionElement.getNodeName())) {
        	...
        	return new IfOlbiusHasPermission(modelScreen, conditionElement, Application.SCREEN);
        } else if ("if-olbius-entity-permission".equals(conditionElement.getNodeName())) {
        	return new IfOlbiusHasPermission(modelScreen, conditionElement, Application.ENTITY);
        } else {
