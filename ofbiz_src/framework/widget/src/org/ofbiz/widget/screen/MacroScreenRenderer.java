...
import com.olbius.widget.html.HtmlScreenletMenuRenderer;
...
public class MacroScreenRenderer implements ScreenStringRenderer {
    ...
    @Override
    public void renderPortalPageRowBegin(Appendable writer, Map<String, Object> context, ModelScreenWidget.PortalPage portalPage, GenericValue portalPortlet) throws IOException  {
        executeMacro(writer, "renderPortalPageRowBegin", null);
    }
    
    @Override
    public void renderPortalPageRowEnd(Appendable writer, Map<String, Object> context, ModelScreenWidget.PortalPage portalPage, GenericValue portalPortlet) throws IOException  {
        executeMacro(writer, "renderPortalPageRowEnd", null);
    }
    ...
    public void renderScreenletBegin(Appendable writer, Map<String, Object> context, boolean collapsed, ModelScreenWidget.Screenlet screenlet) throws IOException {
        ...
        String fullUrlString = "";
        String menuString = "";
        boolean findOptions = screenlet.hasFindOptions();
        String findOptionsLabel = screenlet.getFindOptionsLabel(context);
        String iconStyle = "";
        ...
        if (UtilValidate.isNotEmpty(title) || navMenu != null || navForm != null || collapsible) {
            ...
            if (navMenu != null) {
                ...
                MenuStringRenderer renderer = new HtmlScreenletMenuRenderer(request, response);
        ...
        if (UtilValidate.isNotEmpty(screenlet.getIconStyle())) {
        	parameters.put("iconStyle", screenlet.getIconStyle());
        }
        ...
        parameters.put("findOptions", findOptions);
        parameters.put("findOptionsLabel", findOptionsLabel);
    ...
    public void renderPortalPageColumnBegin(Appendable writer, Map<String, Object> context, ModelScreenWidget.PortalPage portalPage, GenericValue portalPageColumn) throws GeneralException, IOException {
        ...
        String rowSeqId = ""; //portalPageColumn.getString("rowSeqId");
        String colspan = ""; //portalPageColumn.getString("colspan");
    ...
    public void renderPortalPagePortletBegin(Appendable writer, Map<String, Object> context, ModelScreenWidget.PortalPage portalPage, GenericValue portalPortlet) throws GeneralException, IOException {
        ...
        String rowSeqId = portalPortlet.getString("rowSeqId");
        String col = portalPortlet.getString("colspan");
        String row = portalPortlet.getString("rowspan");
        String confMode = portalPage.getConfMode(context);
		...
		int colspan = Integer.parseInt(col);
            sr.append("\" colspan=\"");
            sr.append(String.valueOf(colspan));
        }
        if(UtilValidate.isNotEmpty(row)){
		int rowspan = Integer.parseInt(row);
            sr.append("\" rowspan=\"");
            sr.append(String.valueOf(rowspan));
        }
