...
public class ModelFormField {
    ...
    protected String widgetStyleRow;
    ...
    public ModelFormField(Element fieldElement, ModelForm modelForm) {
        ...
        this.widgetStyleRow = fieldElement.getAttribute("widget-style-row");
    ...
    public void mergeOverrideModelFormField(ModelFormField overrideFormField) {
        ...
        if (UtilValidate.isNotEmpty(overrideFormField.widgetStyleRow)) this.widgetStyleRow = overrideFormField.widgetStyleRow;
    ...
    public String getWidgetStyleRow() {
        if (UtilValidate.isNotEmpty(this.widgetStyleRow)) return this.widgetStyleRow;
        return this.modelForm.getDefaultWidgetStyle();
    }
    ...
    public void setWidgetStyleRow(String string) {
        this.widgetStyleRow = string;
    }
    ...
    public static class DropDownField extends FieldInfoWithOptions {
        ...
        public DropDownField(Element element, ModelFormField modelFormField) {
            ...
            this.selectedAll = element.getAttribute("selected-all");
