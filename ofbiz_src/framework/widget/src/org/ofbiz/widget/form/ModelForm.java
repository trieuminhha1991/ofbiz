...
public class ModelForm extends ModelWidget {
    ...
    public static String DEFAULT_PAG_STYLE = "dataTables_paginate paging_bootstrap pagination";
    public static String DEFAULT_PAG_FIRST_STYLE = "nav-first";
    public static String DEFAULT_PAG_PREV_STYLE = "prev";
    public static String DEFAULT_PAG_NEXT_STYLE = "next";
...
//                formStringRenderer.renderFormatFieldRowOpen(writer, context, this);
                formStringRenderer.renderFormatFieldRowOpenRow(writer, context, this, currentFormField);
