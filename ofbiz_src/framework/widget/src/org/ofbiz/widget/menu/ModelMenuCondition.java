...
import com.olbius.widget.menu.condition.IfOlbiusHasPermission;
...
public class ModelMenuCondition {
    ...
    public static MenuCondition readCondition(ModelMenuItem modelMenuItem, Element conditionElement) {
        ...
        } else if ("if-olbius-has-permission".equals(conditionElement.getNodeName())) {
            return new IfOlbiusHasPermission(modelMenuItem, conditionElement, Application.MENU);
        } else if ("if-olbius-entity-permission".equals(conditionElement.getNodeName())) {
            return new IfOlbiusHasPermission(modelMenuItem, conditionElement, Application.ENTITY);
        } else {
