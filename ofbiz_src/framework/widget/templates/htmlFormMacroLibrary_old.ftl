        ...
        <#else>
			...
			tmpOlFlag = false;
				...
				arrKeysData = columnList.split(";")
                    ...
                    if (urlStatus && !(/^\s*$/.test(urlStatus))) {
                        Grid.updateRow(urlStatus, data, commit);
                    }
                    <#else>
			...
			if(i != 0){
                ...
                deleterow: function (rowid, commit) {
                    ...
                    data += tmpValue;
                    Grid.deleteRow("${removeUrl}", data, commit);
                    <#else>
                        var local = {};
                        ...
                        <#if filterable=="true">
                            if (data.filterscount) {
                                ...
                                for (var i = 0; i < data.filterscount; i++) {
                                    ...
                                    if(getFieldType(${dataField}, filterDataField)=='number'){
                        ...
                        (function(){
                            ...
                            <#if offlinerefreshbutton == "true">
                                ...
                                obj.on('click', function () {
                                   ...
                                   if(remainupdate){
					 Grid.updateRow(urlStatus, {data:remainupdate});
                                   }
                                   if(datadelete){
					Grid.deleteRow("${removeUrl}",{data:datadelete});
                                    }
                                    $('#${id}').jqxGrid('updatebounddata');
                                });
                            </#if>
