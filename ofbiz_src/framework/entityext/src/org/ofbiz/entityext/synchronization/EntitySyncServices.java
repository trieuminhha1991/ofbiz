        ...
        try {
            ...
            for (GenericValue valueToCreate : valuesToCreate) {
                ...
                if (existingValue == null) {
                    ...
                    if (existingValue.get(ModelEntity.CREATE_STAMP_FIELD) != null && existingValue.getTimestamp(ModelEntity.CREATE_STAMP_FIELD).after(valueToCreate.getTimestamp(ModelEntity.CREATE_STAMP_FIELD))) {
                        String entityName = valueToCreate.getEntityName();
                        if ("PartyRelationship".equals(entityName) || "Party".equals(entityName) 
                        		|| "PartyRole".equals(entityName) || "Person".equals(entityName)
                        		|| "PartyGroup".equals(entityName) || "UserLogin".equals(entityName)
                        		|| "OlbiusPartyPermission".equals(entityName) || "UserLoginSecurityGroup".equals(entityName)) {
